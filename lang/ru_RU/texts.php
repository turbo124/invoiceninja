...
Успешно созданы  :count_vendors Поставщик(и) и  :count_expenses и расход(ы)',
 ...
 Получив необходимые суммы, вернитесь к страницу «Способы Платеж и нажмите «Завершить проверку» рядом к нужным счетом.',
    ...
    'refund_without_invoices' => 'При к вернуть Платеж с прикрепленным <span class=\'notranslate\'>Счет а</span> , пожалуйста, укажите действительный Счет , к возврату.',
    ...
    'activity_147' => 'E- Счет :invoice для :client не удалось доставить. :примечания',
