...
<li> « Paiement d&#39;acompte pour :QUARTER +1 » &gt;&gt; « Paiement d&#39;acompte pour le T2 »</li>
    ...
    'no_passkeys_registered' => 'Aucun mot de passe n&#39;est enregistré pour ce compte. Veuillez vous connecter avec un mot de passe ou enregistrer un mot de passe.',
    ...
    'trial_card_authorization_notice' => 'Aucun paiement ne sera prélevé aujourd&#39;hui. Une autorisation temporaire de 1 $ sera effectuée sur votre carte de crédit et levée immédiatement après vérification. Votre banque pourrait brièvement afficher la mention « en attente ». À la fin de la période d&#39;essai de 14 jours, votre carte sera débitée de 14 $/mois. Annulation possible à tout moment.',
    'trial_card_verification_failed' => 'Nous n&#39;avons pas pu vérifier cette carte de crédit. Aucun débit n&#39;a été effectué. Veuillez utiliser une carte de crédit valide avec un solde disponible d&#39;au moins 1 $.',
    'trial_credit_card_required' => 'Seules les cartes de crédit sont acceptées. Les cartes de débit, prépayées et non classées ne sont pas acceptées. Aucun débit n&#39;a été effectué.',
    'trial_card_gateway_error' => 'Nous n&#39;avons pas pu contacter l&#39;émetteur de votre carte. Aucun débit n&#39;a été effectué. Veuillez réessayer.',
    'trial_card_release_failed' => 'Votre carte a été autorisée, mais nous n&#39;avons pas pu confirmer la levée de l&#39;autorisation temporaire. Votre période d&#39;essai n&#39;a pas commencé. Veuillez réessayer plus tard ou contacter l&#39;assistance.',
    'trial_verification_in_progress' => 'La vérification de votre carte est en cours. Veuillez patienter quelques instants et réessayer.',
    'trial_no_longer_available' => 'Ce compte n&#39;est plus éligible à l&#39;essai gratuit.',
    'overdue' => 'En retard',
    ...
    'remove' => 'Retirer',
    'remove_failed_upload' => 'Supprimer le téléchargement échoué',
...
Lorsque les montant apparaîtront sur votre relevé, veuillez revenir sur cette page et cliquez sur "Compléter la vérification" à côté du compte.',
    ...
    'preparing_canonical_pdf' => 'Préparation du PDF canonique',
    'preparing_server_preview' => 'Préparation de l&#39;aperçu du serveur',
    'processing' => 'En cours',
    ...
    'applied' => 'Appliqué',
    'applied_date' => 'Date de la demande',
    'applied_amount' => 'Montant appliqué',
    'applied_refunded' => 'Demande remboursée',
    ...
    'invoice_not_related_to_payment' => 'La facture n° :invoice n&#39;est pas liée à ce paiement.',
    'credit_not_related_to_payment' => 'Le crédit n° :credit n&#39;est pas lié à ce paiement.',
    ...
    'notification_invoice_overdue_subject' => 'La facture :invoice est en retard de paiement pour :client',
    'notification_invoice_overdue' => 'La facture suivante :invoice pour les clients :client et :amount est maintenant en retard.',
    'auto_sync' => 'Auto Sync',
    ...
    'payments_by_month' => 'Paiements mensuels',
    'monthly_breakdown_skipped' => 'Ventilation mensuelle omise : la période étudiée dépasse 24 mois.',
    ...
    'taxable_sales' => 'Ventes taxables',
    'exempt_sales' => 'Ventes exemptées',
    'non_taxable_sales' => 'Ventes non imposables',
    'zero_rated_sales' => 'Ventes à taux zéro',
    'accounting_basis' => 'Base comptable',
    'tax_treatment' => 'Traitement fiscal',
    'summary_source' => 'Source du résumé',
    'sales_breakdown_source' => 'Répartition des ventes',
    'legacy_tax_detail_source' => 'Détails fiscaux hérités',
    'monthly_filing_summary' => 'Résumé des dépôts mensuels',
    'filing_overview' => 'Aperçu du dépôt',
    'jurisdiction_breakdown' => 'Répartition des juridictions',
    'state_breakdown' => 'Répartition par État',
    'filing_period' => 'Période de dépôt',
    'period_start' => 'Début des règles',
    'period_end' => 'Fin de période',
    'jurisdiction_source' => 'Source de juridiction',
    'tax_data_source' => 'Données fiscales',
    'client_shipping_source' => 'Adresse de livraison du client',
    'client_billing_source' => 'Adresse de facturation du client',
    'tax_detail_source' => 'Détails fiscaux Code postal',
    'unknown_source' => 'Source inconnue',
    'district' => 'Canton',
    'metric' => 'Métrique',
    'report_period' => 'Période de rapport',
    'current_filing_rows' => 'Lignes de classement actuelles',
    'correction_rows' => 'Lignes de correction',
    'states_reported' => 'États ayant signalé',
    'jurisdictions_reported' => 'Juridictions signalées',
    'rows_missing_state' => 'Rangées État manquant',
    'rows_using_client_fallback' => 'Lignes utilisant le repli client',
    'prior_period_corrections' => 'Corrections de la période précédente',
    'corrections_review' => 'Examen des corrections',
    'original_tax_period' => 'Période fiscale initiale',
    'correction_recorded_period' => 'Période d&#39;enregistrement de la correction',
    'correction_type' => 'Type de correction',
    'requires_review' => 'Nécessite une révision',
    'current_period_activity' => 'Activité de la période actuelle',
    'invoice_correction' => 'Correction de facture',
    'payment_correction' => 'Correction de paiement',
    'status_correction' => 'Correction de statut',
    'legacy_unknown' => 'Héritage inconnu',
    'tax_summary' => 'Récapitulatif fiscal',
    'reporting_bucket' => 'Compartiment de signalement',
    ...
    'payment_expired' => 'Le paiement a expiré. Veuillez réessayer.',
    'payment_was_not_completed' => 'Le paiement n&#39;a pas pu être effectué. Veuillez réessayer.',
    'no_compatible_app_installed' => 'Si rien ne se passe, il se peut que vous n&#39;ayez pas d&#39;application compatible installée.',
    'payment_type_Mobile Payment' => 'Paiement mobile',
    'gateway_temporarily_unavailable' => 'Ce mode de paiement est temporairement indisponible. Veuillez réessayer plus tard ou choisir un autre mode de paiement.',
    'mybank' => 'Ma banque',
    ...
    'end_all_sessions_help' => 'Déconnecte tous les utilisateurs et exige une réauthentification.',
    ...
    'peppol_credits_info' => 'Des crédits électroniques sont nécessaires pour envoyer et recevoir des factures électroniques. Ces crédits sont facturés par document. Si vous disposez déjà de crédits, cliquez sur Continuer.',
    ...
    'peppol_negative_line_price' => 'Les prix des articles ne peuvent pas être négatifs pour la facturation électronique. Veuillez saisir un prix positif et appliquer toute réduction sous forme de remise ou de quantité négative.',
    ...
    'downgrade_to_free_description' => 'Cela supprimera toutes les fonctionnalités payantes de votre compte.',
    ...
    'docuninja_grant_access_help' => 'Accorder aux utilisateurs d&#39;Invoice Ninja l&#39;accès à DocuNinja',
    ...
    'ses_region_help' => 'La région AWS, c&#39;est-à-dire us-east-1',
    'ses_secret_key' => 'Clé secrète SES',
    'ses_access_key' => 'ID de clé d&#39;accès SES',
    'lifecycle' => 'Cycle de vie',
    'order_columns' => 'Colonnes d&#39;ordre',
    'topic_arn' => 'Sujet ARN',
    'lang_Catalan' => 'catalan',
    'lang_Afrikaans' => 'afrikaans',
    'lang_Indonesian' => 'indonésien',
    'replaced' => 'Remplacé',
    'ses_from_address' => 'SES Adresse de départ',
    'ses_from_address_help' => 'L&#39;adresse e-mail d&#39;envoi doit être vérifiée dans AWS.',
    'unauthorized_action' => 'Vous n&#39;êtes pas autorisé à effectuer cette action',
    'einvoice_received_subject' => 'Facture(s) électronique(s) reçue(s)',
    'einvoice_received_body' => 'Vous avez reçu la/les nouvelle(s) facture(s) électronique(s) :count .<br><br> Connectez-vous pour consulter.',
    'download_files_too_large' => 'Certains fichiers étaient trop volumineux pour être joints directement à l&#39;e-mail. Veuillez utiliser les liens ci-dessous pour les télécharger individuellement.',
    'restore_disabled_verifactu' => 'Il est impossible de restaurer une facture une fois qu&#39;elle a été supprimée.',
    'delete_disabled_verifactu' => 'Vous ne pouvez pas supprimer une facture une fois qu&#39;elle a été annulée ou modifiée.',
    'rectify' => 'Rectificar',
    'verifactu_invoice_send_success' => 'Facture :invoice pour :client envoyée avec succès à AEAT',
    'verifactu_invoice_sent_failure' => 'La facture :invoice relative à :client n&#39;a pas pu être envoyée à AEAT :notes',
    'verifactu_cancellation_send_success' => 'Annulation de la facture :invoice envoyée avec succès à AEAT',
    'verifactu_cancellation_send_failure' => 'L&#39;annulation de la facture :invoice n&#39;a pas pu être envoyée à AEAT :notes',
    'verifactu' => 'Vérifactu',
    'justify' => 'Justifier',
    'outdent' => 'Outdent',
    'indent' => 'Retrait',
    'clear_filters' => 'Filtres transparents',
    'feedback' => 'Retour',
    'feedback_modal_description' => 'Nous serions ravis d&#39;avoir vos commentaires !',
    'do_not_ask_again' => 'Ne posez plus la question',
    'not_likely' => 'Peu probable',
    'extremely_likely' => 'Extrêmement probable',
    'feedback_slider_title' => 'Quelle est la probabilité que vous recommandiez Invoice Ninja à un ami ou un collègue ?',
    'actual_delivery_date' => 'Date de livraison réelle',
    'actual_delivery_date_help' => 'Parfois requis pour la facturation transfrontalière. Indique la date EXACTE de livraison des marchandises.',
    'invoice_period' => 'Période de facturation',
    'invoice_period_help' => 'Définit la période pendant laquelle les services ont été fournis.',
    'paused_recurring_invoice_helper' => 'Attention ! Lors de la réactivation d&#39;une facture récurrente, assurez-vous que la prochaine date d&#39;envoi soit ultérieure.',
    'thank_you_for_feedback' => 'Merci pour vos commentaires !',
    'use_legacy_editor' => 'Utiliser l&#39;éditeur WYSIWYG hérité',
    'use_legacy_editor_help' => 'Utilisez l&#39;éditeur TinyMCE.',
    'enable_e_invoice_received_notification' => 'Activer la notification de réception des factures électroniques',
    'enable_e_invoice_received_notification_help' => 'Vous recevrez une notification par courriel lors de la réception d&#39;une nouvelle facture électronique.',
    'price_changes' => 'Changements de prix des forfaits à compter du 1er janvier 2026',
    'notification_quote_rejected_subject' => 'La requête :quote a été rejetée par :client',
    'notification_quote_rejected' => 'Le client suivant :client a rejeté le devis :quote pour :amount :notes .',
    ...
    'activity_154' => 'Facture électronique :invoice pour :client envoyée avec succès à AEAT',
    'activity_155' => 'La facture électronique :invoice relative à :client n&#39;a pas pu être envoyée à AEAT :notes',
    'activity_156' => 'Annulation de la facture :invoice envoyée avec succès à AEAT',
    'activity_157' => 'L&#39;annulation de la facture :invoice n&#39;a pas pu être envoyée à AEAT :notes',
    'activity_158' => 'La requête :quote a été rejetée par :client :notes',
    'quotes_with_status_sent_can_be_rejected' => 'Seuls les devis ayant le statut « Envoyé » peuvent être rejetés.',
    'reject' => 'Rejeter',
    'rejected' => 'Rejeté',
    'reject_quote' => 'Rejeter le devis',
    'reject_quote_confirmation' => 'Êtes-vous sûr de vouloir rejeter cette citation ?',
    'reason' => 'Raison',
    'enter_reason' => 'Veuillez saisir une raison...',
    ...
    'purge_user_confirmation' => 'Attention ! Cette action réattribuera toutes les entités au propriétaire du compte et supprimera définitivement l’utilisateur de toutes les sociétés et de tous les comptes. Voulez-vous vraiment continuer ?',
    'peppol_sending_failed' => 'L&#39;envoi de la facture électronique a échoué !',
    'peppol_sending_success' => 'Facture électronique envoyée avec succès !',
    'auto_generate' => 'Génération automatique',
    'mollie_payment_pending' => 'Votre paiement est en attente. Veuillez patienter le temps qu&#39;il soit traité. Nous vous enverrons un courriel dès qu&#39;il sera effectué.',
    'over_payment_helper' => 'Facultatif : vous pouvez payer plus que le montant indiqué (par exemple, un pourboire ou un arrondi).',
    'new_resource' => 'Nouvelle ressource',
    'drop_your_logo_here' => 'Déposez votre logo ici ou cliquez pour parcourir',
    'save_to_enable_health_check' => 'Un contrôle de santé sera disponible après l&#39;enregistrement des modifications de la passerelle.',
    'audit_log' => 'Journal d&#39;audit',
    'clone_to_template' => 'Cloner le modèle',
    'clone_document_description' => 'Cloner dans un nouveau document',
    'add_signatories' => 'Ajouter des signataires',
    'authorized_to_sign' => 'Autorisé à signer',
    'ninja_quote_notification' => 'Notification signée de devis',
    'ninja_invoice_notification' => 'Avis de signature de facture',
    'ninja_credit_notification' => 'Avis de crédit signé',
    'ninja_purchase_order_notification' => 'Avis de signature du bon de commande',
    'email_client_when_quote_signed_description' => 'Client de messagerie lorsque le devis est signé',
    'email_client_when_invoice_signed_description' => 'Client de messagerie lors de la signature de la facture',
    'email_client_when_credit_signed_description' => 'Client de messagerie lorsque le crédit est signé',
    'email_vendor_when_purchase_order_signed_description' => 'Envoyer un courriel au fournisseur lorsque le bon de commande est signé',
    'custom_document_completed' => 'Document personnalisé complété',
    'email_client_when_custom_document_completed' => 'Client de messagerie lorsqu&#39;un document personnalisé a été signé',
    'sender' => 'Expéditeur',
    ...
    'document_type_description' => 'Sélectionnez le type de document pour configurer les signatures sur',
    'new_signatory' => 'Nouveau signataire',
    'signatory' => 'Signataire',
    'invoice_ninja_template_description' => 'Personnalisez l&#39;emplacement des signatures sur les documents Invoice Ninja tels que les factures, les devis, etc.',
    'activity_159' => 'La facture :invoice pour :client a été signée',
    'activity_160' => 'Le devis :quote pour :client a été signé',
    'activity_161' => 'Le crédit :credit pour :client a été signé',
    'activity_162' => 'Le bon de commande :purchase_order pour :vendor a été signé.',
    'activity_163' => 'Document personnalisé : le document pour :client a été signé',
    'activity_164' => 'La synchronisation QuickBooks a échoué. :notes',
    'activity_165' => 'Synchronisation QuickBooks réussie. :notes',
    'create_your_own' => 'Créez le vôtre',
    'create_your_own_description' => 'Créez votre propre modèle en utilisant votre propre document PDF à télécharger',
    'new_template_description' => 'Choisissez l&#39;un de nos modèles prédéfinis pour commencer, par exemple un accord de confidentialité, un contrat de vente, etc.',
    'choose_template_type' => 'Sélectionnez le type de modèle que vous souhaitez créer',
    'template' => 'Modèle',
    'templates' => 'Modèles',
    'new_template' => 'Nouveau modèle',
    'user_limit_reached' => 'Besoin de plus d&#39;utilisateurs ? Passez à un forfait supérieur !',
    'requires_approval' => 'Nécessite une approbation',
    'document_viewed_notification' => 'Notifications de consultation de documents',
    'document_created_notification' => 'Notifications de création de document',
    'document_sent_notification' => 'Notifications d&#39;envoi de documents',
    'document_signed_notification' => 'Notifications signées de documents',
    'document_completed_notification' => 'Notifications de documents complétés',
    'document_rejected_notification' => 'Notifications de rejet de document',
    'document_voided_notification' => 'Notifications d&#39;annulation de document',
    'document_expired_notification' => 'Notifications d&#39;expiration de documents',
    'document_created' => 'Document créé',
    'template_loaded' => 'Modèle chargé',
    'select_user_or_client' => 'Sélectionnez Utilisateur ou Client',
    'docuninja_quota_available_but_no_users' => 'Ajoutez d&#39;abord un utilisateur à Invoice Ninja, puis accordez-lui l&#39;accès à DocuNinja ici.',
    'send_confirmation' => 'Envoyer la confirmation',
    'send_emails_to_following' => 'Nous allons envoyer des courriels aux personnes suivantes :',
    'document_queued_for_sending' => 'Document en attente d&#39;envoi',
    'document_voided' => 'Document annulé',
    'view_document' => 'Consulter le document',
    'make_template' => 'Créer un modèle',
    'use_template' => 'Utiliser le modèle',
    'map_signatories' => 'Signataires de la carte',
    'map_signatories_instructions' => 'Attribuer les signataires au modèle',
    'total_signatories' => 'Nombre total de signataires',
    'mapped' => 'Cartographié',
    'docuninja_splash_message' => 'Chargement de DocuNinja...',
    'docuninja_contact_admin_for_access' => 'Contactez votre administrateur pour obtenir l&#39;accès à DocuNinja.',
    'void' => 'Vide',
    'invitation_signatory_help' => 'Les documents sont signés séquentiellement ; après la signature du premier signataire, le signataire suivant pourra signer.',
    'timeline' => 'Chronologie',
    'cloned_document' => 'Document cloné',
    'voided_document' => 'Document annulé',
    'voided' => 'Vidé',
    'archive_document_description' => 'Êtes-vous sûr de vouloir archiver ce document ?',
    'restore_document_description' => 'Êtes-vous sûr de vouloir restaurer ce document ?',
    'delete_document_description' => 'Êtes-vous sûr de vouloir supprimer ce document ?',
    'document_archived' => 'Document archivé',
    'document_restored' => 'Document restauré',
    'document_deleted' => 'Document supprimé',
    'sign_now' => 'Inscrivez-vous maintenant',
    'signed_document' => 'Document signé',
    'tour_document_upload' => 'Pour commencer la signature, téléchargez votre document ici. Glissez-déposez vos fichiers dans cette zone.',
    'tour_signatory_selector' => 'Voici le sélecteur de signataires. Utilisez-le pour gérer les signataires de votre document. Sélectionnez un signataire pour continuer.',
    'tour_continue_select_signatory' => 'Poursuivez en sélectionnant un signataire.',
    ...
    'tour_document_canvas' => 'Ceci est votre zone de travail. Placez et positionnez ici les champs pour vos signataires.',
    'tour_save_document' => 'Lorsque vous aurez terminé, cliquez ici pour enregistrer votre document.',
    'create_signature' => 'Créer une signature',
    'signature_name' => 'Nom de la signature',
    'close_tab' => 'Fermer l&#39;onglet',
    'sign' => 'Signe',
    'add_open_exchange' => 'Ajouter une clé Open Exchange',
    'all_entity_types_created' => 'Tous les types d&#39;entités ont été créés.',
    'amount_must_be_greater_than_zero' => 'Le montant doit être supérieur à zéro',
    'autobill_failure' => 'Échec de la facturation automatique',
    'autobill_success' => 'Facturation automatique réussie',
    'available' => 'Disponible',
    'blueprint' => 'Plan',
    'capabilities' => 'Capacités',
    'card_holder_help' => 'Nom du titulaire de la carte',
    'cards' => 'Cartes',
    'charts' => 'Graphiques',
    'company_logo' => 'Logo de l&#39;entreprise',
    'create_client_or_user' => 'Créer un client ou un utilisateur',
    'create_docuninja_account' => 'Créer un compte DocuNinja',
    'create_recurring_expense' => 'Créer une dépense récurrente',
    'create_recurring_invoice' => 'Créer une facture récurrente',
    'create_recurring_quote' => 'Créer un devis récurrent',
    'create_subscription' => 'Créer un abonnement',
    'create_user' => 'Créer un utilisateur',
    'created' => 'Créé',
    'creating' => 'Création',
    'credit_signed_notification' => 'Avis de crédit signé',
    'customize_cards' => 'Personnaliser les cartes',
    'datatable' => 'Tableau de données',
    'date_must_be_after_previous_schedule' => 'La date doit être postérieure à l&#39;horaire précédent',
    'default_checkbox_label' => 'Case à cocher par défaut',
    'default_multiselect_label' => 'Sélection multiple par défaut',
    'default_radio_group_label' => 'Groupe radio par défaut',
    ...
    'delete_docuninja_document_confirmation' => 'Êtes-vous sûr de vouloir supprimer ce fichier du document ?',
    ...
    'docuninja_access_granted_successfully' => 'Accès à DocuNinja accordé avec succès',
    'download_signed_document' => 'Télécharger le document signé',
    'e_expense_created' => 'Création de la dépense électronique',
    'edit_rule' => 'Règle de modification',
    'einvoice_delivery_failure' => 'La livraison de la facture électronique a échoué.',
    'einvoice_delivery_success' => 'Succès de la livraison des factures électroniques',
    'einvoice_sent' => 'Facture électronique envoyée',
    'element' => 'Élément',
    'email_invoice_failed' => 'L&#39;envoi de l&#39;e-mail a échoué.',
    'empty_checkbox_label' => 'Case à cocher vide',
    'end_of_month' => 'Fin du mois',
    'error_fetching_pricing' => 'Erreur lors de la récupération des prix',
    'exchange_rate_not_enabled' => 'Taux de change non activé',
    'failed_payment' => 'Échec du paiement',
    'field_is_required' => 'Ce champ est obligatoire.',
    'generate' => 'Générer',
    'google_drive' => 'Google Drive',
    'initials' => 'Initiales',
    'initials_description' => 'Description des initiales',
    'invalid_state' => 'État invalide',
    'invoice_signed_notification' => 'Avis de signature de facture',
    'link_copied' => 'Lien copié',
    'make_template_description' => 'Créez votre propre modèle en utilisant votre propre document PDF à télécharger',
    'manage' => 'Gérer',
    'multiselect_needs_two_options' => 'La sélection multiple nécessite deux options',
    'no_cards_selected' => 'Aucune carte sélectionnée',
    'no_templates_found' => 'Aucun modèle trouvé',
    'nordigen' => 'Nordique',
    'pages' => 'Pages',
    'passed' => 'Passé',
    'payment_emailed' => 'Paiement par courriel',
    'payment_successful' => 'Paiement réussi',
    'pdf_password_required' => 'Mot de passe PDF requis',
    'pending_approval' => 'En attente d&#39;approbation',
    'pending_file' => 'Fichier en attente',
    ...
    'please_select_signer' => 'Veuillez sélectionner un signataire',
    'proformal_invoices' => 'Factures pro forma',
    'purchase_order_signed_notification' => 'notification signée du bon de commande',
    'queue' => 'File d&#39;attente',
    'quote_field' => 'Champ de citation',
    'quote_signed_notification' => 'Citation signée notification',
    'radio_needs_two_options' => 'La radio a besoin de deux options',
    'recipient' => 'Destinataire',
    'redirect' => 'Réorienter',
    'refundable' => 'Remboursable',
    'remove_invitations' => 'Supprimer les invitations',
    'removing' => 'Suppression',
    'requirements' => 'Exigences',
    'restore_subscription' => 'Rétablir l&#39;abonnement',
    'sales_above_threshold' => 'Ventes supérieures au seuil',
    'save_to_add_locations' => 'Enregistrer pour ajouter des emplacements',
    'saving' => 'Économie',
    'select_design' => 'Sélectionner le modèle',
    'select_needs_two_options' => 'La sélection nécessite deux options',
    'sending' => 'Envoi',
    'setting_up' => 'Configuration',
    'setup_company' => 'Société de création',
    'signature-placeholder' => 'Emplacement réservé à la signature',
    'signature:font-updated' => 'Police de signature mise à jour',
    'signature_description' => 'Description de la signature',
    'snappdf_not_enabled' => 'Snappdf non activé',
    'start_signing' => 'Commencez à signer',
    'successfully_signed_document' => 'Document signé avec succès',
    'swap_signatory' => 'Signataire de l&#39;échange',
    'template_details' => 'Détails du modèle',
    'tips_and_notes' => 'Conseils et notes',
    'too_many_files' => 'Trop de fichiers',
    'type_signature' => 'Signature du type',
    'untitled_document' => 'Document sans titre',
    'untitled_template' => 'Modèle sans titre',
    'update_recurring_expense' => 'Mise à jour des dépenses récurrentes',
    'update_recurring_invoice' => 'Mise à jour de la facture récurrente',
    'update_recurring_quote' => 'Mise à jour du devis récurrent',
    'update_subscription' => 'Mettre à jour son abonnement',
    'update_user' => 'Mise à jour de l&#39;utilisateur',
    'upgrade_account_message' => 'Message de mise à niveau du compte',
    'upgrade_now' => 'Mettez à niveau maintenant',
    'upgrade_plan_docuninja' => 'Passez à un forfait supérieur pour activer DocuNinja',
    'use_signature' => 'Utiliser la signature',
    'use_snappdf' => 'Utilisez snappdf',
    'user_note' => 'Note de l&#39;utilisateur',
    'vendor_notification_email' => 'Courriel de notification au fournisseur',
    'void_document_description' => 'Description du document vide',
    'voided_payment' => 'Paiement annulé',
    'welcome_to_docuninja' => 'Bienvenue sur DocuNinja',
    'yodlee' => 'Yodlee',
    'location_name' => 'Nom du lieu',
    'quote_rejected' => 'Devis refusé',
    'e_invoice_received_notification' => 'Notification de réception de la facture électronique',
    'e_invoice_received_notification_help' => 'Envoyer un courriel lorsqu&#39;une facture électronique a été reçue',
    ...
    'purged_user' => 'Utilisateur supprimé avec succès',
    'quickbooks_connect_description' => 'Connectez votre compte QuickBooks à Invoice Ninja pour synchroniser automatiquement vos transactions et vos factures.',
    'sync_direction_description' => 'Ces paramètres déterminent comment Invoice Ninja se synchronisera avec QuickBooks.',
    'sync_direction_none_help' => 'Invoice Ninja ne synchronisera aucune donnée avec QuickBooks.',
    'sync_direction_pull_help' => 'Invoice Ninja extraira les données de QuickBooks.',
    'sync_direction_push_help' => 'Invoice Ninja enverra les données à QuickBooks.',
    'sync_direction_bidirectional_help' => 'Invoice Ninja permet à la fois d&#39;extraire et d&#39;importer des données dans QuickBooks.',
    'sync_settings' => 'Paramètres de synchronisation',
    'realm_id' => 'ID du domaine QB',
    'default_income_account' => 'Compte de revenu par défaut',
    'automatic_taxes' => 'Impôts automatiques',
    'automatic_taxes_help' => 'Lorsque les taxes automatiques (AST) sont activées dans QuickBooks, Invoice Ninja crée d&#39;abord la facture dans QuickBooks, puis récupère la facture complète dans Invoice Ninja.',
    'pull' => 'Tirer',
    'push' => 'Pousser',
    'bidirectional' => 'Bidirectionnel',
    'sync_started' => 'La synchronisation a commencé.',
    'quickbooks_read_only_data' => 'Comptes de revenus et taux d&#39;imposition enregistrés dans QuickBooks',
    'hide_peppol_sent_status' => 'Masquer Peppol Statut envoyé',
    'quickbooks_requires_reauth' => 'QuickBooks exige une réauthentification',
    'quickbooks_requires_reauth_body' => 'Votre connexion QuickBooks a expiré et nécessite une nouvelle authentification. Veuillez vous connecter au portail d&#39;administration et reconnecter votre compte QuickBooks. Nous vous enverrons cette notification quotidiennement jusqu&#39;à ce que ce problème soit résolu.',
    'crop_logo' => 'Logo recadré',
    'passkey' => 'Clé d&#39;accès',
    'login_with_passkey' => 'Se connecter avec un mot de passe',
    'manage_passkeys' => 'Gérer les clés d&#39;accès',
    'last_used' => 'Dernière utilisation',
    'unapplied_payments' => 'Paiements non appliqués',
    'debit' => 'Débit',
    'auto_convert_credit_help' => 'Associez ou créez automatiquement un paiement correspondant à ces règles.',
    'clone_client_description' => 'Cela permettra de cloner le client dans un nouvel enregistrement client.',
    'invalid_id_number_format' => 'Format de numéro d&#39;identification invalide',
    'invalid_vat_number_format' => 'Format de numéro de TVA invalide',
    'invalid_routing_id_format' => 'Format d&#39;identifiant de routage invalide',
    'invalid_id_number_checkdigit' => 'Numéro d&#39;identification invalide : erreur de chiffre de contrôle. Veuillez vérifier que le numéro est correct.',
    'invalid_vat_number_checkdigit' => 'Numéro de TVA invalide : erreur de chiffrement. Veuillez vérifier que le numéro est correct.',
    'invalid_routing_id_checkdigit' => 'Identifiant de routage invalide : erreur de chiffre de contrôle. Veuillez vérifier que le numéro est correct.',
    'sign_the_document' => 'Signez le document',
    ...
    'custom_text_with_formatting' => 'Texte personnalisé avec mise en forme',
    'client_name_and_address' => 'Nom et adresse du client',
    'bill_to' => 'Facturer à:',
    'entity_details' => 'Numéro, date, date d&#39;échéance, montant, solde',
    'product_line_items_with_columns' => 'Articles de gamme de produits avec colonnes',
    'task_line_items_with_columns' => 'Éléments de ligne de tâche avec colonnes',
    'divider_line' => 'Séparateur horizontal',
    'signature_line' => 'Zone de signature',
    'authorized_signature' => 'Signature autorisée',
    'essential' => 'Essentiel',
    'public_notes_will_appear_here' => 'Les notes publiques apparaîtront ici',
    'footer_will_appear_here' => 'Le pied de page apparaîtra ici.',
    'terms_will_appear_here' => 'Les conditions apparaîtront ici.',
    'sepa_qr' => 'SEPA QR',
    'swiss_qr' => 'QR suisse',
    'spc_qr' => 'SPC QR',
    'verifactu_qr' => 'Vérification QR',
    'payment_qr' => 'QR code de paiement',
    'download_json' => 'Télécharger JSON',
    'copy_block_to_clipboard' => 'Copier le bloc dans le presse-papiers',
    'duplicate_block' => 'Bloc dupliqué',
    'delete_block' => 'Supprimer le bloc',
    'height_placeholder_example' => 'par exemple, 40px',
    'select_starting_point_for_invoice_design' => 'Choisissez un point de départ pour la conception de votre facture.',
    'no_templates_found_in_category' => 'Aucun modèle trouvé dans cette catégorie',
    'preview_uses_sample_data' => 'L&#39;aperçu utilise des données d&#39;exemple',
    'download_html' => 'Télécharger HTML',
    'blocks_in_design' => 'blocs dans le design',
    'actual_invoices_use_real_data' => 'Les factures réelles utiliseront les données réelles des clients et des factures.',
    'cloned_client' => 'Client cloné avec succès',
    'update_tax_details' => 'Mise à jour des informations fiscales',
    'cc_only' => 'CC uniquement',
    'e_invoice_forward_email' => 'Service de transfert de courriels PEPPOL',
    'e_invoice_forward_email_help' => 'Transmet les factures électroniques envoyées à un service de traitement tiers comme Yuki ou WinAuditor',
    'skip_automatic_email_with_peppol' => 'Désactiver les e-mails envoyés via PEPPOL',
    'skip_automatic_email_with_peppol_help' => 'Si cette option est activée, les factures envoyées via le réseau PEPPOL ne seront pas envoyées par courriel au client.',
    'web_session_timeout_help' => 'Durée pendant laquelle une session de navigation reste active avant d&#39;être déconnectée.',
    'password_timeout_help' => 'Délai avant que le mot de passe administrateur doive être saisi à nouveau.',
    'invoice_status_paid' => 'La facture vient d&#39;être réglée ! L&#39;enregistrement a été mis à jour.',
    'attach_audit_log_to_completed_email' => 'Joindre le journal d&#39;audit à l&#39;e-mail finalisé',
    'attach_audit_log_to_completed_email_help' => 'Si cette option est activée, le journal d&#39;audit sera joint à l&#39;e-mail de confirmation de la finalisation du document signé.',
    'e_expense_forward_email' => 'Service de réexpédition des notes de frais par courriel',
    'e_expense_forward_email_help' => 'Les frais électroniques reçus sont transmis à un service de traitement tiers tel que Yuki ou WinAuditor.',
    'regenerate_token' => 'Jeton de régénération',
    'token_regenerated' => 'Jeton régénéré avec succès',
    'token_regeneration_failed' => 'La régénération du jeton a échoué',
    'show_header' => 'Afficher l&#39;en-tête',
    'select_a_component_to_edit_properties' => 'Sélectionnez un composant à modifier',
    'drag_and_drop_to_add' => 'Glissez et déposez pour ajouter',
    'max_width' => 'Largeur maximale',
    'max_height' => 'Hauteur maximale',
    'alignment' => 'Alignement',
    'object_fit' => 'Ajustement de l&#39;objet',
    'padding' => 'Rembourrage',
    'fix_overlaps' => 'Corriger les chevauchements',
    'spacer' => 'Entretoise',
    'line_height' => 'Hauteur de ligne',
    'text_color' => 'Couleur du texte',
    'font_style' => 'Style de police',
    'alternate_row_colors' => 'Couleurs de rangées alternées',
    'show_borders' => 'Afficher les bordures',
    'cell_padding' => 'Rembourrage cellulaire',
    'suffix' => 'Suffixe',
    'hide_if_empty' => 'Masquer si vide',
    'qr_code' => 'Code QR',
    'qr_code_type' => 'Type de code QR',
    'label_padding' => 'Espace autour de chaque étiquette.',
    'value_padding' => 'Espacer chaque valeur.',
    'label_value_gap' => 'Écart entre l&#39;étiquette et la valeur.',
    'row_spacing' => 'Quelle est la hauteur de l&#39;espace entre chaque rangée ?',
    'value_min_width' => 'Largeur minimale pour les valeurs.',
    'restored_template' => 'Modèle restauré avec succès',
    'archived_template' => 'Modèle archivé avec succès',
    'deleted_template' => 'Modèle supprimé avec succès',
    'top' => 'Haut',
    'table_rows' => 'Rangées',
    'style' => 'Style',
    'widget_defaults' => 'Valeurs par défaut du widget',
    'show_label' => 'Afficher l&#39;étiquette',
    'show_label_help' => 'Afficher l&#39;étiquette du widget à côté de sa valeur.',
    'widget_border_style' => 'Style de bordure du widget',
    'widget_border_style_help' => 'Style de bordure de la zone de widgets.',
    'widget_border_color' => 'Couleur de la bordure du widget',
    'widget_border_color_help' => 'Couleur de la bordure autour de la zone du widget.',
    'card_already_exists' => 'La carte existe déjà.',
    'income_account' => 'Compte de revenus',
    'payment_period' => 'Période de paiement',
    'payment_period_help' => 'Délai de paiement en secondes. Plage acceptée : 60 à 600 secondes.',
    'payware_partner_id_label' => 'Identifiant du partenaire',
    'payware_partner_id_help' => 'Fourni par le logiciel payant après inscription',
    ...
    'gateway_onboarding_description' => 'Votre passerelle de paiement est désormais connectée. Vous pouvez configurer les modes de paiement et définir les limites et les frais de transaction.',
    'gateway_onboarding_payment_methods_help' => 'Activez ou désactivez les modes de paiement acceptés pour vos clients.',
    'gateway_onboarding_limits_fees_help' => 'Définissez les limites minimales et maximales des transactions et configurez les frais de traitement.',
    'gateway_setup_complete' => 'Installation de la passerelle terminée',
    'activity_167' => 'Statut de la facture électronique :invoice mis à jour à :notes',
    'activity_168' => ':notes pour :client',
    'activity_169' => ':notes pour :client',
    ...
    'peppol_partially_paid' => 'Facture électronique partiellement payée.',
    'peppol_paid' => 'Facture électronique payée.',
    'server_not_reachable' => 'Serveur inaccessible. Veuillez vérifier votre connexion Internet et réessayer plus tard.',
    'connecting_calendar' => 'Connecter votre calendrier…',
    'redirecting' => 'Redirection…',
    'calendar_connection_denied' => 'Connexion annulée',
    'calendar_connection_denied_body' => 'Vous avez annulé la connexion. Vous pouvez réessayer à tout moment.',
    'calendar_handoff_expired' => 'La connexion a expiré.',
    'calendar_handoff_expired_body' => 'Le lien de connexion n&#39;est plus valide. Veuillez réessayer.',
    'calendar_handoff_invalid' => 'Impossible d&#39;établir la connexion',
    'calendar_handoff_invalid_body' => 'Une erreur s&#39;est produite lors de la validation de la connexion. Veuillez réessayer.',
    'calendar_connect_failed' => 'Échec de la connexion au calendrier',
    'calendar_connect_failed_body' => 'Nous n&#39;avons pas pu terminer la connexion de votre calendrier. Veuillez réessayer.',
    'back_to_calendar' => 'Retour au calendrier',
    'tag' => 'Étiqueter',
    'new_tag' => 'Nouvelle étiquette',
    'edit_tag' => 'Modifier la balise',
    'task_tags' => 'Étiquettes de tâche',
    'project_tags' => 'Étiquettes du projet',
    'created_tag' => 'Balise créée avec succès',
    'updated_tag' => 'Balise mise à jour avec succès',
    'archived_tag' => 'Étiquette archivée avec succès',
    'restored_tag' => 'Étiquette restaurée avec succès',
    'deleted_tag' => 'Balise supprimée avec succès',
    'e_reporting_enabled' => 'Signalement électronique activé',
    'ten_day_reporting' => 'Rapport sur dix jours',
    'monthly_reporting' => 'Rapports mensuels',
    'ten_day_reporting_help' => 'Veuillez déclarer les transactions de la période en cours par tranches de 10 jours.',
    'monthly_reporting_help' => 'Veuillez déclarer les transactions de la période en cours par tranches mensuelles.',
    'quickbooks_deposit_disabled_warning' => 'Les dépôts sont désactivés dans votre compte QuickBooks connecté ; ce document ne sera donc pas synchronisé avec QuickBooks si un dépôt est présent.',
    'tour_template_signatory_swap' => 'Ce document a été créé à partir de votre modèle. Utilisez le menu déroulant pour remplacer le signataire fictif par un véritable contact client ou utilisateur.',
    'tour_template_save_document' => 'Cliquez ici pour enregistrer vos modifications apportées au document.',
    'tour_template_send_document' => 'Lorsque vous serez prêt, cliquez ici pour envoyer le document à vos signataires.',
    'filter_by_user' => 'Filtrer par utilisateur',
    'add_condition' => 'Ajouter une condition',
    'add_new_option' => 'Ajouter une nouvelle option',
    'add_one_interactive_field_before_sending' => 'Ajoutez au moins un champ interactif (par exemple signature, saisie, date) avant l&#39;envoi.',
    'add_option' => 'Ajouter une option',
    'add_rectangle_for_signatory' => 'Veillez à ajouter au moins un rectangle pour les signataires avant d&#39;enregistrer.',
    'all_conditions_and' => 'Toutes les conditions (ET)',
    'already_invited_uninvite_confirmation' => 'Il semblerait que ce signataire ait déjà été invité. Êtes-vous sûr de vouloir le désinviter ?',
    'already_signed_no_email' => 'Ces utilisateurs se sont déjà inscrits et ne recevront pas d&#39;autre courriel :',
    'already_signed_removal_confirmation' => 'Ces utilisateurs ont déjà signé et leurs contributions seront supprimées. Êtes-vous sûr de vouloir continuer ?',
    'already_used' => ' - déjà utilisé',
    'always_required' => 'Toujours requis',
    'always_visible' => 'Toujours visible',
    'and' => ' ET',
    'any_condition_or' => 'Toute condition (OU)',
    'border_color' => 'Couleur de la bordure',
    'border_style' => 'Style de bordure',
    'character_range' => ':min - :max caractères',
    'clear_default' => 'Effacer par défaut',
    'command_palette' => 'Palette de commandes',
    'condition' => 'Condition',
    'condition_number' => 'Condition :number',
    'contains_all' => 'contient tout',
    'contains_any' => 'contient l&#39;un quelconque de',
    'copy_to_all_pages' => 'Copier sur toutes les pages (pages :count )',
    'custom_regex' => 'Expression régulière personnalisée',
    'custom_regex_pattern' => 'Modèle d&#39;expression régulière personnalisé',
    'decimal_places' => 'Nombre de décimales',
    'default_initials' => 'Initiales par défaut',
    'default_number' => 'numéro par défaut',
    'default_text' => 'Texte par défaut',
    'default_to_checked' => 'Par défaut, coché',
    'default_to_signing_date' => 'par défaut, la date de signature',
    'default_values_comma_separated' => 'Valeurs par défaut (séparées par des virgules)',
    'delete_shortcut' => 'Supprimer (Suppr/Retour arrière)',
    'document_sent' => 'Document envoyé',
    'document_sent_locked' => 'Ce document a été envoyé et est désormais verrouillé. Aucune modification supplémentaire n&#39;est possible.',
    'document_voided_description' => 'Ce document a été annulé et n&#39;est plus disponible.',
    'document_voided_title' => 'Document annulé',
    'does_not_contain' => 'ne contient pas',
    'does_not_equal' => 'n&#39;est pas égal',
    'dotted' => 'Pointé',
    'drag_to_change_signing_order' => 'Faites glisser pour modifier l&#39;ordre de signature',
    'drop_files_or_click' => 'Déposez des fichiers ou cliquez pour les télécharger.',
    'duplicate_shortcut' => 'Dupliquer (Ctrl/Cmd+D)',
    'eg_initials' => 'par exemple, JD',
    'ein' => 'EIN',
    'ein_format_invalid' => 'Le format EIN n&#39;est pas valide.',
    'ein_validation_help' => 'Validation du numéro d&#39;identification fiscale (EIN) : doit être au format XX-XXXXXXX',
    'email_invalid' => 'Le format de l&#39;e-mail n&#39;est pas valide.',
    'email_validation_help' => 'Validation de l&#39;adresse e-mail : doit être un format d&#39;adresse e-mail valide',
    'ends_with' => 'se termine par',
    'enter_a_number' => 'Saisissez un nombre',
    'enter_default_initials' => 'Saisissez les initiales par défaut...',
    'enter_default_text' => 'Saisissez le texte par défaut...',
    'enter_default_values_comma_separated' => 'Saisissez les valeurs par défaut séparées par des virgules...',
    'enter_initials' => 'Entrez vos initiales',
    'enter_number_here' => 'Saisissez le numéro ici',
    'enter_option_text' => 'Saisissez le texte de l&#39;option...',
    'enter_regex_pattern' => 'Saisissez un modèle d&#39;expression régulière...',
    'enter_text' => 'Saisissez du texte',
    'enter_text_here' => 'Saisissez votre texte ici',
    'enter_value' => 'Saisissez une valeur...',
    'enter_values_comma_separated' => 'Saisissez les valeurs séparées par des virgules...',
    'equals' => 'égale',
    'failed_to_rename' => 'Impossible de renommer le fichier.',
    'field_appears_on_all_pages' => 'Ce champ apparaîtra sur toutes les pages. Le signataire ne le remplira qu&#39;une seule fois.',
    'field_visibility' => 'visibilité sur le terrain',
    'field_visibility_help' => 'Ce champ n&#39;apparaît que lorsque ces conditions sont remplies.',
    'file_processing_confirmation_timeout' => 'Le serveur n&#39;a pas confirmé ce téléchargement après plusieurs vérifications. Veuillez le supprimer et réessayer.',
    'file_processing_failed' => 'Le traitement a échoué',
    'file_ready' => 'Prêt',
    'files_not_ready' => 'Fichiers non prêts.',
    'google_drive_import_error' => 'Une erreur s&#39;est produite lors de l&#39;importation depuis Google Drive. Veuillez réessayer.',
    'hide_label_shortcut' => 'Masquer l&#39;étiquette (Ctrl/Cmd+L)',
    'importing_from_google_drive' => 'Importation de fichiers depuis Google Drive...',
    'initials_instruction' => 'Saisissez vos initiales (10 caractères maximum)',
    'input' => 'Saisir',
    'invalid_validation_pattern' => 'Modèle de validation invalide',
    'invitation_not_found' => 'Invitation introuvable.',
    'is_after' => 'est après',
    'is_after_or_equal' => 'est après ou égal à',
    'is_before' => 'est avant',
    'is_before_or_equal' => 'est antérieur ou égal à',
    'is_checked' => 'est vérifié',
    ...
    'is_unchecked' => 'est non vérifié',
    'length' => 'Longueur',
    'letters_only' => 'Lettres seulement',
    'letters_only_help' => 'Lettres uniquement : ce champ n&#39;accepte que les caractères alphabétiques.',
    'mark_optional_shortcut' => 'Marquer comme facultatif (Ctrl/Cmd+R)',
    'mark_required_shortcut' => 'Marquer comme obligatoire (Ctrl/Cmd+R)',
    'match' => 'Correspondre',
    'maximum_length_is' => 'Longueur maximale : :max',
    'max_length' => 'Longueur maximale',
    'max_value' => 'Valeur maximale',
    'minimum_length_is' => 'Longueur minimale : :min',
    'min_length' => 'Longueur minimale',
    'min_value' => 'Valeur minimale',
    'multi_select' => 'Sélection multiple',
    'multiselect_field_needs_options' => 'Les champs à sélection multiple doivent comporter au moins une option avant l&#39;enregistrement.',
    'no_default' => 'Aucun défaut',
    'no_fields_for_conditions' => 'Aucun champ n&#39;est disponible pour créer des conditions. Veuillez d&#39;abord ajouter des champs.',
    'no_maximum' => 'Pas de maximum',
    'no_minimum' => 'Aucun minimum',
    'no_options_configured' => 'Aucune option configurée.',
    'no_options_configured_add_above' => 'Aucune option configurée. Ajoutez des options ci-dessus.',
    'number_format' => 'Format numérique',
    'numbers_only' => 'Numéros seulement',
    'numbers_only_help' => 'Chiffres uniquement : ce champ n’accepte que les caractères numériques.',
    'only_letters_allowed' => 'Seules les lettres sont autorisées.',
    'only_numbers_allowed' => 'Seuls les chiffres sont autorisés.',
    'options_count' => 'Options ( :count )',
    'or_import_from' => 'ou importer depuis',
    'page_number' => 'Page :number',
    'pattern_label' => 'Motif : :motif',
    'pattern_not_matched' => 'Modèle non correspondant',
    'pdf_password_incorrect' => 'Le mot de passe fourni pour « :name » est incorrect. Veuillez saisir le mot de passe correct :',
    'pdf_password_protected' => 'Le fichier PDF « :name » est protégé par un mot de passe. Veuillez saisir le mot de passe :',
    'radio' => 'Radio',
    'radio_group' => 'Groupe radio',
    'radio_selection' => 'Sélection radio',
    'required_when' => 'Obligatoire lorsque...',
    'search_for_command' => 'Recherchez une commande à exécuter...',
    'select_field_needs_options' => 'Les champs de sélection doivent comporter au moins une option avant l&#39;enregistrement.',
    'select_one_or_more_options' => 'Sélectionnez une ou plusieurs options',
    'select_option' => 'Sélectionnez une option',
    'select_option_default' => 'Sélectionnez une option (Par défaut : :label)',
    'send_email_to_contacts' => 'Nous enverrons un courriel aux contacts suivants :',
    'settings_shortcut' => 'Paramètres (Ctrl/Cmd+E)',
    'show_label_shortcut' => 'Afficher l&#39;étiquette (Ctrl/Cmd+L)',
    'shown_later_in_form' => ' - présenté plus tard sous forme',
    'show_when' => 'Afficher quand...',
    'signatories' => 'Signataires',
    'signatory_number' => 'Signataire :number',
    'signatory_required_for_signatures' => 'Un signataire doit être sélectionné pour pouvoir créer des signatures.',
    'signing_error' => 'Erreur de signature',
    'solid' => 'Solide',
    'something_went_wrong' => 'Quelque chose s&#39;est mal passé',
    'ssn' => 'SSN',
    'ssn_format_invalid' => 'Le format du numéro de sécurité sociale n&#39;est pas valide.',
    'ssn_validation_help' => 'Validation du numéro de sécurité sociale : doit être au format XXX-XX-XXXX',
    'successfully_deleted' => 'Fichier supprimé avec succès.',
    'successfully_imported_from_google_drive' => 'Fichiers importés avec succès depuis Google Drive.',
    'successfully_renamed' => 'Fichier renommé avec succès.',
    'successfully_saved' => 'Les modifications ont été enregistrées avec succès.',
    'successfully_updated_document_title' => 'Titre du document mis à jour avec succès.',
    'successfully_uploaded' => 'Fichier(s) téléchargé(s) avec succès.',
    'template_variable' => 'Variable de modèle',
    'template_variable_help' => 'Sélectionnez une variable prédéfinie à afficher dans le document.',
    'toolbox_help_text' => 'Veuillez sélectionner le signataire, puis dessiner un emplacement réservé à la signature.',
    'uninvited_parties_error' => 'Il semblerait que vous ayez des invités indésirables. Veuillez les remplacer par de vrais utilisateurs ou clients.',
    'unknown_signatory' => 'Signataire inconnu',
    'unnamed_contact' => 'Contact non identifié ( :email )',
    'unnamed_user' => 'Utilisateur anonyme',
    'untitled_blueprint' => 'Plan sans titre',
    'upload_cancelled_no_password' => 'Téléchargement annulé pour « :name ». Aucun mot de passe fourni.',
    'upload_error' => 'Une erreur s&#39;est produite lors du chargement du ou des fichiers. Veuillez réessayer.',
    'uploading_files' => 'Téléchargement du ou des fichiers...',
    'uploading_source_file' => 'Téléchargement du fichier source',
    'url_invalid' => 'Le format d&#39;URL est invalide.',
    'url_validation_help' => 'Validation de l&#39;URL : doit être une URL valide.',
    'use_default_value' => 'Utiliser la valeur par défaut',
    'validation' => 'Validation',
    'validation_rule' => 'Règle de validation',
    'value_must_be_at_least' => 'La valeur doit être au moins égale :value',
    'value_must_be_at_most' => 'La valeur doit être au maximum :value',
    'variable' => 'Variable',
    'widget_type' => 'Type de widget',
    'zip' => 'FERMETURE ÉCLAIR',
    'zip_format_invalid' => 'Le format ZIP est invalide.',
    'zip_validation_help' => 'Validation du code postal : doit comporter 5 chiffres ou être au format 5+4 (XXXXX-XXXX).',
    'zoom' => 'Zoom',
    'report_too_large_to_preview' => 'Le rapport est trop volumineux pour être prévisualisé. Veuillez le télécharger pour le consulter.',
    'log_time' => 'Journalisation du temps',
    'filter_by_project' => 'Filtrer par projet',
    'google' => 'Google',
    'app_maintenance' => 'Maintenance de l&#39;application en cours',
    'cloned_design' => 'Conception clonée',
    'no_expenses_selected' => 'Aucune dépense sélectionnée',
    'sync' => 'Synchronisation',
    'updated_tax_data' => 'Données fiscales mises à jour',
    'upload_failed' => 'Échec du chargement',
    'wrong_file_extension' => 'Extension de fichier incorrecte',
    'not_ready_for_download' => 'Fichier non prêt à être téléchargé',
    'list' => 'Liste',
    'already_linked' => 'Déjà lié',
    'convert_to_task' => 'Convertir en tâche',
    'duplicated_entries' => 'Entrées dupliquées',
    'no_entries_to_duplicate' => 'Aucune entrée à dupliquer',
    'please_enter_a_valid_duration' => 'Veuillez saisir une durée valide',
    'calendar_unavailable' => 'Calendrier indisponible',
    'connect_calendar' => 'Calendrier de connexion',
    'disconnect_calendar_confirmation' => 'Êtes-vous sûr de vouloir déconnecter votre calendrier ?',
    'duplicate_yesterday' => 'Dupliqué hier',
    ...
    'no_payment_required' => 'Ce changement de forfait est gratuit. Veuillez revenir en arrière et confirmer le changement de forfait.',
    'subscription_payment_required' => 'Le total a changé et le paiement est maintenant requis. Veuillez choisir un mode de paiement pour continuer.',
    'task_distribution' => 'Répartition des tâches',
    'team_distribution' => 'Répartition des équipes',
    'task_velocity' => 'Vitesse de la tâche',
    'daily_velocity' => 'Vitesse quotidienne',
    'forecast_finish' => 'Fin des prévisions',
    'days_ahead' => 'Jours à venir',
    'days_behind' => 'Jours en arrière',
    'forecast' => 'Prévision',
    'estimated_vs_actual' => 'Estimation vs Réel',
    'budgeted_amount' => 'Montant budgétisé',
    'burn_up' => 'Brûler',
    'actual_spend' => 'Dépenses réelles',
    'margin' => 'Marge',
    'target' => 'Cible',
    'persist_table_filters' => 'Filtres de table persistants',
    'persist_table_filters_help' => 'Si cette option est activée, les filtres du tableau seront conservés lors du rechargement de la page.',
    'billing_progress' => 'État d&#39;avancement de la facturation',
    'budget_vs_actual' => 'Budget vs Réalisé',
    'unbilled_work' => 'Travail non facturé',
    'save_for_later' => 'Enregistrer pour plus tard',
    'deletion_violation_regulatory' => 'Ce document ne peut être supprimé car il est soumis à des obligations de déclaration réglementaires.',
    'currency_syrian_pound' => 'Livre syrienne',
    'account_plan_expired' => 'Forfait expiré',
    'add_files' => 'Ajouter des fichiers',
    'add_reminder_schedule' => 'Ajouter un rappel au calendrier',
    'advanced_options' => 'Options avancées',
    'after_event' => 'après l&#39;événement',
    'after_send' => 'Après l&#39;envoi',
    'before_event' => 'avant l&#39;événement',
    'checklist_fields' => 'Placez les champs sur le document',
    'checklist_ready' => 'Prêt à l&#39;emploi',
    'checklist_send' => 'Envoyer le document',
    'checklist_signatories' => 'Ajouter des signataires',
    'checklist_title' => 'Liste de contrôle des documents',
    'checklist_upload' => 'Téléverser un document',
    'click_to_assign' => 'Cliquez pour attribuer',
    'companies' => 'Entreprises',
    'confirm_remove_signatory' => 'Êtes-vous sûr de vouloir retirer ce signataire ?',
    'created_reminder_schedule' => 'Plan de rappel créé',
    'deleted_reminder_schedule' => 'Rappel supprimé',
    'document_sent_successfully' => 'Document envoyé avec succès',
    'docuninja_join_esignatures' => 'Signatures électroniques',
    'docuninja_join_esignatures_help' => 'Collectez des signatures avec suivi',
    'docuninja_join_features_title' => 'Tout ce que vous obtenez',
    'docuninja_join_integration' => 'Intégration profonde',
    'docuninja_join_integration_help' => 'Gestion des factures, devis et commandes',
    'docuninja_creating_account' => 'Créer votre compte...',
    'documents_public_by_default' => 'Rendre les documents publics par défaut',
    'documents_public_by_default_help' => 'Si cette option est activée, les nouveaux documents seront publics par défaut.',
    'docuninja_join_tagline' => 'Créez, envoyez et signez électroniquement des documents directement depuis Invoice Ninja.',
    'docuninja_join_templates_help' => 'Plans de documents réutilisables',
    'edit_reminder_schedule' => 'Modifier le calendrier des rappels',
    'fewer_tools' => 'Moins d&#39;outils',
    'global_tag_inheritance' => 'Héritage global des étiquettes',
    'global_tag_inheritance_help' => 'Détermine si les entités enfants héritent des balises de leurs entités parentes.',
    'more_tools' => 'Plus d&#39;outils',
    'no_reminder_schedules_found' => 'Aucun calendrier de rappel trouvé',
    'no_template' => 'Aucun modèle',
    'reminder_schedules' => 'Calendriers de rappels',
    'sending_document' => 'Envoi du document',
    'single_signatory_description' => 'Sélectionnez le destinataire de ce document, puis continuez.',
    'trigger_event' => 'Événement déclencheur',
    'updated_reminder_schedule' => 'Calendrier des rappels mis à jour',
    'validation_errors' => 'Erreurs de validation',
    'view_details' => 'Voir les détails',
    'who_to_send_to' => 'À qui envoyer le courrier ?',
    'wait_for_file_processing' => 'Attendez la fin du traitement des fichiers ou supprimez les fichiers qui ont échoué.',
    'yyyy_mm_dd' => 'aaaa-mm-jj',
    'docuninja_unavailable' => 'DocuNinja est actuellement indisponible. Veuillez réessayer plus tard.',
    'add_tax' => 'Ajouter la taxe',
    'what_are_you_charging_for' => 'Qu&#39;est-ce que vous facturez ?',
    'add_value_as_new_client' => 'Ajouter ` :value ` comme nouveau client',
    'stripe_ach_verifiation_pending' => 'Ce mode de paiement n&#39;est pas encore disponible. La vérification est en cours.',
    'deleted_invoices_exist' => 'Ce paiement est lié à une ou plusieurs factures supprimées et ne peut pas être supprimé. Vous devez d&#39;abord restaurer les factures, puis supprimer les paiements.',
    'show_date' => 'Afficher la date',
    'show_signature_line' => 'Afficher la ligne de signature',
    'page_break' => 'Contrôle des sauts de page',
    'page_break_help' => 'Empêcher le contenu de se répartir sur plusieurs pages.',
    'spacing' => 'Espacement',
    'designer' => 'Designer',
    'typography' => 'Typographie',
    'design_name_required' => 'Le nom du design est requis.',
    'preview_indicative_only' => 'Les aperçus sont donnés à titre indicatif seulement. La mise en page finale variera en fonction des données réelles.',
    'total_task_estimated_duration' => 'Tâches Durée estimée',
    'total_task_remaining_estimated_duration' => 'Temps restant pour les tâches',
    'total_unestimated_tasks' => 'Tâches non estimées',
