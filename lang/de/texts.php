...
',
    ...
    'no_passkeys_registered' => 'Für dieses Konto sind keine Passwörter registriert. Bitte melden Sie sich mit Ihrem Passwort an oder registrieren Sie zuerst ein Passwort.',
...
<li>Heute ist Freitag, das Fälligkeitsdatum ist der Freitag einer jeden Woche. Das nächste Fälligkeitsdatum entspricht dem nächsten Freitag, also nicht heute.
    ...
    'trial_card_authorization_notice' => 'Heute wird keine Zahlung abgebucht. Wir reservieren vorübergehend 1 $ auf Ihrer Kreditkarte und geben diesen Betrag nach der Überprüfung sofort wieder frei. Ihre Bank zeigt den Betrag möglicherweise kurzzeitig als ausstehend an. Nach Ablauf der 14-tägigen Testphase werden Ihnen monatlich 14 $ berechnet. Sie können jederzeit kündigen.',
    'trial_card_verification_failed' => 'Diese Kreditkarte konnte nicht verifiziert werden. Es wurde keine Belastung vorgenommen. Bitte verwenden Sie eine gültige Kreditkarte mit mindestens 1 US-Dollar verfügbarem Guthaben.',
    'trial_credit_card_required' => 'Es werden ausschließlich Kreditkarten akzeptiert. Debitkarten, Prepaid-Karten und nicht klassifizierte Karten können nicht verwendet werden. Es wurde keine Gebühr erhoben.',
    'trial_card_gateway_error' => 'Wir konnten den Kartenanbieter nicht erreichen. Es wurde keine Abbuchung vorgenommen. Bitte versuchen Sie es erneut.',
    'trial_card_release_failed' => 'Ihre Karte wurde autorisiert, die Aufhebung der temporären Autorisierung konnte jedoch nicht bestätigt werden. Ihre Testphase wurde nicht gestartet. Bitte versuchen Sie es später erneut oder kontaktieren Sie den Support.',
    'trial_verification_in_progress' => 'Ihre Kartenprüfung wird bereits verarbeitet. Bitte warten Sie einen Moment und versuchen Sie es erneut.',
    'trial_no_longer_available' => 'Dieses Konto ist nicht mehr für die kostenlose Testphase berechtigt.',
    'overdue' => 'Überfällig',
    ...
    'remove' => 'Entfernen',
    'remove_failed_upload' => 'Fehlgeschlagenen Upload entfernen',
...
Sobald Sie die Beträge erhalten haben, kommen Sie bitte wieder zurück zu dieser Zahlungsmethoden-Seite und klicken Sie auf "Complete Verification" neben Ihrem Konto.',
    ...
    'preparing_canonical_pdf' => 'Erstellung der kanonischen PDF-Datei',
    'preparing_server_preview' => 'Servervorschau wird vorbereitet',
    ...
    'applied_amount' => 'Angewendeter Betrag',
    'applied_refunded' => 'Angewendet Rückerstattung',
...
https://invoiceninja.github.io/docs/migration/#troubleshooting',
    ...
    'invoices_by_month' => 'Rechnungen pro Monat',
    'payments_by_month' => 'Zahlungen pro Monat',
    'monthly_breakdown_skipped' => 'Monatliche Aufschlüsselung übersprungen: Der Zeitraum überschreitet 24 Monate.',
    ...
    'taxable_sales' => 'Steuerpflichtige Umsätze',
    'exempt_sales' => 'Steuerbefreite Verkäufe',
    'non_taxable_sales' => 'Nicht steuerpflichtige Verkäufe',
    'zero_rated_sales' => 'Nullsteuer-Verkäufe',
    'accounting_basis' => 'Rechnungslegungsgrundlage',
    'tax_treatment' => 'Steuerliche Behandlung',
    'summary_source' => 'Zusammenfassung Quelle',
    'sales_breakdown_source' => 'Umsatzaufschlüsselung',
    'legacy_tax_detail_source' => 'Legacy-Steuerdetails',
    'monthly_filing_summary' => 'Monatliche Einreichungsübersicht',
    'filing_overview' => 'Einreichungsübersicht',
    'jurisdiction_breakdown' => 'Aufschlüsselung der Zuständigkeiten',
    'state_breakdown' => 'Aufschlüsselung nach Bundesstaaten',
    'filing_period' => 'Einreichungszeitraum',
    'period_start' => 'Periodenbeginn',
    'period_end' => 'Periodenende',
    'jurisdiction_source' => 'Zuständigkeitsquelle',
    'tax_data_source' => 'Steuerdaten',
    'client_shipping_source' => 'Kunde -Lieferadresse',
    'client_billing_source' => 'Kunde',
    'tax_detail_source' => 'Steuerdetails Postleitzahl',
    'unknown_source' => 'Unbekannte Quelle',
    'district' => 'Bezirk',
    'metric' => 'Metrisch',
    'report_period' => 'Berichtszeitraum',
    'current_filing_rows' => 'Aktuelle Ablagezeilen',
    'correction_rows' => 'Korrekturzeilen',
    'states_reported' => 'Staaten meldeten',
    'jurisdictions_reported' => 'Gemeldete Gerichtsbarkeiten',
    'rows_missing_state' => 'Zeilen fehlen Status',
    'rows_using_client_fallback' => 'Zeilen mit Kunde -Fallback',
    'prior_period_corrections' => 'Korrekturen der Vorperiode',
    'corrections_review' => 'Korrekturen Überprüfung',
    'original_tax_period' => 'Ursprünglicher Steuerzeitraum',
    'correction_recorded_period' => 'Korrekturzeitraum',
    'correction_type' => 'Korrekturart',
    'requires_review' => 'Überprüfung erforderlich',
    'current_period_activity' => 'Aktuelle Periodenaktivität',
    'invoice_correction' => 'Rechnungskorrektur',
    'payment_correction' => 'Zahlungskorrektur',
    'status_correction' => 'Statuskorrektur',
    'legacy_unknown' => 'Vermächtnis unbekannt',
    'tax_summary' => 'Steuerzusammenfassung',
    'reporting_bucket' => 'Berichts-Bucket',
    ...
    'payment_expired' => 'Die Zahlung ist abgelaufen. Bitte gehen Sie zurück und versuchen Sie es erneut.',
    'payment_was_not_completed' => 'Die Zahlung konnte nicht abgeschlossen werden. Bitte versuchen Sie es erneut.',
    'no_compatible_app_installed' => 'Wenn nichts passiert, ist möglicherweise keine kompatible App installiert.',
    'payment_type_Mobile Payment' => 'Mobile Zahlung',
    'gateway_temporarily_unavailable' => 'Diese Zahlungsmethode ist vorübergehend nicht verfügbar. Bitte versuchen Sie es später erneut oder wählen Sie eine andere Zahlungsmethode.',
    'mybank' => 'MeineBank',
...
Leistungsempfängers',
    ...
    'use_unapplied_payments' => 'Nicht zugeordnete Zahlungen verwenden',
    ...
    'end_all_sessions_help' => 'Meldet alle Benutzer ab und fordert sie zur erneuten Authentifizierung auf.',
    ...
    'peppol_negative_line_price' => 'Bei der elektronischen Rechnungsstellung dürfen die Preise der einzelnen Positionen nicht negativ sein. Bitte geben Sie einen positiven Preis ein und wenden Sie etwaige Preisnachlässe als Rabatt oder negative Mengenangabe an.',
    ...
    'send_emails_to_following' => 'Wir werden E-Mails an folgende Adressen senden:',
    ...
    'pending_file' => 'Ausstehende Datei',
    ...
    'quickbooks_connect_description' => 'Verbinden Sie Ihr QuickBooks-Konto mit Invoice Ninja, um Ihre Transaktionen und Rechnungen automatisch zu synchronisieren.',
    'sync_direction_description' => 'Diese Einstellungen legen fest, wie Invoice Ninja mit QuickBooks synchronisiert wird.',
    'sync_direction_none_help' => 'Invoice Ninja synchronisiert keine Daten mit QuickBooks und auch keine Daten von QuickBooks.',
    'sync_direction_pull_help' => 'Invoice Ninja ruft Daten aus QuickBooks ab.',
    'sync_direction_push_help' => 'Invoice Ninja überträgt die Daten an QuickBooks.',
    'sync_direction_bidirectional_help' => 'Invoice Ninja kann Daten sowohl abrufen als auch in QuickBooks importieren.',
    'sync_settings' => 'Synchronisierungseinstellungen',
    'realm_id' => 'QB Realm ID',
    'default_income_account' => 'Standard-Einkommenskonto',
    'automatic_taxes' => 'Automatische Steuern',
    'automatic_taxes_help' => 'Wenn die automatische Steuerberechnung (AST) in QuickBooks aktiviert ist, erstellt Invoice Ninja zunächst die Rechnung in QuickBooks und importiert dann die fertige Rechnung zurück zu Invoice Ninja.',
    'pull' => 'Ziehen',
    'push' => 'Drücken',
    'bidirectional' => 'Bidirektional',
    'sync_started' => 'Die Synchronisierung wurde gestartet',
    'quickbooks_read_only_data' => 'QuickBooks-Einkommenskonten und gespeicherte Steuersätze',
    'hide_peppol_sent_status' => 'Peppol-Sendestatus ausblenden',
    'quickbooks_requires_reauth' => 'QuickBooks erfordert eine erneute Authentifizierung.',
    'quickbooks_requires_reauth_body' => 'Ihre QuickBooks-Verbindung ist abgelaufen und muss erneut authentifiziert werden. Bitte melden Sie sich im Administratorportal an und verbinden Sie Ihr QuickBooks-Konto erneut. Wir senden Ihnen diese Benachrichtigung täglich, bis das Problem behoben ist.',
    'crop_logo' => 'Crop-Logo',
    'passkey' => 'Passkey',
    'login_with_passkey' => 'Mit einem Passkey anmelden',
    'manage_passkeys' => 'Passkeys verwalten',
    'last_used' => 'Zuletzt verwendet',
    'unapplied_payments' => 'Nicht zugeordnete Zahlungen',
    'debit' => 'Lastschrift',
    'auto_convert_credit_help' => 'Automatische Verknüpfung oder Erstellung einer Zahlung, die diesen Regeln entspricht.',
    'clone_client_description' => 'Dadurch wird der Kunde in einen neuen Kunde geklont.',
    'invalid_id_number_format' => 'Ungültiges ID-Nummernformat',
    'invalid_vat_number_format' => 'Ungültiges Umsatzsteuer-Identifikationsnummernformat',
    'invalid_routing_id_format' => 'Ungültiges Routing-ID-Format',
    'invalid_id_number_checkdigit' => 'Ungültige Ausweisnummer: Prüfziffernfehler. Bitte überprüfen Sie die Nummer auf Richtigkeit.',
    'invalid_vat_number_checkdigit' => 'Ungültige Umsatzsteuer-Identifikationsnummer: Prüfziffernfehler. Bitte überprüfen Sie die Nummer auf Richtigkeit.',
    'invalid_routing_id_checkdigit' => 'Ungültige Routing-ID: Prüfziffernfehler. Bitte überprüfen Sie die Nummer.',
    'sign_the_document' => 'Unterschreiben Sie das Dokument',
    'client_not_found_on_peppol_network' => 'Kunde konnte im PEPPOL-Netzwerk nicht identifiziert werden.',
    'too_many_requests' => 'Zu viele Anfragen',
    'custom_text_with_formatting' => 'Benutzerdefinierter Text mit Formatierung',
    'client_name_and_address' => 'Name und Anschrift Kunde',
    'bill_to' => 'Gesetzesentwurf für:',
    'entity_details' => 'Nummer, Datum, Fälligkeitsdatum, Betrag, Saldo',
    'product_line_items_with_columns' => 'Produktpositionen mit Spalten',
    'task_line_items_with_columns' => 'Aufgabe mit Spalten',
    'divider_line' => 'Horizontaler Separator',
    'signature_line' => 'Unterschriftenbereich',
    'authorized_signature' => 'Autorisierte Unterschrift',
    'essential' => 'Essentiell',
    'public_notes_will_appear_here' => 'Öffentliche Notizen werden hier erscheinen.',
    'footer_will_appear_here' => 'Die Fußzeile wird hier angezeigt.',
    'terms_will_appear_here' => 'Die Nutzungsbedingungen werden hier angezeigt.',
    'sepa_qr' => 'SEPA QR',
    'swiss_qr' => 'Swiss QR',
    'spc_qr' => 'SPC QR',
    'verifactu_qr' => 'Verifactu QR',
    'payment_qr' => 'Zahlungs-QR',
    'download_json' => 'JSON herunterladen',
    'copy_block_to_clipboard' => 'Block in die Zwischenablage kopieren',
    'duplicate_block' => 'Doppelter Block',
    'delete_block' => 'Block löschen',
    'height_placeholder_example' => 'z.B. 40px',
    'select_starting_point_for_invoice_design' => 'Wählen Sie einen Ausgangspunkt für Ihr Rechnungsdesign.',
    'no_templates_found_in_category' => 'In dieser Kategorie wurden keine Vorlagen gefunden.',
    'preview_uses_sample_data' => 'Die Vorschau verwendet Beispieldaten',
    'download_html' => 'HTML herunterladen',
    'blocks_in_design' => 'Blöcke im Design',
    'actual_invoices_use_real_data' => 'Für die tatsächlichen Rechnungen werden echte Kunde und Rechnungsdaten verwendet.',
    'cloned_client' => 'Kunde erfolgreich geklont',
    'update_tax_details' => 'Steuerdetails aktualisieren',
    'cc_only' => 'Nur CC',
    'e_invoice_forward_email' => 'PEPPOL E-Mail-Weiterleitungsdienst',
    'e_invoice_forward_email_help' => 'Forwards sendeten elektronische Rechnungen an einen externen Verarbeitungsdienstleister wie Yuki oder WinAuditor.',
    'skip_automatic_email_with_peppol' => 'E-Mails beim Versand über PEPPOL deaktivieren',
    'skip_automatic_email_with_peppol_help' => 'Wenn diese Option aktiviert ist, werden über das PEPPOL-Netzwerk versendete Rechnungen nicht per E-Mail an den Kunde gesendet.',
    'web_session_timeout_help' => 'Zeit, die eine Browsersitzung aktiv bleibt, bevor sie abgemeldet wird.',
    'password_timeout_help' => 'Zeit, nach der das Administratorpasswort erneut eingegeben werden muss.',
    'invoice_status_paid' => 'Die Rechnung wurde soeben bezahlt! Der Datensatz wurde aktualisiert .',
    'attach_audit_log_to_completed_email' => 'Fügen Sie das Prüfprotokoll der abgeschlossenen E-Mail bei.',
    'attach_audit_log_to_completed_email_help' => 'Falls diese Option aktiviert ist, wird das Prüfprotokoll der E-Mail mit dem Abschluss der Unterzeichnung des Dokuments beigefügt.',
    'e_expense_forward_email' => 'E-Mail-Dienst zur Ausgabe',
    'e_expense_forward_email_help' => 'Leitet erhaltene elektronische Spesenabrechnungen an einen externen Verarbeitungsdienst wie Yuki oder WinAuditor weiter.',
    'regenerate_token' => 'Token regenerieren',
    'token_regenerated' => 'Token erfolgreich neu generiert',
    'token_regeneration_failed' => 'Token-Regeneration fehlgeschlagen',
    'show_header' => 'Kopfzeile anzeigen',
    'select_a_component_to_edit_properties' => 'Wählen Sie eine Komponente zum Bearbeiten aus.',
    'drag_and_drop_to_add' => 'Per Drag &amp; Drop hinzufügen',
    'max_width' => 'Maximale Breite',
    'max_height' => 'Maximale Höhe',
    'alignment' => 'Ausrichtung',
    'object_fit' => 'Objektpassung',
    'padding' => 'Polsterung',
    'fix_overlaps' => 'Überlappungen beheben',
    'spacer' => 'Abstandshalter',
    'line_height' => 'Linienhöhe',
    'text_color' => 'Textfarbe',
    'font_style' => 'Schriftart',
    'alternate_row_colors' => 'abwechselnde Zeilenfarben',
    'show_borders' => 'Grenzen anzeigen',
    'cell_padding' => 'Zellpolsterung',
    'suffix' => 'Suffix',
    'hide_if_empty' => 'Ausblenden, falls leer',
    'qr_code' => 'QR-Code',
    'qr_code_type' => 'QR-Code-Typ',
    'label_padding' => 'Freiraum um jedes Etikett.',
    'value_padding' => 'Um jeden Wert herum ist Platz.',
    'label_value_gap' => 'Diskrepanz zwischen Bezeichnung und Wert.',
    'row_spacing' => 'Wie viel vertikaler Abstand zwischen den einzelnen Reihen ist.',
    'value_min_width' => 'Mindestbreite für Werte.',
    'restored_template' => 'Vorlage erfolgreich wiederhergestellt',
    'archived_template' => 'Vorlage erfolgreich archiviert',
    'deleted_template' => 'Vorlage erfolgreich gelöscht',
    'top' => 'Spitze',
    'table_rows' => 'Reihen',
    'style' => 'Stil',
    'widget_defaults' => 'Widget-Standardeinstellungen',
    'show_label' => 'Label anzeigen',
    'show_label_help' => 'Die Beschriftung des Widgets soll neben seinem Wert angezeigt werden.',
    'widget_border_style' => 'Widget-Rahmenstil',
    'widget_border_style_help' => 'Rahmenstil des Widget-Bereichs.',
    'widget_border_color' => 'Widget-Rahmenfarbe',
    'widget_border_color_help' => 'Farbe des Rahmens um den Widget-Bereich.',
    'card_already_exists' => 'Die Karte existiert bereits.',
    'income_account' => 'Ertragskonto',
    'payment_period' => 'Zahlungszeitraum',
    'payment_period_help' => 'Die für die Zahlungsabwicklung vorgesehene Zeit in Sekunden. Akzeptierter Bereich: 60–600 Sekunden.',
    'payware_partner_id_label' => 'Partnerkennung',
    'payware_partner_id_help' => 'Bereitgestellt von Payware bei Registrierung',
    'payware_vpos_id_label' => 'webPOS-Kennung',
    'payware_vpos_id_help' => 'webPOS-Kennung aus dem Payware-Dashboard',
    'payware_public_key_help' => 'Öffentlicher RSA-Schlüssel zur Validierung der Webhook-Signatur',
    'gateway_onboarding_description' => 'Ihr Zahlungsportal wurde erfolgreich verbunden. Sie können nun Zahlungsmethoden konfigurieren und Transaktionslimits oder Gebühren festlegen.',
    'gateway_onboarding_payment_methods_help' => 'Aktivieren oder deaktivieren Sie die akzeptierten Zahlungsmethoden für Ihre Kunden.',
    'gateway_onboarding_limits_fees_help' => 'Legen Sie minimale und maximale Transaktionslimits fest und konfigurieren Sie die Bearbeitungsgebühren.',
    'gateway_setup_complete' => 'Gateway-Einrichtung abgeschlossen',
    'activity_167' => 'Status der E-Rechnung :invoice aktualisiert auf :notes',
    'activity_168' => ':notes für :client',
    'activity_169' => ':notes für :client',
    'peppol_accepted' => 'Die elektronische Rechnung wurde vom Empfänger akzeptiert.',
    'peppol_rejected' => 'Die elektronische Rechnung wurde vom Empfänger abgelehnt.',
    'peppol_partially_paid' => 'E-Rechnung teilweise bezahlt.',
    'peppol_paid' => 'E-Rechnung bezahlt.',
    'server_not_reachable' => 'Server nicht erreichbar. Überprüfen Sie Ihre Internetverbindung und versuchen Sie es später erneut.',
    'connecting_calendar' => 'Verbinden Sie Ihren Kalender…',
    'redirecting' => 'Weiterleitung…',
    'calendar_connection_denied' => 'Verbindung abgebrochen',
    'calendar_connection_denied_body' => 'Die Verbindung wurde abgebrochen. Sie können es jederzeit erneut versuchen.',
    'calendar_handoff_expired' => 'Die Verbindung ist abgelaufen.',
    'calendar_handoff_expired_body' => 'Die Verbindung ist nicht mehr gültig. Bitte stellen Sie die Verbindung erneut her.',
    'calendar_handoff_invalid' => 'Verbindung konnte nicht hergestellt werden',
    'calendar_handoff_invalid_body' => 'Bei der Verbindungsprüfung ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut.',
    'calendar_connect_failed' => 'Kalenderverbindung fehlgeschlagen',
    'calendar_connect_failed_body' => 'Die Verbindung Ihres Kalenders konnte nicht abgeschlossen werden. Bitte versuchen Sie es erneut.',
    'back_to_calendar' => 'Zurück zum Kalender',
    'tag' => 'Etikett',
    'new_tag' => 'Neues Etikett',
    'edit_tag' => 'Tag bearbeiten',
    'task_tags' => 'Aufgabe Tags',
    'project_tags' => 'Projekt-Tags',
    'created_tag' => 'Tag erfolgreich erstellt',
    'updated_tag' => 'Tag erfolgreich aktualisiert',
    'archived_tag' => 'Tag erfolgreich archiviert',
    'restored_tag' => 'Tag erfolgreich wiederhergestellt',
    'deleted_tag' => 'Tag erfolgreich gelöscht',
    'e_reporting_enabled' => 'Elektronische Berichterstattung aktiviert',
    'ten_day_reporting' => 'Zehn-Tage-Berichterstattung',
    'monthly_reporting' => 'Monatliche Berichterstattung',
    'ten_day_reporting_help' => 'Die Transaktionen für den laufenden Zeitraum sind in 10-Tage-Schritten zu melden.',
    'monthly_reporting_help' => 'Die Transaktionen für den laufenden Zeitraum sind monatsweise zu melden.',
    'quickbooks_deposit_disabled_warning' => 'Einzahlungen sind in Ihrem verbundenen QuickBooks-Konto deaktiviert. Dieses Dokument wird nicht mit QuickBooks synchronisiert, wenn eine Einzahlung vorhanden ist.',
    'tour_template_signatory_swap' => 'Dieses Dokument wurde anhand Ihrer Vorlage erstellt . Verwenden Sie das Dropdown-Menü, um den Platzhalterunterzeichner durch einen echten Kunde oder Benutzer zu ersetzen.',
    'tour_template_save_document' => 'Klicken Sie hier, um Ihre Änderungen am Dokument zu speichern.',
    'tour_template_send_document' => 'Wenn Sie fertig sind, klicken Sie hier, um das Dokument an Ihre Unterzeichner zu senden.',
    'filter_by_user' => 'Nach Benutzer filtern',
    'add_condition' => 'Bedingung hinzufügen',
    'add_new_option' => 'Neue Option hinzufügen',
    'add_one_interactive_field_before_sending' => 'Fügen Sie vor dem Absenden mindestens ein interaktives Feld hinzu (z. B. Unterschrift, Eingabefeld, Datumsfeld).',
    'add_option' => 'Option hinzufügen',
    'add_rectangle_for_signatory' => 'Fügen Sie vor dem Speichern unbedingt mindestens ein Rechteck für die Unterzeichner hinzu.',
    'all_conditions_and' => 'Alle Bedingungen (UND)',
    'already_invited_uninvite_confirmation' => 'Dieser Unterzeichner scheint bereits eingeladen worden zu sein. Möchten Sie die Einladung wirklich widerrufen?',
    'already_signed_no_email' => 'Diese Nutzer haben sich bereits angemeldet und erhalten keine weitere E-Mail:',
    'already_signed_removal_confirmation' => 'Diese Nutzer haben bereits unterschrieben und ihre Beiträge werden entfernt. Möchten Sie wirklich fortfahren?',
    'already_used' => ' - bereits verwendet',
    'always_required' => 'Immer erforderlich',
    'always_visible' => 'Immer sichtbar',
    'and' => ' UND',
    'any_condition_or' => 'Jede Bedingung (ODER)',
    'border_color' => 'Rahmenfarbe',
    'border_style' => 'Rahmenstil',
    'character_range' => ':min - :max Zeichen',
    'clear_default' => 'Standardeinstellungen löschen',
    'command_palette' => 'Befehlspalette',
    'condition' => 'Zustand',
    'condition_number' => 'Zustand :number',
    'contains_all' => 'enthält alles von',
    'contains_any' => 'enthält eines der folgenden',
    'copy_to_all_pages' => 'Auf alle Seiten kopieren ( :count Seiten)',
    'custom_regex' => 'Benutzerdefinierter regulärer Ausdruck',
    'custom_regex_pattern' => 'Benutzerdefiniertes Regex-Muster',
    'decimal_places' => 'Dezimalstellen',
    'default_initials' => 'Standardinitialen',
    'default_number' => 'Standardnummer',
    'default_text' => 'Standardtext',
    'default_to_checked' => 'Standardmäßig aktiviert',
    'default_to_signing_date' => 'Standardmäßig wird das Datum der Unterzeichnung verwendet.',
    'default_values_comma_separated' => 'Standardwerte (durch Komma getrennt)',
    'delete_shortcut' => 'Löschen (Entf/Backspace)',
    'document_sent' => 'Dokument gesendet',
    'document_sent_locked' => 'Dieses Dokument wurde versendet und ist nun gesperrt. Es können keine weiteren Änderungen vorgenommen werden.',
    'document_voided_description' => 'Dieses Dokument ist ungültig und nicht mehr verfügbar.',
    'document_voided_title' => 'Dokument für ungültig erklärt',
    'does_not_contain' => 'enthält nicht',
    'does_not_equal' => 'ist nicht gleich',
    'dotted' => 'Gepunktet',
    'drag_to_change_signing_order' => 'Ziehen Sie, um die Signaturreihenfolge zu ändern.',
    'drop_files_or_click' => 'Dateien per Drag &amp; Drop oder Klick zum Hochladen hochladen',
    'duplicate_shortcut' => 'Duplizieren (Strg/Cmd+D)',
    'eg_initials' => 'z.B. JD',
    'ein' => 'EIN',
    'ein_format_invalid' => 'Das EIN-Format ist ungültig.',
    'ein_validation_help' => 'EIN-Validierung: Muss im Format XX-XXXXXXX vorliegen',
    'email_invalid' => 'Das E-Mail-Format ist ungültig.',
    'email_validation_help' => 'E-Mail-Validierung: Es muss sich um ein gültiges E-Mail-Format handeln.',
    'ends_with' => 'endet mit',
    'enter_a_number' => 'Geben Sie eine Zahl ein',
    'enter_default_initials' => 'Standardinitialen eingeben...',
    'enter_default_text' => 'Standardtext eingeben...',
    'enter_default_values_comma_separated' => 'Geben Sie durch Kommas getrennte Standardwerte ein...',
    'enter_initials' => 'Initialen eingeben',
    'enter_number_here' => 'Geben Sie hier die Nummer ein.',
    'enter_option_text' => 'Optionstext eingeben...',
    'enter_regex_pattern' => 'Regulären Ausdruck eingeben...',
    'enter_text' => 'Text eingeben',
    'enter_text_here' => 'Hier Text eingeben',
    'enter_value' => 'Wert eingeben...',
    'enter_values_comma_separated' => 'Geben Sie die Werte durch Kommas getrennt ein...',
    'equals' => 'gleich',
    'failed_to_rename' => 'Die Datei konnte nicht umbenannt werden.',
    'field_appears_on_all_pages' => 'Das Feld wird auf allen Seiten angezeigt. Der Unterzeichner füllt es nur einmal aus.',
    'field_visibility' => 'Sichtfeld',
    'field_visibility_help' => 'Das Feld wird nur angezeigt, wenn diese Bedingungen erfüllt sind.',
    'file_processing_confirmation_timeout' => 'Der Server konnte diesen Upload nach wiederholten Prüfungen nicht bestätigen. Bitte entfernen Sie ihn und versuchen Sie es erneut.',
    'file_processing_failed' => 'Verarbeitung fehlgeschlagen',
    'file_ready' => 'Bereit',
    'files_not_ready' => 'Dateien nicht bereit.',
    'google_drive_import_error' => 'Beim Importieren von Google Drive ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut.',
    'hide_label_shortcut' => 'Beschriftung ausblenden (Strg/Cmd+L)',
    'importing_from_google_drive' => 'Datei(en) werden von Google Drive importiert...',
    'initials_instruction' => 'Geben Sie Ihre Initialen ein (maximal 10 Zeichen)',
    'input' => 'Eingang',
    'invalid_validation_pattern' => 'Ungültiges Validierungsmuster',
    'invitation_not_found' => 'Einladung nicht gefunden.',
    'is_after' => 'ist nach',
    'is_after_or_equal' => 'ist nach oder gleich',
    'is_before' => 'ist vorher',
    'is_before_or_equal' => 'ist vor oder gleich',
    'is_checked' => 'wird geprüft',
    'is_greater_than' => 'ist größer als',
    'is_greater_than_or_equal' => 'ist größer oder gleich',
    'is_less_than' => 'ist kleiner als',
    'is_less_than_or_equal' => 'ist kleiner oder gleich',
    'is_not_empty' => 'ist nicht leer',
    'is_unchecked' => 'ist ungeprüft',
    'length' => 'Länge',
    'letters_only' => 'Nur Buchstaben',
    'letters_only_help' => 'Nur Buchstaben: Dieses Feld akzeptiert nur alphabetische Zeichen.',
    'mark_optional_shortcut' => 'Optional markieren (Strg/Cmd+R)',
    'mark_required_shortcut' => 'Erforderlich markieren (Strg/Cmd+R)',
    'match' => 'Übereinstimmen',
    'maximum_length_is' => 'Die maximale Länge beträgt :max Länge',
    'max_length' => 'Maximale Länge',
    'max_value' => 'Maximalwert',
    'minimum_length_is' => 'Die Mindestlänge beträgt :min Länge',
    'min_length' => 'Mindestlänge',
    'min_value' => 'Minimalwert',
    'multi_select' => 'Mehrfachauswahl',
    'multiselect_field_needs_options' => 'Mehrfachauswahlfelder müssen vor dem Speichern mindestens eine Option enthalten.',
    'no_default' => 'Kein Standardwert',
    'no_fields_for_conditions' => 'Es sind keine Felder zum Erstellen von Bedingungen verfügbar. Fügen Sie zuerst Felder hinzu.',
    'no_maximum' => 'Kein Maximum',
    'no_minimum' => 'Kein Mindestbetrag',
    'no_options_configured' => 'Keine Optionen konfiguriert.',
    'no_options_configured_add_above' => 'Keine Optionen konfiguriert. Fügen Sie oben Optionen hinzu.',
    'number_format' => 'Zahlenformat',
    'numbers_only' => 'Nur Zahlen',
    'numbers_only_help' => 'Nur Zahlen: Dieses Feld akzeptiert nur numerische Zeichen.',
    'only_letters_allowed' => 'Nur Buchstaben sind erlaubt',
    'only_numbers_allowed' => 'Nur Zahlen sind erlaubt',
    'options_count' => 'Optionen ( :count )',
    'or_import_from' => 'oder importieren von',
    'page_number' => 'Seite :number',
    'pattern_label' => 'Muster: :Muster',
    'pattern_not_matched' => 'Muster stimmte nicht überein',
    'pdf_password_incorrect' => 'Das für &quot; :name &quot; angegebene Passwort ist falsch. Bitte geben Sie das richtige Passwort ein:',
    'pdf_password_protected' => 'Die PDF-Datei „ :name “ ist passwortgeschützt. Bitte geben Sie das Passwort ein:',
    'radio' => 'Radio',
    'radio_group' => 'Radiogruppe',
    'radio_selection' => 'Radioauswahl',
    'required_when' => 'Erforderlich, wenn...',
    'search_for_command' => 'Suche nach einem auszuführenden Befehl...',
    'select_field_needs_options' => 'Auswahlfelder müssen vor dem Speichern mindestens eine Option enthalten.',
    'select_one_or_more_options' => 'Wählen Sie eine oder mehrere Optionen aus.',
    'select_option' => 'Wählen Sie eine Option aus',
    'select_option_default' => 'Wählen Sie eine Option aus (Standard: :label)',
    'send_email_to_contacts' => 'Wir werden eine E-Mail an die folgenden Kontakte senden:',
    'settings_shortcut' => 'Einstellungen (Strg/Cmd+E)',
    'show_label_shortcut' => 'Beschriftung anzeigen (Strg/Cmd+L)',
    'shown_later_in_form' => ' - wird später in Form',
    'show_when' => 'Anzeige, wenn...',
    'signatories' => 'Unterzeichner',
    'signatory_number' => 'Unterzeichner :number',
    'signatory_required_for_signatures' => 'Um Signaturen zu erstellen, muss ein Unterzeichner ausgewählt werden.',
    'signing_error' => 'Signaturfehler',
    'solid' => 'Solide',
    'something_went_wrong' => 'Etwas ist schiefgelaufen.',
    'ssn' => 'Sozialversicherungsnummer',
    'ssn_format_invalid' => 'Das SSN-Format ist ungültig.',
    'ssn_validation_help' => 'SSN-Validierung: Muss im Format XXX-XX-XXXX vorliegen.',
    'successfully_deleted' => 'Datei erfolgreich gelöscht.',
    'successfully_imported_from_google_drive' => 'Datei(en) erfolgreich von Google Drive importiert.',
    'successfully_renamed' => 'Datei erfolgreich umbenannt.',
    'successfully_saved' => 'Die Änderungen wurden erfolgreich gespeichert.',
    'successfully_updated_document_title' => 'Dokumenttitel erfolgreich aktualisiert .',
    'successfully_uploaded' => 'Datei(en) erfolgreich hochgeladen.',
    'template_variable' => 'Vorlagenvariable',
    'template_variable_help' => 'Wählen Sie eine vordefinierte Variable aus, die im Dokument angezeigt werden soll.',
    'toolbox_help_text' => 'Bitte wählen Sie den Unterzeichner aus und zeichnen Sie dann einen Platzhalter für die Unterschrift.',
    'uninvited_parties_error' => 'Es sieht so aus, als ob Sie ungebetene Gäste haben. Bitte tauschen Sie diese gegen echte Nutzer oder Kunden aus.',
    'unknown_signatory' => 'Unbekannter Unterzeichner',
    'unnamed_contact' => 'Unbenannter Kontakt ( :email )',
    'unnamed_user' => 'Unbekannter Benutzer',
    'untitled_blueprint' => 'Unbetitelter Entwurf',
    'upload_cancelled_no_password' => 'Upload für &quot; :name &quot; abgebrochen. Kein Passwort angegeben.',
    'upload_error' => 'Beim Hochladen der Datei(en) ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut.',
    'uploading_files' => 'Datei(en) werden hochgeladen...',
    'uploading_source_file' => 'Quelldatei wird hochgeladen',
    'url_invalid' => 'Das URL-Format ist ungültig.',
    'url_validation_help' => 'URL-Validierung: Es muss sich um ein gültiges URL-Format handeln.',
    'use_default_value' => 'Standardwert verwenden',
    'validation' => 'Validierung',
    'validation_rule' => 'Validierungsregel',
    'value_must_be_at_least' => 'Der Wert muss mindestens :value betragen.',
    'value_must_be_at_most' => 'Der Wert darf höchstens :value betragen.',
    'variable' => 'Variable',
    'widget_type' => 'Widget-Typ',
    'zip' => 'REISSVERSCHLUSS',
    'zip_format_invalid' => 'Das ZIP-Format ist ungültig.',
    'zip_validation_help' => 'Postleitzahlprüfung: Muss 5-stellig sein oder im Format 5+4 vorliegen (XXXXX-XXXX)',
    'zoom' => 'Zoom',
    'report_too_large_to_preview' => 'Der Bericht ist zu groß, um ihn in der Vorschau anzuzeigen. Bitte laden Sie den Bericht herunter, um ihn anzusehen.',
    'log_time' => 'Protokollzeit',
    'filter_by_project' => 'Nach Projekt filtern',
    'google' => 'Google',
    'app_maintenance' => 'App-Wartung läuft',
    'cloned_design' => 'Klondesign',
    'no_expenses_selected' => 'Keine Ausgaben ausgewählt',
    'sync' => 'Synchronisieren',
    'updated_tax_data' => 'aktualisiert Steuerdaten',
    'upload_failed' => 'Hochladen fehlgeschlagen',
    'wrong_file_extension' => 'Falsche Dateiendung',
    'not_ready_for_download' => 'Datei nicht zum Download bereit',
    'list' => 'Liste',
    'already_linked' => 'Bereits verlinkt',
    'convert_to_task' => 'In Aufgabe umwandeln',
    'duplicated_entries' => 'Doppelte Einträge',
    'no_entries_to_duplicate' => 'Keine Einträge zum Duplizieren',
    'please_enter_a_valid_duration' => 'Bitte geben Sie eine gültige Dauer ein.',
    'calendar_unavailable' => 'Kalender nicht verfügbar',
    'connect_calendar' => 'Kalender verbinden',
    'disconnect_calendar_confirmation' => 'Möchten Sie Ihren Kalender wirklich trennen?',
    'duplicate_yesterday' => 'Duplikat von gestern',
    'hide_events' => 'Ereignisse ausblenden',
    'show_events' => 'Veranstaltungen anzeigen',
    'merge_client' => 'Merge Kunde',
    'merge_vendor' => 'Merge Lieferant',
    'global' => 'Global',
    'disable_all' => 'Alle deaktivieren',
    'press_keys' => 'Tasten drücken',
    'no_payment_required' => 'Für diese Tarifänderung ist keine Zahlung erforderlich. Bitte bestätigen Sie die Tarifänderung.',
    'subscription_payment_required' => 'Der Gesamtbetrag hat sich geändert und eine Zahlung ist nun erforderlich. Bitte wählen Sie eine Zahlungsmethode, um fortzufahren.',
    'task_distribution' => 'Aufgabe',
    'team_distribution' => 'Teamverteilung',
    'task_velocity' => 'Aufgabe',
    'daily_velocity' => 'Tagesgeschwindigkeit',
    'forecast_finish' => 'Prognoseende',
    'days_ahead' => 'Die kommenden Tage',
    'days_behind' => 'Tage hinter',
    'forecast' => 'Vorhersage',
    'estimated_vs_actual' => 'Geschätzt vs. Tatsächlich',
    'budgeted_amount' => 'Budgetierter Betrag',
    'burn_up' => 'Verbrennen',
    'actual_spend' => 'Tatsächliche Ausgaben',
    'margin' => 'Marge',
    'target' => 'Ziel',
    'persist_table_filters' => 'Tabellenfilter beibehalten',
    'persist_table_filters_help' => 'Wenn diese Option aktiviert ist, bleiben die Tabellenfilter auch nach einem Seitenneuladen erhalten.',
    'billing_progress' => 'Abrechnungsfortschritt',
    'budget_vs_actual' => 'Budget vs. Ist',
    'unbilled_work' => 'Nicht abgerechnete Arbeit',
    'save_for_later' => 'Für später speichern',
    'deletion_violation_regulatory' => 'Dieses Dokument kann nicht gelöscht werden, da es den Meldepflichten der Aufsichtsbehörden unterliegt.',
    'currency_syrian_pound' => 'Syrisches Pfund',
    'account_plan_expired' => 'Kontoplan abgelaufen',
    'add_files' => 'Dateien hinzufügen',
    'add_reminder_schedule' => 'Erinnerungsplan hinzufügen',
    'advanced_options' => 'Erweiterte Optionen',
    'after_event' => 'nach dem Ereignis',
    'after_send' => 'Nach dem Absenden',
    'before_event' => 'vor dem Ereignis',
    'checklist_fields' => 'Platzieren Sie Felder im Dokument',
    'checklist_ready' => 'Sofort einsatzbereit',
    'checklist_send' => 'Dokument senden',
    'checklist_signatories' => 'Unterzeichner hinzufügen',
    'checklist_title' => 'Dokumenten-Checkliste',
    'checklist_upload' => 'Laden Sie ein Dokument hoch',
    'click_to_assign' => 'Zum Zuweisen klicken',
    'companies' => 'Unternehmen',
    'confirm_remove_signatory' => 'Sind Sie sicher, dass Sie diesen Unterzeichner entfernen möchten?',
    'created_reminder_schedule' => 'Erinnerungsplan erstellt',
    'deleted_reminder_schedule' => 'Erinnerungsplan gelöscht',
    'document_sent_successfully' => 'Dokument erfolgreich gesendet',
    'docuninja_join_esignatures' => 'Elektronische Signaturen',
    'docuninja_join_esignatures_help' => 'Unterschriften mit Sendungsverfolgung sammeln',
    'docuninja_join_features_title' => 'Alles, was Sie erhalten',
    'docuninja_join_integration' => 'Tiefe Integration',
    'docuninja_join_integration_help' => 'Bearbeitet Rechnungen, Angebote und Bestellungen',
    'docuninja_creating_account' => 'Kontoerstellung...',
    'documents_public_by_default' => 'Dokumente standardmäßig öffentlich festlegen',
    'documents_public_by_default_help' => 'Wenn diese Option aktiviert ist, werden neue Dokumente standardmäßig öffentlich zugänglich gemacht.',
    'docuninja_join_tagline' => 'Dokumente direkt in Invoice Ninja erstellen, versenden und elektronisch signieren.',
    'docuninja_join_templates_help' => 'Wiederverwendbare Dokumentenvorlagen',
    'edit_reminder_schedule' => 'Erinnerungsplan bearbeiten',
    'fewer_tools' => 'Weniger Werkzeuge',
    'global_tag_inheritance' => 'Globale Tag-Vererbung',
    'global_tag_inheritance_help' => 'Legt fest, ob untergeordnete Entitäten Tags von ihren übergeordneten Entitäten erben.',
    'more_tools' => 'Weitere Werkzeuge',
    'no_reminder_schedules_found' => 'Es wurden keine Erinnerungspläne gefunden.',
    'no_template' => 'Keine Vorlage',
    'reminder_schedules' => 'Erinnerungspläne',
    'sending_document' => 'Dokument senden',
    'single_signatory_description' => 'Wählen Sie aus, an wen Sie dieses Dokument senden möchten, und fahren Sie dann fort.',
    'trigger_event' => 'Auslösendes Ereignis',
    'updated_reminder_schedule' => 'Erinnerungsplan aktualisiert',
    'validation_errors' => 'Validierungsfehler',
    'view_details' => 'Details anzeigen',
    'who_to_send_to' => 'An wen soll ich es schicken?',
    'wait_for_file_processing' => 'Warten Sie, bis die Dateiverarbeitung abgeschlossen ist, oder entfernen Sie fehlgeschlagene Uploads.',
    'yyyy_mm_dd' => 'JJJJ-MM-TT',
    'docuninja_unavailable' => 'DocuNinja ist momentan nicht verfügbar. Bitte versuchen Sie es später erneut.',
    'add_tax' => 'Steuer hinzufügen',
    'what_are_you_charging_for' => 'Wofür berechnen Sie eine Gebühr?',
    'add_value_as_new_client' => 'Fügen Sie ` :value als neuen Kunde hinzu',
    'stripe_ach_verifiation_pending' => 'Diese Zahlungsmethode ist noch nicht verfügbar. Die Überprüfung steht noch aus.',
    'deleted_invoices_exist' => 'Diese Zahlung ist mit einer oder mehreren gelöschten Rechnungen verknüpft und kann nicht gelöscht werden. Sie müssen zuerst die Rechnungen wiederherstellen und anschließend die Zahlungen löschen.',
    'show_date' => 'Datum anzeigen',
    'show_signature_line' => 'Unterschriftenzeile anzeigen',
    'page_break' => 'Seitenumbruchsteuerung',
    'page_break_help' => 'Verhindern, dass Inhalte auf mehrere Seiten aufgeteilt werden.',
    'spacing' => 'Abstand',
    'designer' => 'Designer',
    'typography' => 'Typografie',
    'design_name_required' => 'Die Angabe des Designnamens ist erforderlich.',
    'preview_indicative_only' => 'Die Vorschau dient nur zur Veranschaulichung. Das endgültige Layout kann je nach den tatsächlichen Daten abweichen.',
    'total_task_estimated_duration' => 'Aufgaben Geschätzte Zeit',
    'total_task_remaining_estimated_duration' => 'Aufgaben Verbleibende Zeit',
    'total_unestimated_tasks' => 'Ungeschätzte Aufgaben',
