...
<li> “ :QUARTER +1 的預付款” &gt;&gt; “第二季的預付款”</li>
    ...
    'invoice_no' => '發票編號',
    'quote_no' => '報價單編號',
    'recent_payments' => '近期支付',
    'outstanding' => '未付清的',
    'manage_companies' => '處理公司資料',
    'total_revenue' => '總收入',
    'current_user' => '目前使用者',
    'new_recurring_invoice' => '新的週期發票',
    'recurring_invoice' => '週期發票',
    'new_recurring_quote' => '新的週期報價單',
    'recurring_quote' => '週期報價單',
    ...
    'no_passkeys_registered' => '此帳戶未註冊任何密碼。請使用密碼登錄，或先註冊一個密碼。',
    ...
    'archive_recurring_invoice' => '歸檔週期發票',
    'archived_recurring_invoice' => '歸檔週期發票成功',
    'delete_recurring_invoice' => '刪除週期發票',
    'deleted_recurring_invoice' => '刪除週期發票成功',
    'restore_recurring_invoice' => '復原週期發票',
    'restored_recurring_invoice' => '復原週期發票成功',
    'archive_recurring_quote' => '歸檔週期報價單',
    'archived_recurring_quote' => '歸檔週期報價單成功',
    'delete_recurring_quote' => '刪除週期報價單',
    'deleted_recurring_quote' => '刪除週期報價單成功',
    'restore_recurring_quote' => '復原週期報價單',
    'restored_recurring_quote' => '復原週期報價單成功',
    'archived' => '已歸檔',
    ...
    'recurring_due_dates' => '週期發票之應付款日期',
    ...
    'trial_card_authorization_notice' => '今天不會收取任何費用。我們會對您的信用卡進行1美元的臨時授權，驗證通過後會立即解除授權。您的銀行可能會短暫顯示該筆交易處於待處理狀態。 14天試用期結束後，您的信用卡將每月自動扣款14美元。您可以隨時取消訂閱。',
    'trial_card_verification_failed' => '我們無法驗證此信用卡。未產生任何費用。請使用至少有 1 美元可用額度的有效信用卡。',
    'trial_credit_card_required' => '僅接受信用卡付款。金融卡、預付卡和未分類卡均不予使用。未產生任何費用。',
    'trial_card_gateway_error' => '我們無法聯絡到發卡機構。未產生任何費用。請稍後再試。',
    'trial_card_release_failed' => '您的信用卡已獲得授權，但我們無法確認臨時授權已解除。您的試用尚未開始。請稍後再試或聯絡客服。',
    'trial_verification_in_progress' => '您的信用卡驗證正在處理中。請稍等片刻後重試。',
    'trial_no_longer_available' => '此帳戶已不再符合免費試用條件。',
    'overdue' => '逾期未付',
    ...
    'list_recurring_invoices' => '列出週期發票',
    ...
    'invoice_embed_documents' => '嵌入圖片/文檔',
    'invoice_embed_documents_help' => '請在發票中附上圖片/PDF文件。',
    ...
    'remove' => '刪除',
    'remove_failed_upload' => '刪除上傳失敗的文件',
...
一旦您收到這兩筆款項，請回到這個付款方式頁面，並點擊帳號旁邊的「完成驗證」。',
    ...
    'enable_recurring' => '啟用週期',
    'disable_recurring' => '停用週期',
    'text' => '文字',
    ...
    'recurring_expenses' => '週期支出',
    'recurring_expense' => '週期支出',
    'new_recurring_expense' => '新的週期支出',
    'edit_recurring_expense' => '編輯週期支出',
    'archive_recurring_expense' => '歸檔週期支出',
    'list_recurring_expense' => '列出週期支出',
    'updated_recurring_expense' => '更新週期支出成功',
    'created_recurring_expense' => '建立週期支出成功',
    'archived_recurring_expense' => '歸檔週期支出成功',
    'restore_recurring_expense' => '復原週期支出',
    'restored_recurring_expense' => '復原週期支出成功',
    'delete_recurring_expense' => '刪除週期支出',
    'deleted_recurring_expense' => '已成功刪除週期費用',
    'view_recurring_expense' => '檢視週期支出',
    'taxes_and_fees' => '稅金與費用',
    'import_failed' => '匯入失敗',
    'recurring_prefix' => '用以標示週期的前置符號',
    'options' => '選項',
    ...
    'preparing_canonical_pdf' => '準備規格 PDF',
    'preparing_server_preview' => '準備伺服器預覽',
    'processing' => '處理中',
    'reactivate' => '重新生效',
    ...
    'applied' => '應用',
    'applied_date' => '申請日期',
    'applied_amount' => '已應用金額',
    'applied_refunded' => '已申請退款',
    'include_recent_errors' => '包括日誌中的近期錯誤',
    ...
    'removed_recurring_invoice' => '已成功刪除週期發票',
    'search_recurring_invoice' => '搜尋 1 份週期發票',
    'search_recurring_invoices' => '搜尋:count週期發票',
    'send_date' => '發送日期',
    'auto_bill_on' => '自動計費開啟',
    ...
    'list_of_recurring_invoices' => '週期發票清單',
    ...
    'invoice_not_related_to_payment' => '發票號碼:invoice與本次付款無關。',
    'credit_not_related_to_payment' => '信用編號:credit與此付款無關',
    ...
    'recurring_invoice_number_taken' => '週期發票編號:number已使用',
    ...
    'activity_101' => ':user更新的週期發票:recurring_invoice',
    'activity_102' => ':user歸檔的週期發票:recurring_invoice',
    'activity_103' => ':user刪除週期發票:recurring_invoice',
    'activity_104' => ':user恢復週期發票:recurring_invoice',
    'new_login_detected' => '偵測到您的帳戶有新的登入資訊。',
    'new_login_description' => '您近期從新位置或裝置登入了您的 Invoice Ninja 帳戶：<br><br> <b>IP:</b> :ip<br><b>時間:</b> :time<br><b>電子郵件：</b> :email',
    ...
    'removed_recurring_expense' => '成功消除週期費用',
    'search_recurring_expense' => '搜尋週期費用',
    'search_recurring_expenses' => '搜尋週期費用',
    ...
    'remaining' => '其餘的',
    'invoice_paid' => '發票已付',
    'activity_120' => ':user創建週期費用:recurring_expense',
    'activity_121' => ':user更新週期費用:recurring_expense',
    ...
    'notification_invoice_overdue_subject' => '發票:invoice已逾期，應支付的款項為:client',
    'notification_invoice_overdue' => '以下發票:invoice （客戶為:client和:amount現已逾期。',
    'auto_sync' => '自動同步',
    ...
    'optional_recurring_products' => '可選的週期產品',
    'convert_matched' => '轉變',
    ...
    'invoices_by_month' => '按月開立發票',
    'payments_by_month' => '按月付款',
    'monthly_breakdown_skipped' => '跳過月度明細：日期範圍超過 24 個月',
    ...
    'taxable_sales' => '應稅銷售額',
    'exempt_sales' => '免稅銷售',
    'non_taxable_sales' => '非應稅銷售額',
    'zero_rated_sales' => '零稅率銷售',
    'accounting_basis' => '會計基礎',
    'tax_treatment' => '稅務處理',
    'summary_source' => '摘要來源',
    'sales_breakdown_source' => '銷售明細',
    'legacy_tax_detail_source' => '遺產稅詳情',
    'monthly_filing_summary' => '月度申報摘要',
    'filing_overview' => '文件概述',
    'jurisdiction_breakdown' => '管轄權劃分',
    'state_breakdown' => '狀態崩潰',
    'filing_period' => '申報期間',
    'period_start' => '期開始',
    'period_end' => '期末',
    'jurisdiction_source' => '管轄權來源',
    'tax_data_source' => '稅務數據',
    'client_shipping_source' => '客戶收貨地址',
    'client_billing_source' => '客戶帳單地址',
    'tax_detail_source' => '稅務詳情郵遞區號',
    'unknown_source' => '來源不明',
    'district' => '區',
    'metric' => '指標',
    'report_period' => '報告期間',
    'current_filing_rows' => '目前文件行',
    'correction_rows' => '更正行',
    'states_reported' => '各州報告',
    'jurisdictions_reported' => '已報告的司法管轄區',
    'rows_missing_state' => '缺少狀態的行',
    'rows_using_client_fallback' => '使用客戶端回退的行',
    'prior_period_corrections' => '前期更正',
    'corrections_review' => '更正審查',
    'original_tax_period' => '原始納稅期間',
    'correction_recorded_period' => '更正記錄期間',
    'correction_type' => '校正類型',
    'requires_review' => '需要審核',
    'current_period_activity' => '本期活動',
    'invoice_correction' => '發票更正',
    'payment_correction' => '付款更正',
    'status_correction' => '狀態修正',
    'legacy_unknown' => '未知遺產',
    'tax_summary' => '稅務摘要',
    'reporting_bucket' => '報告桶',
    'invoice_count' => '發票數量',
    'oauth_mail' => 'OAuth / 郵件',
    'preferences' => '優先',
    'analytics' => '分析',
    ...
    'payment_expired' => '付款已過期。請返回重試。',
    'payment_was_not_completed' => '付款未成功，請重試。',
    'no_compatible_app_installed' => '如果沒有任何反應，可能是您沒有安裝相容的應用程式。',
    'payment_type_Mobile Payment' => '行動支付',
    'gateway_temporarily_unavailable' => '此付款方式暫時無法使用。請稍後再試或選擇其他付款方式。',
    'mybank' => '網路商家',
    ...
    'nordigen_handler_error_contents_eua_failure' => '創建最終用戶協議時發生錯誤：',
    ...
    'show_pdfhtml_on_mobile' => '在行動裝置上查看時顯示 HTML 版本',
    ...
    'use_unapplied_payments' => '使用未應用付款',
    ...
    'upcoming_recurring_invoices' => '即將開立的週期發票',
    ...
    'quick_actions' => '快速行動',
    'end_all_sessions_help' => '註銷所有用戶，要求用戶重新進行身份驗證。',
    ...
    'peppol_credits_info' => '發送和接收電子發票需要電子信用額度。電子信用額度以單據收費。如果您已有信用額度，請點選「繼續」。',
    'buy_credits' => '購買電子積分',
    ...
    'currency_central_african_cfa_franc' => '中非金融合作法郎',
    ...
    'peppol_negative_line_price' => '電子發票中，單價不能為負數。請輸入正數價格，並將任何減價以折扣或負數量的形式應用。',
    'account_holder' => '帳戶名稱',
    ...
    'use_system_fonts' => '使用系統字體',
    'use_system_fonts_help' => '使用網頁瀏覽器中的字體覆蓋標準字體。',
    'active_tasks' => '目前任務',
    'of_budget' => '預算',
    'invoiced_hours' => '已開票工時',
    'less' => '較少的',
    'enable_notifications' => '啟用通知',
    'enable_public_notifications' => '啟用公共通知',
    'enable_public_notifications_help' => '啟用 Invoice Ninja 的即時通知。',
    'navigate' => '導航',
    'calculate_taxes_warning' => '此操作將啟用明細稅並停用總稅。所有未結帳發票都可能使用新設定重新計算！',
    'activity_149' => ':user透過電子郵件向:credit :client TXEND，用於抵扣:contact費用。',
    'email_history_empty' => '未找到郵件歷史記錄，此功能僅在使用 Postmark/Mailgun 發送郵件時可用。',
    'e_invoicing' => '電子發票',
    'einvoice_token_not_found' => '未找到電子發票令牌。請前往「設定」&gt;「電子發票」重新產生令牌。',
    'regenerate' => '再生',
    'subscription_unavailable' => '此商品已售罄。',
    'currency_samoan_tala' => '薩摩亞塔拉',
    'confirm_duplicate_gateway' => '您確定要建立另一個連線嗎？',
    'clients_limit' => '您的用戶端數量已達上限，請升級您的套餐。',
    'remaining_hours' => '剩餘時間',
    'just_now' => '現在',
    'yesterday' => '昨天',
    'enable_client_profile_update' => '允許客戶更新其個人資料',
    'enable_client_profile_update_help' => '允許客戶透過客戶入口網站更新其個人資料資訊。',
    'preference_product_notes_for_html_view' => '使用 HTML 視圖中的項目備註',
    'preference_product_notes_for_html_view_help' => '如果以 HTML 格式顯示發票，請優先顯示商品描述而不是商品標題。',
    'project_report' => '專案報告',
    'unlock_invoice_documents_after_payment' => '付款後解鎖文檔',
    'unlock_invoice_documents_after_payment_help' => '允許客戶在發票付款後存取發票文件。',
    'quickbooks' => 'QuickBooks',
    'disable_emails' => '停用電子郵件',
    'disable_emails_error' => '您無權發送電子郵件。',
    'disable_emails_help' => '阻止使用者從系統發送電子郵件',
    'add_location' => '新增位置',
    'updated_location' => '更新位置',
    'created_location' => '建立位置',
    'sync_send_time' => '同步發送時間',
    'sync_send_time_help' => '更新所有提醒/定期發票，使其使用此新的發送時間',
    'edit_location' => '編輯位置',
    'downgrade' => '降級',
    'downgrade_to_free' => '降級至免費套餐',
    'downgrade_to_free_description' => '這將從您的帳戶中移除所有付費功能。',
    'delete_location' => '刪除位置',
    'delete_location_confirmation' => '這將從客戶記錄中刪除位置資訊。',
    'add_card_reminder' => '您可以隨時再次新增銀行卡。',
    'free_trial_then' => '免費試用，然後',
    'days_left' => ':day剩餘天數',
    'days_trial' => ':day s 天試用',
    'pro_plan_label' => '忍者職業',
    'enterprise_plan_label' => '企業',
    'premium_business_plus_label' => '高級商務+',
    'pro_plan_feature_1' => '客戶和發票數量不限',
    'pro_plan_feature_2' => '刪除“由 Invoice Ninja 建立”',
    'pro_plan_feature_3' => '透過 Gmail 和 Microsoft 發送電子郵件發票',
    'pro_plan_feature_4' => '透過您自訂的 SMTP 發送電子郵件發票',
    'pro_plan_feature_5' => '品牌網址：「您的網站」。 Invoicing.co',
    'pro_plan_feature_6' => '11款專業發票模板',
    'pro_plan_feature_7' => '自訂發票設計',
    'pro_plan_feature_8' => '與第三方應用程式的 API 集成',
    'pro_plan_feature_9' => '客戶端入口網站密碼保護',
    'pro_plan_feature_10' => '設定自動提醒郵件',
    'pro_plan_feature_11' => '自動將發票PDF附件新增至電子郵件中',
    'pro_plan_feature_12' => '在發票上顯示客戶電子簽名',
    'pro_plan_feature_13' => "啟用“批准條款”複選框",
    'pro_plan_feature_14' => '報表：發票、費用、損益表等',
    'pro_plan_feature_15' => '大量電子郵件發票、報價單、貸項通知單',
    'pro_plan_feature_16' => '用一個登入帳號連結 10 家公司',
    'pro_plan_feature_17' => '建立唯一的“客戶群組”設置',
    'pro_plan_feature_18' => '美國各州汽車銷售稅計算',
    'enterprise_plan_feature_1' => '其他帳戶使用者和權限',
    'enterprise_plan_feature_2' => '上傳並附加文件',
    'enterprise_plan_feature_3' => '自訂門戶域名',
    'enterprise_plan_feature_4' => '銀行帳戶同步',
    'premium_business_plus_feature_1' => '開發商禮賓服務',
    'premium_business_plus_feature_2' => '直接優先支持',
    'premium_business_plus_feature_3' => '發票設計服務',
    'premium_business_plus_feature_4' => '功能請求優先權',
    'premium_business_plus_feature_5' => '資料遷移助手',
    'premium_business_plus_feature_6' => '建立自訂報告',
    'upgrade_popup_headline' => '不僅僅是開立發票',
    'upgrade_popup_description' => '定價簡單明了，功能強大。',
    'upgrade_popup_pro_headline' => '一年內只需支付 10 個月的費用，另加 2 個月免費！',
    'upgrade_popup_enterprise_headline' => '一年內只需支付 10 個月的費用，另加 2 個月免費！',
    'upgrade_popup_premium_business_plus_headline' => '專業版 + 企業版 + 高級商務禮賓服務',
    'all_free_features_plus' => '所有免費功能 +',
    'all_pro_features_plus' => '所有專業功能 +',
    'all_features_plus' => '所有功能 +',
    'upgrade_plan' => '升級計劃',
    'upgrade_popup_premium_business_plus_pricing' => '價格？咱們聊聊！',
    'plan_selected' => '方案已選定',
    'invalid_date_create_syntax' => '日期語法無效',
    'start_and_end_date_required' => '需要填寫開始日期和結束日期。',
    'project_value' => '專案價值',
    'invalid_csv_data' => 'CSV 資料無效，匯入已取消。',
    'selected_products' => '精選商品',
    'create_company_error_unauthorized' => '您沒有權限建立公司。只有帳戶所有者才能創建公司。',
    'deleted_location' => '位置已刪除',
    'currency_caribbean_guilder' => '加勒比海公爵領',
    'is_shipping' => '是否出貨',
    'added_location' => '位置添加成功',
    'send_emails' => '傳送電子郵件',
    'send_emails_permission' => '允許使用者發送電子郵件',
    'cancel_trial' => '取消試用',
    'cancel_trial_description' => '這將取消您的試用期，並從您的帳戶中移除所有付費功能。',
    'existing_gateway' => '網關已存在',
    'docuninja' => 'DocuNinja',
    'pro_rata' => '按比例',
    'change_docuninja_plan' => '更改 DocuNinja 計劃',
    'downgrade_end_of_cycle' => '您的套餐將在目前計費週期結束時自動降級。',
    'docuninja_change_users' => 'DocuNinja 新的使用者限制',
    'docuninja_disable_warning' => '這將移除您對DocuNinja帳戶的所有存取權。',
    'docuninja_downgrade_info' => '您的使用者限額將在目前計費週期結束時自動減少。',
    'docuninja_grant_access_help' => '授予 Invoice Ninja 使用者對 DocuNinja 的存取權限',
    'recurring_invoice_item' => '循環發票項目',
    'disable_recurring_payment_notification' => '禁用定期付款通知',
    'disable_recurring_payment_notification_help' => '不會發送定期帳單付款成功的通知。',
    'invoice_outstanding_tasks' => '待處理發票任務',
    'payment_schedule' => '付款計劃',
    'time_zone' => '時區',
    'tax_names' => '稅名',
    'auto_bill_help' => '如果啟用此功能，則在計劃運行時，系統將嘗試以計劃金額自動扣款。',
    'choose_schedule_type' => '選擇日程類型',
    'split_payments' => '分期付款',
    'split_payments_help' => '將發票金額分割成多筆款項，並在一段時間內支付。例如，分 4 個月支付 4 次。',
    'custom_schedule' => '手動建立自訂付款計劃',
    'custom_schedule_help' => '建立自訂付款計劃，允許為每個計劃設定特定的日期和金額。',
    'schedule_frequency_help' => '每次付款之間的間隔時間',
    'first_payment_date' => '首次付款日期',
    'first_payment_date_help' => '首次付款日期',
    'payment_schedule_interval' => '付款： :total的索引，用於:amount',
    'payment_schedule_table' => '付款： :date的金鑰，用於:amount',
    'auto_send' => '自動發送',
    'auto_send_help' => '自動將發票透過電子郵件發送給客戶',
    'include_project_tasks' => '包含專案任務',
    'include_project_tasks_help' => '此外，也要對專案中的任務進行開票。',
    'tax_nexus' => '稅務關係',
    'tax_period_report' => '稅務期報告',
    'creator' => '由…創建',
    'ses_topic_arn_help' => 'SES 主題（可選，僅用於 webhook 追蹤）',
    'ses_region_help' => 'AWS 區域，即 us-east-1',
    'ses_secret_key' => 'SES 密鑰',
    'ses_access_key' => 'SES 存取密鑰 ID',
    'lifecycle' => '生命週期',
    'order_columns' => '列排序',
    'topic_arn' => '主題 ARN',
    'lang_Catalan' => '加泰隆尼亞語',
    'lang_Afrikaans' => '南非荷蘭語',
    'lang_Indonesian' => '印尼',
    'replaced' => '已更換',
    'ses_from_address' => '來自地址的 SES',
    'ses_from_address_help' => '寄件者電子郵件地址必須在 AWS 中經過驗證。',
    'unauthorized_action' => '您無權執行此操作',
    'einvoice_received_subject' => '已收到電子發票',
    'einvoice_received_body' => '您已收到:count新電子發票。<br><br>登入後即可查看。',
    'download_files_too_large' => '部分文件過大，無法直接作為附件發送到您的郵箱。請使用以下連結單獨下載這些文件。',
    'restore_disabled_verifactu' => '發票一旦刪除，便無法恢復。',
    'delete_disabled_verifactu' => '發票一旦被取消或修改，就無法刪除。',
    'rectify' => '整流劑',
    'verifactu_invoice_send_success' => '發票:invoice （ :client已成功寄送至 AEAT',
    'verifactu_invoice_sent_failure' => '發票:invoice （ :client寄至 AEAT :notes失敗',
    'verifactu_cancellation_send_success' => '已成功向 AEAT 發送:invoice發票取消請求',
    'verifactu_cancellation_send_failure' => ':invoice的發票取消請求發送至 AEAT :notes失敗',
    'verifactu' => 'Verifactu',
    'justify' => '證明合法',
    'outdent' => '凹痕',
    'indent' => '縮排',
    ...
    'feedback' => '回饋',
    'feedback_modal_description' => '我們非常希望聽到您的回饋！',
    'do_not_ask_again' => '不要再問了',
    'not_likely' => '不太可能',
    'extremely_likely' => '極有可能',
    'feedback_slider_title' => '您有多大可能向朋友或同事推薦 Invoice Ninja？',
    'actual_delivery_date' => '實際交貨日期',
    'actual_delivery_date_help' => '跨境結算時有時需要此項。用於確定貨物的確切交付日期。',
    'invoice_period' => '發票週期',
    'invoice_period_help' => '界定提供服務的期限。',
    'paused_recurring_invoice_helper' => '注意！重新啟動定期發票時，請確保下次發送日期在未來。',
    'thank_you_for_feedback' => '感謝您的回饋！',
    'use_legacy_editor' => '使用舊版所見即所得編輯器',
    'use_legacy_editor_help' => '使用 TinyMCE 編輯器。',
    'enable_e_invoice_received_notification' => '啟用電子發票接收通知',
    'enable_e_invoice_received_notification_help' => '收到新的電子發票時，您將收到電子郵件通知。',
    'price_changes' => '2026年1月1日起計畫價格變更',
    'notification_quote_rejected_subject' => '報價:quote被:client拒絕',
    'notification_quote_rejected' => '下列用戶端:client拒絕了:quote的報價，該報價用於:amount :notes 。',
    'activity_150' => '帳號已刪除:notes',
    'activity_151' => '客戶端:notes已由:client合併至:user中。',
    'activity_152' => '供應商:notes已由:vendor合併至:user中。',
    'activity_153' => '用戶端:notes已被:user清除',
    'activity_154' => '電子發票:invoice （ :client已成功寄送至 AEAT。',
    'activity_155' => '電子發票:invoice （收件者： :client寄至 AEAT :notes失敗',
    'activity_156' => '已成功向 AEAT 發送:invoice發票取消請求',
    'activity_157' => ':invoice的發票取消請求發送至 AEAT :notes失敗',
    'activity_158' => '報價:quote被:client和:notes拒絕。',
    'quotes_with_status_sent_can_be_rejected' => '只有狀態為「已發送」的報價才能被拒絕。',
    'reject' => '拒絕',
    'rejected' => '已拒絕',
    'reject_quote' => '拒絕報價',
    'reject_quote_confirmation' => '您確定要拒絕這份報價嗎？',
    'reason' => '原因',
    'enter_reason' => '請輸入原因…',
    'notification_invoice_overdue_summary_subject' => '逾期發票總表： :date',
    'notification_invoice_overdue_summary' => '以下發票已逾期：',
    'purge_user_confirmation' => '警告！此操作會將所有實體重新指派給帳戶擁有者，並永久刪除所有公司和帳戶中的該使用者。您確定要繼續嗎？',
    'peppol_sending_failed' => '電子發票發送失敗！',
    'peppol_sending_success' => '電子發票已成功發送！',
    'auto_generate' => '自動生成',
    'mollie_payment_pending' => '您的付款正在處理中，請稍候。處理完成後，我們將透過電子郵件通知您。',
    'over_payment_helper' => '可選：您可以支付比此處顯示金額更多的費用。 （例如小費或向上取整）',
    'new_resource' => '新資源',
    'drop_your_logo_here' => '在這裡留下您的徽標，或點擊瀏覽',
    'save_to_enable_health_check' => '儲存網關變更後，即可進行健康檢查。',
    'audit_log' => '審計日誌',
    'clone_to_template' => '克隆到模板',
    'clone_document_description' => '克隆到新文檔',
    'add_signatories' => '新增簽署人',
    'authorized_to_sign' => '獲授權簽署',
    'ninja_quote_notification' => '已簽署的報價通知',
    'ninja_invoice_notification' => '發票已簽署通知',
    'ninja_credit_notification' => '信用簽名通知',
    'ninja_purchase_order_notification' => '採購訂單已簽署通知',
    'email_client_when_quote_signed_description' => '報價單簽署後，電子郵件用戶端將收到通知。',
    'email_client_when_invoice_signed_description' => '發票簽署後，電子郵件用戶端將收到通知。',
    'email_client_when_credit_signed_description' => '信用協議簽署後，電子郵件用戶端將收到通知。',
    'email_vendor_when_purchase_order_signed_description' => '採購訂單簽署後，請透過電子郵件通知供應商。',
    'custom_document_completed' => '海關文件已完成',
    'email_client_when_custom_document_completed' => '自訂文件簽署後，將透過電子郵件通知客戶端。',
    'sender' => '寄件人',
    'create_template' => '建立模板',
    'edit_template' => '編輯模板',
    'delete_template' => '刪除模板',
    'template_created' => '建立模板',
    'template_updated' => '模板已更新',
    'template_deleted' => '模板已刪除',
    'template_name' => '模板名稱',
    'template_description' => '模板描述',
    'document_type' => '文件類型',
    'document_type_description' => '選擇要設定簽署的文檔類型',
    'new_signatory' => '新簽署人',
    'signatory' => '簽署人',
    'invoice_ninja_template_description' => '自訂 Invoice Ninja 文件（例如發票、報價單等）上的簽章位置',
    'activity_159' => '發票:invoice （對應:client已簽署',
    'activity_160' => ':quote :client報價單已簽署。',
    'activity_161' => ':credit的信用額度已簽署， :client已簽署。',
    'activity_162' => '採購訂單:purchase_order （商品編號:vendor已簽署',
    'activity_163' => '自訂文件： :client的文件已簽名',
    'activity_164' => 'QuickBooks 同步失敗。 TXPROTECT :notes',
    'activity_165' => 'QuickBooks 同步成功。 TXPROTECT :notes',
    'create_your_own' => '創建你自己的',
    'create_your_own_description' => '建立您自己的模板，並使用您自己的 PDF 文件進行上傳。',
    'new_template_description' => '選擇我們預先製作的範本之一即可開始，例如保密協議、銷售協議等。',
    'choose_template_type' => '選擇要建立的範本類型',
    'template' => '範本',
    'templates' => '範本',
    'new_template' => '新模板',
    'user_limit_reached' => '用戶不夠用？升級套餐吧！',
    'requires_approval' => '需要審批',
    'document_viewed_notification' => '查看文件通知',
    'document_created_notification' => '建立文件通知',
    'document_sent_notification' => '已發送文件通知',
    'document_signed_notification' => '文件已簽署通知',
    'document_completed_notification' => '文件已完成通知',
    'document_rejected_notification' => '文件被拒絕通知',
    'document_voided_notification' => '文件作廢通知',
    'document_expired_notification' => '文件過期通知',
    'document_created' => '已建立文檔',
    'template_loaded' => '模板已載入',
    'select_user_or_client' => '選擇使用者或客戶端',
    'docuninja_quota_available_but_no_users' => '請先將使用者新增至 Invoice Ninja，然後在此處授予他們 DocuNinja 的存取權限。',
    'send_confirmation' => '發送確認訊息',
    'send_emails_to_following' => '我們將向以下地址發送電子郵件：',
    'document_queued_for_sending' => '文件已排隊等待發送',
    'document_voided' => '文件作廢',
    'view_document' => '查看文件',
    'make_template' => '建立模板',
    'use_template' => '使用模板',
    'map_signatories' => '地圖簽署人',
    'map_signatories_instructions' => '將簽署人分配給模板',
    'total_signatories' => '簽署人總數',
    'mapped' => '已對應',
    'docuninja_splash_message' => '正在加載 DocuNinja...',
    'docuninja_contact_admin_for_access' => '請聯絡您的管理員以取得 DocuNinja 的存取權限。',
    'void' => '空白',
    'invitation_signatory_help' => '文件依序簽署，第一位簽署人簽署後，下一位簽署人才能簽署。',
    'timeline' => '時間軸',
    'cloned_document' => '文檔克隆',
    'voided_document' => '文件作廢',
    'voided' => '無效',
    'archive_document_description' => '您確定要將此文件存檔嗎？',
    'restore_document_description' => '您確定要還原此文件嗎？',
    'delete_document_description' => '您確定要刪除此文件嗎？',
    'document_archived' => '文件已存檔',
    'document_restored' => '文件已恢復',
    'document_deleted' => '文件已刪除',
    'sign_now' => '立即註冊',
    'signed_document' => '已簽署文件',
    'tour_document_upload' => '若要開始簽署，請在此處上傳您的文件。將檔案拖曳到此區域即可。',
    'tour_signatory_selector' => '這是簽署人選擇器。使用它來管理文件的簽署人。選擇一位簽署人繼續。',
    'tour_continue_select_signatory' => '接下來請選出一位簽名人。',
    'tour_toolbox_description' => '右側是工具箱。您可以使用它來添加供簽署人互動的欄位和元素。簽名欄位已選取。點擊繼續。',
    'tour_document_canvas' => '這是您的文件畫布。請在此處放置和定位簽名者的欄位。',
    'tour_save_document' => '完成後，請點擊此處儲存文件。',
    'create_signature' => '建立簽名',
    'signature_name' => '簽名',
    'close_tab' => '關閉標籤頁',
    'sign' => '符號',
    'add_open_exchange' => '新增開放交換密鑰',
    'all_entity_types_created' => '已建立的所有實體類型',
    'amount_must_be_greater_than_zero' => '金額必須大於零',
    'autobill_failure' => '自動扣款失敗',
    'autobill_success' => '自動扣款成功',
    'available' => '可用的',
    'blueprint' => '藍圖',
    'capabilities' => '能力',
    'card_holder_help' => '持卡人姓名',
    'cards' => '牌',
    'charts' => '圖表',
    'company_logo' => '公司標誌',
    'create_client_or_user' => '創建客戶端或用戶',
    'create_docuninja_account' => '建立 DocuNinja 帳戶',
    'create_recurring_expense' => '創建定期支出',
    'create_recurring_invoice' => '建立定期發票',
    'create_recurring_quote' => '建立定期報價',
    'create_subscription' => '建立訂閱',
    'create_user' => '創建用戶',
    'created' => '創建',
    'creating' => '創建',
    'credit_signed_notification' => '信用簽名通知',
    'customize_cards' => '自訂卡片',
    'datatable' => '數據表',
    'date_must_be_after_previous_schedule' => '日期必須在前一個日程安排之後',
    'default_checkbox_label' => '預設複選框',
    'default_multiselect_label' => '預設多選',
    'default_radio_group_label' => '預設單選按鈕組',
    'default_select_label' => '預設選擇',
    'delete_document' => '刪除文檔',
    'delete_docuninja_document' => '刪除文件',
    'delete_docuninja_document_confirmation' => '您確定要從文件中刪除此文件嗎？',
    'delete_subscription' => '刪除訂閱',
    'disable_docuninja' => '停用 DocuNinja',
    'document_not_found' => '未找到文檔',
    'docuninja_access_grant_failed' => '',
    'docuninja_access_granted_successfully' => 'DocuNinja 存取權限已成功授予',
    'download_signed_document' => '下載已簽署文件',
    'e_expense_created' => '電子費用創建',
    'edit_rule' => '編輯規則',
    'einvoice_delivery_failure' => '電子發票發送失敗',
    'einvoice_delivery_success' => '電子發票交付成功',
    'einvoice_sent' => '已發送電子發票',
    'element' => '元素',
    'email_invoice_failed' => '郵件發送失敗',
    'empty_checkbox_label' => '空白複選框',
    'end_of_month' => '月底',
    'error_fetching_pricing' => '取得價格資訊時出錯',
    'exchange_rate_not_enabled' => '匯率功能未啟用',
    'failed_payment' => '付款失敗',
    'field_is_required' => '此欄位為必填項',
    'generate' => '產生',
    'google_drive' => 'Google 雲端硬碟',
    'initials' => '首字母',
    'initials_description' => '首字母描述',
    'invalid_state' => '無效狀態',
    'invoice_signed_notification' => '發票已簽署通知',
    'link_copied' => '連結已複製',
    'make_template_description' => '建立您自己的模板，並使用您自己的 PDF 文件進行上傳。',
    'manage' => '管理',
    'multiselect_needs_two_options' => '多選需要兩個選項',
    'no_cards_selected' => '未選擇任何卡片',
    'no_templates_found' => '未找到模板',
    'nordigen' => 'Nordigen',
    'pages' => '頁',
    'passed' => '透過',
    'payment_emailed' => '付款已透過電子郵件發送',
    'payment_successful' => '付款成功',
    'pdf_password_required' => 'PDF密碼',
    'pending_approval' => '待批准',
    'pending_file' => '待處理文件',
    'please_select_at_least_one_user' => '請至少選擇一位用戶',
    'please_select_plan' => '請選擇方案',
    'please_select_signer' => '請選擇一位簽名人',
    'proformal_invoices' => '形式發票',
    'purchase_order_signed_notification' => '採購訂單已簽署通知',
    'queue' => '佇列',
    'quote_field' => '引用字段',
    'quote_signed_notification' => '已簽署通知',
    'radio_needs_two_options' => '收音機需要兩個選項',
    'recipient' => '接受者',
    'redirect' => '重定向',
    'refundable' => '可退款',
    'remove_invitations' => '刪除邀請',
    'removing' => '移除',
    'requirements' => '要求',
    'restore_subscription' => '恢復訂閱',
    'sales_above_threshold' => '銷售額超過門檻',
    'save_to_add_locations' => '儲存以新增位置',
    'saving' => '儲存',
    'select_design' => '選擇設計',
    'select_needs_two_options' => '選擇需要兩個選項',
    'sending' => '傳送',
    'setting_up' => '設定',
    'setup_company' => '成立公司',
    'signature-placeholder' => '簽章佔位符',
    'signature:font-updated' => '簽名字體已更新',
    'signature_description' => '簽名描述',
    'snappdf_not_enabled' => 'Snappdf 未啟用',
    'start_signing' => '開始簽名',
    'successfully_signed_document' => '文件簽署成功',
    'swap_signatory' => '交換簽署人',
    'template_details' => '模板詳情',
    'tips_and_notes' => '提示和筆記',
    'too_many_files' => '文件過多',
    'type_signature' => '類型簽名',
    'untitled_document' => '未命名文檔',
    'untitled_template' => '無標題模板',
    'update_recurring_expense' => '更新經常性支出',
    'update_recurring_invoice' => '更新定期發票',
    'update_recurring_quote' => '更新定期報價',
    'update_subscription' => '更新訂閱',
    'update_user' => '更新用戶',
    'upgrade_account_message' => '升級帳戶訊息',
    'upgrade_now' => '立即升級',
    'upgrade_plan_docuninja' => '升級您的方案即可啟用 DocuNinja',
    'use_signature' => '使用簽名',
    'use_snappdf' => '使用 snappdf',
    'user_note' => '使用者說明',
    'vendor_notification_email' => '供應商通知郵件',
    'void_document_description' => '作廢文件描述',
    'voided_payment' => '付款已取消',
    'welcome_to_docuninja' => '歡迎來到DocuNinja',
    'yodlee' => '約德利',
    'location_name' => '地點名稱',
    'quote_rejected' => '報價被拒',
    'e_invoice_received_notification' => '電子發票已收到通知',
    'e_invoice_received_notification_help' => '收到電子發票後發送電子郵件',
    'location_field' => '位置字段',
    'access_key' => '存取密鑰',
    'payment_type_FPX' => 'FPX',
    'payment_type_Stripe Bank Transfer' => 'Stripe銀行轉賬',
    'activity_166' => '使用者:notes已被:user清除',
    'purged_user' => '已成功清除用戶',
    'quickbooks_connect_description' => '將您的 QuickBooks 帳戶連接到 Invoice Ninja，即可自動同步您的交易和發票。',
    'sync_direction_description' => '這些設定決定了 Invoice Ninja 如何與 QuickBooks 同步。',
    'sync_direction_none_help' => 'Invoice Ninja 不會與 QuickBooks 進行任何資料同步。',
    'sync_direction_pull_help' => 'Invoice Ninja 將從 QuickBooks 中提取資料。',
    'sync_direction_push_help' => 'Invoice Ninja會將資料推送至QuickBooks。',
    'sync_direction_bidirectional_help' => 'Invoice Ninja 既可以提取數據，也可以將數據匯入 QuickBooks。',
    'sync_settings' => '同步設定',
    'realm_id' => 'QB 領域 ID',
    'default_income_account' => '預設收入帳戶',
    'automatic_taxes' => '自動課稅',
    'automatic_taxes_help' => '在 QuickBooks 中啟用自動徵稅 (AST) 後，Invoice Ninja 將首先在 QuickBooks 中建立發票，然後將完整的發票拉回 Invoice Ninja。',
    'pull' => '拉',
    'push' => '推',
    'bidirectional' => '雙向',
    'sync_started' => '同步已開始',
    'quickbooks_read_only_data' => 'QuickBooks收入帳戶和儲存的稅率',
    'hide_peppol_sent_status' => '隱藏 Peppol 發送狀態',
    'quickbooks_requires_reauth' => 'QuickBooks需要重新驗證身份',
    'quickbooks_requires_reauth_body' => '您的 QuickBooks 連線已過期，需要重新驗證。請登入管理員入口網站並重新連接您的 QuickBooks 帳戶。我們將每天向您發送此通知，直到問題解決為止。',
    'crop_logo' => '裁剪標誌',
    'passkey' => '通行金鑰',
    'login_with_passkey' => '使用密碼登入',
    'manage_passkeys' => '管理密碼',
    'last_used' => '上次使用',
    'unapplied_payments' => '未應用付款',
    'debit' => '借方',
    'auto_convert_credit_help' => '自動連結或建立符合這些規則的付款。',
    'clone_client_description' => '這將把客戶資訊克隆到一個新的客戶記錄中。',
    'invalid_id_number_format' => '無效的身份證號碼格式',
    'invalid_vat_number_format' => '無效的增值稅號格式',
    'invalid_routing_id_format' => '無效的路由 ID 格式',
    'invalid_id_number_checkdigit' => '無效的身分證號碼：校驗位錯誤，請檢查號碼是否正確。',
    'invalid_vat_number_checkdigit' => '增值稅號無效：校驗位錯誤，請核對號碼是否正確。',
    'invalid_routing_id_checkdigit' => '無效的路由ID：校驗位錯誤，請檢查號碼是否正確。',
    'sign_the_document' => '簽署文件',
    'client_not_found_on_peppol_network' => '無法在 PEPPOL 網路上辨識客戶端。',
    'too_many_requests' => '請求過多',
    'custom_text_with_formatting' => '自訂文字格式',
    'client_name_and_address' => '客戶姓名和地址',
    'bill_to' => '記帳到：',
    'entity_details' => '數字、日期、到期日、金額、餘額',
    'product_line_items_with_columns' => '產品線項目（包含列）',
    'task_line_items_with_columns' => '包含列的任務列項目',
    'divider_line' => '水平隔板',
    'signature_line' => '簽名區域',
    'authorized_signature' => '授權簽名',
    'essential' => '基本的',
    'public_notes_will_appear_here' => '公開通知將顯示在此。',
    'footer_will_appear_here' => '頁尾將顯示在此處',
    'terms_will_appear_here' => '條款將顯示在此處',
    'sepa_qr' => 'SEPA二維碼',
    'swiss_qr' => '瑞士QR',
    'spc_qr' => 'SPC QR',
    ...
    'copy_block_to_clipboard' => '複製區塊到剪貼簿',
    'duplicate_block' => '重複區塊',
    'delete_block' => '刪除區塊',
    'height_placeholder_example' => '例如，40像素',
    'select_starting_point_for_invoice_design' => '選擇發票設計的起點',
    'no_templates_found_in_category' => '此類別中未找到模板',
    'preview_uses_sample_data' => '預覽使用範例數據',
    'download_html' => '下載 HTML',
    'blocks_in_design' => '設計中的模組',
    'actual_invoices_use_real_data' => '實際發票將使用真實的客戶和發票資料。',
    'cloned_client' => '客戶端克隆成功',
    'update_tax_details' => '更新稅務詳情',
    'cc_only' => '僅限 CC',
    'e_invoice_forward_email' => 'PEPPOL 轉寄電子郵件服務',
    'e_invoice_forward_email_help' => '將發送的電子發票轉發給 Yuki 或 WinAuditor 等第三方處理服務商。',
    'skip_automatic_email_with_peppol' => '透過 PEPPOL 發送郵件時停用電子郵件',
    'skip_automatic_email_with_peppol_help' => '如果啟用此功能，透過 PEPPOL 網路傳送的發票將不會透過電子郵件傳送給客戶。',
    'web_session_timeout_help' => '瀏覽器會話保持活動狀態直至註銷的時間。',
    'password_timeout_help' => '管理者密碼需要重新輸入的時間。',
    'invoice_status_paid' => '發票已付款！記錄已更新。',
    'attach_audit_log_to_completed_email' => '將審計日誌附加到已完成的電子郵件中。',
    'attach_audit_log_to_completed_email_help' => '如果啟用，審計日誌將作為附件新增至已簽署文件的完成電子郵件中。',
    'e_expense_forward_email' => '費用轉發電子郵件服務',
    'e_expense_forward_email_help' => '將收到的電子費用轉發給第三方處理服務商，例如 Yuki 或 WinAuditor。',
    'regenerate_token' => '重新產生令牌',
    'token_regenerated' => '令牌已成功重新生成',
    'token_regeneration_failed' => '令牌重新生成失敗',
    'show_header' => '顯示頁眉',
    'select_a_component_to_edit_properties' => '選擇要編輯的元件',
    'drag_and_drop_to_add' => '拖放添加',
    'max_width' => '最大寬度',
    'max_height' => '最大高度',
    'alignment' => '結盟',
    'object_fit' => '物件擬合',
    ...
    'text_color' => '文字顏色',
    'font_style' => '字體樣式',
    'alternate_row_colors' => '隔行顏色',
    'show_borders' => '顯示邊框',
    'cell_padding' => '細胞填充',
    'suffix' => '後綴',
    'hide_if_empty' => '如果為空則隱藏。',
    'qr_code' => 'QR 圖碼',
    'qr_code_type' => 'QR 圖碼類型',
    'label_padding' => '標籤周圍留有空白。',
    'value_padding' => '每個數值周圍都要留空格。',
    'label_value_gap' => '標籤與價值之間的差距。',
    'row_spacing' => '每行之間有多少垂直空間。',
    'value_min_width' => '值的最小寬度。',
    'restored_template' => '模板已成功恢復',
    'archived_template' => '模板已成功存檔',
    'deleted_template' => '模板已成功刪除',
    'top' => '頂部',
    'table_rows' => '列',
    'style' => '風格',
    'widget_defaults' => '小部件預設值',
    'show_label' => '顯示標籤',
    'show_label_help' => '在控制項值旁邊顯示控制項標籤。',
    'widget_border_style' => '小部件邊框樣式',
    'widget_border_style_help' => '小部件區域的邊框樣式。',
    'widget_border_color' => '小部件邊框顏色',
    'widget_border_color_help' => '小部件區域周圍邊框的顏色。',
    'card_already_exists' => '卡片已存在',
    'income_account' => '收入帳戶',
    'payment_period' => '付款期限',
    'payment_period_help' => '支付完成所需時間（秒）。可接受範圍：60 - 600。',
    'payware_partner_id_label' => '合作夥伴識別符',
    'payware_partner_id_help' => '報名後由付費軟體提供',
    'payware_vpos_id_label' => 'webPOS 識別符',
    'payware_vpos_id_help' => '來自支付軟體控制面板的 webPOS 標識符',
    'payware_public_key_help' => '用於 Webhook 簽章驗證的 RSA 公鑰',
    'gateway_onboarding_description' => '您的支付網關已成功連線。現在您可以配置付款方式並設定交易限額或手續費。',
    'gateway_onboarding_payment_methods_help' => '啟用或停用客戶可接受的付款方式。',
    'gateway_onboarding_limits_fees_help' => '設定最低和最高交易限額並配置手續費。',
    'gateway_setup_complete' => '網關設定完成',
    'activity_167' => '電子發票:invoice狀態已更新為:notes',
    'activity_168' => ':notes用於:client',
    'activity_169' => ':notes用於:client',
    'peppol_accepted' => '收款方已接受電子發票。',
    'peppol_rejected' => '電子發票被收件人拒收。',
    'peppol_partially_paid' => '電子發票已部分付款。',
    'peppol_paid' => '電子發票已支付。',
    'server_not_reachable' => '伺服器無法連接。請檢查您的網路連接，稍後再試。',
    'connecting_calendar' => '連結您的日曆…',
    'redirecting' => '正在重定向…',
    'calendar_connection_denied' => '連線已取消',
    'calendar_connection_denied_body' => '您已取消連線。您可以隨時重試。',
    'calendar_handoff_expired' => '連結連結已過期',
    'calendar_handoff_expired_body' => '連線已失效，請重新連線。',
    'calendar_handoff_invalid' => '連線失敗',
    'calendar_handoff_invalid_body' => '連線驗證出錯，請重試。',
    'calendar_connect_failed' => '日曆連線失敗',
    'calendar_connect_failed_body' => '日曆連線失敗，請稍後再試。',
    'back_to_calendar' => '返回日曆',
    'tag' => '標籤',
    'new_tag' => '新標籤',
    'edit_tag' => '編輯標籤',
    'task_tags' => '任務標籤',
    ...
    'created_tag' => '標籤創建成功',
    'updated_tag' => '標籤已成功更新',
    'archived_tag' => '標籤已成功歸檔',
    'restored_tag' => '標籤已成功恢復',
    'deleted_tag' => '標籤已成功刪除',
    'e_reporting_enabled' => '已啟用電子報告',
    'ten_day_reporting' => '十日報告',
    'monthly_reporting' => '月度報告',
    'ten_day_reporting_help' => '以10天為週期報告本期交易情形。',
    'monthly_reporting_help' => '按月彙總報告本期交易情形。',
    'quickbooks_deposit_disabled_warning' => '如果您的 QuickBooks 帳戶中已關閉存款功能，則如果有存款，此文件將不會同步至 QuickBooks。',
    'tour_template_signatory_swap' => '此文件由您的範本建立。請使用下拉式選單將佔位符簽名人替換為真實的客戶聯絡人或使用者。',
    'tour_template_save_document' => '點擊這裡儲存您對文件所做的變更。',
    'tour_template_send_document' => '準備好後，請點擊此處將文件發送給您的簽字人。',
    'filter_by_user' => '依使用者篩選',
    'add_condition' => '新增條件',
    'add_new_option' => '新增選項',
    'add_one_interactive_field_before_sending' => '發送前至少新增一個互動式欄位（例如簽名、輸入內容、日期）。',
    'add_option' => '新增選項',
    'add_rectangle_for_signatory' => '儲存前，請務必新增至少一個簽名框。',
    'all_conditions_and' => '所有條件（AND）',
    'already_invited_uninvite_confirmation' => '這位簽署人似乎已經被邀請過了。您確定要取消邀請嗎？',
    'already_signed_no_email' => '這些用戶已經註冊，不會再收到電子郵件：',
    'already_signed_removal_confirmation' => '這些用戶已經簽名，他們的提交內容將會被刪除。您確定要繼續嗎？',
    'already_used' => ' - 已使用',
    'always_required' => '始終需要',
    'always_visible' => '始終可見',
    'and' => ' 和',
    'any_condition_or' => '任何條件（或）',
    'border_color' => '邊框顏色',
    'border_style' => '邊框樣式',
    'character_range' => ':min - :max字符',
    'clear_default' => '清除預設設定',
    'command_palette' => '命令面板',
    'condition' => '狀態',
    'condition_number' => '條件:number',
    'contains_all' => '包含所有內容',
    'contains_any' => '包含任何',
    'copy_to_all_pages' => '複製到所有頁面（ :count頁）',
    'custom_regex' => '自訂正規表示式',
    'custom_regex_pattern' => '自訂正規表示式模式',
    'decimal_places' => '小數位數',
    'default_initials' => '預設首字母',
    'default_number' => '預設值',
    'default_text' => '預設文字',
    'default_to_checked' => '預設選取',
    'default_to_signing_date' => '預設簽署日期',
    'default_values_comma_separated' => '預設值（以逗號分隔）',
    'delete_shortcut' => '刪除（Del/退格鍵）',
    'document_sent' => '文件已發送',
    'document_sent_locked' => '此文件已傳送並鎖定，無法再進行任何編輯。',
    'document_voided_description' => '該文件已作廢，不再可用。',
    'document_voided_title' => '文件作廢',
    'does_not_contain' => '不含',
    'does_not_equal' => '不等於',
    'dotted' => '點狀',
    'drag_to_change_signing_order' => '拖曳即可更改簽名順序',
    'drop_files_or_click' => '拖放檔案或點擊上傳',
    'duplicate_shortcut' => '複製（Ctrl/Cmd+D）',
    'eg_initials' => '例如，京東',
    'ein' => '雇主識別號',
    'ein_format_invalid' => 'EIN格式無效',
    'ein_validation_help' => 'EIN驗證：必須採用XX-XXXXXXX格式',
    'email_invalid' => '電子郵件格式無效',
    'email_validation_help' => '電子郵件驗證：必須是有效的電子郵件地址',
    'ends_with' => '以……結尾',
    'enter_a_number' => '請輸入一個數字',
    'enter_default_initials' => '請輸入預設首字母縮寫...',
    'enter_default_text' => '請輸入預設文字...',
    'enter_default_values_comma_separated' => '請輸入預設值，以逗號分隔…',
    'enter_initials' => '請輸入姓名首字母。',
    'enter_number_here' => '在此輸入號碼',
    'enter_option_text' => '請輸入選項文字...',
    'enter_regex_pattern' => '請輸入正規表示式模式…',
    'enter_text' => '輸入文字',
    'enter_text_here' => '在此輸入文字',
    'enter_value' => '請輸入數值...',
    'enter_values_comma_separated' => '請輸入以逗號分隔的數值…',
    'equals' => '等於',
    'failed_to_rename' => '文件重命名失敗。',
    'field_appears_on_all_pages' => '此欄位將顯示在所有頁面上。簽名者只需填寫一次。',
    'field_visibility' => '場地可見性',
    'field_visibility_help' => '僅當滿足這些條件時，該欄位才會顯示。',
    'file_processing_confirmation_timeout' => '伺服器多次檢查後仍未確認此次上傳。請刪除並重試。',
    'file_processing_failed' => '處理失敗',
    'file_ready' => '準備好',
    'files_not_ready' => '文件尚未準備就緒。',
    'google_drive_import_error' => '從 Google 雲端硬碟匯入時出錯，請重試。',
    'hide_label_shortcut' => '隱藏標籤（Ctrl/Cmd+L）',
    'importing_from_google_drive' => '正在從 Google 雲端硬碟匯入檔案...',
    'initials_instruction' => '請輸入您的姓名首字母（最多 10 個字元）',
    'input' => '輸入',
    'invalid_validation_pattern' => '無效的驗證模式',
    'invitation_not_found' => '未找到邀請函。',
    'is_after' => '之後',
    'is_after_or_equal' => '位於或等於',
    'is_before' => '之前',
    'is_before_or_equal' => '早於或等於',
    'is_checked' => '已檢查',
    'is_greater_than' => '大於',
    'is_greater_than_or_equal' => '大於或等於',
    'is_less_than' => '小於',
    'is_less_than_or_equal' => '小於或等於',
    'is_not_empty' => '不為空',
    'is_unchecked' => '未經檢查',
    'length' => '長度',
    'letters_only' => '僅限信件',
    'letters_only_help' => '僅限字母：此欄位僅接受字母字符',
    'mark_optional_shortcut' => '標記為可選（Ctrl/Cmd+R）',
    'mark_required_shortcut' => '標記為必填項（Ctrl/Cmd+R）',
    'match' => '匹配',
    'maximum_length_is' => '最大長度為:max長度',
    'max_length' => '最大長度',
    'max_value' => '最大值',
    'minimum_length_is' => '最小長度為:min長度',
    'min_length' => '最小長度',
    'min_value' => '最小值',
    'multi_select' => '多選',
    'multiselect_field_needs_options' => '多選字段必須至少有一個選項才能保存。',
    'no_default' => '無預設值',
    'no_fields_for_conditions' => '沒有可用於建立條件的欄位。請先新增字段。',
    'no_maximum' => '沒有上限',
    'no_minimum' => '無最低消費',
    'no_options_configured' => '未配置任何選項。',
    'no_options_configured_add_above' => '未配置任何選項。請在上方新增選項。',
    'number_format' => '數字格式',
    'numbers_only' => '僅限數字',
    'numbers_only_help' => '僅限數字：此欄位僅接受數字字符',
    'only_letters_allowed' => '只允許使用字母。',
    'only_numbers_allowed' => '只允許輸入數字',
    'options_count' => '選項（ :count ）',
    'or_import_from' => '或從…導入',
    'page_number' => ':number頁',
    'pattern_label' => '模式：:模式',
    'pattern_not_matched' => '模式未匹配',
    'pdf_password_incorrect' => '使用者「 :name 」提供的密碼不正確。請輸入正確的密碼：',
    'pdf_password_protected' => 'PDF 檔案「 :name 」已設定密碼保護。請輸入密碼：',
    'radio' => '收音機',
    'radio_group' => '廣播集團',
    'radio_selection' => '無線電選擇',
    'required_when' => '需要時…',
    'search_for_command' => '尋找要運行的命令…',
    'select_field_needs_options' => '儲存前，所選欄位必須至少有一個選項。',
    'select_one_or_more_options' => '選擇一個或多個選項',
    'select_option' => '選擇一個選項',
    'select_option_default' => '選擇一個選項（預設值：標籤）',
    'send_email_to_contacts' => '我們將向以下聯絡人發送電子郵件：',
    'settings_shortcut' => '設定（Ctrl/Cmd+E）',
    'show_label_shortcut' => '顯示標籤（Ctrl/Cmd+L）',
    'shown_later_in_form' => ' - 稍後以形式顯示',
    'show_when' => '顯示何時...',
    'signatories' => '簽署人',
    'signatory_number' => '簽署方:number',
    'signatory_required_for_signatures' => '必須選定簽字人才能建立簽名。',
    'signing_error' => '簽名錯誤',
    'solid' => '堅硬的',
    'something_went_wrong' => '出問題了',
    'ssn' => '社會安全號碼',
    'ssn_format_invalid' => '社會安全號碼格式無效',
    'ssn_validation_help' => '社會安全號碼驗證：必須採用 XXX-XX-XXXX 格式。',
    'successfully_deleted' => '文件已成功刪除。',
    'successfully_imported_from_google_drive' => '文件已成功從 Google 雲端硬碟匯入。',
    'successfully_renamed' => '文件重命名成功。',
    'successfully_saved' => '更改已成功儲存。',
    'successfully_updated_document_title' => '文檔標題已成功更新。',
    'successfully_uploaded' => '文件上傳成功。',
    'template_variable' => '模板變數',
    'template_variable_help' => '選擇要在文件中顯示的預定義變數。',
    'toolbox_help_text' => '請選擇簽字人，然後繪製簽章佔位符。',
    'uninvited_parties_error' => '看起來您有未經邀請的訪客。請將其替換為真實用戶或客戶。',
    'unknown_signatory' => '未知簽名人',
    'unnamed_contact' => '未命名聯絡人（ :email ）',
    'unnamed_user' => '未命名用戶',
    'untitled_blueprint' => '無題藍圖',
    'upload_cancelled_no_password' => '已取消「 :name 」的上傳。未提供密碼。',
    'upload_error' => '文件上傳過程中出現錯誤，請重試。',
    'uploading_files' => '正在上傳文件...',
    'uploading_source_file' => '上傳原始檔',
    'url_invalid' => 'URL格式無效',
    'url_validation_help' => 'URL驗證：必須是有效的URL格式',
    'use_default_value' => '使用預設值',
    'validation' => '驗證',
    'validation_rule' => '驗證規則',
    'value_must_be_at_least' => '值必須至少為:value',
    'value_must_be_at_most' => '值必須最大為:value',
    'variable' => '多變的',
    'widget_type' => '小部件類型',
    'zip' => '拉鍊',
    'zip_format_invalid' => 'ZIP格式無效',
    'zip_validation_help' => '郵遞區號驗證：必須為 5 位數字或 5+4 格式（XXXXX-XXXX）',
    'zoom' => '飛漲',
    'report_too_large_to_preview' => '報告文件過大，無法預覽。請下載報告查看。',
    'log_time' => '日誌時間',
    'filter_by_project' => '按項目篩選',
    'google' => 'Google',
    'app_maintenance' => '應用程式維護進行中',
    'cloned_design' => '克隆設計',
    'no_expenses_selected' => '未選擇任何費用',
    'sync' => '同步',
    'updated_tax_data' => '更新後的稅務數據',
    'upload_failed' => '上傳失敗',
    'wrong_file_extension' => '檔案副檔名錯誤',
    'not_ready_for_download' => '文件尚未準備好下載',
    'list' => '清單',
    'already_linked' => '已連結',
    'convert_to_task' => '轉換為任務',
    'duplicated_entries' => '重複條目',
    'no_entries_to_duplicate' => '沒有重複條目',
    'please_enter_a_valid_duration' => '請輸入有效時長',
    'calendar_unavailable' => '日曆不可用',
    'connect_calendar' => '連結日曆',
    'disconnect_calendar_confirmation' => '您確定要中斷日曆連線嗎？',
    'duplicate_yesterday' => '昨天重複了',
    'hide_events' => '隱藏事件',
    'show_events' => '演出活動',
    'merge_client' => '合併客戶',
    'merge_vendor' => '合併供應商',
    ...
    'disable_all' => '全部禁用',
    'press_keys' => '按鍵',
    'no_payment_required' => '此次方案變更無需支付任何費用。請返回並確認方案變更。',
    'subscription_payment_required' => '總金額已更改，現在需要付款。請選擇付款方式繼續。',
    'task_distribution' => '任務分配',
    'team_distribution' => '團隊分佈',
    'task_velocity' => '任務速度',
    'daily_velocity' => '日速度',
    'forecast_finish' => '預測結果',
    'days_ahead' => '未來幾天',
    'days_behind' => '落後的日子',
    'forecast' => '預報',
    'estimated_vs_actual' => '預估值與實際值',
    'budgeted_amount' => '預算金額',
    'burn_up' => '燃燒殆盡',
    'actual_spend' => '實際支出',
    'margin' => '利潤',
    'target' => '目標',
    'persist_table_filters' => '持久化表篩選器',
    'persist_table_filters_help' => '如果啟用，表格篩選器將在頁面重新載入後保留。',
    'billing_progress' => '帳單進度',
    'budget_vs_actual' => '預算與實際',
    'unbilled_work' => '未開票工作',
    'save_for_later' => '稍後儲存',
    'deletion_violation_regulatory' => '由於該文件受監管報告要求約束，因此無法刪除。',
    'currency_syrian_pound' => 'Syrian Pound',
    'account_plan_expired' => '帳戶計劃已過期',
    'add_files' => '新增文件',
    'add_reminder_schedule' => '新增提醒日程',
    'advanced_options' => '進階選項',
    'after_event' => '事件之後',
    'after_send' => '發送後',
    'before_event' => '事件發生前',
    'checklist_fields' => '在文件上放置字段',
    'checklist_ready' => '即用型',
    'checklist_send' => '傳送文件',
    'checklist_signatories' => '新增簽署人',
    'checklist_title' => '文件清單',
    'checklist_upload' => '上傳文件',
    'click_to_assign' => '點擊分配',
    'companies' => '公司',
    'confirm_remove_signatory' => '您確定要移除這位簽字人嗎？',
    'created_reminder_schedule' => '已建立提醒計劃',
    'deleted_reminder_schedule' => '提醒日程已刪除',
    'document_sent_successfully' => '文件已成功發送',
    'docuninja_join_esignatures' => '電子簽名',
    'docuninja_join_esignatures_help' => '收集簽名並跟踪',
    'docuninja_join_features_title' => '您將獲得的一切',
    'docuninja_join_integration' => '深度整合',
    'docuninja_join_integration_help' => '可處理發票、報價單和訂單',
    'docuninja_creating_account' => '正在建立您的帳戶…',
    'documents_public_by_default' => '預設將文檔設為公開',
    'documents_public_by_default_help' => '啟用後，新文檔預設為公開。',
    'docuninja_join_tagline' => '直接透過 Invoice Ninja 建立、傳送和電子簽章文件。',
    'docuninja_join_templates_help' => '可重複使用的文件藍圖',
    'edit_reminder_schedule' => '編輯提醒日程',
    'fewer_tools' => '工具較少',
    'global_tag_inheritance' => '全域標籤繼承',
    'global_tag_inheritance_help' => '確定子實體是否繼承父實體的標籤。',
    'more_tools' => '更多工具',
    'no_reminder_schedules_found' => '未找到提醒日程',
    'no_template' => '無模板',
    'reminder_schedules' => '提醒日程',
    'sending_document' => '傳送文件',
    'single_signatory_description' => '選擇您要將此文件傳送給誰，然後繼續。',
    'trigger_event' => '觸發事件',
    'updated_reminder_schedule' => '提醒日程已更新',
    'validation_errors' => '驗證錯誤',
    'view_details' => '看詳情',
    'who_to_send_to' => '寄給誰？',
    'wait_for_file_processing' => '等待檔案處理完成，或刪除上傳失敗的檔案。',
    'yyyy_mm_dd' => 'yyyy-mm-dd',
    'docuninja_unavailable' => 'DocuNinja目前無法使用，請稍後再試。',
    'add_tax' => '加稅',
    'what_are_you_charging_for' => '你們的收費項目是什麼？',
    'add_value_as_new_client' => '新增 ` :value作為新客戶端',
    'stripe_ach_verifiation_pending' => '此付款方式尚未開通，正在審核中。',
    'deleted_invoices_exist' => '此付款與一個或多個已刪除的發票相關聯，無法刪除，您必須先恢復發票，然後刪除付款。',
    'show_date' => '顯示日期',
    'show_signature_line' => '簽名行',
    'page_break' => '分頁符號控件',
    'page_break_help' => '防止內容跨頁面顯示。',
    'spacing' => '間距',
    'designer' => '設計師',
    'typography' => '排版',
    'design_name_required' => '設計名稱必須填寫。',
    'preview_indicative_only' => '預覽圖僅供參考，最終佈局將根據實際數據而有所不同。',
    'total_task_estimated_duration' => '任務預計時間',
    'total_task_remaining_estimated_duration' => '剩餘任務時間',
    'total_unestimated_tasks' => '未估算的任務',
