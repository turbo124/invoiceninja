...
<li>"Προκαταβολή πληρωμής για το :QUARTER+1" >> "Προκαταβολή πληρωμής για το Τρίμηνο 2"</li>
    ...
    'duration' => 'Διάρκεια',
    'estimated_duration' => 'Εκτιμώμενη διάρκεια',
    ...
    'no_passkeys_registered' => 'Δεν έχουν καταχωρηθεί κλειδιά πρόσβασης για αυτόν τον λογαριασμό. Χρησιμοποιήστε πρώτα τον κωδικό πρόσβασης σύνδεσης ή καταχωρίστε έναν κωδικό πρόσβασης.',
    ...
    'trial_card_authorization_notice' => 'Δεν θα εισπραχθεί καμία πληρωμή σήμερα. Θα τοποθετήσουμε μια προσωρινή εξουσιοδότηση 1 $ στην πιστωτική σας κάρτα και θα την αποδεσμεύσουμε αμέσως μετά την επαλήθευση. Η τράπεζά σας ενδέχεται να την εμφανίσει για λίγο ως εκκρεμή. Στο τέλος της 14ήμερης δοκιμαστικής περιόδου, η κάρτα σας θα χρεώνεται 14 $/μήνα. Μπορείτε να ακυρώσετε οποιαδήποτε στιγμή.',
    'trial_card_verification_failed' => 'Δεν ήταν δυνατή η επαλήθευση αυτής της πιστωτικής κάρτας. Δεν έγινε χρέωση. Χρησιμοποιήστε μια έγκυρη πιστωτική κάρτα με διαθέσιμο υπόλοιπο τουλάχιστον 1 $.',
    'trial_credit_card_required' => 'Γίνονται δεκτές μόνο πιστωτικές κάρτες. Δεν μπορούν να χρησιμοποιηθούν χρεωστικές, προπληρωμένες και μη ταξινομημένες κάρτες. Δεν έγινε χρέωση.',
    'trial_card_gateway_error' => 'Δεν μπορέσαμε να επικοινωνήσουμε με τον πάροχο της κάρτας. Δεν έγινε καμία χρέωση. Δοκιμάστε ξανά.',
    'trial_card_release_failed' => 'Η κάρτα σας εγκρίθηκε, αλλά δεν μπορέσαμε να επιβεβαιώσουμε ότι η προσωρινή εξουσιοδότηση αποδεσμεύτηκε. Η δοκιμαστική σας περίοδος δεν ξεκίνησε. Δοκιμάστε ξανά αργότερα ή επικοινωνήστε με την υποστήριξη.',
    'trial_verification_in_progress' => 'Η επαλήθευση της κάρτας σας βρίσκεται ήδη σε επεξεργασία. Περιμένετε λίγο και δοκιμάστε ξανά.',
    'trial_no_longer_available' => 'Αυτός ο λογαριασμός δεν είναι πλέον επιλέξιμος για τη δωρεάν δοκιμαστική περίοδο.',
    'overdue' => 'Εκπρόθεσμος',
    ...
    'remove' => 'Διαγραφή',
    'remove_failed_upload' => 'Κατάργηση αποτυχημένης μεταφόρτωσης',
    ...
    'preparing_canonical_pdf' => 'Προετοιμασία κανονικού PDF',
    'preparing_server_preview' => 'Προετοιμασία προεπισκόπησης διακομιστή',
    ...
    'applied_amount' => 'Εφαρμοσμένη ποσότητα',
    'applied_refunded' => 'Επιστράφηκε η αίτηση',
    ...
    'invoice_not_related_to_payment' => 'Το τιμολόγιο με αριθμό :invoice δεν σχετίζεται με αυτήν την πληρωμή',
    'credit_not_related_to_payment' => 'Η πίστωση # :credit δεν σχετίζεται με αυτήν την πληρωμή',
    ...
    'notification_invoice_overdue_subject' => 'Το τιμολόγιο :invoice για :client έχει εκπρόθεσμη ημερομηνία παράδοσης.',
    'notification_invoice_overdue' => 'Το ακόλουθο τιμολόγιο :invoice για τους πελάτες :client και :amount έχει πλέον εκπρόθεσμη ημερομηνία παράδοσης.',
    ...
    'invoices_by_month' => 'Τιμολόγια ανά μήνα',
    'payments_by_month' => 'Πληρωμές ανά μήνα',
    'monthly_breakdown_skipped' => 'Η μηνιαία ανάλυση παραλείφθηκε: το εύρος ημερομηνιών υπερβαίνει τους 24 μήνες',
    ...
    'taxable_sales' => 'Φορολογητέες πωλήσεις',
    'exempt_sales' => 'Απαλλαγμένες Πωλήσεις',
    'non_taxable_sales' => 'Μη φορολογητέες πωλήσεις',
    'zero_rated_sales' => 'Πωλήσεις με μηδενική βαθμολογία',
    'accounting_basis' => 'Λογιστική Βάση',
    'tax_treatment' => 'Φορολογική Μεταχείριση',
    'summary_source' => 'Πηγή σύνοψης',
    'sales_breakdown_source' => 'Ανάλυση Πωλήσεων',
    'legacy_tax_detail_source' => 'Λεπτομέρειες παλαιού φόρου',
    'monthly_filing_summary' => 'Μηνιαία Σύνοψη Υποβολής',
    'filing_overview' => 'Επισκόπηση Υποβολής',
    'jurisdiction_breakdown' => 'Ανάλυση Δικαιοδοσίας',
    'state_breakdown' => 'Ανάλυση κατάστασης',
    'filing_period' => 'Περίοδος υποβολής',
    'period_start' => 'Έναρξη Περιόδου',
    'period_end' => 'Τέλος Περιόδου',
    'jurisdiction_source' => 'Πηγή Δικαιοδοσίας',
    'tax_data_source' => 'Φορολογικά Δεδομένα',
    'client_shipping_source' => 'Διεύθυνση Αποστολής Πελάτη',
    'client_billing_source' => 'Διεύθυνση Χρέωσης Πελάτη',
    'tax_detail_source' => 'Ταχυδρομικός Κώδικας Λεπτομέρειες Φόρου',
    'unknown_source' => 'Άγνωστη πηγή',
    'district' => 'Περιοχή',
    'metric' => 'Μετρικός',
    'report_period' => 'Περίοδος αναφοράς',
    'current_filing_rows' => 'Τρέχουσες γραμμές αρχειοθέτησης',
    'correction_rows' => 'Γραμμές διόρθωσης',
    'states_reported' => 'Αναφερόμενες Πολιτείες',
    'jurisdictions_reported' => 'Αναφερόμενες δικαιοδοσίες',
    'rows_missing_state' => 'Λείπουν οι γραμμές',
    'rows_using_client_fallback' => 'Γραμμές που χρησιμοποιούν εφεδρική υποστήριξη προγράμματος-πελάτη',
    'prior_period_corrections' => 'Διορθώσεις Προηγούμενων Περιόδων',
    'corrections_review' => 'Αναθεώρηση Διορθώσεων',
    'original_tax_period' => 'Αρχική Φορολογική Περίοδος',
    'correction_recorded_period' => 'Περίοδος Καταγραφής Διόρθωσης',
    'correction_type' => 'Τύπος διόρθωσης',
    'requires_review' => 'Απαιτείται αναθεώρηση',
    'current_period_activity' => 'Δραστηριότητα τρέχουσας περιόδου',
    'invoice_correction' => 'Διόρθωση Τιμολογίου',
    'payment_correction' => 'Διόρθωση Πληρωμής',
    'status_correction' => 'Διόρθωση κατάστασης',
    'legacy_unknown' => 'Άγνωστο παλαιού τύπου',
    'tax_summary' => 'Περίληψη Φορολογίας',
    'reporting_bucket' => 'Κάδος αναφορών',
    'invoice_count' => 'Αριθμός τιμολογίων',
    ...
    'mobile_payment' => 'Πληρωμή μέσω κινητού',
    'awaiting_payment' => 'Αναμονή πληρωμής',
    'payment_confirmed' => 'Η πληρωμή επιβεβαιώθηκε',
    'payment_expired' => 'Η πληρωμή έληξε. Επιστρέψτε και προσπαθήστε ξανά.',
    'payment_was_not_completed' => 'Η πληρωμή δεν ολοκληρώθηκε. Δοκιμάστε ξανά.',
    'no_compatible_app_installed' => 'Εάν δεν συμβεί τίποτα, ενδέχεται να μην έχετε εγκαταστήσει κάποια συμβατή εφαρμογή.',
    'payment_type_Mobile Payment' => 'Πληρωμή μέσω κινητού',
    'gateway_temporarily_unavailable' => 'Αυτή η μέθοδος πληρωμής δεν είναι προσωρινά διαθέσιμη. Δοκιμάστε ξανά αργότερα ή επιλέξτε άλλη μέθοδο πληρωμής.',
    'mybank' => 'MyBank',
    ...
    'show_pdfhtml_on_mobile' => 'Εμφάνιση έκδοσης HTML κατά την προβολή σε κινητό',
    ...
    'use_unapplied_payments' => 'Χρήση μη εφαρμοσμένων πληρωμών',
    ...
    'end_all_sessions_help' => 'Αποσυνδέει όλους τους χρήστες, απαιτεί εκ νέου έλεγχο ταυτότητας από τους χρήστες.',
    ...
    'peppol_credits_info' => 'Απαιτούνται ηλεκτρονικές πιστώσεις για την αποστολή και λήψη ηλεκτρονικών τιμολογίων. Αυτές χρεώνονται ανά έγγραφο. Εάν έχετε ήδη πιστώσεις, κάντε κλικ στην επιλογή Συνέχεια.',
    ...
    'peppol_negative_line_price' => 'Οι τιμές των στοιχείων γραμμής δεν μπορούν να είναι αρνητικές για την ηλεκτρονική τιμολόγηση. Εισαγάγετε μια θετική τιμή και εφαρμόστε οποιαδήποτε μείωση ως έκπτωση ή αρνητική ποσότητα.',
    ...
    'of_budget' => 'του Προϋπολογισμού',
    'invoiced_hours' => 'Τιμολογημένες Ώρες',
    'less' => 'Μείον',
    ...
    'preference_product_notes_for_html_view' => 'Χρήση σημειώσεων στοιχείων για προβολή HTML',
    'preference_product_notes_for_html_view_help' => 'Προτιμήστε την Περιγραφή του είδους έναντι του Τίτλου του είδους, εάν το τιμολόγιο εμφανίζεται σε μορφή HTML.',
    'project_report' => 'Αναφορά Έργου',
    'unlock_invoice_documents_after_payment' => 'Ξεκλείδωμα εγγράφων μετά την πληρωμή',
    'unlock_invoice_documents_after_payment_help' => 'Επιτρέπει στον πελάτη πρόσβαση σε έγγραφα τιμολογίου όταν έχει εξοφληθεί ένα τιμολόγιο',
    'quickbooks' => 'Γρήγορα βιβλία',
    'disable_emails' => 'Απενεργοποίηση email',
    'disable_emails_error' => 'Δεν έχετε εξουσιοδότηση για αποστολή email',
    'disable_emails_help' => 'Αποτρέπει έναν χρήστη από το να στέλνει email από το σύστημα',
    'add_location' => 'Προσθήκη τοποθεσίας',
    'updated_location' => 'Ενημερωμένη τοποθεσία',
    'created_location' => 'Δημιουργήθηκε τοποθεσία',
    'sync_send_time' => 'Ώρα αποστολής συγχρονισμού',
    'sync_send_time_help' => 'Ενημέρωση όλων των υπενθυμίσεων / επαναλαμβανόμενων τιμολογίων για χρήση αυτής της νέας ώρας αποστολής',
    'edit_location' => 'Επεξεργασία τοποθεσίας',
    'downgrade' => 'Κατηφορικός',
    'downgrade_to_free' => 'Υποβάθμιση σε Δωρεάν Πρόγραμμα',
    'downgrade_to_free_description' => 'Αυτό θα καταργήσει όλες τις λειτουργίες επί πληρωμή από τον λογαριασμό σας.',
    'delete_location' => 'Διαγραφή τοποθεσίας',
    'delete_location_confirmation' => 'Αυτό θα καταργήσει την τοποθεσία από την εγγραφή του πελάτη.',
    'add_card_reminder' => 'Μπορείτε να προσθέσετε ξανά μια κάρτα ανά πάσα στιγμή.',
    'free_trial_then' => 'Δωρεάν δοκιμή, λοιπόν',
    'days_left' => ':day Απομένουν s ημέρες',
    'days_trial' => 'Ημερήσια δοκιμαστική περίοδος :day',
    'pro_plan_label' => 'Νίντζα επαγγελματίας',
    'enterprise_plan_label' => 'Επιχείρηση',
    'premium_business_plus_label' => 'Premium Business+',
    'pro_plan_feature_1' => 'Απεριόριστοι Πελάτες &amp; Τιμολόγια',
    'pro_plan_feature_2' => 'Αφαίρεση του &quot;Δημιουργήθηκε από τον Invoice Ninja&quot;',
    'pro_plan_feature_3' => 'Αποστολή τιμολογίων μέσω email μέσω Gmail και Microsoft',
    'pro_plan_feature_4' => 'Αποστολή τιμολογίων μέσω email μέσω του προσαρμοσμένου SMTP σας',
    'pro_plan_feature_5' => 'URL επωνυμίας: &quot;YourSite&quot;.Invoicing.co',
    'pro_plan_feature_6' => '11 Επαγγελματικά Πρότυπα Τιμολογίων',
    'pro_plan_feature_7' => 'Προσαρμόστε τα σχέδια τιμολογίων',
    'pro_plan_feature_8' => 'Ενσωμάτωση API με εφαρμογές τρίτων',
    'pro_plan_feature_9' => 'Πύλη προστασίας από την πλευρά του πελάτη με κωδικό πρόσβασης',
    ...
    'pro_plan_feature_17' => 'Δημιουργήστε μοναδικές ρυθμίσεις &quot;Ομάδας πελατών&quot;',
    'pro_plan_feature_18' => 'Υπολογισμός Φόρου Πωλήσεων Αυτοκινήτων (Πολιτείες των ΗΠΑ)',
    'enterprise_plan_feature_1' => 'Επιπλέον χρήστες λογαριασμού και δικαιώματα',
    'enterprise_plan_feature_2' => 'Μεταφόρτωση και επισύναψη αρχείων',
    'enterprise_plan_feature_3' => 'Προσαρμοσμένος τομέας πύλης',
    'enterprise_plan_feature_4' => 'Συγχρονισμός τραπεζικού λογαριασμού',
    'premium_business_plus_feature_1' => 'Θυρωρός Προγραμματιστών',
    'premium_business_plus_feature_2' => 'Άμεση Υποστήριξη Προτεραιότητας',
    'premium_business_plus_feature_3' => 'Υπηρεσία Σχεδιασμού Τιμολογίων',
    'premium_business_plus_feature_4' => 'Προτεραιότητα αιτήματος χαρακτηριστικών',
    'premium_business_plus_feature_5' => 'Βοήθεια μετεγκατάστασης δεδομένων',
    'premium_business_plus_feature_6' => 'Δημιουργήστε προσαρμοσμένες αναφορές',
    'upgrade_popup_headline' => 'Περισσότερο από την τιμολόγηση',
    'upgrade_popup_description' => 'Απλή Τιμολόγηση. Προηγμένες Λειτουργίες.',
    'upgrade_popup_pro_headline' => 'Πληρώστε το έτος για 10 μήνες + 2 δωρεάν!',
    'upgrade_popup_enterprise_headline' => 'Πληρώστε το έτος για 10 μήνες + 2 δωρεάν!',
    'upgrade_popup_premium_business_plus_headline' => 'Pro + Enterprise + Premium Business Concierge',
    'all_free_features_plus' => 'Όλες οι δωρεάν λειτουργίες +',
    'all_pro_features_plus' => 'Όλες οι επαγγελματικές λειτουργίες +',
    'all_features_plus' => 'Όλα τα χαρακτηριστικά +',
    'upgrade_plan' => 'Πρόγραμμα αναβάθμισης',
    'upgrade_popup_premium_business_plus_pricing' => 'Τιμολόγηση; Ας μιλήσουμε!',
    'plan_selected' => 'Επιλέχθηκε σχέδιο',
    'invalid_date_create_syntax' => 'Μη έγκυρη σύνταξη ημερομηνίας',
    'start_and_end_date_required' => 'Απαιτούνται η ημερομηνία έναρξης και λήξης',
    'project_value' => 'Αξία Έργου',
    'invalid_csv_data' => 'Μη έγκυρα δεδομένα CSV, η εισαγωγή σας ακυρώθηκε.',
    'selected_products' => 'Επιλεγμένα προϊόντα',
    'create_company_error_unauthorized' => 'Δεν έχετε εξουσιοδότηση να δημιουργήσετε εταιρεία. Μόνο ο κάτοχος του λογαριασμού μπορεί να δημιουργήσει εταιρεία.',
    'deleted_location' => 'Η τοποθεσία διαγράφηκε',
    'currency_caribbean_guilder' => 'Γκίλντερ Καραϊβικής',
    'is_shipping' => 'Αποστέλλεται;',
    'added_location' => 'Η τοποθεσία προστέθηκε με επιτυχία',
    'send_emails' => 'Αποστολή μηνυμάτων ηλεκτρονικού ταχυδρομείου',
    'send_emails_permission' => 'Επιτρέψτε στον χρήστη να στέλνει email',
    'cancel_trial' => 'Ακύρωση δοκιμής',
    'cancel_trial_description' => 'Αυτό θα ακυρώσει τη δοκιμαστική σας περίοδο και θα καταργήσει όλες τις λειτουργίες επί πληρωμή από τον λογαριασμό σας.',
    'existing_gateway' => 'Η πύλη υπάρχει ήδη',
    'docuninja' => 'ΝτόκουΝίντζα',
    'pro_rata' => 'Αναλογικά',
    'change_docuninja_plan' => 'Αλλαγή Σχεδίου DocuNinja',
    'downgrade_end_of_cycle' => 'Το πρόγραμμά σας θα υποβαθμιστεί αυτόματα στο τέλος του τρέχοντος κύκλου χρέωσης.',
    'docuninja_change_users' => 'Νέο όριο χρηστών DocuNinja',
    'docuninja_disable_warning' => 'Αυτό θα καταργήσει κάθε πρόσβαση στον λογαριασμό σας DocuNinja.',
    'docuninja_downgrade_info' => 'Το όριο χρηστών σας θα μειωθεί αυτόματα στο τέλος του τρέχοντος κύκλου χρέωσης.',
    'docuninja_grant_access_help' => 'Χορήγηση πρόσβασης χρηστών Ninja σε τιμολόγια στο DocuNinja',
    'recurring_invoice_item' => 'Επαναλαμβανόμενο στοιχείο τιμολογίου',
    'disable_recurring_payment_notification' => 'Απενεργοποίηση ειδοποίησης επαναλαμβανόμενης πληρωμής',
    'disable_recurring_payment_notification_help' => 'Δεν θα αποστέλλονται ειδοποιήσεις για επιτυχημένες επαναλαμβανόμενες πληρωμές τιμολογίων.',
    'invoice_outstanding_tasks' => 'Τιμολόγηση Εκκρεμών Εργασιών',
    'payment_schedule' => 'Πρόγραμμα πληρωμών',
    'time_zone' => 'Ζώνη ώρας',
    'tax_names' => 'Ονόματα Φόρων',
    'auto_bill_help' => 'Εάν ενεργοποιηθεί, όταν εκτελείται το πρόγραμμα, θα επιχειρηθεί αυτόματη χρέωση για το προγραμματισμένο ποσό.',
    'choose_schedule_type' => 'Επιλέξτε τύπο χρονοδιαγράμματος',
    'split_payments' => 'Διαχωρισμένες πληρωμές',
    'split_payments_help' => 'Χωρίζει το ποσό του τιμολογίου σε πολλαπλές πληρωμές σε μια χρονική περίοδο, δηλαδή 4 πληρωμές σε διάστημα 4 μηνών.',
    'custom_schedule' => 'Δημιουργήστε χειροκίνητα ένα προσαρμοσμένο πρόγραμμα πληρωμών',
    'custom_schedule_help' => 'Δημιουργήστε ένα προσαρμοσμένο πρόγραμμα πληρωμών, επιτρέποντας τη δημιουργία ακριβών ημερομηνιών και ποσών για κάθε πρόγραμμα',
    'schedule_frequency_help' => 'Το χρονικό διάστημα μεταξύ κάθε πληρωμής',
    'first_payment_date' => 'Ημερομηνία Πρώτης Πληρωμής',
    'first_payment_date_help' => 'Η ημερομηνία της πρώτης πληρωμής',
    'payment_schedule_interval' => 'Πληρωμή: δείκτης :total για :amount',
    'payment_schedule_table' => 'Πληρωμή: κλειδί στο :date για :amount',
    'auto_send' => 'Αυτόματη αποστολή',
    'auto_send_help' => 'Αυτόματη αποστολή του τιμολογίου μέσω email στον πελάτη',
    'include_project_tasks' => 'Συμπερίληψη εργασιών έργου',
    'include_project_tasks_help' => 'Επίσης, εργασίες τιμολόγησης που αποτελούν μέρος ενός έργου',
    'tax_nexus' => 'Φορολογικός σύνδεσμος',
    'tax_period_report' => 'Έκθεση Φορολογικής Περιόδου',
    'creator' => 'Δημιουργήθηκε από',
    'ses_topic_arn_help' => 'Το θέμα SES (προαιρετικό, μόνο για παρακολούθηση webhook)',
    'ses_region_help' => 'Η περιοχή AWS, δηλαδή η ανατολική Αμερική-1',
    'ses_secret_key' => 'Μυστικό Κλειδί SES',
    'ses_access_key' => 'Αναγνωριστικό κλειδιού πρόσβασης SES',
    'lifecycle' => 'Κύκλος ζωής',
    'order_columns' => 'Στήλες παραγγελίας',
    'topic_arn' => 'Θέμα ARN',
    'lang_Catalan' => 'Καταλανικά',
    'lang_Afrikaans' => 'Αφρικάανς',
    'lang_Indonesian' => 'Ινδονησιακά',
    'replaced' => 'Αντικαταστάθηκε',
    'ses_from_address' => 'SES Από Διεύθυνση',
    'ses_from_address_help' => 'Η διεύθυνση email αποστολής πρέπει να επαληθευτεί στο AWS',
    'unauthorized_action' => 'Δεν έχετε εξουσιοδότηση για να εκτελέσετε αυτήν την ενέργεια',
    'einvoice_received_subject' => 'Λήψη ηλεκτρονικού τιμολογίου/ών',
    'einvoice_received_body' => 'Λάβατε νέο/α ηλεκτρονικό/ά τιμολόγιο/α :count .<br><br> Συνδεθείτε για προβολή.',
    'download_files_too_large' => 'Ορισμένα αρχεία ήταν πολύ μεγάλα για να επισυναφθούν απευθείας στο μήνυμα ηλεκτρονικού ταχυδρομείου. Χρησιμοποιήστε τους παρακάτω συνδέσμους για να τα κατεβάσετε ξεχωριστά.',
    'restore_disabled_verifactu' => 'Δεν μπορείτε να επαναφέρετε ένα τιμολόγιο αφού διαγραφεί',
    'delete_disabled_verifactu' => 'Δεν μπορείτε να διαγράψετε ένα τιμολόγιο αφού ακυρωθεί ή τροποποιηθεί',
    'rectify' => 'Διορθωτικό',
    'verifactu_invoice_send_success' => 'Το τιμολόγιο :invoice για :client στάλθηκε με επιτυχία στην AEAT',
    'verifactu_invoice_sent_failure' => 'Το τιμολόγιο :invoice για :client απέτυχε να σταλεί στο AEAT :notes',
    'verifactu_cancellation_send_success' => 'Η ακύρωση του τιμολογίου για :invoice στάλθηκε με επιτυχία στην AEAT',
    'verifactu_cancellation_send_failure' => 'Η ακύρωση τιμολογίου για :invoice απέτυχε να σταλεί στο AEAT :notes',
    'verifactu' => 'Επαληθεύτηκε',
    'justify' => 'Δικαιολογώ',
    'outdent' => 'Προεξοχή',
    'indent' => 'Δαντελώνω',
    'clear_filters' => 'Καθαρισμός φίλτρων',
    'feedback' => 'Ανατροφοδότηση',
    'feedback_modal_description' => 'Θα χαρούμε πολύ να ακούσουμε τα σχόλιά σας!',
    'do_not_ask_again' => 'Μην ρωτήσεις ξανά',
    'not_likely' => 'Δεν είναι πιθανό',
    'extremely_likely' => 'Εξαιρετικά πιθανό',
    'feedback_slider_title' => 'Πόσο πιθανό είναι να συστήσετε την Invoice Ninja σε έναν φίλο ή συνάδελφο;',
    'actual_delivery_date' => 'Πραγματική Ημερομηνία Παράδοσης',
    'actual_delivery_date_help' => 'Μερικές φορές απαιτείται κατά την χρέωση εκτός συνόρων. Ορίζει την ΑΚΡΙΒΗ ημερομηνία παράδοσης των αγαθών.',
    'invoice_period' => 'Περίοδος Τιμολογίου',
    'invoice_period_help' => 'Ορίζει το χρονικό διάστημα για το οποίο παρέχονται οι υπηρεσίες.',
    'paused_recurring_invoice_helper' => 'Προσοχή! Κατά την επανεκκίνηση ενός επαναλαμβανόμενου τιμολογίου, βεβαιωθείτε ότι η επόμενη ημερομηνία αποστολής είναι στο μέλλον.',
    'thank_you_for_feedback' => 'Σας ευχαριστώ για τα σχόλιά σας!',
    'use_legacy_editor' => 'Χρήση παλαιού επεξεργαστή Wysiwyg',
    'use_legacy_editor_help' => 'Χρησιμοποιήστε τον επεξεργαστή TinyMCE.',
    'enable_e_invoice_received_notification' => 'Ενεργοποίηση ειδοποίησης λήψης ηλεκτρονικού τιμολογίου',
    'enable_e_invoice_received_notification_help' => 'Λάβετε ειδοποίηση μέσω email όταν λαμβάνεται ένα νέο ηλεκτρονικό τιμολόγιο.',
    'price_changes' => 'Αλλαγές τιμών προγράμματος από 1η Ιανουαρίου 2026',
    'notification_quote_rejected_subject' => 'Η προσφορά :quote απορρίφθηκε από :client',
    'notification_quote_rejected' => 'Ο ακόλουθος πελάτης :client απορρίφθηκε. Παραθέτω :quote για :amount :notes .',
    'activity_150' => 'Ο λογαριασμός διαγράφηκε :notes',
    'activity_151' => 'Ο πελάτης :notes συγχωνεύτηκε με :client από τον :user',
    'activity_152' => 'Ο προμηθευτής :notes συγχωνεύτηκε με :vendor από τον :user',
    'activity_153' => 'Ο υπολογιστής-πελάτης :notes καθαρίστηκε από :user',
    'activity_154' => 'Το ηλεκτρονικό τιμολόγιο :invoice για :client στάλθηκε με επιτυχία στο AEAT',
    'activity_155' => 'Η αποστολή του ηλεκτρονικού τιμολογίου :invoice για :client :notes AEAT απέτυχε.',
    'activity_156' => 'Η ακύρωση του τιμολογίου για :invoice στάλθηκε με επιτυχία στην AEAT',
    'activity_157' => 'Η ακύρωση τιμολογίου για :invoice απέτυχε να σταλεί στο AEAT :notes',
    'activity_158' => 'Η προσφορά :quote απορρίφθηκε από τον :client :notes απορρίφθηκε.',
    'quotes_with_status_sent_can_be_rejected' => 'Μόνο οι προσφορές με κατάσταση &quot;Απεστάλη&quot; μπορούν να απορριφθούν.',
    'reject' => 'Απορρίπτω',
    'rejected' => 'Απορρίφθηκε',
    'reject_quote' => 'Απόρριψη προσφοράς',
    'reject_quote_confirmation' => 'Είστε σίγουροι ότι θέλετε να απορρίψετε αυτήν την προσφορά;',
    'reason' => 'Λόγος',
    'enter_reason' => 'Εισαγάγετε έναν λόγο...',
    'notification_invoice_overdue_summary_subject' => 'Σύνοψη Ληξιπρόθεσμου Τιμολογίου: :date',
    'notification_invoice_overdue_summary' => 'Τα ακόλουθα τιμολόγια είναι εκπρόθεσμα:',
    'purge_user_confirmation' => 'Προειδοποίηση! Αυτή η ενέργεια θα εκχωρήσει εκ νέου όλες τις οντότητες στον κάτοχο του λογαριασμού και θα διαγράψει οριστικά τον χρήστη από όλες τις εταιρείες και τους λογαριασμούς. Είστε βέβαιοι ότι θέλετε να συνεχίσετε;',
    'peppol_sending_failed' => 'Η αποστολή του ηλεκτρονικού τιμολογίου απέτυχε!',
    'peppol_sending_success' => 'Το ηλεκτρονικό τιμολόγιο στάλθηκε με επιτυχία!',
    'auto_generate' => 'Αυτόματη δημιουργία',
    'mollie_payment_pending' => 'Η πληρωμή σας εκκρεμεί. Περιμένετε να διεκπεραιωθεί. Θα σας στείλουμε email όταν ολοκληρωθεί.',
    'over_payment_helper' => 'Προαιρετικά: μπορείτε να πληρώσετε περισσότερα από το ποσό που αναγράφεται εδώ. (π.χ. φιλοδώρημα, στρογγυλοποίηση προς τα πάνω)',
    'new_resource' => 'Νέος Πόρος',
    'drop_your_logo_here' => 'Αποθέστε το λογότυπό σας εδώ ή κάντε κλικ για περιήγηση',
    'save_to_enable_health_check' => 'Ο έλεγχος εύρυθμης λειτουργίας θα είναι διαθέσιμος μετά την αποθήκευση των αλλαγών στην πύλη.',
    'audit_log' => 'Αρχείο καταγραφής ελέγχου',
    'clone_to_template' => 'Κλωνοποίηση σε πρότυπο',
    'clone_document_description' => 'Κλωνοποίηση σε νέο έγγραφο',
    'add_signatories' => 'Προσθήκη υπογραφόντων',
    'authorized_to_sign' => 'Εξουσιοδοτημένος/η για υπογραφή',
    'ninja_quote_notification' => 'Υπογεγραμμένη ειδοποίηση προσφοράς',
    'ninja_invoice_notification' => 'Ειδοποίηση Υπογραφής Τιμολογίου',
    'ninja_credit_notification' => 'Ειδοποίηση Υπογεγραμμένης Πίστωσης',
    'ninja_purchase_order_notification' => 'Υπογεγραμμένη Ειδοποίηση Παραγγελίας Αγοράς',
    'email_client_when_quote_signed_description' => 'Πρόγραμμα-πελάτης ηλεκτρονικού ταχυδρομείου όταν υπογράφεται η προσφορά',
    'email_client_when_invoice_signed_description' => 'Αποστολή email σε πρόγραμμα-πελάτη κατά την υπογραφή του τιμολογίου',
    'email_client_when_credit_signed_description' => 'Πρόγραμμα-πελάτης ηλεκτρονικού ταχυδρομείου όταν υπογράφεται η Πίστωση',
    'email_vendor_when_purchase_order_signed_description' => 'Στείλτε email στον προμηθευτή όταν υπογραφεί η παραγγελία αγοράς',
    'custom_document_completed' => 'Το προσαρμοσμένο έγγραφο ολοκληρώθηκε',
    'email_client_when_custom_document_completed' => 'Πρόγραμμα-πελάτης ηλεκτρονικού ταχυδρομείου όταν έχει υπογραφεί ένα προσαρμοσμένο έγγραφο',
    'sender' => 'Αποστολέας',
    'create_template' => 'Δημιουργία προτύπου',
    'edit_template' => 'Επεξεργασία προτύπου',
    'delete_template' => 'Διαγραφή προτύπου',
    'template_created' => 'Το πρότυπο δημιουργήθηκε',
    'template_updated' => 'Το πρότυπο ενημερώθηκε',
    ...
    'document_type_description' => 'Επιλέξτε τον τύπο εγγράφου στον οποίο θα διαμορφώσετε τις υπογραφές',
    'new_signatory' => 'Νέος Υπογράφων',
    'signatory' => 'Υπογράφων',
    'invoice_ninja_template_description' => 'Προσαρμόστε τη θέση των υπογραφών σε έγγραφα Invoice Ninja όπως Τιμολόγια, Προσφορές κ.λπ.',
    'activity_159' => 'Το τιμολόγιο :invoice για :client υπογράφηκε',
    'activity_160' => 'Η προσφορά :quote για :client υπογράφηκε',
    'activity_161' => 'Πίστωση :credit για :client που υπογράφηκε',
    'activity_162' => 'Η παραγγελία αγοράς :purchase_order για :vendor υπογράφηκε',
    'activity_163' => 'Προσαρμοσμένο έγγραφο: το έγγραφο για :client υπογράφηκε',
    'activity_164' => 'Ο συγχρονισμός του QuickBooks απέτυχε. :notes',
    'activity_165' => 'Ο συγχρονισμός του QuickBooks ήταν επιτυχής. :notes',
    'create_your_own' => 'Δημιουργήστε το δικό σας',
    'create_your_own_description' => 'Δημιουργήστε το δικό σας πρότυπο χρησιμοποιώντας το δικό σας έγγραφο PDF για μεταφόρτωση',
    'new_template_description' => 'Επιλέξτε ένα από τα έτοιμα πρότυπά μας για να ξεκινήσετε, π.χ. Συμφωνία Διαφάνειας Πώλησης, Συμφωνία Πώλησης, κ.λπ.',
    'choose_template_type' => 'Επιλέξτε τον τύπο του προτύπου που θέλετε να δημιουργήσετε',
    'template' => 'Πρότυπο',
    'templates' => 'Πρότυπα',
    'new_template' => 'Νέο πρότυπο',
    'user_limit_reached' => 'Χρειάζεστε περισσότερους χρήστες; Αναβαθμίστε το πρόγραμμά σας!',
    'requires_approval' => 'Απαιτείται έγκριση',
    'document_viewed_notification' => 'Ειδοποιήσεις προβολής εγγράφων',
    'document_created_notification' => 'Ειδοποιήσεις δημιουργίας εγγράφου',
    'document_sent_notification' => 'Ειδοποιήσεις αποστολής εγγράφων',
    'document_signed_notification' => 'Ειδοποιήσεις υπογεγραμμένων εγγράφων',
    'document_completed_notification' => 'Ειδοποιήσεις ολοκλήρωσης εγγράφου',
    'document_rejected_notification' => 'Ειδοποιήσεις απόρριψης εγγράφων',
    'document_voided_notification' => 'Ειδοποιήσεις ακύρωσης εγγράφων',
    'document_expired_notification' => 'Ειδοποιήσεις λήξης εγγράφου',
    'document_created' => 'Το έγγραφο δημιουργήθηκε',
    'template_loaded' => 'Το πρότυπο φορτώθηκε',
    'select_user_or_client' => 'Επιλέξτε Χρήστη ή Πελάτη',
    'docuninja_quota_available_but_no_users' => 'Προσθέστε πρώτα έναν χρήστη στο Invoice Ninja και, στη συνέχεια, παραχωρήστε του πρόσβαση στο DocuNinja εδώ.',
    'send_confirmation' => 'Αποστολή επιβεβαίωσης',
    'send_emails_to_following' => 'Θα στείλουμε email στις ακόλουθες διευθύνσεις:',
    'document_queued_for_sending' => 'Έγγραφο σε ουρά για αποστολή',
    'document_voided' => 'Ακυρώθηκε το έγγραφο',
    'view_document' => 'Προβολή εγγράφου',
    'make_template' => 'Δημιουργία προτύπου',
    'use_template' => 'Χρήση προτύπου',
    'map_signatories' => 'Υπογράφοντες του Χάρτη',
    'map_signatories_instructions' => 'Αντιστοίχιση των Υπογραφόντων στο πρότυπο',
    'total_signatories' => 'Σύνολο υπογραφόντων',
    'mapped' => 'Χαρτογραφημένο',
    'docuninja_splash_message' => 'Φόρτωση DocuNinja...',
    'docuninja_contact_admin_for_access' => 'Επικοινωνήστε με τον διαχειριστή σας για πρόσβαση στο DocuNinja.',
    'void' => 'Κενός',
    'invitation_signatory_help' => 'Τα έγγραφα υπογράφονται διαδοχικά, αφού υπογράψει ο πρώτος υπογράφων, ο επόμενος θα μπορεί να υπογράψει.',
    'timeline' => 'Χρονολόγιο',
    'cloned_document' => 'Κλωνοποιημένο έγγραφο',
    'voided_document' => 'Ακυρώθηκε το έγγραφο',
    'voided' => 'Ακυρώθηκε',
    'archive_document_description' => 'Είστε βέβαιοι ότι θέλετε να αρχειοθετήσετε αυτό το έγγραφο;',
    'restore_document_description' => 'Είστε βέβαιοι ότι θέλετε να επαναφέρετε αυτό το έγγραφο;',
    'delete_document_description' => 'Είστε βέβαιοι ότι θέλετε να διαγράψετε αυτό το έγγραφο;',
    'document_archived' => 'Αρχείο εγγράφου',
    'document_restored' => 'Έγινε επαναφορά του εγγράφου',
    'document_deleted' => 'Το έγγραφο διαγράφηκε',
    'sign_now' => 'Εγγραφή τώρα',
    'signed_document' => 'Υπογεγραμμένο έγγραφο',
    'tour_document_upload' => 'Για να ξεκινήσετε την υπογραφή, ανεβάστε το έγγραφό σας εδώ. Σύρετε και αποθέστε τα αρχεία σας σε αυτήν την περιοχή.',
    'tour_signatory_selector' => 'Αυτός είναι ο επιλογέας υπογραφής. Χρησιμοποιήστε τον για να διαχειριστείτε τους υπογράφοντες για το έγγραφό σας. Επιλέξτε έναν υπογράφοντα για να συνεχίσετε.',
    'tour_continue_select_signatory' => 'Συνεχίστε επιλέγοντας έναν υπογράφοντα.',
    'tour_toolbox_description' => 'Στα δεξιά βρίσκεται η εργαλειοθήκη. Χρησιμοποιήστε την για να προσθέσετε πεδία και στοιχεία με τα οποία θα αλληλεπιδρούν οι υπογράφοντες. Το πεδίο υπογραφής είναι ήδη επιλεγμένο. Κάντε κλικ για να συνεχίσετε.',
    'tour_document_canvas' => 'Αυτός είναι ο καμβάς του εγγράφου σας. Πεδία θέσης και τοποθεσίας για τους υπογράφοντες σας εδώ.',
    'tour_save_document' => 'Όταν τελειώσετε, κάντε κλικ εδώ για να αποθηκεύσετε το έγγραφό σας.',
    'create_signature' => 'Δημιουργία υπογραφής',
    'signature_name' => 'Υπογραφή Όνομα',
    'close_tab' => 'Κλείσιμο καρτέλας',
    'sign' => 'Σημείο',
    'add_open_exchange' => 'Προσθήκη ανοιχτού κλειδιού Exchange',
    'all_entity_types_created' => 'Όλοι οι τύποι οντοτήτων δημιουργήθηκαν',
    'amount_must_be_greater_than_zero' => 'Το ποσό πρέπει να είναι μεγαλύτερο από μηδέν',
    'autobill_failure' => 'Η αυτόματη χρέωση απέτυχε',
    'autobill_success' => 'Η αυτόματη χρέωση ήταν επιτυχής',
    'available' => 'Διαθέσιμος',
    'blueprint' => 'Προσχέδιο',
    'capabilities' => 'Δυνατότητες',
    'card_holder_help' => 'Όνομα κατόχου κάρτας',
    'cards' => 'Καρτέλλες',
    'charts' => 'Γραφήματα',
    'company_logo' => 'Λογότυπο εταιρείας',
    'create_client_or_user' => 'Δημιουργία Πελάτη ή Χρήστη',
    'create_docuninja_account' => 'Δημιουργία λογαριασμού DocuNinja',
    'create_recurring_expense' => 'Δημιουργία επαναλαμβανόμενων εξόδων',
    'create_recurring_invoice' => 'Δημιουργία Επαναλαμβανόμενου Τιμολογίου',
    'create_recurring_quote' => 'Δημιουργία επαναλαμβανόμενης προσφοράς',
    'create_subscription' => 'Δημιουργία Συνδρομής',
    'create_user' => 'Δημιουργία χρήστη',
    'created' => 'Δημιουργήθηκε',
    'creating' => 'Δημιουργία',
    'credit_signed_notification' => 'Ειδοποίηση Υπογεγραμμένης Πίστωσης',
    'customize_cards' => 'Προσαρμόστε τις κάρτες',
    'datatable' => 'Πίνακας Δεδομένων',
    'date_must_be_after_previous_schedule' => 'Η ημερομηνία πρέπει να είναι μεταγενέστερη του προηγούμενου χρονοδιαγράμματος',
    'default_checkbox_label' => 'Προεπιλεγμένο πλαίσιο ελέγχου',
    'default_multiselect_label' => 'Προεπιλεγμένη πολλαπλή επιλογή',
    'default_radio_group_label' => 'Προεπιλεγμένη ομάδα ραδιοφώνου',
    'default_select_label' => 'Προεπιλεγμένη επιλογή',
    'delete_document' => 'Διαγραφή εγγράφου',
    'delete_docuninja_document' => 'Διαγραφή αρχείου',
    'delete_docuninja_document_confirmation' => 'Είστε βέβαιοι ότι θέλετε να καταργήσετε αυτό το αρχείο από το έγγραφο;',
    'delete_subscription' => 'Διαγραφή Συνδρομής',
    'disable_docuninja' => 'Απενεργοποίηση DocuNinja',
    'document_not_found' => 'Το έγγραφο δεν βρέθηκε',
    'docuninja_access_grant_failed' => '',
    'docuninja_access_granted_successfully' => 'Η πρόσβαση στο DocuNinja χορηγήθηκε με επιτυχία.',
    'download_signed_document' => 'Λήψη υπογεγραμμένου εγγράφου',
    'e_expense_created' => 'Δημιουργήθηκε ηλεκτρονικό έξοδο',
    'edit_rule' => 'Επεξεργασία κανόνα',
    'einvoice_delivery_failure' => 'Η παράδοση του ηλεκτρονικού τιμολογίου απέτυχε',
    'einvoice_delivery_success' => 'Επιτυχής παράδοση ηλεκτρονικού τιμολογίου',
    'einvoice_sent' => 'Ηλεκτρονικό τιμολόγιο που στάλθηκε',
    'element' => 'Στοιχείο',
    'email_invoice_failed' => 'Η αποστολή του email απέτυχε',
    'empty_checkbox_label' => 'Κενό πλαίσιο ελέγχου',
    'end_of_month' => 'Τέλος μήνα',
    'error_fetching_pricing' => 'Σφάλμα κατά την ανάκτηση της τιμολόγησης',
    'exchange_rate_not_enabled' => 'Η συναλλαγματική ισοτιμία δεν είναι ενεργοποιημένη',
    'failed_payment' => 'Η πληρωμή απέτυχε',
    'field_is_required' => 'Απαιτείται πεδίο',
    'generate' => 'Παράγω',
    'google_drive' => 'Google Drive',
    'initials' => 'Αρχικά γράμματα ενός ονόματος',
    'initials_description' => 'Περιγραφή αρχικών',
    'invalid_state' => 'Μη έγκυρη πολιτεία',
    'invoice_signed_notification' => 'Ειδοποίηση υπογραφής τιμολογίου',
    'link_copied' => 'Ο σύνδεσμος αντιγράφηκε',
    'make_template_description' => 'Δημιουργήστε το δικό σας πρότυπο χρησιμοποιώντας το δικό σας έγγραφο PDF για μεταφόρτωση',
    'manage' => 'Διαχειρίζομαι',
    'multiselect_needs_two_options' => 'Η πολλαπλή επιλογή χρειάζεται δύο επιλογές',
    'no_cards_selected' => 'Δεν έχουν επιλεγεί κάρτες',
    'no_templates_found' => 'Δεν βρέθηκαν πρότυπα',
    'nordigen' => 'Νόρντιγκεν',
    'pages' => 'Σελίδες',
    'passed' => 'Πέρασε',
    'payment_emailed' => 'Η πληρωμή στάλθηκε μέσω email',
    'payment_successful' => 'Η πληρωμή ήταν επιτυχής',
    'pdf_password_required' => 'Απαιτείται κωδικός πρόσβασης PDF',
    'pending_approval' => 'Εκκρεμεί έγκριση',
    'pending_file' => 'Εκκρεμές αρχείο',
    'please_select_at_least_one_user' => 'Επιλέξτε τουλάχιστον έναν χρήστη',
    'please_select_plan' => 'Επιλέξτε ένα πρόγραμμα',
    'please_select_signer' => 'Παρακαλώ επιλέξτε έναν υπογράφοντα',
    'proformal_invoices' => 'Προφορματικά τιμολόγια',
    'purchase_order_signed_notification' => 'Υπογεγραμμένη ειδοποίηση παραγγελίας αγοράς',
    'queue' => 'Ουρά',
    'quote_field' => 'Πεδίο προσφοράς',
    'quote_signed_notification' => 'Υπογεγραμμένη ειδοποίηση προσφοράς',
    'radio_needs_two_options' => 'Το ραδιόφωνο χρειάζεται δύο επιλογές.',
    'recipient' => 'Παραλήπτης',
    'redirect' => 'Διευθύνω πάλιν',
    'refundable' => 'Επιστρεφόμενο ποσό',
    'remove_invitations' => 'Αφαίρεση προσκλήσεων',
    'removing' => 'Αφαίρεση',
    'requirements' => 'Απαιτήσεις',
    'restore_subscription' => 'Επαναφορά συνδρομής',
    'sales_above_threshold' => 'Πωλήσεις πάνω από το όριο',
    'save_to_add_locations' => 'Αποθήκευση για προσθήκη τοποθεσιών',
    'saving' => 'Οικονομία',
    'select_design' => 'Επιλέξτε σχέδιο',
    'select_needs_two_options' => 'Η επιλογή χρειάζεται δύο επιλογές',
    'sending' => 'Αποστολή',
    'setting_up' => 'Κατάρτιση',
    'setup_company' => 'Εταιρεία εγκατάστασης',
    'signature-placeholder' => 'Υπογραφή',
    'signature:font-updated' => 'Η γραμματοσειρά υπογραφής ενημερώθηκε',
    'signature_description' => 'Περιγραφή υπογραφής',
    'snappdf_not_enabled' => 'Το Snappdf δεν είναι ενεργοποιημένο',
    'start_signing' => 'Έναρξη υπογραφής',
    'successfully_signed_document' => 'Επιτυχής υπογραφή εγγράφου',
    'swap_signatory' => 'Υπογράφων ανταλλαγής',
    'template_details' => 'Λεπτομέρειες προτύπου',
    'tips_and_notes' => 'Συμβουλές και σημειώσεις',
    'too_many_files' => 'Πάρα πολλά αρχεία',
    'type_signature' => 'Υπογραφή τύπου',
    'untitled_document' => 'Έγγραφο χωρίς τίτλο',
    'untitled_template' => 'Πρότυπο χωρίς τίτλο',
    'update_recurring_expense' => 'Ενημέρωση επαναλαμβανόμενων εξόδων',
    'update_recurring_invoice' => 'Ενημέρωση επαναλαμβανόμενου τιμολογίου',
    'update_recurring_quote' => 'Ενημέρωση επαναλαμβανόμενης προσφοράς',
    'update_subscription' => 'Ενημέρωση συνδρομής',
    'update_user' => 'Ενημέρωση χρήστη',
    'upgrade_account_message' => 'Μήνυμα αναβάθμισης λογαριασμού',
    'upgrade_now' => 'Αναβάθμιση τώρα',
    'upgrade_plan_docuninja' => 'Αναβαθμίστε το πρόγραμμά σας για να ενεργοποιήσετε το DocuNinja.',
    'use_signature' => 'Χρήση υπογραφής',
    'use_snappdf' => 'Χρήση snappdf',
    'user_note' => 'Σημείωση χρήστη',
    'vendor_notification_email' => 'Ηλεκτρονικό μήνυμα ειδοποίησης προμηθευτή',
    'void_document_description' => 'Άκυρη περιγραφή εγγράφου',
    'voided_payment' => 'Η πληρωμή ακυρώθηκε',
    'welcome_to_docuninja' => 'Καλώς ορίσατε στο DocuNinja',
    'yodlee' => 'Γιόντλι',
    'location_name' => 'Όνομα τοποθεσίας',
    'quote_rejected' => 'Η προσφορά απορρίφθηκε',
    'e_invoice_received_notification' => 'Ειδοποίηση λήψης ηλεκτρονικού τιμολογίου',
    'e_invoice_received_notification_help' => 'Αποστολή email όταν ληφθεί ένα ηλεκτρονικό τιμολόγιο',
    'location_field' => 'Πεδίο τοποθεσίας',
    'access_key' => 'Κλειδί πρόσβασης',
    'payment_type_FPX' => 'FPX',
    'payment_type_Stripe Bank Transfer' => 'Τραπεζική Μεταφορά Stripe',
    'activity_166' => 'Ο χρήστης :notes διαγράφηκε από :user',
    'purged_user' => 'Ο χρήστης διαγράφηκε με επιτυχία',
    'quickbooks_connect_description' => 'Συνδέστε τον λογαριασμό σας QuickBooks με το Invoice Ninja για να συγχρονίσετε αυτόματα τις συναλλαγές και τα τιμολόγιά σας.',
    'sync_direction_description' => 'Αυτές οι ρυθμίσεις καθορίζουν τον τρόπο με τον οποίο το Invoice Ninja θα συγχρονίζεται με το QuickBooks.',
    'sync_direction_none_help' => 'Το Invoice Ninja δεν θα συγχρονίσει δεδομένα από ή προς το QuickBooks.',
    'sync_direction_pull_help' => 'Το Invoice Ninja θα αντλήσει δεδομένα από το QuickBooks.',
    'sync_direction_push_help' => 'Το Invoice Ninja θα προωθήσει δεδομένα στο QuickBooks.',
    'sync_direction_bidirectional_help' => 'Το Invoice Ninja θα τραβάει και θα μεταφέρει δεδομένα στο QuickBooks.',
    'sync_settings' => 'Ρυθμίσεις συγχρονισμού',
    'realm_id' => 'Αναγνωριστικό QB Realm',
    'default_income_account' => 'Λογαριασμός Προεπιλεγμένου Εισοδήματος',
    'automatic_taxes' => 'Αυτόματοι φόροι',
    'automatic_taxes_help' => 'Όταν οι Αυτόματοι Φόροι (AST) είναι ενεργοποιημένοι στο Quickbooks, το Invoice Ninja θα δημιουργήσει πρώτα το τιμολόγιο στο Quickbooks και, στη συνέχεια, θα ανακτήσει το πλήρως διαμορφωμένο τιμολόγιο πίσω στο Invoice Ninja.',
    'pull' => 'Τραβήξτε',
    'push' => 'Σπρώξτε',
    'bidirectional' => 'Αμφίδρομος',
    'sync_started' => 'Ο συγχρονισμός ξεκίνησε',
    'quickbooks_read_only_data' => 'Λογαριασμοί Εισοδήματος QuickBooks και Συντελεστές Αποθηκευμένου Φόρου',
    'hide_peppol_sent_status' => 'Απόκρυψη κατάστασης αποστολής Peppol',
    'quickbooks_requires_reauth' => 'Το QuickBooks απαιτεί εκ νέου έλεγχο ταυτότητας',
    'quickbooks_requires_reauth_body' => 'Η σύνδεσή σας στο QuickBooks έχει λήξει και απαιτεί εκ νέου έλεγχο ταυτότητας. Συνδεθείτε στην πύλη διαχειριστή και επανασυνδέστε τον λογαριασμό σας στο QuickBooks. Θα σας στέλνουμε αυτήν την ειδοποίηση καθημερινά μέχρι να επιλυθεί αυτό το πρόβλημα.',
    'crop_logo' => 'Λογότυπο περικοπής',
    'passkey' => 'Αντικλείδι',
    'login_with_passkey' => 'Σύνδεση με κωδικό πρόσβασης',
    'manage_passkeys' => 'Διαχείριση κλειδιών πρόσβασης',
    'last_used' => 'Τελευταία χρήση',
    'unapplied_payments' => 'Μη εφαρμοσμένες πληρωμές',
    'debit' => 'Χρέωση',
    'auto_convert_credit_help' => 'Αυτόματη σύνδεση ή δημιουργία μιας πληρωμής που να ταιριάζει με αυτούς τους κανόνες.',
    'clone_client_description' => 'Αυτό θα κλωνοποιήσει τον πελάτη σε μια νέα εγγραφή πελάτη.',
    'invalid_id_number_format' => 'Μη έγκυρη μορφή αριθμού αναγνώρισης',
    'invalid_vat_number_format' => 'Μη έγκυρη μορφή αριθμού ΦΠΑ',
    'invalid_routing_id_format' => 'Μη έγκυρη μορφή αναγνωριστικού δρομολόγησης',
    'invalid_id_number_checkdigit' => 'Μη έγκυρος αριθμός αναγνώρισης: σφάλμα ψηφίου ελέγχου, επαληθεύστε ότι ο αριθμός είναι σωστός',
    'invalid_vat_number_checkdigit' => 'Μη έγκυρος αριθμός ΦΠΑ: σφάλμα ψηφίου ελέγχου, επαληθεύστε ότι ο αριθμός είναι σωστός',
    'invalid_routing_id_checkdigit' => 'Μη έγκυρο αναγνωριστικό δρομολόγησης: σφάλμα ψηφίου ελέγχου, επαληθεύστε ότι ο αριθμός είναι σωστός',
    'sign_the_document' => 'Υπογράψτε το έγγραφο',
    'client_not_found_on_peppol_network' => 'Δεν ήταν δυνατή η αναγνώριση του πελάτη στο δίκτυο PEPPOL.',
    'too_many_requests' => 'Πάρα πολλά αιτήματα',
    'custom_text_with_formatting' => 'Προσαρμοσμένο κείμενο με μορφοποίηση',
    'client_name_and_address' => 'Όνομα και διεύθυνση πελάτη',
    'bill_to' => 'Χρέωση προς:',
    'entity_details' => 'Αριθμός, ημερομηνία, ημερομηνία λήξης, ποσό, υπόλοιπο',
    'product_line_items_with_columns' => 'Στοιχεία γραμμής προϊόντος με στήλες',
    'task_line_items_with_columns' => 'Στοιχεία γραμμής εργασίας με στήλες',
    'divider_line' => 'Οριζόντιος διαχωριστής',
    'signature_line' => 'Περιοχή υπογραφής',
    'authorized_signature' => 'Εξουσιοδοτημένη Υπογραφή',
    'essential' => 'Ουσιώδης',
    'public_notes_will_appear_here' => 'Οι δημόσιες σημειώσεις θα εμφανίζονται εδώ',
    'footer_will_appear_here' => 'Το υποσέλιδο θα εμφανίζεται εδώ',
    'terms_will_appear_here' => 'Οι όροι θα εμφανίζονται εδώ',
    'sepa_qr' => 'SEPA QR',
    'swiss_qr' => 'Ελβετικό QR',
    'spc_qr' => 'SPC QR',
    'verifactu_qr' => 'Επαλήθευση QR',
    'payment_qr' => 'QR πληρωμής',
    'download_json' => 'Λήψη JSON',
    'copy_block_to_clipboard' => 'Αντιγραφή μπλοκ στο πρόχειρο',
    'duplicate_block' => 'Διπλότυπο μπλοκ',
    'delete_block' => 'Διαγραφή μπλοκ',
    'height_placeholder_example' => 'π.χ., 40px',
    'select_starting_point_for_invoice_design' => 'Επιλέξτε ένα σημείο εκκίνησης για το σχεδιασμό του τιμολογίου σας',
    'no_templates_found_in_category' => 'Δεν βρέθηκαν πρότυπα σε αυτήν την κατηγορία',
    'preview_uses_sample_data' => 'Η προεπισκόπηση χρησιμοποιεί δείγματα δεδομένων.',
    'download_html' => 'Λήψη HTML',
    'blocks_in_design' => 'μπλοκ στο σχεδιασμό',
    'actual_invoices_use_real_data' => 'Τα πραγματικά τιμολόγια θα χρησιμοποιούν πραγματικά δεδομένα πελατών και τιμολογίων',
    'cloned_client' => 'Κλωνοποιήθηκε με επιτυχία ο πελάτης',
    'update_tax_details' => 'Ενημέρωση φορολογικών στοιχείων',
    'cc_only' => 'Μόνο CC',
    'e_invoice_forward_email' => 'Υπηρεσία προώθησης ηλεκτρονικού ταχυδρομείου PEPPOL',
    'e_invoice_forward_email_help' => 'Προωθήσεις που έστειλαν ηλεκτρονικά τιμολόγια σε μια τρίτη υπηρεσία επεξεργασίας όπως η Yuki ή η WinAuditor',
    'skip_automatic_email_with_peppol' => 'Απενεργοποίηση email όταν αποστέλλεται μέσω PEPPOL',
    'skip_automatic_email_with_peppol_help' => 'Εάν ενεργοποιηθεί, τα τιμολόγια που αποστέλλονται μέσω του δικτύου PEPPOL δεν θα αποστέλλονται μέσω email στον πελάτη.',
    'web_session_timeout_help' => 'Χρόνος που μια περίοδος λειτουργίας του προγράμματος περιήγησης θα παραμείνει ενεργή πριν από την αποσύνδεση.',
    'password_timeout_help' => 'Χρόνος πριν από την επανεισαγωγή του κωδικού πρόσβασης διαχειριστή.',
    'invoice_status_paid' => 'Το τιμολόγιο μόλις πληρώθηκε! Το αρχείο έχει πλέον ενημερωθεί.',
    'attach_audit_log_to_completed_email' => 'Επισύναψη αρχείου καταγραφής ελέγχου στο ολοκληρωμένο μήνυμα ηλεκτρονικού ταχυδρομείου',
    'attach_audit_log_to_completed_email_help' => 'Εάν ενεργοποιηθεί, το αρχείο καταγραφής ελέγχου θα επισυνάπτεται στο email ολοκλήρωσης του υπογεγραμμένου εγγράφου.',
    'e_expense_forward_email' => 'Υπηρεσία ηλεκτρονικού ταχυδρομείου προώθησης εξόδων',
    'e_expense_forward_email_help' => 'Προωθεί τα εισπραχθέντα ηλεκτρονικά έξοδα σε μια τρίτη υπηρεσία επεξεργασίας όπως η Yuki ή η WinAuditor',
    'regenerate_token' => 'Αναγέννηση διακριτικού',
    'token_regenerated' => 'Το διακριτικό αναγεννήθηκε με επιτυχία',
    'token_regeneration_failed' => 'Η αναγέννηση διακριτικού απέτυχε.',
    'show_header' => 'Εμφάνιση κεφαλίδας',
    'select_a_component_to_edit_properties' => 'Επιλέξτε ένα στοιχείο για επεξεργασία',
    'drag_and_drop_to_add' => 'Σύρετε και αποθέστε για προσθήκη',
    'max_width' => 'Μέγιστο πλάτος',
    'max_height' => 'Μέγιστο ύψος',
    'alignment' => 'Ευθυγραμμία',
    'object_fit' => 'Προσαρμογή αντικειμένου',
    'padding' => 'Υλικό παραγεμίσματος',
    'fix_overlaps' => 'Διόρθωση επικαλύψεων',
    'spacer' => 'Αραιώνων',
    'line_height' => 'Ύψος γραμμής',
    'text_color' => 'Χρώμα κειμένου',
    'font_style' => 'Στυλ γραμματοσειράς',
    'alternate_row_colors' => 'Εναλλακτικά χρώματα γραμμών',
    'show_borders' => 'Εμφάνιση περιγραμμάτων',
    'cell_padding' => 'Επένδυση κελιών',
    'suffix' => 'Κατάληξη',
    'hide_if_empty' => 'Απόκρυψη εάν είναι κενό',
    'qr_code' => 'Κωδικός QR',
    'qr_code_type' => 'Τύπος κωδικού QR',
    'label_padding' => 'Χώρος γύρω από κάθε ετικέτα.',
    'value_padding' => 'Χώρος γύρω από κάθε τιμή.',
    'label_value_gap' => 'Χάσμα μεταξύ ετικέτας και αξίας.',
    'row_spacing' => 'Πόσος κάθετος χώρος υπάρχει μεταξύ κάθε σειράς.',
    'value_min_width' => 'Ελάχιστο πλάτος για τιμές.',
    'restored_template' => 'Το πρότυπο επαναφέρθηκε με επιτυχία',
    'archived_template' => 'Το πρότυπο αρχειοθετήθηκε με επιτυχία',
    'deleted_template' => 'Το πρότυπο διαγράφηκε με επιτυχία',
    'top' => 'Κορυφή',
    'table_rows' => 'Σειρές',
    'style' => 'Στυλ',
    'widget_defaults' => 'Προεπιλογές γραφικού στοιχείου',
    'show_label' => 'Εμφάνιση ετικέτας',
    'show_label_help' => 'Εμφανίστε την ετικέτα του γραφικού στοιχείου δίπλα στην τιμή του.',
    'widget_border_style' => 'Στυλ περιγράμματος γραφικού στοιχείου',
    'widget_border_style_help' => 'Στυλ περιγράμματος της περιοχής γραφικού στοιχείου.',
    'widget_border_color' => 'Χρώμα περιγράμματος γραφικού στοιχείου',
    'widget_border_color_help' => 'Χρώμα του περιγράμματος γύρω από την περιοχή του γραφικού στοιχείου.',
    'card_already_exists' => 'Η κάρτα υπάρχει ήδη',
    'income_account' => 'Λογαριασμός Εισοδήματος',
    'payment_period' => 'Περίοδος Πληρωμής',
    'payment_period_help' => 'Ο χρόνος που επιτρέπεται για την ολοκλήρωση της πληρωμής σε δευτερόλεπτα. Αποδεκτό εύρος 60 - 600.',
    'payware_partner_id_label' => 'Αναγνωριστικό Συνεργάτη',
    'payware_partner_id_help' => 'Παρέχεται από το payware κατά την εγγραφή',
    'payware_vpos_id_label' => 'Αναγνωριστικό webPOS',
    'payware_vpos_id_help' => 'αναγνωριστικό webPOS από τον πίνακα ελέγχου payware',
    'payware_public_key_help' => 'Δημόσιο κλειδί RSA για επικύρωση υπογραφής webhook',
    'gateway_onboarding_description' => 'Η πύλη πληρωμής σας έχει συνδεθεί με επιτυχία. Μπορείτε πλέον να διαμορφώσετε μεθόδους πληρωμής και να ορίσετε όρια συναλλαγών ή χρεώσεις.',
    'gateway_onboarding_payment_methods_help' => 'Ενεργοποιήστε ή απενεργοποιήστε τις αποδεκτές μεθόδους πληρωμής για τους πελάτες σας.',
    'gateway_onboarding_limits_fees_help' => 'Ορίστε ελάχιστα και μέγιστα όρια συναλλαγών και διαμορφώστε τις χρεώσεις επεξεργασίας.',
    'gateway_setup_complete' => 'Η ρύθμιση της πύλης ολοκληρώθηκε',
    'activity_167' => 'Η κατάσταση του ηλεκτρονικού τιμολογίου :invoice ενημερώθηκε σε :notes',
    'activity_168' => ':notes για :client',
    'activity_169' => ':notes για :client',
    'peppol_accepted' => 'Το ηλεκτρονικό τιμολόγιο έγινε δεκτό από τον παραλήπτη.',
    'peppol_rejected' => 'Το ηλεκτρονικό τιμολόγιο απορρίφθηκε από τον παραλήπτη.',
    'peppol_partially_paid' => 'Το ηλεκτρονικό τιμολόγιο εξοφλήθηκε μερικώς.',
    'peppol_paid' => 'Το ηλεκτρονικό τιμολόγιο πληρώθηκε.',
    'server_not_reachable' => 'Ο διακομιστής δεν είναι προσβάσιμος. Ελέγξτε τη σύνδεσή σας στο διαδίκτυο και δοκιμάστε ξανά αργότερα.',
    'connecting_calendar' => 'Σύνδεση του ημερολογίου σας…',
    'redirecting' => 'Ανακατεύθυνση…',
    'calendar_connection_denied' => 'Η σύνδεση ακυρώθηκε',
    'calendar_connection_denied_body' => 'Ακυρώσατε τη σύνδεση. Μπορείτε να προσπαθήσετε ξανά οποιαδήποτε στιγμή.',
    'calendar_handoff_expired' => 'Ο σύνδεσμος σύνδεσης έληξε',
    'calendar_handoff_expired_body' => 'Ο σύνδεσμος σύνδεσης δεν είναι πλέον έγκυρος. Ξεκινήστε ξανά τη σύνδεση.',
    'calendar_handoff_invalid' => 'Δεν ήταν δυνατή η ολοκλήρωση της σύνδεσης',
    'calendar_handoff_invalid_body' => 'Παρουσιάστηκε κάποιο πρόβλημα κατά την επικύρωση της σύνδεσης. Δοκιμάστε ξανά.',
    'calendar_connect_failed' => 'Η σύνδεση στο ημερολόγιο απέτυχε.',
    'calendar_connect_failed_body' => 'Δεν ήταν δυνατή η ολοκλήρωση της σύνδεσης του ημερολογίου σας. Δοκιμάστε ξανά.',
    'back_to_calendar' => 'Επιστροφή στο ημερολόγιο',
    'tag' => 'Ετικέτα',
    'new_tag' => 'Νέα ετικέτα',
    'edit_tag' => 'Επεξεργασία ετικέτας',
    'task_tags' => 'Ετικέτες εργασιών',
    'project_tags' => 'Ετικέτες έργου',
    'created_tag' => 'Η ετικέτα δημιουργήθηκε με επιτυχία',
    'updated_tag' => 'Η ετικέτα ενημερώθηκε με επιτυχία',
    'archived_tag' => 'Η ετικέτα αρχειοθετήθηκε με επιτυχία',
    'restored_tag' => 'Η ετικέτα επαναφέρθηκε με επιτυχία',
    'deleted_tag' => 'Η ετικέτα διαγράφηκε με επιτυχία',
    'e_reporting_enabled' => 'Ενεργοποιημένη ηλεκτρονική αναφορά',
    'ten_day_reporting' => 'Δεκαήμερη Αναφορά',
    'monthly_reporting' => 'Μηνιαία Αναφορά',
    'ten_day_reporting_help' => 'Αναφέρετε συναλλαγές για την τρέχουσα περίοδο σε διαστήματα 10 ημερών.',
    'monthly_reporting_help' => 'Αναφέρετε συναλλαγές για την τρέχουσα περίοδο σε μηνιαίες αυξήσεις.',
    'quickbooks_deposit_disabled_warning' => 'Οι καταθέσεις είναι απενεργοποιημένες στον συνδεδεμένο λογαριασμό σας QuickBooks. Αυτό το έγγραφο δεν θα συγχρονιστεί με το QuickBooks εάν υπάρχει κατάθεση.',
    'tour_template_signatory_swap' => 'Αυτό το έγγραφο δημιουργήθηκε από το πρότυπό σας. Χρησιμοποιήστε το αναπτυσσόμενο μενού για να αντικαταστήσετε τον υπογράφοντα με μια πραγματική επαφή πελάτη ή χρήστη.',
    'tour_template_save_document' => 'Κάντε κλικ εδώ για να αποθηκεύσετε τις αλλαγές σας στο έγγραφο.',
    'tour_template_send_document' => 'Όταν είναι έτοιμο, κάντε κλικ εδώ για να στείλετε το έγγραφο στους υπογράφοντες.',
    'filter_by_user' => 'Φιλτράρισμα κατά χρήστη',
    'add_condition' => 'Προσθήκη συνθήκης',
    'add_new_option' => 'Προσθήκη νέας επιλογής',
    'add_one_interactive_field_before_sending' => 'Προσθέστε τουλάχιστον ένα διαδραστικό πεδίο (π.χ. υπογραφή, εισαγωγή, ημερομηνία) πριν από την αποστολή.',
    'add_option' => 'Προσθήκη επιλογής',
    'add_rectangle_for_signatory' => 'Βεβαιωθείτε ότι έχετε προσθέσει τουλάχιστον ένα ορθογώνιο για τους υπογράφοντες πριν από την αποθήκευση.',
    'all_conditions_and' => 'Όλες οι συνθήκες (ΚΑΙ)',
    'already_invited_uninvite_confirmation' => 'Φαίνεται ότι αυτός ο υπογράφων έχει ήδη προσκληθεί. Είστε βέβαιοι ότι θέλετε να τον καταργήσετε;',
    'already_signed_no_email' => 'Αυτοί οι χρήστες έχουν ήδη υπογράψει και δεν θα λάβουν άλλο μήνυμα ηλεκτρονικού ταχυδρομείου:',
    'already_signed_removal_confirmation' => 'Αυτοί οι χρήστες έχουν ήδη υπογράψει και οι υποβολές τους θα καταργηθούν. Είστε βέβαιοι ότι θέλετε να συνεχίσετε;',
    'already_used' => ' - ήδη χρησιμοποιημένο',
    'always_required' => 'Πάντα απαραίτητο',
    'always_visible' => 'Πάντα ορατό',
    'and' => ' ΚΑΙ',
    'any_condition_or' => 'Οποιαδήποτε πάθηση (Ή)',
    'border_color' => 'Χρώμα περιγράμματος',
    'border_style' => 'Στυλ περιγράμματος',
    'character_range' => ':min - Χαρακτήρες :max',
    'clear_default' => 'Εκκαθάριση προεπιλογής',
    'command_palette' => 'Παλέτα εντολών',
    'condition' => 'Κατάσταση',
    'condition_number' => 'Κατάσταση :number',
    'contains_all' => 'περιέχει όλα τα',
    'contains_any' => 'περιέχει οποιοδήποτε από',
    'copy_to_all_pages' => 'Αντιγραφή σε όλες τις σελίδες (σελίδες :count )',
    'custom_regex' => 'Προσαρμοσμένη Regex',
    'custom_regex_pattern' => 'Προσαρμοσμένο μοτίβο Regex',
    'decimal_places' => 'Δεκαδικά ψηφία',
    'default_initials' => 'Προεπιλεγμένα αρχικά',
    'default_number' => 'Προεπιλεγμένος αριθμός',
    'default_text' => 'Προεπιλεγμένο κείμενο',
    'default_to_checked' => 'Προεπιλογή σε επιλεγμένο',
    'default_to_signing_date' => 'Προεπιλογή στην ημερομηνία υπογραφής',
    'default_values_comma_separated' => 'Προεπιλεγμένες τιμές (διαχωρισμένες με κόμμα)',
    'delete_shortcut' => 'Διαγραφή (Διαγραφή/Backspace)',
    'document_sent' => 'Έγγραφο που στάλθηκε',
    'document_sent_locked' => 'Αυτό το έγγραφο έχει σταλεί και είναι πλέον κλειδωμένο. Δεν είναι δυνατή η πραγματοποίηση περαιτέρω επεξεργασιών.',
    'document_voided_description' => 'Αυτό το έγγραφο έχει ακυρωθεί και δεν είναι πλέον διαθέσιμο.',
    'document_voided_title' => 'Το έγγραφο ακυρώθηκε',
    'does_not_contain' => 'δεν περιέχει',
    'does_not_equal' => 'δεν ισούται με',
    'dotted' => 'Διάσπαρτος',
    'drag_to_change_signing_order' => 'Σύρετε για να αλλάξετε τη σειρά υπογραφής',
    'drop_files_or_click' => 'Αποθέστε αρχεία ή κάντε κλικ για μεταφόρτωση',
    'duplicate_shortcut' => 'Διπλότυπο (Ctrl/Cmd+D)',
    'eg_initials' => 'π.χ., JD',
    'ein' => 'ΑΦΜ',
    'ein_format_invalid' => 'Η μορφή EIN δεν είναι έγκυρη.',
    'ein_validation_help' => 'Επικύρωση EIN: Πρέπει να είναι σε μορφή XX-XXXXXXX',
    'email_invalid' => 'Η μορφή email δεν είναι έγκυρη',
    'email_validation_help' => 'Επικύρωση email: Πρέπει να είναι σε έγκυρη μορφή email',
    'ends_with' => 'τελειώνει με',
    'enter_a_number' => 'Εισαγάγετε έναν αριθμό',
    'enter_default_initials' => 'Εισαγάγετε τα προεπιλεγμένα αρχικά...',
    'enter_default_text' => 'Εισαγάγετε προεπιλεγμένο κείμενο...',
    'enter_default_values_comma_separated' => 'Εισαγάγετε προεπιλεγμένες τιμές διαχωρισμένες με κόμματα...',
    'enter_initials' => 'Εισαγάγετε αρχικά',
    'enter_number_here' => 'Εισαγάγετε τον αριθμό εδώ',
    'enter_option_text' => 'Εισαγάγετε κείμενο επιλογής...',
    'enter_regex_pattern' => 'Εισαγάγετε μοτίβο regex...',
    'enter_text' => 'Εισαγωγή κειμένου',
    'enter_text_here' => 'Εισαγάγετε κείμενο εδώ',
    'enter_value' => 'Εισαγάγετε τιμή...',
    'enter_values_comma_separated' => 'Εισαγάγετε τιμές διαχωρισμένες με κόμματα...',
    'equals' => 'ίσον',
    'failed_to_rename' => 'Η μετονομασία του αρχείου απέτυχε.',
    'field_appears_on_all_pages' => 'Το πεδίο θα εμφανίζεται σε όλες τις σελίδες. Ο υπογράφων το συμπληρώνει μόνο μία φορά.',
    'field_visibility' => 'Ορατότητα πεδίου',
    'field_visibility_help' => 'Το πεδίο εμφανίζεται μόνο όταν πληρούνται αυτές οι προϋποθέσεις',
    'file_processing_confirmation_timeout' => 'Ο διακομιστής δεν επιβεβαίωσε αυτήν τη μεταφόρτωση μετά από επανειλημμένους ελέγχους. Αφαιρέστε την και δοκιμάστε ξανά.',
    'file_processing_failed' => 'Η επεξεργασία απέτυχε.',
    'file_ready' => 'Ετοιμος',
    'files_not_ready' => 'Τα αρχεία δεν είναι έτοιμα.',
    'google_drive_import_error' => 'Παρουσιάστηκε κάποιο πρόβλημα κατά την εισαγωγή από το Google Drive. Δοκιμάστε ξανά.',
    'hide_label_shortcut' => 'Απόκρυψη ετικέτας (Ctrl/Cmd+L)',
    'importing_from_google_drive' => 'Εισαγωγή αρχείου/αρχείων από το Google Drive...',
    'initials_instruction' => 'Εισαγάγετε τα αρχικά σας (μέγιστο 10 χαρακτήρες)',
    'input' => 'Εισαγωγή',
    'invalid_validation_pattern' => 'Μη έγκυρο μοτίβο επικύρωσης',
    'invitation_not_found' => 'Η πρόσκληση δεν βρέθηκε.',
    'is_after' => 'είναι μετά',
    'is_after_or_equal' => 'είναι μετά ή ίσο με',
    'is_before' => 'είναι πριν',
    'is_before_or_equal' => 'είναι πριν ή ίσο με',
    'is_checked' => 'είναι επιλεγμένο',
    'is_greater_than' => 'είναι μεγαλύτερο από',
    'is_greater_than_or_equal' => 'είναι μεγαλύτερο ή ίσο με',
    'is_less_than' => 'είναι μικρότερο από',
    'is_less_than_or_equal' => 'είναι μικρότερο ή ίσο με',
    'is_not_empty' => 'δεν είναι άδειο',
    'is_unchecked' => 'δεν είναι ελεγμένο',
    'length' => 'Μήκος',
    'letters_only' => 'Μόνο γράμματα',
    'letters_only_help' => 'Μόνο γράμματα: Το πεδίο θα δέχεται μόνο αλφαβητικούς χαρακτήρες',
    'mark_optional_shortcut' => 'Επισήμανση ως προαιρετική (Ctrl/Cmd+R)',
    'mark_required_shortcut' => 'Επισήμανση ως απαιτούμενη (Ctrl/Cmd+R)',
    'match' => 'Αγώνας',
    'maximum_length_is' => 'Το μέγιστο μήκος είναι :max Μήκος',
    'max_length' => 'Μέγιστο μήκος',
    'max_value' => 'Μέγιστη τιμή',
    'minimum_length_is' => 'Το ελάχιστο μήκος είναι :min Μήκος',
    'min_length' => 'Ελάχιστο μήκος',
    'min_value' => 'Ελάχιστη τιμή',
    'multi_select' => 'Πολλαπλή επιλογή',
    'multiselect_field_needs_options' => 'Τα πεδία πολλαπλής επιλογής πρέπει να έχουν τουλάχιστον μία επιλογή πριν από την αποθήκευση.',
    'no_default' => 'Χωρίς προεπιλογή',
    'no_fields_for_conditions' => 'Δεν υπάρχουν διαθέσιμα πεδία για τη δημιουργία συνθηκών. Προσθέστε πρώτα τα πεδία.',
    'no_maximum' => 'Δεν υπάρχει μέγιστο',
    'no_minimum' => 'Δεν υπάρχει ελάχιστο',
    'no_options_configured' => 'Δεν έχουν ρυθμιστεί επιλογές.',
    'no_options_configured_add_above' => 'Δεν έχουν ρυθμιστεί επιλογές. Προσθέστε επιλογές παραπάνω.',
    'number_format' => 'Μορφή Αριθμών',
    'numbers_only' => 'Μόνο αριθμοί',
    'numbers_only_help' => 'Μόνο αριθμοί: Το πεδίο δέχεται μόνο αριθμητικούς χαρακτήρες.',
    'only_letters_allowed' => 'Επιτρέπονται μόνο γράμματα',
    'only_numbers_allowed' => 'Επιτρέπονται μόνο αριθμοί',
    'options_count' => 'Επιλογές ( :count )',
    'or_import_from' => 'ή εισαγωγή από',
    'page_number' => 'Σελίδα :number',
    'pattern_label' => 'Μοτίβο: :pattern',
    'pattern_not_matched' => 'Το μοτίβο δεν ταιριάζει',
    'pdf_password_incorrect' => 'Ο κωδικός πρόσβασης που παρέχεται για το &quot; :name &quot; είναι λανθασμένος. Παρακαλώ εισάγετε τον σωστό κωδικό πρόσβασης:',
    'pdf_password_protected' => 'Το αρχείο PDF &quot; :name &quot; προστατεύεται με κωδικό πρόσβασης. Παρακαλώ εισάγετε τον κωδικό πρόσβασης:',
    'radio' => 'Ραδιόφωνο',
    'radio_group' => 'Ραδιοφωνική Ομάδα',
    'radio_selection' => 'Επιλογή ραδιοφώνου',
    'required_when' => 'Υποχρεωτικό όταν...',
    'search_for_command' => 'Αναζήτηση εντολής για εκτέλεση...',
    'select_field_needs_options' => 'Τα επιλεγμένα πεδία πρέπει να έχουν τουλάχιστον μία επιλογή πριν από την αποθήκευση.',
    'select_one_or_more_options' => 'Επιλέξτε μία ή περισσότερες επιλογές',
    'select_option' => 'Επιλέξτε μια επιλογή',
    'select_option_default' => 'Επιλέξτε μια επιλογή (Προεπιλογή: :label)',
    'send_email_to_contacts' => 'Θα στείλουμε email στις ακόλουθες επαφές:',
    'settings_shortcut' => 'Ρυθμίσεις (Ctrl/Cmd+E)',
    'show_label_shortcut' => 'Εμφάνιση ετικέτας (Ctrl/Cmd+L)',
    'shown_later_in_form' => ' - εμφανίζεται αργότερα στη φόρμα',
    'show_when' => 'Εμφάνιση πότε...',
    'signatories' => 'Υπογράφοντες',
    'signatory_number' => 'Υπογράφων :number',
    'signatory_required_for_signatures' => 'Πρέπει να επιλεγεί ένας υπογράφων για να δημιουργηθούν υπογραφές.',
    'signing_error' => 'Σφάλμα υπογραφής',
    'solid' => 'Στερεός',
    'something_went_wrong' => 'Κάτι πήγε στραβά',
    'ssn' => 'ΑΜΚΑ',
    'ssn_format_invalid' => 'Η μορφή ΑΜΚΑ δεν είναι έγκυρη.',
    'ssn_validation_help' => 'Επικύρωση ΑΜΚΑ: Πρέπει να είναι σε μορφή XXX-XX-XXXX',
    'successfully_deleted' => 'Το αρχείο διαγράφηκε με επιτυχία.',
    'successfully_imported_from_google_drive' => 'Τα αρχεία εισήχθησαν με επιτυχία από το Google Drive.',
    'successfully_renamed' => 'Το αρχείο μετονομάστηκε με επιτυχία.',
    'successfully_saved' => 'Οι αλλαγές αποθηκεύτηκαν με επιτυχία.',
    'successfully_updated_document_title' => 'Ο τίτλος του εγγράφου ενημερώθηκε με επιτυχία.',
    'successfully_uploaded' => 'Τα αρχεία μεταφορτώθηκαν με επιτυχία.',
    'template_variable' => 'Μεταβλητή προτύπου',
    'template_variable_help' => 'Επιλέξτε μια προκαθορισμένη μεταβλητή για εμφάνιση στο έγγραφο.',
    'toolbox_help_text' => 'Επιλέξτε υπογράφοντα και, στη συνέχεια, σχεδιάστε ένα σύμβολο κράτησης θέσης για την υπογραφή.',
    'uninvited_parties_error' => 'Φαίνεται ότι έχετε απρόσκλητους συμμετέχοντες. Παρακαλώ ανταλλάξτε τους με πραγματικούς χρήστες ή πελάτες.',
    'unknown_signatory' => 'Άγνωστος υπογράφων',
    'unnamed_contact' => 'Ανώνυμη επαφή ( :email )',
    'unnamed_user' => 'Ανώνυμος χρήστης',
    'untitled_blueprint' => 'Σχέδιο χωρίς τίτλο',
    'upload_cancelled_no_password' => 'Η μεταφόρτωση ακυρώθηκε για το &quot; :name &quot;. Δεν δόθηκε κωδικός πρόσβασης.',
    'upload_error' => 'Παρουσιάστηκε κάποιο πρόβλημα κατά τη μεταφόρτωση του/των αρχείου/αρχείων. Δοκιμάστε ξανά.',
    'uploading_files' => 'Μεταφόρτωση αρχείου/αρχείων...',
    'uploading_source_file' => 'Μεταφόρτωση αρχείου πηγής',
    'url_invalid' => 'Η μορφή URL δεν είναι έγκυρη',
    'url_validation_help' => 'Επικύρωση διεύθυνσης URL: Πρέπει να είναι μια έγκυρη μορφή διεύθυνσης URL',
    'use_default_value' => 'Χρήση προεπιλεγμένης τιμής',
    'validation' => 'Νομιμοποίηση',
    'validation_rule' => 'Κανόνας επικύρωσης',
    'value_must_be_at_least' => 'Η τιμή πρέπει να είναι τουλάχιστον :value',
    'value_must_be_at_most' => 'Η τιμή πρέπει να είναι το πολύ :value',
    'variable' => 'Μεταβλητός',
    'widget_type' => 'Τύπος γραφικού στοιχείου',
    'zip' => 'ΕΝΕΡΓΗΤΙΚΟΤΗΣ',
    'zip_format_invalid' => 'Η μορφή ZIP δεν είναι έγκυρη.',
    'zip_validation_help' => 'Επικύρωση Ταχυδρομικού Κώδικα: Πρέπει να είναι 5 ψηφία ή σε μορφή 5+4 (XXXXX-XXXX)',
    'zoom' => 'Ανίπταμαι διαγωνίως',
    'report_too_large_to_preview' => 'Η αναφορά είναι πολύ μεγάλη για προεπισκόπηση. Κατεβάστε την αναφορά για να την δείτε.',
    'log_time' => 'Ώρα καταγραφής',
    'filter_by_project' => 'Φιλτράρισμα κατά έργο',
    'google' => 'Google',
    'app_maintenance' => 'Συντήρηση εφαρμογής σε εξέλιξη',
    'cloned_design' => 'Κλωνοποιημένος Σχεδιασμός',
    'no_expenses_selected' => 'Δεν έχουν επιλεγεί έξοδα',
    'sync' => 'Συγχρονισμός',
    'updated_tax_data' => 'Ενημερωμένα Φορολογικά Δεδομένα',
    'upload_failed' => 'Η μεταφόρτωση απέτυχε.',
    'wrong_file_extension' => 'Λάθος επέκταση αρχείου',
    'not_ready_for_download' => 'Το αρχείο δεν είναι έτοιμο για λήψη',
    'list' => 'Λίστα',
    'already_linked' => 'Ήδη συνδεδεμένο',
    'convert_to_task' => 'Μετατροπή σε εργασία',
    'duplicated_entries' => 'Διπλότυπες καταχωρήσεις',
    'no_entries_to_duplicate' => 'Δεν υπάρχουν καταχωρήσεις για αντιγραφή',
    'please_enter_a_valid_duration' => 'Παρακαλώ εισάγετε μια έγκυρη διάρκεια',
    'calendar_unavailable' => 'Το ημερολόγιο δεν είναι διαθέσιμο',
    'connect_calendar' => 'Σύνδεση Ημερολογίου',
    'disconnect_calendar_confirmation' => 'Είστε βέβαιοι ότι θέλετε να αποσυνδέσετε το ημερολόγιό σας;',
    'duplicate_yesterday' => 'Διπλότυπο χθες',
    'hide_events' => 'Απόκρυψη συμβάντων',
    'show_events' => 'Εμφάνιση συμβάντων',
    'merge_client' => 'Συγχώνευση πελάτη',
    'merge_vendor' => 'Συγχώνευση προμηθευτή',
    'global' => 'Καθολικός',
    'disable_all' => 'Απενεργοποίηση όλων',
    'press_keys' => 'Πατήστε τα πλήκτρα',
    'no_payment_required' => 'Αυτή η αλλαγή προγράμματος δεν απαιτεί πληρωμή. Επιστρέψτε και επιβεβαιώστε την αλλαγή προγράμματος.',
    'subscription_payment_required' => 'Το σύνολο έχει αλλάξει και πλέον απαιτείται πληρωμή. Επιλέξτε μια μέθοδο πληρωμής για να συνεχίσετε.',
    'task_distribution' => 'Κατανομή εργασιών',
    'team_distribution' => 'Κατανομή ομάδων',
    'task_velocity' => 'Ταχύτητα Εργασίας',
    'daily_velocity' => 'Ημερήσια Ταχύτητα',
    'forecast_finish' => 'Πρόβλεψη λήξης',
    'days_ahead' => 'Οι επόμενες μέρες',
    'days_behind' => 'Μέρες πίσω',
    'forecast' => 'Πρόβλεψη',
    'estimated_vs_actual' => 'Εκτιμώμενη έναντι Πραγματικής',
    'budgeted_amount' => 'Προϋπολογισμένο Ποσό',
    'burn_up' => 'Κάψιμο',
    'actual_spend' => 'Πραγματική δαπάνη',
    'margin' => 'Περιθώριο',
    'target' => 'Στόχος',
    'persist_table_filters' => 'Φίλτρα Πίνακα Διατήρησης',
    'persist_table_filters_help' => 'Εάν ενεργοποιηθεί, τα φίλτρα πίνακα θα διατηρηθούν σε όλες τις επαναφορτώσεις σελίδας.',
    'billing_progress' => 'Πρόοδος χρέωσης',
    'budget_vs_actual' => 'Προϋπολογισμός έναντι Πραγματικού',
    'unbilled_work' => 'Μη τιμολογημένη εργασία',
    'save_for_later' => 'Αποθήκευση για αργότερα',
    'deletion_violation_regulatory' => 'Αυτό το έγγραφο δεν μπορεί να διαγραφεί επειδή υπόκειται σε κανονιστικές απαιτήσεις αναφοράς.',
    'currency_syrian_pound' => 'Συριακή λίρα',
    'account_plan_expired' => 'Το Πρόγραμμα Λογαριασμού Έληξε',
    'add_files' => 'Προσθήκη αρχείων',
    'add_reminder_schedule' => 'Προσθήκη χρονοδιαγράμματος υπενθύμισης',
    'advanced_options' => 'Προηγμένες επιλογές',
    'after_event' => 'μετά την εκδήλωση',
    'after_send' => 'Μετά την αποστολή',
    'before_event' => 'πριν από την εκδήλωση',
    'checklist_fields' => 'Τοποθέτηση πεδίων στο έγγραφο',
    'checklist_ready' => 'Έτοιμο για χρήση',
    'checklist_send' => 'Αποστολή εγγράφου',
    'checklist_signatories' => 'Προσθήκη υπογραφόντων',
    'checklist_title' => 'Λίστα ελέγχου εγγράφων',
    'checklist_upload' => 'Μεταφόρτωση εγγράφου',
    'click_to_assign' => 'Κάντε κλικ για ανάθεση',
    'companies' => 'Εταιρείες',
    'confirm_remove_signatory' => 'Είστε βέβαιοι ότι θέλετε να καταργήσετε αυτόν τον υπογράφοντα;',
    'created_reminder_schedule' => 'Δημιουργήθηκε πρόγραμμα υπενθυμίσεων',
    'deleted_reminder_schedule' => 'Το πρόγραμμα υπενθυμίσεων διαγράφηκε',
    'document_sent_successfully' => 'Το έγγραφο στάλθηκε με επιτυχία',
    'docuninja_join_esignatures' => 'Ηλεκτρονικές υπογραφές',
    'docuninja_join_esignatures_help' => 'Συλλέξτε υπογραφές με παρακολούθηση',
    'docuninja_join_features_title' => 'Όλα όσα παίρνετε',
    'docuninja_join_integration' => 'Βαθιά Ενσωμάτωση',
    'docuninja_join_integration_help' => 'Λειτουργεί με τιμολόγια, προσφορές και παραγγελίες',
    'docuninja_creating_account' => 'Δημιουργία του λογαριασμού σας...',
    'documents_public_by_default' => 'Ορισμός εγγράφων ως Δημόσια από προεπιλογή',
    'documents_public_by_default_help' => 'Εάν ενεργοποιηθεί, τα νέα έγγραφα θα είναι δημόσια από προεπιλογή.',
    'docuninja_join_tagline' => 'Δημιουργήστε, στείλτε και υπογράψτε ηλεκτρονικά έγγραφα απευθείας από το Invoice Ninja.',
    'docuninja_join_templates_help' => 'Επαναχρησιμοποιήσιμα σχέδια εγγράφων',
    'edit_reminder_schedule' => 'Επεξεργασία χρονοδιαγράμματος υπενθύμισης',
    'fewer_tools' => 'Λιγότερα εργαλεία',
    'global_tag_inheritance' => 'Κληρονομικότητα καθολικής ετικέτας',
    'global_tag_inheritance_help' => 'Καθορίζει εάν οι θυγατρικές οντότητες κληρονομούν ετικέτες από τις γονικές τους οντότητες.',
    'more_tools' => 'Περισσότερα εργαλεία',
    'no_reminder_schedules_found' => 'Δεν βρέθηκαν χρονοδιαγράμματα υπενθυμίσεων',
    'no_template' => 'Δεν υπάρχει πρότυπο',
    'reminder_schedules' => 'Χρονοδιαγράμματα Υπενθυμίσεων',
    'sending_document' => 'Αποστολή εγγράφου',
    'single_signatory_description' => 'Επιλέξτε σε ποιον θέλετε να στείλετε αυτό το έγγραφο και, στη συνέχεια, συνεχίστε.',
    'trigger_event' => 'Συμβάν ενεργοποίησης',
    'updated_reminder_schedule' => 'Το πρόγραμμα υπενθυμίσεων ενημερώθηκε',
    'validation_errors' => 'Σφάλματα επικύρωσης',
    'view_details' => 'Προβολή λεπτομερειών',
    'who_to_send_to' => 'Σε ποιον να στείλω;',
    'wait_for_file_processing' => 'Περιμένετε να ολοκληρωθεί η επεξεργασία του αρχείου ή καταργήστε τις αποτυχημένες μεταφορτώσεις.',
    'yyyy_mm_dd' => 'εεεε-μμ-ηη',
    'docuninja_unavailable' => 'Το DocuNinja δεν είναι διαθέσιμο αυτήν τη στιγμή. Δοκιμάστε ξανά αργότερα.',
    'add_tax' => 'Προσθήκη φόρου',
    'what_are_you_charging_for' => 'Τι χρεώνεις;',
    'add_value_as_new_client' => 'Προσθήκη ` :value ` ως νέου πελάτη',
    'stripe_ach_verifiation_pending' => 'Αυτή η μέθοδος πληρωμής δεν είναι ακόμη έτοιμη για χρήση. Η επαλήθευση εκκρεμεί.',
    'deleted_invoices_exist' => 'Αυτή η πληρωμή συνδέεται με ένα ή περισσότερα διαγραμμένα τιμολόγια και δεν μπορεί να διαγραφεί. Πρέπει πρώτα να επαναφέρετε τα τιμολόγια και στη συνέχεια να διαγράψετε τις πληρωμές.',
    'show_date' => 'Εμφάνιση ημερομηνίας',
    'show_signature_line' => 'Εμφάνιση γραμμής υπογραφής',
    'page_break' => 'Έλεγχος αλλαγής σελίδας',
    'page_break_help' => 'Αποτρέψτε τον διαχωρισμό περιεχομένου σε σελίδες.',
    'spacing' => 'Διάστιχο',
    'designer' => 'Σχεδιαστής',
    'typography' => 'Τυπογραφία',
    'design_name_required' => 'Απαιτείται όνομα σχεδίασης',
    'preview_indicative_only' => 'Οι προεπισκοπήσεις είναι μόνο ενδεικτικές. Η τελική διάταξη θα διαφέρει ανάλογα με τα πραγματικά δεδομένα.',
    'total_task_estimated_duration' => 'Εκτιμώμενος χρόνος εργασιών',
    'total_task_remaining_estimated_duration' => 'Εργασίες που απομένουν',
    'total_unestimated_tasks' => 'Εργασίες που δεν έχουν εκτιμηθεί',
