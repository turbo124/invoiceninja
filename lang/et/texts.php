...
<p>Dünaamiliste kuupäevade jaoks kasutage :KUU, :KVARTAL või :AASTA. Ka elementaarne matemaatika töötab, näiteks :KUU-1.</p>
 ...
 <li>"Kinnipidamistasu KVARTAL+1 eest" >> "Teise kvartali kinnipidamistasu"
    ...
    'duration' => 'Kestvus',
    'estimated_duration' => 'Eeldatav kestus',
    'time_log' => 'Ajalogi',
    'end_time' => 'Lõpuaeg',
    'end' => 'Lõpp',
    ...
    'no_passkeys_registered' => 'Sellele kontole pole paroole registreeritud. Palun logige sisse parooliga või registreerige esmalt parool.',
...
<p>Kuu- või aastatsükli arved, mille maksetähtaeg on koostamise päeval või enne seda, tuleb tasuda järgmisel kuul. Arved, mille maksetähtaeg on 29. või 30. kuu jooksul, millel seda päeva pole, tuleb tasuda kuu viimasel päeval.</p>
 ...
 <li>Täna on reede, tähtaeg on 1. reede pärast seda. Tähtaeg on järgmisel reedel, mitte täna.
    ...
    'trial_card_authorization_notice' => 'Täna Makse ei võeta. Teie krediitkaardile paigutame ajutise 1-dollarise autoriseeringu ja vabastame selle kohe pärast kinnitamist. Teie pank võib seda korraks ootel olevaks kuvada. 14-päevase prooviperioodi lõpus võetakse teie kaardilt maha 14 dollarit kuus. Katkesta igal ajal.',
    'trial_card_verification_failed' => 'Me ei saanud seda krediitkaarti kinnitada. Makset ei tehtud. Palun kasutage kehtivat krediitkaarti, millel on vähemalt 1 dollar krediiti.',
    'trial_credit_card_required' => 'Aktsepteeritakse ainult krediitkaarte. Deebet-, ettemakstud ja klassifitseerimata kaarte ei saa kasutada. Tasu ei võetud.',
    'trial_card_gateway_error' => 'Kaardipakkujaga ei õnnestunud kontakt . Mingit tasu ei võetud. Palun proovige uuesti.',
    'trial_card_release_failed' => 'Teie kaart autoriseeritud, kuid me ei saanud kinnitada, et ajutine autoriseerimine vabastati. Teie prooviperioodi ei alustatud. Palun proovige hiljem uuesti või kontakt toega.',
    'trial_verification_in_progress' => 'Teie kaardi kinnitust juba töödeldakse. Palun oodake hetk ja proovige uuesti.',
    'trial_no_longer_available' => 'See konto ei ole enam tasuta prooviperioodiks kõlblik.',
    ...
    'remove' => 'Eemalda',
    'remove_failed_upload' => 'Eemalda ebaõnnestunud üleslaadimine',
    ...
    'preparing_canonical_pdf' => 'Kanoonilise PDF ettevalmistamine',
    'preparing_server_preview' => 'Serveri eelvaate ettevalmistamine',
    ...
    'applied' => 'Rakendatud',
    'applied_date' => 'Rakendatud kuupäev',
    'applied_amount' => 'Rakendatud Summa',
    'applied_refunded' => 'Tagastatud',
    ...
    'invoice_not_related_to_payment' => 'Arve # :invoice ei ole selle Makse seotud',
    'credit_not_related_to_payment' => 'Krediit # :credit ei ole selle Makse seotud',
    ...
    'notification_invoice_overdue_subject' => 'Arve :invoice on :client jaoks hilinenud.',
    'notification_invoice_overdue' => 'Järgmine Arve :invoice Klient :client ja :amount on nüüdseks hilinenud.',
    ...
    'invoices_by_month' => 'Kuu Arved',
    'payments_by_month' => 'Kuu Maksed',
    'monthly_breakdown_skipped' => 'Kuupõhine jaotus vahele jäetud: kuupäevavahemik ületab 24 kuud',
    ...
    'gross_sales' => 'Brutomüük',
    'taxable_sales' => 'Maksustatav müük',
    'exempt_sales' => 'Vabastatud müük',
    'non_taxable_sales' => 'Mittemaksustatav müük',
    'zero_rated_sales' => 'Nullmääraga müük',
    'accounting_basis' => 'Raamatupidamislik alus',
    'tax_treatment' => 'Maksukäsitlus',
    'summary_source' => 'Kokkuvõtte allikas',
    'sales_breakdown_source' => 'Müügi jaotus',
    'legacy_tax_detail_source' => 'Pärandmaksu üksikasjad',
    'monthly_filing_summary' => 'Kuu esitamise kokkuvõte',
    'filing_overview' => 'Esitamise ülevaade',
    'jurisdiction_breakdown' => 'Jurisdiktsiooni jaotus',
    'state_breakdown' => 'Osariikide jaotus',
    'filing_period' => 'Esitamise periood',
    'period_start' => 'Perioodi algus',
    'period_end' => 'Perioodi lõpp',
    'jurisdiction_source' => 'Jurisdiktsiooni allikas',
    'tax_data_source' => 'Maksuandmed',
    'client_shipping_source' => 'Klient saatmisaadress',
    'client_billing_source' => 'Klient arveldusaadress',
    'tax_detail_source' => 'Maksuandmete postiindeks',
    'unknown_source' => 'Tundmatu allikas',
    'district' => 'Piirkond',
    'metric' => 'Mõõdik',
    'report_period' => 'Aruandeperiood',
    'current_filing_rows' => 'Praegused esitamise read',
    'correction_rows' => 'Parandusread',
    'states_reported' => 'Teatatud osariigid',
    'jurisdictions_reported' => 'Teatatud jurisdiktsioonid',
    'rows_missing_state' => 'Ridade puuduv olek',
    'rows_using_client_fallback' => 'Read, mis kasutavad Klient varuvarianti',
    'prior_period_corrections' => 'Eelmise perioodi parandused',
    'corrections_review' => 'Paranduste ülevaade',
    'original_tax_period' => 'Algne maksuperiood',
    'correction_recorded_period' => 'Parandusregistri periood',
    'correction_type' => 'Paranduse tüüp',
    'requires_review' => 'Vajab ülevaatamist',
    'current_period_activity' => 'Praeguse perioodi tegevus',
    'invoice_correction' => 'Arve parandus',
    'payment_correction' => 'Makse parandus',
    'status_correction' => 'Staatuse parandus',
    'legacy_unknown' => 'Pärand teadmata',
    'tax_summary' => 'Maksude kokkuvõte',
    'reporting_bucket' => 'Aruandlusrühm',
    'invoice_count' => 'Arve krahv',
    ...
    'mobile_payment' => 'Mobiilne Makse',
    'awaiting_payment' => 'Ootan Makse',
    'payment_confirmed' => 'Makse kinnitas',
    'payment_expired' => 'Makse aegus. Palun minge tagasi ja proovige uuesti.',
    'payment_was_not_completed' => 'Makse ei olnud lõpetatud. Palun proovige uuesti.',
    'no_compatible_app_installed' => 'Kui midagi ei juhtu, ei pruugi teil olla ühilduvat rakendust installitud.',
    'payment_type_Mobile Payment' => 'Mobiilne Makse',
    'gateway_temporarily_unavailable' => 'See Makse meetod pole ajutiselt saadaval. Palun proovige hiljem uuesti või valige mõni teine Makse meetod.',
    'mybank' => 'MyBank',
    ...
    'use_unapplied_payments' => 'Kasutage rakendamata Maksed',
    ...
    'end_all_sessions_help' => 'Logib kõik kasutajad välja, nõuab kasutajatelt uuesti autentimist.',
    ...
    'peppol_credits_info' => 'E-arvete saatmiseks ja vastuvõtmiseks on vaja e-krediiti. Nende eest võetakse tasu dokumendipõhiselt. Kui teil on juba krediiti, klõpsake nuppu „Jätka”.',
    ...
    'peppol_negative_line_price' => 'E-arvete puhul ei saa reaüksuste hinnad olla negatiivsed. Palun Sisesta positiivne hind ja rakendage mis tahes vähendust allahindluse või negatiivse kogusena.',
    ...
    'of_budget' => 'eelarvest',
    'invoiced_hours' => 'Arveldatud tunnid',
    'less' => 'Vähem',
    ...
    'downgrade_to_free_description' => 'See eemaldab teie kontolt kõik tasulised funktsioonid.',
    ...
    'docuninja_grant_access_help' => 'Anna Arve Ninja kasutajatele juurdepääs DocuNinjale',
    ...
    'creator' => 'Loonud',
    'ses_topic_arn_help' => 'SES-i teema (valikuline, ainult veebikonksude jälgimise jaoks)',
    'ses_region_help' => 'AWS-piirkond, st US-East-1',
    'ses_secret_key' => 'SES-i salajane võti',
    'ses_access_key' => 'SES-i juurdepääsuvõtme ID',
    'lifecycle' => 'Elutsükkel',
    'order_columns' => 'Telli veerud',
    'topic_arn' => 'Teema ARN',
    'lang_Catalan' => 'katalaani',
    'lang_Afrikaans' => 'afrikaani keel',
    'lang_Indonesian' => 'Indoneesia',
    'replaced' => 'Asendatud',
    'ses_from_address' => 'SES-i saatja aadress',
    'ses_from_address_help' => 'Saatja e-post aadress tuleb AWS-is kinnitada.',
    'unauthorized_action' => 'Teil pole selle toimingu tegemiseks volitusi',
    'einvoice_received_subject' => 'E Arve /s sai kätte',
    'einvoice_received_body' => 'Olete saanud :count uue E- Arve /s.<br><br> Logi sisse vaatamiseks.',
    'download_files_too_large' => 'Mõned failid olid e-post otse lisamiseks liiga suured. Nende eraldi allalaadimiseks kasutage allolevaid linke.',
    'restore_disabled_verifactu' => 'Pärast Arve kustutamist ei saa seda Taasta',
    'delete_disabled_verifactu' => 'Pärast tühistamist või muutmist ei saa Kustuta an Arve enam teha.',
    'rectify' => 'Alaldi',
    'verifactu_invoice_send_success' => 'Arve :invoice :client kohta saadeti edukalt AEAT-ile',
    'verifactu_invoice_sent_failure' => 'Arve :invoice saatmine AEAT-ile :notes :client jaoks ebaõnnestus.',
    'verifactu_cancellation_send_success' => ':invoice Arve tühistamine saadeti edukalt AEAT-ile',
    'verifactu_cancellation_send_failure' => ':invoice Arve tühistamise saatmine AEAT-ile :notes ebaõnnestus.',
    'verifactu' => 'Verifactu',
    'justify' => 'Joonda',
    'outdent' => 'Taande väljapoole',
    'indent' => 'Taane',
    'clear_filters' => 'Tühjenda filtrid',
    'feedback' => 'Tagasiside',
    'feedback_modal_description' => 'Meile meeldiks teie tagasisidet kuulda!',
    'do_not_ask_again' => 'Ära küsi uuesti',
    'not_likely' => 'Tõenäoliselt mitte',
    'extremely_likely' => 'Äärmiselt tõenäoline',
    'feedback_slider_title' => 'Kui tõenäoliselt soovitaksite Arve Ninjat sõbrale või kolleegile?',
    'actual_delivery_date' => 'Tegelik tarnekuupäev',
    'actual_delivery_date_help' => 'Mõnikord on see vajalik piiriülese arvelduse korral. Määrab kauba TÄPSE tarnekuupäeva.',
    'invoice_period' => 'Arve periood',
    'invoice_period_help' => 'Määrab ajaperioodi, mille jooksul teenuseid osutati.',
    'paused_recurring_invoice_helper' => 'Ettevaatust! Perioodiline Arve taaskäivitamisel veenduge, et järgmine saatmiskuupäev on tulevikus.',
    'thank_you_for_feedback' => 'Täname tagasiside eest!',
    'use_legacy_editor' => 'Kasuta pärand-Wysiwyg redaktorit',
    'use_legacy_editor_help' => 'Kasutage TinyMCE redaktorit.',
    'enable_e_invoice_received_notification' => 'Luba E- Arve saabumise teavitus',
    'enable_e_invoice_received_notification_help' => 'Saate e-post teel teate, kui uus E- Arve on saabunud.',
    'price_changes' => 'Paketi hinnamuudatused alates 1. jaanuarist 2026',
    'notification_quote_rejected_subject' => 'Tsitaat :quote lükati :client poolt tagasi',
    'notification_quote_rejected' => 'Järgmine Klient :client lükkas tagasi tsitaadi :quote :amount :notes kohta.',
    'activity_150' => 'Konto kustutati :notes',
    'activity_151' => 'Klient :notes liideti kliendiga :client kliendi :user poolt.',
    'activity_152' => 'Tarnija :notes liideti :vendor -ga :user poolt.',
    'activity_153' => 'Klient :notes puhastati :user poolt.',
    'activity_154' => 'E- Arve :invoice :client kohta saadeti edukalt AEAT-ile.',
    'activity_155' => 'E- Arve :invoice faili :client saatmine AEAT-ile :notes ebaõnnestus.',
    'activity_156' => ':invoice Arve tühistamine saadeti edukalt AEAT-ile',
    'activity_157' => ':invoice Arve tühistamise saatmine AEAT-ile :notes ebaõnnestus.',
    'activity_158' => 'Tsitaat :quote lükati tagasi kasutaja :client poolt :notes poolt.',
    'quotes_with_status_sent_can_be_rejected' => 'Ainult &quot;Saadetud&quot; staatusega hinnapakkumisi saab tagasi lükata.',
    'reject' => 'Keeldu',
    'rejected' => 'Tagasilükatud',
    'reject_quote' => 'Keeldu tsitaadist',
    'reject_quote_confirmation' => 'Kas oled kindel, et soovid selle tsitaadi tagasi lükata?',
    'reason' => 'Põhjus',
    'enter_reason' => 'Sisesta põhjust...',
    'notification_invoice_overdue_summary_subject' => 'Arve hilinenud kokkuvõte: :date',
    'notification_invoice_overdue_summary' => 'Järgmised Arved on hilinenud:',
    'purge_user_confirmation' => 'Hoiatus! See toiming määrab kõik üksused konto omanikule ja Kustuta kasutaja jäädavalt kõigis ettevõtetes ja kontodel. Kas olete kindel, et soovite jätkata?',
    'peppol_sending_failed' => 'E- Arve saatmine ebaõnnestus!',
    'peppol_sending_success' => 'E- Arve saadeti edukalt!',
    'auto_generate' => 'Automaatne genereerimine',
    'mollie_payment_pending' => 'Teie Makse on ootel. Palun oodake, kuni see on töödeldud. Saadame teile e-post kui see on valmis.',
    'over_payment_helper' => 'Valikuline: võite maksta rohkem kui siin näidatud Summa (nt jootraha, ümardada üles).',
    'new_resource' => 'Uus ressurss',
    'drop_your_logo_here' => 'Lohista oma logo siia või klõpsa sirvimiseks',
    'save_to_enable_health_check' => 'Tervisekontroll on saadaval pärast lüüsi muudatuste salvestamist.',
    'audit_log' => 'Auditilogi',
    'clone_to_template' => 'Klooni malliks',
    'clone_document_description' => 'Klooni uude dokumenti',
    'add_signatories' => 'Lisa allkirjastajad',
    'authorized_to_sign' => 'Allkirjastamiseks volitatud',
    'ninja_quote_notification' => 'Tsitaadi allkirjastatud teatis',
    'ninja_invoice_notification' => 'Arve allkirjastatud teatis',
    'ninja_credit_notification' => 'Krediidi allkirjaga teatis',
    'ninja_purchase_order_notification' => 'Ostutellimuse allkirjastatud teatis',
    'email_client_when_quote_signed_description' => 'Saada Klient e-post , kui pakkumine on allkirjastatud',
    'email_client_when_invoice_signed_description' => 'e-post Klient , kui Arve on lepingu sõlminud',
    'email_client_when_credit_signed_description' => 'e-post Klient , kui akreditiiv on allkirjastatud',
    'email_vendor_when_purchase_order_signed_description' => 'Saada müüjale e-post kui ostutellimus on allkirjastatud',
    'custom_document_completed' => 'Kohandatud dokument on valmis',
    'email_client_when_custom_document_completed' => 'e-post Klient , kui Kohandatud dokument on allkirjastatud',
    'sender' => 'Saatja',
    'create_template' => 'Loo',
    'edit_template' => 'Muuda mall',
    'delete_template' => 'Kustuta mall',
    'template_created' => 'Mall loodud',
    'template_updated' => 'Mall on uuendatud',
    'template_deleted' => 'Mall kustutatud',
    'template_name' => 'Malli nimi',
    'template_description' => 'Malli kirjeldus',
    'document_type' => 'Dokumendi tüüp',
    'document_type_description' => 'Valige dokumendi tüüp, millele allkirju konfigureerida',
    'new_signatory' => 'Uus allakirjutanu',
    'signatory' => 'Allakirjutanu',
    'invoice_ninja_template_description' => 'Kohanda allkirjade asukohta Arve Ninja dokumentides, näiteks Arve d, Quotes jne',
    'activity_159' => 'Arve :invoice lepingule :client allkirjastati',
    'activity_160' => 'Tsitaat :quote allkirjastati :client jaoks',
    'activity_161' => 'Krediit :credit :client eest allkirjastati',
    'activity_162' => 'Ostutellimus :purchase_order toote :vendor kohta allkirjastati',
    'activity_163' => 'Kohandatud dokument: dokument :client allkirjastati',
    'activity_164' => 'QuickBooksi sünkroonimine nurjus. :notes',
    'activity_165' => 'QuickBooksi sünkroonimine õnnestus. :notes',
    'create_your_own' => 'Loo oma',
    'create_your_own_description' => 'Loo oma mall, kasutades üleslaadimiseks oma PDF dokumenti',
    'new_template_description' => 'Alustamiseks valige üks meie eelvalmistatud mallidest, nt konfidentsiaalsusleping, müügileping jne.',
    'choose_template_type' => 'Valige malli tüüp, mida soovite Loo',
    'template' => 'Mall',
    'templates' => 'Mallid',
    'new_template' => 'Uus mall',
    'user_limit_reached' => 'Vajad rohkem kasutajaid? Uuenda oma paketti!',
    'requires_approval' => 'Nõuab kinnitust',
    'document_viewed_notification' => 'Dokumentide vaadatuse märguanded',
    'document_created_notification' => 'Dokumendi loomise teatised',
    'document_sent_notification' => 'Dokumendi saatmise teatised',
    'document_signed_notification' => 'Dokumendi allkirjastamise teated',
    'document_completed_notification' => 'Dokumendi valmimise teated',
    'document_rejected_notification' => 'Dokumendi tagasilükkamise teated',
    'document_voided_notification' => 'Dokumendi tühistamise teated',
    'document_expired_notification' => 'Dokumendi aegumise teated',
    'document_created' => 'Dokument loodud',
    'template_loaded' => 'Mall laaditud',
    'select_user_or_client' => 'Valige kasutaja või Klient',
    'docuninja_quota_available_but_no_users' => 'Lisa esmalt Arve Ninja kasutaja ja seejärel anna talle ligipääs DocuNinjale siin',
    'send_confirmation' => 'Saada kinnitus',
    'send_emails_to_following' => 'Saadame e-kirju järgmistele aadressidele:',
    'document_queued_for_sending' => 'Dokument on saatmiseks järjekorras',
    'document_voided' => 'Dokument tühistatud',
    'view_document' => 'Vaata dokumenti',
    'make_template' => 'Loo mall',
    'use_template' => 'Kasuta malli',
    'map_signatories' => 'Kaardi allkirjastajad',
    'map_signatories_instructions' => 'Määrake mallile allkirjastajad',
    'total_signatories' => 'Allakirjutanute koguarv',
    'mapped' => 'Kaardistatud',
    'docuninja_splash_message' => 'DocuNinja laadimine...',
    'docuninja_contact_admin_for_access' => 'DocuNinjale juurdepääsu saamiseks kontakt oma administraatoriga.',
    'void' => 'Tühistatud',
    'invitation_signatory_help' => 'Dokumentidele kirjutatakse alla järjestikku – pärast esimese allkirjastaja allkirja saab järgmine allkirjastaja alla kirjutada.',
    'timeline' => 'Ajajoon',
    'cloned_document' => 'Dokument kloonitud',
    'voided_document' => 'Dokument tühistatud',
    'voided' => 'Tühistatud',
    'archive_document_description' => 'Kas olete kindel, et soovite selle dokumendi arhiveerida?',
    'restore_document_description' => 'Kas olete kindel, et soovite selle dokumendi Taasta ?',
    'delete_document_description' => 'Kas oled kindel, et tahad seda dokumenti Kustuta ?',
    'document_archived' => 'Dokument arhiveeritud',
    'document_restored' => 'Dokument taastatud',
    'document_deleted' => 'Dokument kustutatud',
    'sign_now' => 'Logi kohe sisse',
    'signed_document' => 'Allkirjastatud dokument',
    'tour_document_upload' => 'Allkirjastamise alustamiseks laadige oma dokument siia üles. Lohistage failid sellesse alasse.',
    'tour_signatory_selector' => 'See on allkirjastaja valija. Kasutage seda oma dokumendi allkirjastajate haldamiseks. Jätkamiseks valige allkirjastaja.',
    'tour_continue_select_signatory' => 'Jätkake allkirjastaja valimisega.',
    'tour_toolbox_description' => 'Paremal on tööriistakast. Kasutage seda allkirjastajate suhtluseks vajalike väljade ja elementide Lisa . Allkirjaväli on juba valitud. Jätkamiseks klõpsake.',
    'tour_document_canvas' => 'See on teie dokumendi lõuend. Siia saate paigutada oma allkirjastajate väljad.',
    'tour_save_document' => 'Kui olete lõpetanud, klõpsake dokumendi salvestamiseks siin.',
    'create_signature' => 'Loo allkiri',
    'signature_name' => 'Allkirja nimi',
    'close_tab' => 'Sule vahekaart',
    'sign' => 'Märk',
    'add_open_exchange' => 'Lisa avatud vahetusvõti',
    'all_entity_types_created' => 'Kõik üksusetüübid on loodud',
    'amount_must_be_greater_than_zero' => 'Summa peab olema suurem kui null',
    'autobill_failure' => 'Automaatne arveldamine ebaõnnestus',
    'autobill_success' => 'Automaatne arveldamine õnnestus',
    'available' => 'Saadaval',
    'blueprint' => 'Plaan',
    'capabilities' => 'Võimed',
    'card_holder_help' => 'Kaardiomaniku nimi',
    'cards' => 'Kaardid',
    'charts' => 'Diagrammid',
    'company_logo' => 'Ettevõtte logo',
    'create_client_or_user' => 'Loo Klient või kasutaja',
    'create_docuninja_account' => 'Loo DocuNinja konto',
    'create_recurring_expense' => 'Loo Perioodiline kulu',
    'create_recurring_invoice' => 'Loo Perioodiline Arve',
    'create_recurring_quote' => 'Loo Perioodiline tsitaat',
    'create_subscription' => 'Loo tellimus',
    'create_user' => 'Loo kasutaja',
    'created' => 'Loodud',
    'creating' => 'Loomine',
    'credit_signed_notification' => 'Krediidi allkirjaga teatis',
    'customize_cards' => 'Kohanda kaarte',
    'datatable' => 'Andmetabel',
    'date_must_be_after_previous_schedule' => 'Kuupäev peab olema eelmisest ajakavast hilisem',
    'default_checkbox_label' => 'Vaikimisi märkeruut',
    'default_multiselect_label' => 'Vaikimisi mitmikvalik',
    'default_radio_group_label' => 'Vaikimisi raadiorühm',
    'default_select_label' => 'Vaikimisi valik',
    'delete_document' => 'Kustuta dokument',
    'delete_docuninja_document' => 'Kustuta fail',
    'delete_docuninja_document_confirmation' => 'Kas olete kindel, et soovite selle faili dokumendist eemaldada?',
    'delete_subscription' => 'Kustuta tellimus',
    'disable_docuninja' => 'Keela DocuNinja',
    'document_not_found' => 'Dokumenti ei leitud',
    'docuninja_access_grant_failed' => '',
    'docuninja_access_granted_successfully' => 'DocuNinja juurdepääs edukalt antud',
    'download_signed_document' => 'Laadi alla allkirjastatud dokument',
    'e_expense_created' => 'E-kulu loodud',
    'edit_rule' => 'Muuda reegel',
    'einvoice_delivery_failure' => 'E- Arve kohaletoimetamine ebaõnnestus',
    'einvoice_delivery_success' => 'E- Arve kohaletoimetamine õnnestus',
    'einvoice_sent' => 'E- Arve saatis',
    'element' => 'Element',
    'email_invoice_failed' => 'e-post saatmine ebaõnnestus',
    'empty_checkbox_label' => 'Tühi märkeruut',
    'end_of_month' => 'Kuu lõpp',
    'error_fetching_pricing' => 'Viga hinna toomisel',
    'exchange_rate_not_enabled' => 'Vahetuskurss pole lubatud',
    'failed_payment' => 'Makse ebaõnnestus',
    'field_is_required' => 'Väli on kohustuslik',
    'generate' => 'Genereeri',
    'google_drive' => 'Google Drive',
    'initials' => 'Initsiaalid',
    'initials_description' => 'Initsiaalide kirjeldus',
    'invalid_state' => 'Kehtetu osariik',
    'invoice_signed_notification' => 'Arve allkirjastas teate',
    'link_copied' => 'Link kopeeritud',
    'make_template_description' => 'Loo oma mall, kasutades üleslaadimiseks oma PDF dokumenti',
    'manage' => 'Halda',
    'multiselect_needs_two_options' => 'Mitmikvalik vajab kahte valikut',
    'no_cards_selected' => 'Kaarte pole valitud',
    'no_templates_found' => 'Malle ei leitud',
    'nordigen' => 'Nordigen',
    'pages' => 'Lehed',
    'passed' => 'Läbitud',
    'payment_emailed' => 'Makse saatis e-kirja',
    'payment_successful' => 'Makse edukas',
    'pdf_password_required' => 'PDF i parool on vajalik',
    'pending_approval' => 'Kinnitust ootab',
    'pending_file' => 'Ootel fail',
    'please_select_at_least_one_user' => 'Palun vali vähemalt üks kasutaja',
    'please_select_plan' => 'Palun vali pakett',
    'please_select_signer' => 'Palun vali allkirjastaja',
    'proformal_invoices' => 'Proforma Arved',
    'purchase_order_signed_notification' => 'Ostutellimuse allkirjastamise teatis',
    'queue' => 'Järjekord',
    'quote_field' => 'Tsitaadi väli',
    'quote_signed_notification' => 'Tsitaadi allkirjastatud teatis',
    'radio_needs_two_options' => 'Raadiol on vaja kahte valikut',
    'recipient' => 'Saaja',
    'redirect' => 'Ümbersuunamine',
    'refundable' => 'Tagastatav',
    'remove_invitations' => 'Eemalda kutsed',
    'removing' => 'Eemaldamine',
    'requirements' => 'Nõuded',
    'restore_subscription' => 'Taasta tellimus',
    'sales_above_threshold' => 'Müük üle läve',
    'save_to_add_locations' => 'Salvesta Lisa asukohtadesse',
    'saving' => 'Salvestamine',
    'select_design' => 'Valige kujundus',
    'select_needs_two_options' => 'Valikuvajadused on kaks',
    'sending' => 'Saatmine',
    'setting_up' => 'Seadistamine',
    'setup_company' => 'Asutusfirma',
    'signature-placeholder' => 'Allkirja kohatäide',
    'signature:font-updated' => 'Allkirja font on uuendatud',
    'signature_description' => 'Allkirja kirjeldus',
    'snappdf_not_enabled' => 'Snappdf pole lubatud',
    'start_signing' => 'Alusta allkirjastamist',
    'successfully_signed_document' => 'Dokumendi allkirjastamine õnnestus',
    'swap_signatory' => 'Vaheta allakirjutanu',
    'template_details' => 'Malli üksikasjad',
    'tips_and_notes' => 'Näpunäited ja märkused',
    'too_many_files' => 'Liiga palju faile',
    'type_signature' => 'Tüübi allkiri',
    'untitled_document' => 'Pealkirjata dokument',
    'untitled_template' => 'Pealkirjata mall',
    'update_recurring_expense' => 'Perioodiline kulu uuendamine',
    'update_recurring_invoice' => 'Perioodiline Arve uuendamine',
    'update_recurring_quote' => 'Värskenda Perioodiline pakkumist',
    'update_subscription' => 'Tellimuse värskendamine',
    'update_user' => 'Kasutaja värskendamine',
    'upgrade_account_message' => 'Konto uuendamine Sõnum',
    'upgrade_now' => 'Uuenda kohe',
    'upgrade_plan_docuninja' => 'DocuNinja lubamiseks uuendage oma paketti',
    'use_signature' => 'Kasuta allkirja',
    'use_snappdf' => 'Kasutage snappdf-i',
    'user_note' => 'Kasutaja Märge',
    'vendor_notification_email' => 'Tarnija teavitus e-post',
    'void_document_description' => 'Kehtetu dokumendi kirjeldus',
    'voided_payment' => 'Makse tühistatud',
    'welcome_to_docuninja' => 'Tere tulemast DocuNinjasse',
    'yodlee' => 'Yodlee',
    'location_name' => 'Asukoha nimi',
    'quote_rejected' => 'Tsitaat tagasi lükatud',
    'e_invoice_received_notification' => 'E- Arve sai teate',
    'e_invoice_received_notification_help' => 'Saada e-post kui e- Arve on saabunud',
    'location_field' => 'Asukoha väli',
    'access_key' => 'Juurdepääsuvõti',
    'payment_type_FPX' => 'FPX',
    'payment_type_Stripe Bank Transfer' => 'Stripe&#39;i pangaülekanne',
    'activity_166' => 'Kasutaja :notes kustutati :user poolt',
    'purged_user' => 'Kasutaja edukalt kustutatud',
    'quickbooks_connect_description' => 'Ühendage oma QuickBooksi konto Arve Ninjaga, et oma tehingud ja Arve automaatselt sünkroonida.',
    'sync_direction_description' => 'Need Seaded määravad, kuidas Arve Ninja QuickBooksiga sünkroonib.',
    'sync_direction_none_help' => 'Arve Ninja ei sünkrooni QuickBooksiga ega QuickBooksist mingeid andmeid.',
    'sync_direction_pull_help' => 'Arve Ninja hangib andmeid QuickBooksist.',
    'sync_direction_push_help' => 'Arve Ninja saadab andmed QuickBooksi.',
    'sync_direction_bidirectional_help' => 'Arve Ninja nii tõmbab kui ka tõmbab andmeid QuickBooksi.',
    'sync_settings' => 'Sünkroonimine Seaded',
    'realm_id' => 'QB Realmi ID',
    'default_income_account' => 'Vaikimisi sissetulekukonto',
    'automatic_taxes' => 'Automaatsed maksud',
    'automatic_taxes_help' => 'Kui QuickBooksis on lubatud automaatsed maksud (AST), Loo Arve Ninja esmalt Arve QuickBooksis ja seejärel tõmbab täielikult moodustatud Arve tagasi Arve Ninjasse.',
    'pull' => 'Tõmba',
    'push' => 'Lükka',
    'bidirectional' => 'Kahesuunaline',
    'sync_started' => 'Sünkroonimine on alanud',
    'quickbooks_read_only_data' => 'QuickBooksi sissetulekukontod ja salvestatud maksumäärad',
    'hide_peppol_sent_status' => 'Peida Peppoli saadetud olek',
    'quickbooks_requires_reauth' => 'QuickBooks nõuab uuesti autentimist',
    'quickbooks_requires_reauth_body' => 'Teie QuickBooksi ühendus on aegunud ja vajab uuesti autentimist. Palun logige sisse administraatori portaali ja ühendage oma QuickBooksi konto uuesti. Saadame teile selle teate iga päev, kuni probleem on lahendatud.',
    'crop_logo' => 'Kärpimislogo',
    'passkey' => 'Parool',
    'login_with_passkey' => 'Logi sisse parooliga',
    'manage_passkeys' => 'Paroolide haldamine',
    'last_used' => 'Viimati kasutatud',
    'unapplied_payments' => 'Rakendamata Maksed',
    'debit' => 'Deebet',
    'auto_convert_credit_help' => 'Lingi automaatselt või Loo nendele reeglitele vastavat Makse .',
    'clone_client_description' => 'See kloonib Klient uude Klient .',
    'invalid_id_number_format' => 'Kehtetu ID-number Vorming',
    'invalid_vat_number_format' => 'Kehtetu käibemaksukohustuslase number Vorming',
    'invalid_routing_id_format' => 'Kehtetu marsruudi ID Vorming',
    'invalid_id_number_checkdigit' => 'Kehtetu ID-number: kontrollnumbri viga, palun kontrollige numbri õigsust',
    'invalid_vat_number_checkdigit' => 'Kehtetu käibemaksukohustuslase number: kontrollnumbri viga, palun kontrollige numbri õigsust',
    'invalid_routing_id_checkdigit' => 'Kehtetu marsruudi ID: kontrollnumbri viga, palun kontrollige numbri õigsust',
    'sign_the_document' => 'Allkirjastage dokument',
    'client_not_found_on_peppol_network' => 'Klient ei õnnestunud PEPPOL-võrgus tuvastada.',
    'too_many_requests' => 'Liiga palju päringuid',
    'custom_text_with_formatting' => 'Kohandatud tekst koos vorminguga',
    'client_name_and_address' => 'Klient nimi ja aadress',
    'bill_to' => 'Arve saaja:',
    'entity_details' => 'Arv, kuupäev, tähtaeg, Summa , saldo',
    'product_line_items_with_columns' => 'Tooterea üksused veergudega',
    'task_line_items_with_columns' => 'Ülesande reaüksused veergudega',
    'divider_line' => 'Horisontaalne eraldaja',
    'signature_line' => 'Allkirjaala',
    'authorized_signature' => 'Volitatud allkiri',
    'essential' => 'Oluline',
    'public_notes_will_appear_here' => 'Avalikud märkmed kuvatakse siin',
    'footer_will_appear_here' => 'Jalus kuvatakse siin',
    'terms_will_appear_here' => 'Tingimused ilmuvad siia',
    'sepa_qr' => 'SEPA QR-kood',
    'swiss_qr' => 'Šveitsi QR-kood',
    'spc_qr' => 'SPC QR-kood',
    'verifactu_qr' => 'Verifactu QR-kood',
    'payment_qr' => 'Makse QR',
    'download_json' => 'Laadi alla JSON',
    'copy_block_to_clipboard' => 'Kopeeri plokk lõikelauale',
    'duplicate_block' => 'Duplikaatplokk',
    'delete_block' => 'Kustuta plokk',
    'height_placeholder_example' => 'nt 40px',
    'select_starting_point_for_invoice_design' => 'Valige oma Arve kujunduse lähtepunkt',
    'no_templates_found_in_category' => 'Selles kategoorias ei leitud malle',
    'preview_uses_sample_data' => 'Eelvaade kasutab näidisandmeid',
    'download_html' => 'Laadi alla HTML',
    'blocks_in_design' => 'plokid disainis',
    'actual_invoices_use_real_data' => 'Tegelik >Arve d kasutab päris Klient ja Arve andmeid',
    'cloned_client' => 'Klient klooniti edukalt',
    'update_tax_details' => 'Maksuandmete värskendamine',
    'cc_only' => 'Ainult CC',
    'e_invoice_forward_email' => 'PEPPOL Edastamise e-post teenus',
    'e_invoice_forward_email_help' => 'Edastatud e-kirjad Arved kolmanda osapoole töötlusteenusele, näiteks Yukile või WinAuditorile.',
    'skip_automatic_email_with_peppol' => 'Keela e-post kui see saadetakse PEPPOL-i kaudu',
    'skip_automatic_email_with_peppol_help' => 'Kui see on lubatud, siis PEPPOL-võrgu kaudu saadetud Arved Klient e-posti teel ei saadeta.',
    'web_session_timeout_help' => 'Aeg, mille jooksul brauseriseanss jääb aktiivseks enne väljalogimist.',
    'password_timeout_help' => 'Aeg, mille möödudes tuleb administraatori parool uuesti sisestada.',
    'invoice_status_paid' => 'Arve sai just palga kätte! Andmeid on nüüd uuendatud.',
    'attach_audit_log_to_completed_email' => 'Lisa auditilogi täidetud e-post',
    'attach_audit_log_to_completed_email_help' => 'Kui see on lubatud, lisatakse auditilogi allkirjastatud dokumendi valmimise e-post aadressile.',
    'e_expense_forward_email' => 'Kulude edastamise e-post teenus',
    'e_expense_forward_email_help' => 'Edasta saadud e-kulud kolmanda osapoole töötlemisteenusele, näiteks Yuki või WinAuditor',
    'regenerate_token' => 'Tokeni uuesti genereerimine',
    'token_regenerated' => 'Tokeni taastamine õnnestus',
    'token_regeneration_failed' => 'Märgi taastamine ebaõnnestus',
    'show_header' => 'Näita päist',
    'select_a_component_to_edit_properties' => 'Valige Muuda jaoks komponent',
    'drag_and_drop_to_add' => 'Lohistage Lisa juurde',
    'max_width' => 'Maksimaalne laius',
    'max_height' => 'Maksimaalne kõrgus',
    'alignment' => 'Joondus',
    'object_fit' => 'Objekti sobivus',
    'padding' => 'Polsterdus',
    'fix_overlaps' => 'Kattumiste parandamine',
    'spacer' => 'Vaheplaat',
    'line_height' => 'Joone kõrgus',
    'text_color' => 'Teksti värv',
    'font_style' => 'Fondi stiil',
    'alternate_row_colors' => 'Alternatiivsed rea värvid',
    'show_borders' => 'Näita ääriseid',
    'cell_padding' => 'Lahtri täitmine',
    'suffix' => 'Sufiks',
    'hide_if_empty' => 'Peida, kui tühi',
    'qr_code' => 'QR-kood',
    'qr_code_type' => 'QR-koodi tüüp',
    'label_padding' => 'Iga sildi ümber ruumi.',
    'value_padding' => 'Iga väärtuse ümber tühik.',
    'label_value_gap' => 'Sildi ja väärtuse vaheline vahe.',
    'row_spacing' => 'Kui palju vertikaalset ruumi jääb iga rea vahele.',
    'value_min_width' => 'Väärtuste minimaalne laius.',
    'restored_template' => 'Mall edukalt taastatud',
    'archived_template' => 'Mall edukalt arhiveeritud',
    'deleted_template' => 'Mall edukalt kustutatud',
    'top' => 'Ülemine',
    'table_rows' => 'Read',
    'style' => 'Stiil',
    'widget_defaults' => 'Vidina vaikesätted',
    'show_label' => 'Näita silti',
    'show_label_help' => 'Kuva vidina silt selle väärtuse kõrval.',
    'widget_border_style' => 'Vidina äärise stiil',
    'widget_border_style_help' => 'Vidinaala äärise stiil.',
    'widget_border_color' => 'Vidina äärise värv',
    'widget_border_color_help' => 'Vidina ala ümbritseva äärise värv.',
    'card_already_exists' => 'Kaart on juba olemas',
    'income_account' => 'Tulukonto',
    'payment_period' => 'Makse periood',
    'payment_period_help' => 'Makse täitmiseks kuluv aeg sekundites. Lubatud on vahemik 60–600.',
    'payware_partner_id_label' => 'Partneri identifikaator',
    'payware_partner_id_help' => 'Registreerimisel pakub tasuline tarkvara',
    'payware_vpos_id_label' => 'webPOS-i identifikaator',
    'payware_vpos_id_help' => 'webPOS-i identifikaator tasulise tarkvara armatuurlaualt',
    'payware_public_key_help' => 'RSA avalik võti veebikonksu allkirja valideerimiseks',
    'gateway_onboarding_description' => 'Teie Makse värav on edukalt ühendatud. Nüüd saate konfigureerida Makse meetodeid ja määrata tehingulimiite või tasusid.',
    'gateway_onboarding_payment_methods_help' => 'Luba või keela oma Kliendid jaoks aktsepteeritud Makse meetodid.',
    'gateway_onboarding_limits_fees_help' => 'Määrake tehingute miinimum- ja maksimumlimiidid ning konfigureerige töötlemistasud.',
    'gateway_setup_complete' => 'Värava seadistamine on lõpetatud',
    'activity_167' => 'E- Arve :invoice olek uuendatud :notes',
    'activity_168' => ':notes :client jaoks',
    'activity_169' => ':notes :client jaoks',
    'peppol_accepted' => 'E- Vastuvõtja võttis Arve vastu.',
    'peppol_rejected' => 'E- Vastuvõtja lükkas Arve tagasi.',
    'peppol_partially_paid' => 'E- Arve osaliselt tasus.',
    'peppol_paid' => 'E- Arve maksis.',
    'server_not_reachable' => 'Server pole kättesaadav. Kontrollige oma internetiühendust ja proovige hiljem uuesti.',
    'connecting_calendar' => 'Kalendri ühendamine…',
    'redirecting' => 'Ümbersuunamine…',
    'calendar_connection_denied' => 'Ühendus tühistati',
    'calendar_connection_denied_body' => 'Sa tühistasid ühenduse. Võid igal ajal uuesti proovida.',
    'calendar_handoff_expired' => 'Ühenduse link aegunud',
    'calendar_handoff_expired_body' => 'Ühenduse link ei kehti enam. Palun loo ühendus uuesti.',
    'calendar_handoff_invalid' => 'Ühenduse loomine ebaõnnestus',
    'calendar_handoff_invalid_body' => 'Ühenduse valideerimisel tekkis viga. Palun proovige uuesti.',
    'calendar_connect_failed' => 'Kalendriga ühenduse loomine ebaõnnestus',
    'calendar_connect_failed_body' => 'Me ei saanud teie kalendrit ühendada. Palun proovige uuesti.',
    'back_to_calendar' => 'Tagasi kalendrisse',
    'tag' => 'Silt',
    'new_tag' => 'Uus silt',
    'edit_tag' => 'Muuda silt',
    'task_tags' => 'Ülesande sildid',
    'project_tags' => 'Projekti sildid',
    'created_tag' => 'Silt loodi edukalt',
    'updated_tag' => 'Silt edukalt uuendatud',
    'archived_tag' => 'Silt arhiveeriti edukalt',
    'restored_tag' => 'Silt taastati edukalt',
    'deleted_tag' => 'Silt edukalt kustutatud',
    'e_reporting_enabled' => 'E-aruandlus lubatud',
    'ten_day_reporting' => 'Kümne päeva aruandlus',
    'monthly_reporting' => 'Kuuaruannete',
    'ten_day_reporting_help' => 'Esitage käesoleva perioodi tehingud 10-päevaste intervallidega.',
    'monthly_reporting_help' => 'Esitage käesoleva perioodi tehingute kohta aruanded igakuiste sammudega.',
    'quickbooks_deposit_disabled_warning' => 'Teie ühendatud QuickBooksi kontol on sissemaksed välja lülitatud, see dokument ei sünkroonita QuickBooksiga, kui sissemakse on olemas.',
    'tour_template_signatory_swap' => 'See dokument loodi teie malli põhjal. Kasutage rippmenüüd kontakt et vahetada kohatäite allkirjastaja tegeliku Klient või kasutajaga.',
    'tour_template_save_document' => 'Dokumendi muudatuste salvestamiseks klõpsake siin.',
    'tour_template_send_document' => 'Kui see on valmis, klõpsake siin, et saata dokument oma allkirjastajatele.',
    'filter_by_user' => 'Filtreeri kasutaja järgi',
    'add_condition' => 'Lisa seisund',
    'add_new_option' => 'Lisa uus valik',
    'add_one_interactive_field_before_sending' => 'Lisa enne saatmist vähemalt üks interaktiivne väli (nt allkiri, sisend, kuupäev).',
    'add_option' => 'Lisa variant',
    'add_rectangle_for_signatory' => 'Enne salvestamist Lisa kindlasti allkirjastajate jaoks vähemalt üks ristkülik.',
    'all_conditions_and' => 'Kõik tingimused (JA)',
    'already_invited_uninvite_confirmation' => 'Paistab, et see allakirjutanu on juba kutsutud. Kas olete kindel, et soovite kutse tühistada?',
    'already_signed_no_email' => 'Need kasutajad on juba registreerunud ja ei saa enam e-post :',
    'already_signed_removal_confirmation' => 'Need kasutajad on juba allkirjastanud ja nende esildised eemaldatakse. Kas olete kindel, et soovite jätkata?',
    'already_used' => ' - juba kasutatud',
    'always_required' => 'Alati nõutav',
    'always_visible' => 'Alati nähtav',
    'and' => ' JA',
    'any_condition_or' => 'Mistahes seisund (VÕI)',
    'border_color' => 'Äärise värv',
    'border_style' => 'Äärise stiil',
    'character_range' => ':min - TXPROTECT :max tähemärgid',
    'clear_default' => 'Tühjenda vaikeseaded',
    'command_palette' => 'Käskude palett',
    'condition' => 'Seisund',
    'condition_number' => 'Seisukord :number',
    'contains_all' => 'sisaldab kõiki',
    'contains_any' => 'sisaldab ükskõik millist järgmistest',
    'copy_to_all_pages' => 'Kopeeri kõikidele lehtedele ( :count lehed)',
    'custom_regex' => 'Kohandatud regulaaravaldis',
    'custom_regex_pattern' => 'Kohandatud regulaaravaldise muster',
    'decimal_places' => 'Kümnendkohad',
    'default_initials' => 'Vaikimisi initsiaalid',
    'default_number' => 'Vaikimisi number',
    'default_text' => 'Vaikimisi tekst',
    'default_to_checked' => 'Vaikimisi märgitud',
    'default_to_signing_date' => 'Vaikimisi allkirjastamiskuupäev',
    'default_values_comma_separated' => 'Vaikimisi väärtused (komaga eraldatud)',
    'delete_shortcut' => 'Kustuta (Del/Backspace)',
    'document_sent' => 'Dokument saadetud',
    'document_sent_locked' => 'See dokument on saadetud ja nüüd lukustatud. Edasisi muudatusi teha ei saa.',
    'document_voided_description' => 'See dokument on kehtetuks tunnistatud ja pole enam saadaval.',
    'document_voided_title' => 'Dokument tühistatud',
    'does_not_contain' => 'ei sisalda',
    'does_not_equal' => 'ei võrdu',
    'dotted' => 'Punktiline',
    'drag_to_change_signing_order' => 'Lohistage allkirjastamise järjekorra muutmiseks',
    'drop_files_or_click' => 'Lohista failid või klõpsa üleslaadimiseks',
    'duplicate_shortcut' => 'Duplikaat (Ctrl/Cmd+D)',
    'eg_initials' => 'nt JD',
    'ein' => 'Tööandja number',
    'ein_format_invalid' => 'EIN Vorming on kehtetu',
    'ein_validation_help' => 'EIN-koodi valideerimine: Peab olema Vorming XX-XXXXXXX',
    'email_invalid' => 'e-post Vorming on kehtetu',
    'email_validation_help' => 'e-post valideerimine: Peab olema kehtiv e-post Vorming',
    'ends_with' => 'lõpeb',
    'enter_a_number' => 'Sisesta number',
    'enter_default_initials' => 'Sisesta vaikimisi initsiaalid...',
    'enter_default_text' => 'Sisesta vaiketekst...',
    'enter_default_values_comma_separated' => 'Sisesta vaikeväärtused komadega eraldatuna...',
    'enter_initials' => 'Sisesta initsiaalid',
    'enter_number_here' => 'Sisesta number siin',
    'enter_option_text' => 'Sisesta valiku tekst...',
    'enter_regex_pattern' => 'Sisesta regulaaravaldise muster...',
    'enter_text' => 'Sisesta tekst',
    'enter_text_here' => 'Sisesta tekst siin',
    'enter_value' => 'Sisesta väärtus...',
    'enter_values_comma_separated' => 'Sisesta väärtused eraldatud komadega...',
    'equals' => 'võrdub',
    'failed_to_rename' => 'Faili ümbernimetamine ebaõnnestus.',
    'field_appears_on_all_pages' => 'See väli kuvatakse kõigil lehtedel. Allkirjastaja täidab selle ainult üks kord.',
    'field_visibility' => 'Väljaku nähtavus',
    'field_visibility_help' => 'Väli kuvatakse ainult siis, kui need tingimused on täidetud.',
    'file_processing_confirmation_timeout' => 'Server ei kinnitanud seda üleslaadimist pärast korduvaid kontrollimisi. Eemaldage see ja proovige uuesti.',
    'file_processing_failed' => 'Töötlemine ebaõnnestus',
    'file_ready' => 'Valmis',
    'files_not_ready' => 'Failid pole valmis.',
    'google_drive_import_error' => 'Google Drive&#39;ist importimisel läks midagi valesti. Proovige uuesti.',
    'hide_label_shortcut' => 'Peida silt (Ctrl/Cmd+L)',
    'importing_from_google_drive' => 'Failide importimine Google Drive&#39;ist...',
    'initials_instruction' => 'Sisesta oma initsiaalid (maksimaalselt 10 tähemärki)',
    'input' => 'Sisend',
    'invalid_validation_pattern' => 'Kehtetu valideerimismuster',
    'invitation_not_found' => 'Kutset ei leitud.',
    'is_after' => 'on pärast',
    'is_after_or_equal' => 'on pärast või võrdne',
    'is_before' => 'on enne',
    'is_before_or_equal' => 'on enne või võrdne',
    'is_checked' => 'on märgitud',
    'is_greater_than' => 'on suurem kui',
    'is_greater_than_or_equal' => 'on suurem või võrdne',
    'is_less_than' => 'on väiksem kui',
    'is_less_than_or_equal' => 'on väiksem või võrdne',
    'is_not_empty' => 'ei ole tühi',
    'is_unchecked' => 'on märkimata',
    'length' => 'Pikkus',
    'letters_only' => 'Ainult tähed',
    'letters_only_help' => 'Ainult tähed: väli aktsepteerib ainult tähestikulisi märke',
    'mark_optional_shortcut' => 'Märgi valikuliseks (Ctrl/Cmd+R)',
    'mark_required_shortcut' => 'Märgi kohustuslikuks tegemine (Ctrl/Cmd+R)',
    'match' => 'Matš',
    'maximum_length_is' => 'Maksimaalne pikkus on :max',
    'max_length' => 'Maksimaalne pikkus',
    'max_value' => 'Maksimaalne väärtus',
    'minimum_length_is' => 'Minimaalne pikkus on :min',
    'min_length' => 'Minimaalne pikkus',
    'min_value' => 'Minimaalne väärtus',
    'multi_select' => 'Mitmikvalik',
    'multiselect_field_needs_options' => 'Mitme valikuga väljadel peab enne salvestamist olema vähemalt üks valik.',
    'no_default' => 'Vaikimisi pole',
    'no_fields_for_conditions' => 'Loo tingimustele pole ühtegi välja saadaval. Lisa väljad esimesena.',
    'no_maximum' => 'Maksimumväärtust pole',
    'no_minimum' => 'Minimaalset summat pole',
    'no_options_configured' => 'Valikud pole konfigureeritud.',
    'no_options_configured_add_above' => 'Valikud pole konfigureeritud. Lisa valikud ülalpool.',
    'number_format' => 'Numbrite Vorming',
    'numbers_only' => 'Ainult numbrid',
    'numbers_only_help' => 'Ainult numbrid: väli aktsepteerib ainult numbreid',
    'only_letters_allowed' => 'Lubatud on ainult tähed',
    'only_numbers_allowed' => 'Lubatud on ainult numbrid',
    'options_count' => 'Valikud ( :count )',
    'or_import_from' => 'või importida',
    'page_number' => 'Lehekülg :number',
    'pattern_label' => 'Muster: :muster',
    'pattern_not_matched' => 'Mustrile ei leitud vastet',
    'pdf_password_incorrect' => '&quot; :name &quot; jaoks sisestatud parool on vale. Palun Sisesta õige parool:',
    'pdf_password_protected' => 'PDF fail &quot; :name &quot; on parooliga kaitstud. Palun Sisesta parool:',
    'radio' => 'Raadio',
    'radio_group' => 'Raadiogrupp',
    'radio_selection' => 'Raadio valik',
    'required_when' => 'Nõutav, kui...',
    'search_for_command' => 'Otsi käsku käivitamiseks...',
    'select_field_needs_options' => 'Valitud väljadel peab enne salvestamist olema vähemalt üks valik.',
    'select_one_or_more_options' => 'Valige üks või mitu valikut',
    'select_option' => 'Valige suvand',
    'select_option_default' => 'Valige suvand (vaikimisi: :label)',
    'send_email_to_contacts' => 'Saadame e-post järgmistele kontaktidele:',
    'settings_shortcut' => 'Seaded (Ctrl/Cmd+E)',
    'show_label_shortcut' => 'Näita silti (Ctrl/Cmd+L)',
    'shown_later_in_form' => ' - näidatud hiljem kujul',
    'show_when' => 'Näita, millal...',
    'signatories' => 'Allakirjutanud',
    'signatory_number' => 'Allkirjastaja :number',
    'signatory_required_for_signatures' => 'Allkirjade Loo tuleb valida allkirjastaja.',
    'signing_error' => 'Allkirjastamisviga',
    'solid' => 'Tahke',
    'something_went_wrong' => 'Midagi läks valesti',
    'ssn' => 'sotsiaalkindlustuse number',
    'ssn_format_invalid' => 'Sotsiaalkindlustusnumbri Vorming on kehtetu',
    'ssn_validation_help' => 'Sotsiaalkindlustusnumbri valideerimine: peab olema Vorming XXX-XX-XXXX',
    'successfully_deleted' => 'Fail edukalt kustutatud.',
    'successfully_imported_from_google_drive' => 'Fail(id) on Google Drive&#39;ist edukalt imporditud.',
    'successfully_renamed' => 'Faili ümbernimetamine õnnestus.',
    'successfully_saved' => 'Muudatused on edukalt salvestatud.',
    'successfully_updated_document_title' => 'Dokumendi pealkiri on edukalt uuendatud.',
    'successfully_uploaded' => 'Fail(id) edukalt üles laaditud.',
    'template_variable' => 'Malli muutuja',
    'template_variable_help' => 'Valige dokumendis kuvamiseks eelmääratletud muutuja.',
    'toolbox_help_text' => 'Palun vali allkirjastaja ja seejärel joonista allkirjale kohatäide.',
    'uninvited_parties_error' => 'Paistab, et teil on kutsumata seltskondi. Palun vahetage nad päris kasutajate või Kliendid vastu.',
    'unknown_signatory' => 'Tundmatu allkirjastaja',
    'unnamed_contact' => 'Nimetu kontakt ( :email )',
    'unnamed_user' => 'Nimetu kasutaja',
    'untitled_blueprint' => 'Pealkirjata plaan',
    'upload_cancelled_no_password' => 'Faili „ :name ” üleslaadimine tühistati. Parooli pole sisestatud.',
    'upload_error' => 'Faili(de) üleslaadimisel läks midagi valesti. Palun proovige uuesti.',
    'uploading_files' => 'Faili(de) üleslaadimine...',
    'uploading_source_file' => 'Lähtefaili üleslaadimine',
    'url_invalid' => 'URL-i Vorming on sobimatu',
    'url_validation_help' => 'URL-i valideerimine: Peab olema kehtiv URL-i Vorming',
    'use_default_value' => 'Kasuta vaikeväärtust',
    'validation' => 'Valideerimine',
    'validation_rule' => 'Valideerimisreegel',
    'value_must_be_at_least' => 'Väärtus peab olema vähemalt :value',
    'value_must_be_at_most' => 'Väärtus peab olema maksimaalselt :value',
    'variable' => 'Muutuja',
    'widget_type' => 'Vidina tüüp',
    'zip' => 'Postiindeks',
    'zip_format_invalid' => 'Vorming on sobimatu',
    'zip_validation_help' => 'Postiindeksi valideerimine: Peab olema 5 numbrit või 5+4 Vorming (XXXXX-XXXX)',
    'zoom' => 'Suum',
    'report_too_large_to_preview' => 'Aruanne on eelvaate jaoks liiga suur. Aruande vaatamiseks laadige see alla.',
    'log_time' => 'Logimise aeg',
    'filter_by_project' => 'Filtreeri projekti järgi',
    'google' => 'Google',
    'app_maintenance' => 'Rakenduse hooldus on pooleli',
    'cloned_design' => 'Kloonitud disain',
    'no_expenses_selected' => 'Kulusid pole valitud',
    'sync' => 'Sünkroonimine',
    'updated_tax_data' => 'Uuendatud maksuandmed',
    'upload_failed' => 'Üleslaadimine ebaõnnestus',
    'wrong_file_extension' => 'Vale faililaiend',
    'not_ready_for_download' => 'Fail pole allalaadimiseks valmis',
    'list' => 'Loend',
    'already_linked' => 'Juba lingitud',
    'convert_to_task' => 'Teisenda ülesandeks',
    'duplicated_entries' => 'Duplikaatkirjed',
    'no_entries_to_duplicate' => 'Kopeeritavaid kirjeid pole',
    'please_enter_a_valid_duration' => 'Palun Sisesta kehtiv kestus',
    'calendar_unavailable' => 'Kalender pole saadaval',
    'connect_calendar' => 'Ühenda kalender',
    'disconnect_calendar_confirmation' => 'Kas olete kindel, et soovite oma kalendri lahti ühendada?',
    'duplicate_yesterday' => 'Duplikaat eile',
    'hide_events' => 'Peida sündmused',
    'show_events' => 'Näita sündmusi',
    'merge_client' => 'Ühenda Klient',
    'merge_vendor' => 'Tarnija ühendamine',
    'global' => 'Globaalne',
    'disable_all' => 'Keela kõik',
    'press_keys' => 'Vajutage klahve',
    'no_payment_required' => 'See plaanimuudatus ei nõua Makse . Palun minge tagasi ja kinnitage plaanimuudatus.',
    'subscription_payment_required' => 'Kogusumma on muutunud ja nüüd on Makse kohustuslik. Jätkamiseks valige Makse meetod.',
    'task_distribution' => 'Ülesannete jaotus',
    'team_distribution' => 'Meeskonna jaotus',
    'task_velocity' => 'Ülesande kiirus',
    'daily_velocity' => 'Päevane kiirus',
    'forecast_finish' => 'Prognoosi lõpp',
    'days_ahead' => 'Päevad ees',
    'days_behind' => 'Päevad maha jäänud',
    'forecast' => 'Prognoos',
    'estimated_vs_actual' => 'Hinnanguline vs tegelik',
    'budgeted_amount' => 'Eelarve Summa',
    'burn_up' => 'Põlema',
    'actual_spend' => 'Tegelik kulu',
    'margin' => 'Marginaal',
    'target' => 'Sihtmärk',
    'persist_table_filters' => 'Säilita tabeli filtrid',
    'persist_table_filters_help' => 'Kui see on lubatud, jäävad tabeli filtrid lehe uuesti laadimisel alles.',
    'billing_progress' => 'Arvelduse edenemine',
    'budget_vs_actual' => 'Eelarve vs tegelik',
    'unbilled_work' => 'Arveldamata töö',
    'save_for_later' => 'Salvesta hilisemaks',
    'deletion_violation_regulatory' => 'Seda dokumenti ei saa kustutada, kuna see kuulub regulatiivsete aruandlusnõuete alla.',
    'currency_syrian_pound' => 'Süüria nael',
    'account_plan_expired' => 'Kontoplaan on aegunud',
    'add_files' => 'Lisa failid',
    'add_reminder_schedule' => 'Lisa meeldetuletuste ajakava',
    'advanced_options' => 'Täpsemad valikud',
    'after_event' => 'pärast üritust',
    'after_send' => 'Pärast saatmist',
    'before_event' => 'enne sündmust',
    'checklist_fields' => 'Väljade paigutamine dokumendile',
    'checklist_ready' => 'Kasutusvalmis',
    'checklist_send' => 'Saada dokument',
    'checklist_signatories' => 'Lisa allakirjutanud',
    'checklist_title' => 'Dokumentide kontroll-leht',
    'checklist_upload' => 'Laadi dokument üles',
    'click_to_assign' => 'Klõpsake määramiseks',
    'companies' => 'Ettevõtted',
    'confirm_remove_signatory' => 'Kas oled kindel, et soovid selle allakirjutanu eemaldada?',
    'created_reminder_schedule' => 'Meeldetuletuste ajakava loodud',
    'deleted_reminder_schedule' => 'Meeldetuletuste ajakava kustutatud',
    'document_sent_successfully' => 'Dokument edukalt saadetud',
    'docuninja_join_esignatures' => 'E-allkirjad',
    'docuninja_join_esignatures_help' => 'Koguge allkirju jälgimisega',
    'docuninja_join_features_title' => 'Kõik, mida sa saad',
    'docuninja_join_integration' => 'Sügav integratsioon',
    'docuninja_join_integration_help' => 'Töötab Arved , hinnapakkumiste ja tellimuste koostamisel',
    'docuninja_creating_account' => 'Konto loomine...',
    'documents_public_by_default' => 'Määra dokumendid vaikimisi avalikuks',
    'documents_public_by_default_help' => 'Kui see on lubatud, on uued dokumendid vaikimisi avalikud.',
    'docuninja_join_tagline' => 'Loo , saatke ja allkirjastage dokumente otse Arve Ninjast.',
    'docuninja_join_templates_help' => 'Korduvkasutatavate dokumentide joonised',
    'edit_reminder_schedule' => 'Muuda meeldetuletuste ajakava',
    'fewer_tools' => 'Vähem tööriistu',
    'global_tag_inheritance' => 'Globaalne siltide pärimine',
    'global_tag_inheritance_help' => 'Määrab, kas tütarüksused pärivad sildid oma emaüksustelt.',
    'more_tools' => 'Rohkem tööriistu',
    'no_reminder_schedules_found' => 'Meeldetuletuste ajakavasid ei leitud',
    'no_template' => 'Malli pole',
    'reminder_schedules' => 'Meeldetuletuste ajakavad',
    'sending_document' => 'Dokumendi saatmine',
    'single_signatory_description' => 'Valige, kellele soovite selle dokumendi saata, seejärel jätkake.',
    'trigger_event' => 'Käivitussündmus',
    'updated_reminder_schedule' => 'Meeldetuletuste ajakava on uuendatud',
    'validation_errors' => 'Valideerimisvead',
    'view_details' => 'Vaata üksikasju',
    'who_to_send_to' => 'Kellele saata?',
    'wait_for_file_processing' => 'Oota, kuni failide töötlemine on lõppenud, või eemalda ebaõnnestunud üleslaadimised.',
    'yyyy_mm_dd' => 'aaaa-kk-pp',
    'docuninja_unavailable' => 'DocuNinja pole hetkel saadaval. Palun proovige hiljem uuesti.',
    'add_tax' => 'Lisa Maks',
    'what_are_you_charging_for' => 'Mille eest sa raha küsid?',
    'add_value_as_new_client' => 'Lisa ` :value uue Klient',
    'stripe_ach_verifiation_pending' => 'See Makse meetod pole veel kasutusvalmis. Kinnitamine on pooleli.',
    'deleted_invoices_exist' => 'See Makse on seotud ühe või mitme kustutatud Arved ja seda ei saa kustutada, peate esmalt Arved Taasta ja seejärel >Makse d Kustuta .',
    'show_date' => 'Näita kuupäeva',
    'show_signature_line' => 'Näita allkirjajoont',
    'page_break' => 'Leheküljevahetuse juhtelement',
    'page_break_help' => 'Vältige sisu jagunemist lehtede vahel.',
    'spacing' => 'Vahed',
    'designer' => 'Disainer',
    'typography' => 'Tüpograafia',
    'design_name_required' => 'Kujunduse nimi on kohustuslik',
    'preview_indicative_only' => 'Eelvaated on vaid soovituslikud. Lõplik paigutus varieerub olenevalt tegelikest andmetest.',
    'total_task_estimated_duration' => 'Ülesannete eeldatav aeg',
    'total_task_remaining_estimated_duration' => 'Ülesannete järelejäänud aeg',
    'total_unestimated_tasks' => 'Ülesanded hindamata',
