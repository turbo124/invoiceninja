...
$lang = array(
    ...
    'enable_invoice_tax' => 'Aktiver angivelse af en <b>momsskattesætning</b>',
    ...
    'recurring_help' => '<p>Send automatisk kunder de samme <span class=\'notranslate\'>fakturaer</span> ugentligt, hver anden måned, månedlig, kvartalsvis eller årligt.</p>
...
<li> &quot;Egenbetaling for :QUARTER +1&quot; &gt;&gt; &quot;Egenbetaling for Q2&quot;</li>
</ul>',
    'recurring_quotes' => 'Tilbagevendende tilbud',
    'in_total_revenue' => 'Samlede omsætning',
    'billed_client' => 'faktureret kunde',
    'billed_clients' => 'faktureret kunder',
    'active_client' => 'aktiv kunde',
    'active_clients' => 'aktive kunder',
    'invoices_past_due' => 'Fakturaer forfalden',
    ...
    'default_email_footer' => 'Sæt standard e-mail signatur',
    ...
    'stripe_payment_text' => 'Faktura :invoice nummer for :amount for kunde :client',
    'stripe_payment_text_without_invoice' => 'Betaling uden faktura på beløb :amount for kunde :client',
    ...
    'app_description' => 'Invoice Ninja er en gratis, åben kodeløsning til fakturering og faktureringskunder. Med Invoice Ninja kan du nemt bygge og sende smukke fakturaer fra enhver enhed, der har adgang til nettet. Din kunder kan udskrive din fakturaer, downloade dem som PDF filer og endda betale dig online inde fra systemet.',
    'rows' => 'rækker',
    'www' => 'www',
    'logo' => 'Logo',
    ...
    'duration' => 'Varighed',
    'estimated_duration' => 'Estimeret varighed',
    'time_log' => 'Tids log',
    ...
    'last_sent' => 'Sidst sendt',
    'reminder_emails' => 'Påmindelsesmails',
    'quote_reminder_emails' => 'Tilbuds påmindelses e-mails',
    'templates_and_reminders' => 'Skabeloner og påmindelser',
    'subject' => 'Emne',
    'body' => 'Brødtekst',
    'first_reminder' => 'Første påmindelse',
    'second_reminder' => 'Anden påmindelse',
    'third_reminder' => 'Tredje påmindelse',
    'num_days_reminder' => 'Dage efter forfaldsdato',
    'reminder_subject' => 'Påmindelse: Faktura :invoice fra :account',
    'reset' => 'Nulstil',
    'invoice_not_found' => 'Den ønskede faktura er ikke tilgængelig',
    'referral_program' => 'Henvisningsprogram',
    'referral_code' => 'Henvisnings-URL',
    'last_sent_on' => 'Sendt sidst: :date',
    'page_expire' => 'Denne side udløber snart, :click_here så vi kan fortsætte arbejdet',
    'upcoming_quotes' => 'Kommende tilbud',
    'expired_quotes' => 'Udløbet tilbud',
    'sign_up_using' => 'Tilmeld dig ved hjælp af',
    'invalid_credentials' => 'Disse legitimationsoplysninger stemmer ikke overens med vores optegnelser',
    'no_passkeys_registered' => 'Ingen adgangsnøgler registreret til denne konto . Brug venligst adgangskode eller registrer en adgangsnøgle først.',
    'show_all_options' => 'Vis alle muligheder',
    'user_details' => 'Brugeroplysninger',
    'oneclick_login' => 'Forbundet konto',
    'disable' => 'Deaktiver',
    'invoice_quote_number' => 'Faktura- og tilbudsnumre',
    ...
    'notification_invoice_bounced_subject' => 'Ikke istand til at levere faktura :invoice',
    'notification_quote_bounced' => 'Vi var ikke i stand til at levere tilbud :invoice til :contact .<br><br> :error',
    'notification_quote_bounced_subject' => 'Ikke istand til at levere tilbud :invoice',
    'custom_invoice_link' => 'Brugerdefineret fakturalink',
    'total_invoiced' => 'Faktureret i alt',
    'open_balance' => 'Udestående:',
    'verify_email' => 'Besøg venligst linket i kontobekræftelsesmailen for at bekræfte din e-mailadresse.',
    'basic_settings' => 'Indstillinger',
    'pro' => 'Pro',
    'gateways' => 'Betalingsgateways',
    'next_send_on' => 'Send næste: :date',
    'no_longer_running' => 'Denne faktura er ikke planlagt til at køre',
    'general_settings' => 'Generelle indstillinger',
    'customize' => 'Tilpas',
    'oneclick_login_help' => 'Forbind en konto for at logge ind uden adgangskode',
    'referral_code_help' => 'Tjen penge ved at dele vores app online',
    'enable_with_stripe' => 'Aktivér | Kræver Stripe',
    'tax_settings' => 'Skatteindstillinger',
    'create_tax_rate' => 'Tilføj skattesats',
    'updated_tax_rate' => 'Skattesatsen er blevet opdateret',
    'created_tax_rate' => 'Skattesatsen er oprettet',
    'edit_tax_rate' => 'Rediger skattesats',
    'archive_tax_rate' => 'Arkivskattesats',
    'archived_tax_rate' => 'Skattesatsen er arkiveret',
    'default_tax_rate_id' => 'Standardskattesats',
    'tax_rate' => 'Skattesats',
    'recurring_hour' => 'Tilbagevendende time',
    'pattern' => 'Mønster',
    'pattern_help_title' => 'Hjælp med mønstre',
    'pattern_help_1' => 'Opret brugerdefineret nummer ved at specificere et mønster',
    'pattern_help_2' => 'Tilgængelige variabler:',
    'pattern_help_3' => 'For eksempel, :example ville blive konverteret til :value',
    'see_options' => 'Se muligheder',
    'invoice_counter' => 'Fakturatæller',
    'quote_counter' => 'Tilbudstæller',
    'type' => 'Type',
    'activity_1' => ':user oprettede kunde :client',
    ...
    'default_messages' => 'Standardmeddelelser',
    'quote_terms' => 'Tilbudsbetingelser',
    'default_quote_terms' => 'Standardtilbudsbetingelser',
    'default_invoice_terms' => 'Sæt standard fakturavilkår',
    'default_invoice_footer' => 'Sæt standard faktura fodnoter',
    'quote_footer' => 'Tilbudsfodnote',
    'free' => 'Gratis',
    'quote_is_approved' => 'Tilbuddet er nu godkendt. Betal gerne med det samme',
    'apply_credit' => 'Ansøg kredit',
    'system_settings' => 'System indstillinger',
    'archive_token' => 'Arkivtoken',
    'archived_token' => 'Tokenet er arkiveret',
    'archive_user' => 'Arkivér bruger',
    'archived_user' => 'Brugeren er blevet arkiveret',
    'archive_account_gateway' => 'Slet gateway',
    'archived_account_gateway' => 'Gateway blev arkiveret',
    'archive_recurring_invoice' => 'Arkivér tilbagevendende faktura',
    'archived_recurring_invoice' => 'Tilbagevendende faktura er blevet arkiveret',
    'delete_recurring_invoice' => 'Slet tilbagevendende faktura',
    'deleted_recurring_invoice' => 'Tilbagevendende faktura er slettet',
    'restore_recurring_invoice' => 'Gendan tilbagevendende faktura',
    'restored_recurring_invoice' => 'Tilbagevendende faktura er blevet gendannet',
    ...
    'archived' => 'Arkiveret',
    'untitled_account' => 'Unavngivet firma',
    'before' => 'Før',
    'after' => 'Efter',
    'reset_terms_help' => 'Nulstil til standardkontovilkårene',
    'reset_footer_help' => 'Nulstil til standardkontoens sidefod',
    ...
    'import_freshbooks' => 'Importer fra FreshBooks',
    'import_data' => 'Importér data',
    'source' => 'Kilde',
    'csv' => 'CSV',
    'client_file' => 'Kunde fil',
    'invoice_file' => 'Faktura fil',
    'task_file' => 'Opgave fil',
    'no_mapper' => 'Ingen gyldig tilknytning til filen',
    'invalid_csv_header' => 'Ugyldig CSV-header',
    'client_portal' => 'Kunde portal',
    'admin' => 'Admin',
    'disabled' => 'Deaktiveret',
    'show_archived_users' => 'Vis arkiveret brugere',
    'notes' => 'Noter',
    'invoice_will_create' => 'faktura vil blive oprettet',
    'invoices_will_create' => 'fakturaer vil blive oprettet',
    'failed_to_import' => 'Følgende poster kunne ikke importeres. De findes enten allerede, eller der mangler obligatoriske felter.',
    'publishable_key' => 'Publicerbar nøgle',
    'secret_key' => 'Hemmelig nøgle',
    'missing_publishable_key' => 'Indstil din Stripe-publiceringsnøgle for en forbedret betalingsproces',
    ...
    'template_help_title' => 'Hjælp til skabeloner',
    'template_help_1' => 'Tilgængelige variabler:',
    'email_design_id' => 'E-mail stil',
    'email_design_help' => 'Giv dine e-mails et mere professionelt udseende med HTML-layouts.',
    'plain' => 'Plain',
    'light' => 'Light',
    'dark' => 'Dark',
    'industry_help' => 'Bruges til at sammenligne med gennemsnittet af virksomheder af lignende størrelse og branche.',
    ...
    'invoice_number_help' => 'Angiv et præfiks, eller brug et speciel mønster til dynamisk at indstille faktura nummeret.',
    'quote_number_help' => 'Angiv et præfiks, eller brug et speciel mønster til dynamisk at indstille tilbud.',
    'custom_client_fields_helps' => 'Tilføj et felt, når du opretter en klient, og vis eventuelt etiketten og værdien på PDF-filen.',
    'custom_account_fields_helps' => 'Tilføj en etiket og en værdi til afsnittet med virksomhedsoplysninger i PDF-filen.',
    ...
    'custom_invoice_charges_helps' => 'Tilføj et felt når du opretter en faktura og inkluder gebyret i faktura subtotalerne.',
    'token_expired' => 'Valideringstokenet er udløbet. Prøv igen.',
    'invoice_link' => 'Faktura Link',
    'button_confirmation_message' => 'Klik for at bekræfte din e-mail.',
    'confirm' => 'Bekræft',
    'email_preferences' => 'E-mail præferencer',
    'created_invoices' => ':count faktura(er) er oprettet',
    'next_invoice_number' => 'Det næste faktura nummer er :number .',
    'next_quote_number' => 'Det næste tilbudsnummer er :number .',
    'days_before' => 'Dage før',
    'days_after' => 'Dage efter',
    'field_due_date' => 'forfaldsdato',
    'field_invoice_date' => 'Faktura dato',
    'schedule' => 'Tidsplan',
    'email_designs' => 'E-mail designs',
    'assigned_when_sent' => 'Tildelt ved afsendelse',
    ...
    'public_notes' => 'Offentlige noter',
    'invoice_amount' => 'Faktura beløb',
    'exchange_rate' => 'Valutakurs',
    'yes' => 'Ja',
    'no' => 'Nej',
    'should_be_invoiced' => 'Skal faktureres',
    'view_expense' => 'Vis udgift # :expense',
    ...
    'expense_error_multiple_clients' => 'Udgifterne kan ikke tilhøre forskellige kunder',
    'expense_error_invoiced' => 'Udgiftsbilag er allerede faktureret',
    'convert_currency' => 'Konverter valuta',
    'num_days' => 'Antal dage',
    'create_payment_term' => 'Opret betalingsbetingelser',
    'edit_payment_terms' => 'Redigér betalingsbetingelser',
    'edit_payment_term' => 'Redigér betalingsbetingelser',
    'archive_payment_term' => 'Arkivér betalingsbetingelser',
    'recurring_due_dates' => 'Tilbagevendende fakturaforfaldsdatoer',
    'recurring_due_date_help' => '<p>Sætter automatisk en forfaldsdato for fakturaen.</p>
<p> Fakturaer på en månedlig eller årlig cyklus, der forfalder på eller før den dato, de oprettes, forfalder den næste måned. Fakturaer, der forfalder den 29. eller 30. i måneder, der ikke har denne dag, forfalder den sidste dag i måneden.</p>
<p> Fakturaer med en ugentlig cyklus, der forfalder på den ugedag, de oprettes, forfalder den følgende uge.</p>
<p> For eksempel:</p>
<ul>
<li> I dag er det den 15., og forfaldsdatoen er den 1. i måneden. Forfaldsdatoen burde sandsynligvis være den 1. i den næste måned.</li>
<li> I dag er det den 15., forfaldsdatoen er den sidste dag i måneden. Forfaldsdatoen vil være den sidste dag i denne måned.
</li>
<li> I dag er det den 15., forfaldsdatoen er den 15. dag i måneden. Forfaldsdatoen vil være den 15. dag i <strong>næste</strong> måned.
</li>
<li> I dag er det fredag, afleveringsdatoen er den første fredag ​​efter. Afleveringsdatoen er næste fredag, ikke i dag.
</li>
</ul>',
    'due' => 'Forfalden',
    'next_due_on' => 'Forfalder næste: :date',
    'use_client_terms' => 'Brug kundevilkår',
    'day_of_month' => ':almindelig månedsdag',
    'last_day_of_month' => 'Sidste dag i måneden',
    ...
    'friday' => 'Fredag',
    'saturday' => 'Lørdag',
    'header_font_id' => 'Overskriftsskrifttype',
    'body_font_id' => 'Skrifttype',
    ...
    'invalid_mail_config' => 'Kan ikke sende e-mail. Kontroller venligst at e-mail indstillingerne er korrekte.',
    'invoice_message_button' => 'For at vise din faktura til :amount, klik på knappen nedenfor.',
    'quote_message_button' => 'For at vise dit tilbud på :amount, klik på knappen nedenfor.',
    'payment_message_button' => 'Tak for din betaling af :amount .',
    'payment_type_direct_debit' => 'Betalingsservice',
    'bank_accounts' => 'Kreditkort og banker',
    'add_bank_account' => 'Tilføj bankkonto',
    'setup_account' => 'Opsæt konto',
    'import_expenses' => 'Importer Udgifter',
    'bank_id' => 'Bank',
    'integration_type' => 'Integration Type',
    'updated_bank_account' => 'Bankkontoen er blevet opdateret',
    'edit_bank_account' => 'Rediger bankkonto',
    'archive_bank_account' => 'Arkiver bankkonto',
    'archived_bank_account' => 'Bankkontoen er blevet arkiveret',
    'created_bank_account' => 'Bankkontoen er oprettet',
    'validate_bank_account' => 'Valider bankkonto',
    'bank_password_help' => 'Bemærk: Din adgangskode overføres sikkert og gemmes aldrig på vores servere.',
    ...
    'bank_account_error' => 'Kontooplysningerne kunne ikke hentes. Kontroller venligst dine loginoplysninger.',
    'status_approved' => 'Godkendt',
    'quote_settings' => 'Tilbudsindstillinger',
    ...
    'iframe_url_help3' => 'Bemærk: Hvis du planlægger at acceptere kreditkort detaljer anbefaler vi kraftigt at aktivere HTTPS på dit websted.',
    'expense_error_multiple_currencies' => 'Udgifterne kan ikke have forskellige valutaer.',
    'expense_error_mismatch_currencies' => 'Kunde valuta matcher ikke udgift valuta.',
    'trello_roadmap' => 'Trello Roadmap',
    'header_footer' => 'Sidehoved/fodtekst',
    'first_page' => 'Første side',
    'all_pages' => 'Alle sider',
    'last_page' => 'Sidste side',
    'all_pages_header' => 'Vis overskrift på',
    'all_pages_footer' => 'Vis sidefod på',
    'invoice_currency' => 'Faktura valuta',
    'enable_https' => 'Vi anbefaler stærkt at bruge HTTPS for accept af kreditkort detaljer online',
    'quote_issued_to' => 'Tilbud udstedt til',
    'show_currency_code' => 'Valuta kode',
    'free_year_message' => 'Din konto er opgraderet til pro i et år uden extra omkostninger.',
    'trial_message' => 'Din konto giver dig en gratis to ugers prøveperiode af vores pro-abonnement.',
    ...
    'trial_success' => 'To ugers gratis prøveperiode på Pro-planen er blevet aktiveret',
    'trial_card_authorization_notice' => 'Der vil ikke blive opkrævet Betaling i dag. Vi vil midlertidigt godkende dit kreditkort med 1 USD og frigive det umiddelbart efter bekræftelse. Din bank kan kort vise det som afventende. Ved udgangen af den 14-dages prøveperiode vil dit kort blive debiteret med 14 USD/måned. annullere når som helst.',
    'trial_card_verification_failed' => 'Vi kunne ikke bekræfte dette kreditkort. Der blev ikke foretaget nogen betaling. Brug venligst et gyldigt kreditkort med mindst 1 USD i tilgængelig kredit.',
    'trial_credit_card_required' => 'Kun kreditkort accepteres. Debetkort, forudbetalte kort og uklassificerede kort kan ikke bruges. Der blev ikke opkrævet noget gebyr.',
    'trial_card_gateway_error' => 'Vi kunne ikke kontakt kortudbyderen. Der blev ikke opkrævet noget beløb. Prøv igen.',
    'trial_card_release_failed' => 'Dit kort blev godkendt, men vi kunne ikke bekræfte, at den midlertidige godkendelse blev frigivet. Din prøveperiode blev ikke startet. Prøv igen senere, eller kontakt support.',
    'trial_verification_in_progress' => 'Din kortbekræftelse er allerede under behandling. Vent et øjeblik, og prøv igen.',
    'trial_no_longer_available' => 'Denne konto er ikke længere berettiget til den gratis prøveperiode.',
    'overdue' => 'Forfaldet',
    ...
    'email_error_inactive_contact' => 'E-mails kan ikke sendes til inaktive kontakter',
    'email_error_inactive_invoice' => 'E-mails kan ikke sendes til inaktive fakturaer',
    'email_error_user_unregistered' => 'Registrer venligst din konto for at sende e-mails',
    'email_error_user_unconfirmed' => 'Bekræft venligst din konto for at sende e-mails',
    'email_error_invalid_contact_email' => 'Ugyldig kontakt e-mail',
    'navigation' => 'Navigation',
    'list_invoices' => 'Liste over fakturaer',
    'list_clients' => 'Liste over kunder',
    'list_quotes' => 'Liste over tilbud',
    'list_tasks' => 'Liste over opgaver',
    'list_expenses' => 'Liste over udgifter',
    'list_recurring_invoices' => 'Liste over tilbagevendende fakturaer',
    'list_payments' => 'Liste over betalinger',
    'list_credits' => 'Liste over kreditnota',
    'tax_name' => 'Tax Name',
    'report_settings' => 'Rapportér indstillinger',
    'new_user' => 'Ny bruger',
    'new_product' => 'Nyt produkt',
    'new_tax_rate' => 'Ny skattesats',
    'invoiced_amount' => 'Faktureret beløb',
    'invoice_item_fields' => 'Fakturaelementfelter',
    ...
    'send_portal_password_help' => 'Hvis der ikke er angivet en adgangskode, genereres en, som sendes sammen med den første faktura.',

    'expired' => 'Udløbet',
    'invalid_card_number' => 'Kreditkortnummeret er ikke gyldigt.',
    'invalid_expiry' => 'Udløbsdatoen er ikke gyldig.',
    'invalid_cvv' => 'CVV&#39;en er ikke gyldig.',
    'cost' => 'Omkostninger',
    'create_invoice_for_sample' => 'Bemærk: Opret din første faktura for at se en forhåndsvisning her.',

    // User Permissions
    'owner' => 'Ejer',
    'administrator' => 'Administrator',
    'administrator_help' => 'Tillad bruger at administrere brugere, ændre indstillinger og redigere alle poster',
    'user_create_all' => 'Opret kunder, fakturaer mv.',
    'user_view_all' => 'Vis alle kunder, fakturaer mv.',
    'user_edit_all' => 'Redigér alle kunder, fakturaer mv.',
    'partial_due' => 'Delvis forfalden',
    'restore_vendor' => 'Gendan leverandør',
    'restored_vendor' => 'Leverandør gendannet',
    'restored_expense' => 'Udgift gendannet med succes',
    'permissions' => 'Tilladelser',
    'create_all_help' => 'Tillad bruger at oprette og ændre poster',
    'view_all_help' => 'Tillad brugeren at se registreringer, de ikke har oprettet',
    'edit_all_help' => 'Tillad brugeren at ændre poster, de ikke har oprettet',
    ...
    'email_documents_example_1' => 'Widgets-kvittering.pdf',
    'email_documents_example_2' => 'Final Deliverable.zip',
    'quote_documents' => 'Tilbudsdokumenter',
    'invoice_documents' => 'Faktura dokumenter',
    'expense_documents' => 'Udgiftsdokumenter',
    ...
    'download_documents' => 'Download dokumenter ( :size )',
    'documents_from_expenses' => 'Fra udgifter:',
    'dropzone_default_message' => 'Slip filer eller klik for at uploade',
    'dropzone_default_message_disabled' => 'Uploads er slået fra',
    'dropzone_fallback_message' => 'Din browser understøtter ikke træk-og-slip-filuploads.',
    'dropzone_fallback_text' => 'Brug venligst reserveformularen nedenfor til at uploade dine filer ligesom i gamle dage.',
    'dropzone_file_too_big' => 'Filen er for stor ({{filesize}}MiB). Maksimal filstørrelse: {{maxFilesize}}MiB.',
    ...
    'document_size' => 'Størrelse',

    'enable_client_portal' => 'Kundeportal',
    'enable_client_portal_help' => 'Vis/skjul kunde.',
    'enable_client_portal_dashboard' => 'Dashboard',
    'enable_client_portal_dashboard_help' => 'Vis/skjul dashboard-siden i kundeportalen.',

    // Plans
    'account_management' => 'Kontostyring',
    'plan_status' => 'Planstatus',

    'plan_upgrade' => 'Opgrader',
    'plan_change' => 'Administrer plan',
    'pending_change_to' => 'Ændringer til',
    'plan_changes_to' => ':plan on :date',
    'plan_term_changes_to' => ':plan (:term) on :date',
    'cancel_plan_change' => 'Annuller ændring',
    'plan' => 'Plan',
    'expires' => 'Udløber',
    'renews' => 'Fornyer',
    'plan_expired' => ':plan Plan udløbet',
    'trial_expired' => ':plan Planprøveperiode afsluttet',
    'never' => 'Aldrig',
    'plan_free' => 'Gratis',
    'plan_pro' => 'Pro',
    ...
    'plan_trial' => 'Prøveperiode',
    'plan_term' => 'Term',
    'plan_term_monthly' => 'Månedlig',
    'plan_term_yearly' => 'Årlig',
    'plan_term_month' => 'Måned',
    'plan_term_year' => 'År',
    'plan_price_monthly' => '$:pris/måned',
    'plan_price_yearly' => '$:pris/år',
    'updated_plan' => 'Opdateret indstillinger',
    ...
    'pro_plan_year_description' => 'Et års tilmelding til Invoice Ninja Pro-planen.',
    'pro_plan_month_description' => 'En måneds tilmelding til Invoice Ninja Pro-planen.',
    'enterprise_plan_product' => 'Enterprise Plan',
    'enterprise_plan_year_description' => 'Et års tilmelding til Invoice Ninja Enterprise Plan.',
    'enterprise_plan_month_description' => 'En måneds tilmelding til Invoice Ninja Enterprise Plan.',
    'plan_credit_product' => 'Credit',
    'plan_credit_description' => 'Credit for unused time',
    'plan_pending_monthly' => 'Skifter til månedlig på :date',
    'plan_refunded' => 'Der er udstedt en refusion.',

    'page_size' => 'Sidestørrelse',
    'live_preview_disabled' => 'Live forhåndsvisning er blevet deaktiveret for at understøtte den valgte skrifttype',
    'invoice_number_padding' => 'Padding',
    'preview' => 'Forhåndsvisning',
    'list_vendors' => 'Vis sælgere',
    'add_users_not_supported' => 'Opgrader til Enterprise Plan for at tilføje yderligere brugere til din konto.',
    ...
    'ach' => 'ACH',
    'enable_ach' => 'Accepter amerikanske bankoverførsler',
    ...
    'remove' => 'Fjern',
    'remove_failed_upload' => 'Fjern mislykket upload',
    ...
    'country_Cayman Islands' => 'Caymanøerne',
    'country_Central African Republic' => 'Centralafrikanske Republik',
    ...
    'country_Cocos (Keeling) Islands' => 'Kokosøerne (Keelingøerne)',
    'country_Colombia' => 'Colombia',
    'country_Comoros' => 'Comoros',
    'country_Mayotte' => 'Mayotte',
    'country_Congo' => 'Congo',
    'country_Congo, the Democratic Republic of the' => 'Congo, Den Demokratiske Republik',
    ...
    'country_Dominican Republic' => 'Den Dominikanske Republik',
    ...
    'country_Falkland Islands (Malvinas)' => 'Falklandsøerne (Malvinas)',
    'country_South Georgia and the South Sandwich Islands' => 'Sydgeorgien og Sydsandwichøerne',
    'country_Fiji' => 'Fiji',
    'country_Finland' => 'Finland',
    'country_Åland Islands' => 'Ålandsøerne',
    'country_France' => 'Frankrig',
    'country_French Guiana' => 'Fransk Guyana',
    'country_French Polynesia' => 'Fransk Polynesien',
    'country_French Southern Territories' => 'Franske sydlige territorier',
    ...
    'country_Holy See (Vatican City State)' => 'Den Hellige Stol (Vatikanstaten)',
    ...
    'country_Tanzania, United Republic of' => 'Tanzania, Den Forenede Republik',
    'country_United States' => 'USA',
    'country_Virgin Islands, U.S.' => 'Virgin Islands, U.S.',
    'country_Burkina Faso' => 'Burkina Faso',
    'country_Uruguay' => 'Uruguay',
    'country_Uzbekistan' => 'Uzbekistan',
    'country_Venezuela, Bolivarian Republic of' => 'Venezuela, Den Bolivariske Republik',
    ...
    // Languages
    'lang_Brazilian Portuguese' => 'Brasiliansk portugisisk',
    ...
    'lang_English - Australia' => 'Engelsk - Australien',
    ...
    'industry_Healthcare & Life Sciences' => 'Sundhedspleje og biovidenskab',
    ...
    'archived_expense_categories' => 'Succesfuldt arkiveret :count udgift kategori',
    ...
    'show_accept_quote_terms' => 'Afkrydsningsfelt for tilbudsvilkår',
    ...
    'marked_sent_invoice' => 'Faktura markeret sendt',
    'marked_sent_invoices' => 'Fakturaer markeret sendt',
    ...
    'tax_quote' => 'Tilbud',
    'tax_invoice' => 'Faktura',
    'emailed_invoices' => 'Fakturaer er sendt via e-mail',
    'emailed_quotes' => 'Tilbud er sendt via e-mail',
    ...
    'custom_product_fields_help' => 'Tilføj et felt, når du opretter et produkt eller en faktura, og vis etiketten og værdien på PDF\'en.',
    'freq_two_months' => 'To måneder',
    'freq_yearly' => 'Årligt',
    'profile' => 'Profil',
    'industry_Construction' => 'Konstruktion',
    'your_statement' => 'Dit kontoudtog',
    'statement_issued_to' => 'Kontoudtog udstedt til',
    'statement_to' => 'Kontoudtog til',
    'customize_options' => 'Tilpas valgmuligheder',
    'created_payment_term' => 'Betalingsbetingelser er oprettet',
    'updated_payment_term' => 'Betalingsbetingelser er blevet opdateret',
    'archived_payment_term' => 'Betalingsbetingelser er blevet arkiveret',
    'resend_invite' => 'Send invitationen igen',
    'credit_created_by' => 'Kredit oprettet ved betaling :transaction_reference',
    'created_payment_and_credit' => 'Betaling og kredit er oprettet',
    'created_payment_and_credit_emailed_client' => 'Der er oprettet en betaling og kredit, og en e-mail er blevet sendt til kunden.',
    'create_project' => 'Opret projekt',
    'create_vendor' => 'Opret leverandør',
    ...
    'gateway_fees_help' => 'Tilføj automatisk et online betalingstillæg/rabat.',
    'gateway' => 'Gateway',
    'gateway_fee_change_warning' => 'Hvis der er ubetalte fakturaer med gebyrer, skal de opdateres manuelt.',
    ...
    'data' => 'Data',
    'imported_settings' => 'Indstillinger blev importeret',
    ...
    'online_payment_discount' => 'Rabat på onlinebetaling',
    'created_new_company' => 'Ny virksomhed blev oprettet',
    ...
    'purge_data_help' => 'Slet alle data permanent, men behold kontoen og indstillingerne.',
    'cancel_account_help' => 'Slet kontoen permanent sammen med alle data og indstillinger.',
    'purge_successful' => 'Virksomhedsdata er blevet slettet',
    'forbidden' => 'Forbudt',
    ...
    'archived_products' => ':count produkter blev arkiveret',
    ...
    'white_label_license_error' => 'Kunne ikke validere licensen, enten udløbet eller overdrevne aktiveringer. E-mail contact@invoiceninja.com for mere information.',
    'plan_price' => 'Plan pris',
    'wrong_confirmation' => 'Forkert bekræftelseskode',
    'oauth_taken' => 'Kontoen er allerede registreret',
    'emailed_payment' => 'Betalingen blev sendt via e-mail',
    ...
    'resumed_task' => 'Opgaven blev genoptaget',
    'quote_design' => 'Tilbudsdesign',
    ...
    'application_settings' => 'Applikationsindstillinger',
    ...
    'label' => 'Etiket',
    'service' => 'Service',
    'update_payment_details' => 'Opdater betalingsoplysninger',
    'updated_payment_details' => 'Betalingsoplysningerne er blevet opdateret',
    'update_credit_card' => 'Opdater kreditkort',
    'recurring_expenses' => 'Tilbagevendende udgifter',
    'recurring_expense' => 'Tilbagevendende udgift',
    'new_recurring_expense' => 'Ny tilbagevendende udgift',
    'edit_recurring_expense' => 'Redigér tilbagevendende udgift',
    'archive_recurring_expense' => 'Arkiver tilbagevendende udgift',
    'list_recurring_expense' => 'Liste over tilbagevendende udgifter',
    'updated_recurring_expense' => 'Den tilbagevendende udgift er blevet opdateret',
    'created_recurring_expense' => 'Den tilbagevendende udgift er blevet oprettet',
    'archived_recurring_expense' => 'Den tilbagevendende udgift er blevet arkiveret',
    'restore_recurring_expense' => 'Gendan tilbagevendende udgift',
    'restored_recurring_expense' => 'Gendannet tilbagevendende udgift',
    'delete_recurring_expense' => 'Slet tilbagevendende udgift',
    'deleted_recurring_expense' => 'Tilbagevendende udgift slettet',
    'view_recurring_expense' => 'Se tilbagevendende udgift',
    ...
    'charge_late_fee' => 'Opkræv gebyr for forsinket betaling',
    'late_fee_amount' => 'Rykkergebyr beløb',
    'late_fee_percent' => 'Rykkergebyr procent',
    'late_fee_added' => 'Rykkergebyr tilføjet :date',
    'download_invoice' => 'Download faktura',
    'download_quote' => 'Download tilbud',
    'invoices_are_attached' => 'Din faktura PDF&#39;er er vedhæftet.',
    ...
    'currency_danish_krone' => 'Danske krone',
    ...
    'delete_company_help' => 'Slet virksomheden permanent sammen med al data og indstillinger.',
    'delete_company_message' => 'Advarsel: Dette vil permanent slette din virksomhed og det kan ikke fortrydes.',
    ...
    'customer' => 'Kunde',
    'customers' => 'Kunder',
    'created_customer' => 'Kunden blev oprettet',
    'created_customers' => 'Der er oprettet :count kunder',

    'purge_details' => 'Dataene i din virksomhed ( :account ) er blevet slettet.',
    'deleted_company' => 'Virksomheden blev slettet',
    'deleted_account' => 'Kontoen blev annulleret',
    'deleted_company_details' => 'Din virksomhed (:account) er blevet slettet.',
    'deleted_account_details' => 'Din konto (:account) er blevet slettet.',
    ...
    'started_task' => 'Opgaven er startet',
    ...
    'time_tracker_mobile_help' => 'Dobbeltklik på en opgave for at vælge den',
    'stopped' => 'Stoppet',
    'ascending' => 'Stigende',
    ...
    'time_hrs' => 'timer',
    'clear' => 'Ryd',
    'warn_payment_gateway' => 'Bemærk: at acceptere onlinebetalinger kræver en betalingsgateway, :link for at tilføje en.',
    'task_rate' => 'Opgave',
    ...
    'preparing_canonical_pdf' => 'Forbereder kanonisk PDF',
    'preparing_server_preview' => 'Forbereder serverforhåndsvisning',
    ...
    'migrate_to_next_version' => 'Migrer til den næste version af Invoice Ninja',
    ...
    'migration' => 'Migration',
    'welcome_to_the_new_version' => 'Velkommen til den nye version af Invoice Ninja',
    ...
    'applied_refunded' => 'Ansøgt refusion',
    ...
    'migration_went_wrong' => 'Ups! Noget gik galt! Sørg for, at du har opsat en Invoice Ninja v5-instans, før du starter migreringen.',
    ...
    'bank_account_not_linked' => 'For at betale med en bankkonto skal du først tilføje den som betalingsmetode.',
    'application_settings_label' => 'Lad os gemme grundlæggende oplysninger om din Invoice Ninja!',
    ...
    'invoice_not_related_to_payment' => 'Faktura # :invoice er ikke relateret til denne Betaling',
    'credit_not_related_to_payment' => 'Kreditnummer :credit er ikke relateret til denne Betaling',
    ...
    'migration_api_secret_notice' => 'Du kan finde API_SECRET i .env-filen eller Invoice Ninja v5. Hvis ejendom mangler, lad feltet stå tomt.',
    ...
    'new_login_description' => 'Du har for nylig logget ind på din Invoice Ninja-konto fra en ny placering eller enhed:<br><br> <b>IP:</b> :ip<br> <b>Tid:</b> :time<br> <b>e-mail :</b> :email',
    ...
    'promptpay' => 'PromptPay',
    'payment_type_PromptPay' => 'PromptPay',
    'promptpay_instructions' => 'Click Pay Now to display a PromptPay QR code, then scan it with your Thai banking app to complete the payment.',
    ...
    'notification_invoice_overdue_subject' => 'Faktura :invoice er for sent for :client',
    'notification_invoice_overdue' => 'Følgende Faktura :invoice for kunde :client og :amount er nu forfalden.',
    ...
    'white_label_body' => 'Tak fordi du har købt en hvidmærke licens.<br><br> Din licensnøgle er:<br><br> :license_key<br><br> Du kan administrere din licens her: https://invoiceninja.invoicing.co/client/login',
    ...
    'invoices_by_month' => 'Fakturaer efter måned',
    'payments_by_month' => 'Betalinger pr. måned',
    'monthly_breakdown_skipped' => 'Månedlig oversigt sprunget over: datointerval overstiger 24 måneder',
    ...
    'gross_sales' => 'Bruttoomsætning',
    'taxable_sales' => 'Skattepligtigt salg',
    'exempt_sales' => 'Fritaget salg',
    'non_taxable_sales' => 'Ikke-skattepligtigt salg',
    'zero_rated_sales' => 'Nulsatset salg',
    'accounting_basis' => 'Regnskabsgrundlag',
    'tax_treatment' => 'Skattebehandling',
    'summary_source' => 'Kilde til oversigt',
    'sales_breakdown_source' => 'Salgsoversigt',
    'legacy_tax_detail_source' => 'Detaljer om ældre skatter',
    'monthly_filing_summary' => 'Månedlig indberetningsoversigt',
    'filing_overview' => 'Oversigt over arkivering',
    'jurisdiction_breakdown' => 'Jurisdiktionsfordeling',
    'state_breakdown' => 'Statsfordeling',
    'filing_period' => 'Indleveringsperiode',
    'period_start' => 'Periodestart',
    'period_end' => 'Periodens afslutning',
    'jurisdiction_source' => 'Jurisdiktion Kilde',
    'tax_data_source' => 'Skattedata',
    'client_shipping_source' => 'Kunde leveringsadresse',
    'client_billing_source' => 'Kunde faktureringsadresse',
    'tax_detail_source' => 'Skatteoplysninger Postnummer',
    'unknown_source' => 'Ukendt kilde',
    'district' => 'Distrikt',
    'metric' => 'Metrisk',
    'report_period' => 'Rapportperiode',
    'current_filing_rows' => 'Aktuelle arkiveringsrækker',
    'correction_rows' => 'Rettelsesrækker',
    'states_reported' => 'Stater rapporteret',
    'jurisdictions_reported' => 'Rapporterede jurisdiktioner',
    'rows_missing_state' => 'Rækker mangler status',
    'rows_using_client_fallback' => 'Rækker ved hjælp af Kunde Fallback',
    'prior_period_corrections' => 'Rettelser i tidligere perioder',
    'corrections_review' => 'Gennemgang af rettelser',
    'original_tax_period' => 'Oprindelig skatteperiode',
    'correction_recorded_period' => 'Korrektion Registreret Periode',
    'correction_type' => 'Korrektionstype',
    'requires_review' => 'Kræver gennemgang',
    'current_period_activity' => 'Aktivitet i den nuværende periode',
    'invoice_correction' => 'Faktura -korrektion',
    'payment_correction' => 'Betaling',
    'status_correction' => 'Statuskorrektion',
    'legacy_unknown' => 'Ukendt arv',
    'tax_summary' => 'Skatteoversigt',
    'reporting_bucket' => 'Rapporteringsspand',
    'invoice_count' => 'Faktura Count',
    ...
    'mobile_payment' => 'Betaling',
    'awaiting_payment' => 'Afventer Betaling',
    'payment_confirmed' => 'Betaling bekræftet',
    'payment_expired' => 'Betaling er udløbet. Gå tilbage og prøv igen.',
    'payment_was_not_completed' => 'Betaling blev ikke gennemført. Prøv igen.',
    'no_compatible_app_installed' => 'Hvis der ikke sker noget, har du muligvis ikke en kompatibel app installeret.',
    'payment_type_Mobile Payment' => 'Betaling',
    'gateway_temporarily_unavailable' => 'Denne Betaling er midlertidigt utilgængelig. Prøv igen senere, eller vælg en anden Betaling .',
    'mybank' => 'MyBank',
    ...
    'nordigen_requisition_body' => 'Adgang til bankkontofeeds er udløbet som angivet i brugeraftalen.<br><br> Log venligst ind på Invoice Ninja og genautentificer med dine banker for at fortsætte med at modtage transaktioner.',
    ...
    'use_unapplied_payments' => 'Brug upåført Betalinger',
    ...
    'expense_mailbox_help' => 'Den indgående e-mailadresse, som accepterer udgiftsdokumenter. f.eks. expense@invoiceninja.com',
    ...
    'end_all_sessions_help' => 'Logger alle brugere ud, kræver at brugerne godkender igen.',
    ...
    'peppol_credits_info' => 'E-kreditter er nødvendige for at sende og modtage e-fakturaer. Disse opkræves pr. dokument. Hvis du allerede har kreditter, skal du klikke på Fortsæt.',
    ...
    'peppol_token_description' => 'Token bruges som endnu et trin for at sikre, <span class=\'notranslate\'>Faktura er</span> er sendt sikkert. I modsætning til white-label-licenser kan token roteres når som helst uden at skulle vente på Invoice Ninja-support.',
    ...
    'payer_bank_account_help' => 'Betalerens bankkontonummer',
    ...
    'giropay_stripe_help' => 'Giropay er en tysk betalingsmetode, der muliggør sikre og øjeblikkelige online bankoverførsler.',
    ...
    'saved_einvoice_details' => 'Gemte e-faktura indstillinger',
    ...
    'peppol_negative_line_price' => 'Priser på linjeposter kan ikke være negative for e- Fakturering . Indtast venligst en positiv pris, og anvend enhver reduktion som en rabat eller en negativ mængde.',
    ...
    'einvoice_something_went_wrong' => 'Ups! Noget gik galt. kontakt os på contact@invoiceninja.com for mere information.',
    ...
    'of_budget' => 'af budgettet',
    'invoiced_hours' => 'Faktureret timer',
    'less' => 'Mindre',
    'enable_notifications' => 'Aktivér notifikationer',
    'enable_public_notifications' => 'Aktivér offentlige notifikationer',
    'enable_public_notifications_help' => 'Aktivér notifikationer i realtid fra Invoice Ninja.',
    'navigate' => 'Navigere',
    ...
    'downgrade_to_free_description' => 'Dette vil fjerne alle betalte funktioner fra din konto.',
    'delete_location' => 'Slet placering',
    'delete_location_confirmation' => 'Dette vil fjerne placeringen fra kundens register.',
    ...
    'pro_plan_feature_2' => 'Fjern &quot; oprettet af Invoice Ninja&quot;',
    ...
    'pro_plan_feature_17' => 'Opret unikke &quot;kunde gruppe&quot; indstillinger',
    'pro_plan_feature_18' => 'Beregning af bilsalgsafgift (amerikanske stater)',
    'enterprise_plan_feature_1' => 'Yderligere brugere og tilladelser',
    ...
    'create_company_error_unauthorized' => 'Du er ikke autoriseret til at oprette en virksomhed. Kun kontoejeren kan oprette en virksomhed.',
    'deleted_location' => 'Placering slettet',
    'currency_caribbean_guilder' => 'Caribisk gylden',
    'is_shipping' => 'Er forsendelse',
    'added_location' => 'Placering tilføjet',
    'send_emails' => 'Send e-mails',
    'send_emails_permission' => 'Tillad bruger at sende e-mails',
    'cancel_trial' => 'Annuller prøveperiode',
    ...
    'docuninja_downgrade_info' => 'Din brugergrænse reduceres automatisk ved udgangen af ​​den nuværende faktureringsperiode.',
    'docuninja_grant_access_help' => 'Giv Invoice Ninja-brugere adgang til DocuNinja',
    'recurring_invoice_item' => 'Tilbagevendende fakturapost',
    ...
    'creator' => 'oprettet af',
    'ses_topic_arn_help' => 'SES-emnet (valgfrit, kun til webhook-sporing)',
    'ses_region_help' => 'AWS-regionen, dvs. us-east-1',
    'ses_secret_key' => 'SES hemmelig nøgle',
    'ses_access_key' => 'SES-adgangsnøgle-ID',
    'lifecycle' => 'Livscyklus',
    'order_columns' => 'Ordne kolonner',
    'topic_arn' => 'Emne ARN',
    'lang_Catalan' => 'Catalansk',
    'lang_Afrikaans' => 'Afrikaans',
    'lang_Indonesian' => 'Indonesisk',
    'replaced' => 'Erstattet',
    'ses_from_address' => 'SES fra adresse',
    'ses_from_address_help' => 'Afsender e-mail skal verificeres i AWS',
    'unauthorized_action' => 'Du er ikke autoriseret til at udføre denne handling',
    'einvoice_received_subject' => 'E- faktura modtaget',
    'einvoice_received_body' => 'Du har modtaget :count ny e- Faktura /s.<br><br> Log ind på Vis .',
    'download_files_too_large' => 'Nogle filer var for store til at blive vedhæftet direkte til e-mail . Brug venligst linkene nedenfor til at downloade dem enkeltvis.',
    'restore_disabled_verifactu' => 'Du kan ikke Genskab en Faktura , når den først er blevet slettet',
    'delete_disabled_verifactu' => 'Du kan ikke Slet en Faktura når den er blevet annulleret eller ændret',
    'rectify' => 'Berigtigelse',
    'verifactu_invoice_send_success' => 'Faktura :invoice for :client sendt til AEAT. Succesfuldt',
    'verifactu_invoice_sent_failure' => 'Faktura :invoice for :client kunne ikke sendes til AEAT :notes',
    'verifactu_cancellation_send_success' => 'Faktura -annullering for :invoice sendt til AEAT Succesfuldt',
    'verifactu_cancellation_send_failure' => 'Faktura annullering for :invoice kunne ikke sendes til AEAT :notes',
    'verifactu' => 'Verifactu',
    'justify' => 'Begrund',
    'outdent' => 'Ryk ud',
    'indent' => 'Indryk',
    ...
    'feedback' => 'Feedback',
    'feedback_modal_description' => 'Vi vil meget gerne høre din feedback!',
    'do_not_ask_again' => 'Spørg ikke igen',
    'not_likely' => 'Ikke sandsynligt',
    'extremely_likely' => 'Ekstremt sandsynligt',
    'feedback_slider_title' => 'Hvor sandsynligt er det, at du vil anbefale Invoice Ninja til en ven eller kollega?',
    'actual_delivery_date' => 'Faktisk leveringsdato',
    'actual_delivery_date_help' => 'Nogle gange påkrævet ved fakturering på tværs af grænser. Definerer den PRÆCISKE leveringsdato for varer.',
    'invoice_period' => 'Faktura periode',
    'invoice_period_help' => 'Definerer den periode, hvor tjenesterne blev leveret.',
    'paused_recurring_invoice_helper' => 'Forsigtig! Når du genstarter en Gentagen Faktura , skal du sørge for, at den næste afsendelsesdato er i fremtiden.',
    'thank_you_for_feedback' => 'Tak for din feedback!',
    'use_legacy_editor' => 'Brug den ældre Wysiwyg-editor',
    'use_legacy_editor_help' => 'Brug TinyMCE-editoren.',
    'enable_e_invoice_received_notification' => 'Aktivér modtagelsesbesked om e-faktura',
    'enable_e_invoice_received_notification_help' => 'Modtag en e-mail besked, når vi modtager en ny e-faktura .',
    'price_changes' => 'Ændringer i planpriser fra 1. januar 2026',
    'notification_quote_rejected_subject' => 'Tilbud :quote blev afvist af :client',
    'notification_quote_rejected' => 'Følgende kunde :client afviste tilbud :quote for :amount :notes .',
    'activity_150' => 'Konto blev slettet :notes',
    'activity_151' => 'Kunde :notes blev fusioneret med :client af :user',
    'activity_152' => 'Sælger :notes blev fusioneret med :vendor af :user',
    'activity_153' => 'Kunde :notes blev slettet af :user',
    'activity_154' => 'E- Faktura :invoice for :client sendt til AEAT. Succesfuldt',
    'activity_155' => 'E- Faktura :invoice for :client kunne ikke sendes til AEAT :notes',
    'activity_156' => 'Faktura -annullering for :invoice sendt til AEAT Succesfuldt',
    'activity_157' => 'Faktura annullering for :invoice kunne ikke sendes til AEAT :notes',
    'activity_158' => 'tilbud :quote blev afvist af :client :notes',
    'quotes_with_status_sent_can_be_rejected' => 'Kun tilbud med status &quot;Sendt&quot; kan afvises.',
    'reject' => 'Afvise',
    'rejected' => 'Afvist',
    'reject_quote' => 'Afvis tilbud',
    'reject_quote_confirmation' => 'Er du sikker på, at du vil afvise dette tilbud ?',
    'reason' => 'Årsag',
    'enter_reason' => 'Indtast en grund...',
    'notification_invoice_overdue_summary_subject' => 'Faktura Forfalden Resumé: :date',
    'notification_invoice_overdue_summary' => 'Følgende Fakturaer er forfaldne:',
    'purge_user_confirmation' => 'Advarsel! Denne handling vil omfordele alle enheder til konto og permanent Slet Bruger på tværs af alle virksomheder og konti. Er du sikker på, at du vil fortsætte?',
    'peppol_sending_failed' => 'Afsendelse af e-faktura mislykkedes!',
    'peppol_sending_success' => 'E-faktura sendt succesfuldt!',
    'auto_generate' => 'Automatisk generering',
    'mollie_payment_pending' => 'Din Betaling afventer behandling. Vent venligst på, at den bliver behandlet. Vi sender dig e-mail når den er færdig.',
    'over_payment_helper' => 'Valgfrit: Du kan betale mere end det viste Beløb . (dvs. drikkepenge, rund op)',
    'new_resource' => 'Ny ressource',
    'drop_your_logo_here' => 'Sæt dit logo her, eller klik for at gennemse',
    'save_to_enable_health_check' => 'En sundhedskontrol vil være tilgængelig, når ændringerne i Gateway er gemt.',
    'audit_log' => 'Revisionslog',
    'clone_to_template' => 'Kopiere til skabelon',
    'clone_document_description' => 'Kopiere til et ny -dokument',
    'add_signatories' => 'Tilføj Underskrivere',
    'authorized_to_sign' => 'Bemyndiget til at underskrive',
    'ninja_quote_notification' => 'tilbud Underskrevet meddelelse',
    'ninja_invoice_notification' => 'Fakturaunderskrevet notifikation',
    'ninja_credit_notification' => 'Kreditunderskrevet meddelelse',
    'ninja_purchase_order_notification' => 'Meddelelse om underskrevet indkøbsordre',
    'email_client_when_quote_signed_description' => 'E-mail kunden når tilbuddet er underskrevet',
    'email_client_when_invoice_signed_description' => 'E-mail kunden når fakturaen er underskrevet',
    'email_client_when_credit_signed_description' => 'E-mail kunden når kreditnota er underskrevet',
    'email_vendor_when_purchase_order_signed_description' => 'Send en e-mail til leverandøren, når indkøbsordren er underskrevet',
    'custom_document_completed' => 'Speciel færdiggjort',
    'email_client_when_custom_document_completed' => 'E-mail kunden når et brugerdefineret dokument er blevet underskrevet',
    'sender' => 'Afsender',
    'create_template' => 'Oprette skabelon',
    'edit_template' => 'Redigér skabelon',
    'delete_template' => 'Slet skabelon',
    'template_created' => 'Skabelon oprettet',
    'template_updated' => 'Skabelon opdateret',
    'template_deleted' => 'Skabelon slettet',
    'template_name' => 'Skabelonnavn',
    'template_description' => 'Skabelonbeskrivelse',
    'document_type' => 'Dokumenttype',
    'document_type_description' => 'Vælg den dokumenttype, signaturer skal konfigureres på',
    'new_signatory' => 'Ny underskriver',
    'signatory' => 'Underskriver',
    'invoice_ninja_template_description' => 'Tilpas placeringen af ​​underskrifter på Invoice Ninja-dokumenter som fakturaer, tilbud osv.',
    'activity_159' => 'Faktura :invoice for :client blev underskrevet',
    'activity_160' => 'Tilbud :quote til :client blev underskrevet',
    'activity_161' => 'Kreditér :credit for :client blev underskrevet.',
    'activity_162' => 'Indkøbsordre :purchase_order for :vendor blev underskrevet',
    'activity_163' => 'Speciel dokument: dokument for :client blev underskrevet',
    'activity_164' => 'QuickBooks-synkronisering mislykkedes. :notes',
    'activity_165' => 'QuickBooks-synkroniseringen er gennemført. :notes',
    'create_your_own' => 'Opret din egen',
    'create_your_own_description' => 'Opret din egen skabelon ved at uploade dit eget PDF dokument',
    'new_template_description' => 'Vælg en af vores præbyggede skabeloner for at komme i gang, f.eks. fortrolighedsaftale, salgsaftale osv.',
    'choose_template_type' => 'Vælg den type skabelon, du vil oprette',
    'template' => 'Skabelon',
    'templates' => 'Skabeloner',
    'new_template' => 'Ny skabelon',
    'user_limit_reached' => 'Brug for flere brugere? Opgrader dit abonnement!',
    'requires_approval' => 'Kræver godkendelse',
    'document_viewed_notification' => 'Notifikationer om viste dokumenter',
    'document_created_notification' => 'Oprettet notifikationer',
    'document_sent_notification' => 'Notifikationer om afsendelse af dokumenter',
    'document_signed_notification' => 'Underskriftsmeddelelser om dokumentation',
    'document_completed_notification' => 'Meddelelser om fuldført dokument',
    'document_rejected_notification' => 'Dokumentafviste meddelelser',
    'document_voided_notification' => 'Dokument annullerede notifikationer',
    'document_expired_notification' => 'Meddelelser om udløbet dokument',
    'document_created' => 'Dokument oprettet',
    'template_loaded' => 'Skabelon indlæst',
    'select_user_or_client' => 'Vælg Bruger eller Kunde',
    'docuninja_quota_available_but_no_users' => 'Tilføj en bruger til Invoice Ninja først, og giv dem derefter adgang til DocuNinja her',
    'send_confirmation' => 'Send bekræftelse',
    'send_emails_to_following' => 'Vi vil sende e-mails til følgende:',
    'document_queued_for_sending' => 'Dokument i kø til afsendelse',
    'document_voided' => 'Dokument annulleret',
    'view_document' => 'Vis dokument',
    'make_template' => 'Lav skabelon',
    'use_template' => 'Brug skabelon',
    'map_signatories' => 'Kortunderskrivere',
    'map_signatories_instructions' => 'Tildel underskriverne til skabelonen',
    'total_signatories' => 'Total underskrivere',
    'mapped' => 'Kortlagt',
    'docuninja_splash_message' => 'Indlæser DocuNinja...',
    'docuninja_contact_admin_for_access' => 'Kontakt din administrator for at få adgang til DocuNinja.',
    'void' => 'Ugyldig',
    'invitation_signatory_help' => 'Dokumenter underskrives sekventielt, så efter den første underskriver har underskrevet, kan den næste underskriver underskrive.',
    'timeline' => 'Tidslinje',
    'cloned_document' => 'Dokument klonet',
    'voided_document' => 'Dokument annulleret',
    'voided' => 'Annulleret',
    'archive_document_description' => 'Er du sikker på, at du vil arkivere dette dokument?',
    'restore_document_description' => 'Er du sikker på, at du vil genskabe dette dokument?',
    'delete_document_description' => 'Er du sikker på, at du vil slette dette dokument?',
    'document_archived' => 'Arkiveret',
    'document_restored' => 'Genskabt',
    'document_deleted' => 'Slettet',
    'sign_now' => 'Tilmeld dig nu',
    'signed_document' => 'Underskrevet dokument',
    'tour_document_upload' => 'For at begynde at underskrive skal du uploade dit dokument her. Træk og slip dine filer ind i dette område.',
    'tour_signatory_selector' => 'Dette er underskrivervælgeren. Brug den til at administrere underskriverne for dit dokument. Vælg en underskriver for at fortsætte.',
    'tour_continue_select_signatory' => 'Fortsæt ved at vælge en underskriver.',
    'tour_toolbox_description' => 'Til højre er værktøjskassen. Brug den til Tilføj felter og elementer, som underskrivere kan interagere med. Underskriftsfeltet er allerede valgt. Klik for at fortsætte.',
    'tour_document_canvas' => 'Dette er dit dokumentlærred. Placer og placer felter til dine underskrivere her.',
    'tour_save_document' => 'Når du er færdig, skal du klikke her for at Gem dit dokument.',
    'create_signature' => 'Opret signatur',
    'signature_name' => 'Signatur navn',
    'close_tab' => 'Luk fane',
    'sign' => 'Underskriv',
    'add_open_exchange' => 'Tilføj Open Exchange-nøgle',
    'all_entity_types_created' => 'Alle entitetstyper oprettet',
    'amount_must_be_greater_than_zero' => 'Beløb skal være større end nul',
    'autobill_failure' => 'Automatisk fakturering mislykkedes',
    'autobill_success' => 'Automatisk fakturering gennemført',
    'available' => 'Tilgængelig',
    'blueprint' => 'Plantegning',
    'capabilities' => 'Evner',
    'card_holder_help' => 'Kortholderens navn',
    'cards' => 'Kort',
    'charts' => 'Diagrammer',
    'company_logo' => 'Firmalogo',
    'create_client_or_user' => 'Opret kunde eller bruger',
    'create_docuninja_account' => 'Opret DocuNinja konto',
    'create_recurring_expense' => 'Opret tilbagevendende udgift',
    'create_recurring_invoice' => 'Opret tilbagevendende faktura',
    'create_recurring_quote' => 'Opret tilbagevendende tilbud',
    'create_subscription' => 'Opret abonnement',
    'create_user' => 'Opret bruger',
    'created' => 'Oprettet',
    'creating' => 'Oprettelse',
    'credit_signed_notification' => 'Kreditunderskrevet meddelelse',
    'customize_cards' => 'Tilpas kort',
    'datatable' => 'Datatabel',
    'date_must_be_after_previous_schedule' => 'Datoen skal være efter den forrige tidsplan',
    'default_checkbox_label' => 'Standardafkrydsningsfelt',
    'default_multiselect_label' => 'Standard flervalg',
    'default_radio_group_label' => 'Standardradiogruppe',
    'default_select_label' => 'Standardvalg',
    'delete_document' => 'Slet dokument',
    'delete_docuninja_document' => 'Slet -fil',
    'delete_docuninja_document_confirmation' => 'Er du sikker på, at du vil fjerne denne fil fra dokumentet?',
    'delete_subscription' => 'Slet abonnement',
    'disable_docuninja' => 'Deaktiver DocuNinja',
    'document_not_found' => 'Dokumentet er ikke fundet',
    'docuninja_access_grant_failed' => '',
    'docuninja_access_granted_successfully' => 'DocuNinja adgang givet Succesfuldt',
    'download_signed_document' => 'Download underskrevet dokument',
    'e_expense_created' => 'E- Udgift oprettet',
    'edit_rule' => 'Redigér -regel',
    'einvoice_delivery_failure' => 'Levering af e-faktura mislykkedes',
    'einvoice_delivery_success' => 'Levering af e-faktura succesfuld',
    'einvoice_sent' => 'E-faktura sendt',
    'element' => 'Element',
    'email_invoice_failed' => 'Email kunne ikke sendes',
    'empty_checkbox_label' => 'Tom afkrydsningsfelt',
    'end_of_month' => 'Månedens slutning',
    'error_fetching_pricing' => 'Fejl ved hentning af priser',
    'exchange_rate_not_enabled' => 'Valutakurs ikke aktiveret',
    'failed_payment' => 'Betaling mislykkedes',
    'field_is_required' => 'Feltet er påkrævet',
    'generate' => 'Frembringe',
    'google_drive' => 'Google Drev',
    'initials' => 'Initialer',
    'initials_description' => 'Beskrivelse af initialer',
    'invalid_state' => 'Ugyldig tilstand',
    'invoice_signed_notification' => 'Faktura underskrevet meddelelse',
    'link_copied' => 'Link kopieret',
    'make_template_description' => 'Oprette din egen skabelon ved at uploade dit eget PDF dokument',
    'manage' => 'Styre',
    'multiselect_needs_two_options' => 'Multivalg kræver to muligheder',
    'no_cards_selected' => 'Ingen kort valgt',
    'no_templates_found' => 'Ingen skabeloner fundet',
    'nordigen' => 'Nordigen',
    'pages' => 'Sider',
    'passed' => 'Bestået',
    'payment_emailed' => 'Betaling sendt via e-mail',
    'payment_successful' => 'Betaling succesfuld',
    'pdf_password_required' => 'PDF -adgangskode kræves',
    'pending_approval' => 'Afventer godkendelse',
    'pending_file' => 'Afventende fil',
    'please_select_at_least_one_user' => 'Vælg venligst mindst én Bruger',
    'please_select_plan' => 'Vælg venligst en plan',
    'please_select_signer' => 'Vælg venligst en underskriver',
    'proformal_invoices' => 'Proforma Fakturaer',
    'purchase_order_signed_notification' => 'Meddelelse om underskrevet indkøbsordre',
    'queue' => 'Kø',
    'quote_field' => 'tilbud',
    'quote_signed_notification' => 'tilbud underskrevet meddelelse',
    'radio_needs_two_options' => 'Radioen har brug for to muligheder',
    'recipient' => 'Modtager',
    'redirect' => 'Omdiriger',
    'refundable' => 'Refunderbar',
    'remove_invitations' => 'Fjern invitationer',
    'removing' => 'Fjernelse',
    'requirements' => 'Krav',
    'restore_subscription' => 'Genskab -abonnement',
    'sales_above_threshold' => 'Salg over tærsklen',
    'save_to_add_locations' => 'Gem til Tilføj lokationer',
    'saving' => 'Gemmer',
    'select_design' => 'Vælg design',
    'select_needs_two_options' => 'Vælg har brug for to muligheder',
    'sending' => 'Sender',
    'setting_up' => 'Opsætning',
    'setup_company' => 'Opsæt firma',
    'signature-placeholder' => 'Signaturpladsholder',
    'signature:font-updated' => 'Signaturfont opdateret',
    'signature_description' => 'Beskrivelse af signatur',
    'snappdf_not_enabled' => 'Snappdf er ikke aktiveret',
    'start_signing' => 'Begynd at underskrive',
    'successfully_signed_document' => 'Dokumentet er blevet underskrevet',
    'swap_signatory' => 'Bytteunderskriver',
    'template_details' => 'detaljer',
    'tips_and_notes' => 'Tips og noter',
    'too_many_files' => 'For mange filer',
    'type_signature' => 'Skriv underskrift',
    'untitled_document' => 'Unavngivet dokument',
    'untitled_template' => 'Unavngivet skabelon',
    'update_recurring_expense' => 'Opdater Gentagen Udgift',
    'update_recurring_invoice' => 'Opdater Gentagen Faktura',
    'update_recurring_quote' => 'Opdater Gentagen tilbud',
    'update_subscription' => 'Opdater abonnement',
    'update_user' => 'Opdater bruger',
    'upgrade_account_message' => 'Opgrader konto Besked',
    'upgrade_now' => 'Opgrader nu',
    'upgrade_plan_docuninja' => 'Opgrader din plan for at aktivere DocuNinja',
    'use_signature' => 'Brug signatur',
    'use_snappdf' => 'Brug snappdf',
    'user_note' => 'Bruger Bemærk',
    'vendor_notification_email' => 'Sælger notifikations- e-mail',
    'void_document_description' => 'Beskrivelse af ugyldigt dokument',
    'voided_payment' => 'Betaling annulleret',
    'welcome_to_docuninja' => 'Velkommen til DocuNinja',
    'yodlee' => 'Yodlee',
    'location_name' => 'Placeringsnavn',
    'quote_rejected' => 'Tilbud afvist',
    'e_invoice_received_notification' => 'Meddelelse om modtaget e-faktura',
    'e_invoice_received_notification_help' => 'Send en e-mail, når en e-faktura er modtaget',
    'location_field' => 'Placeringsfelt',
    'access_key' => 'Adgangsnøgle',
    'payment_type_FPX' => 'FPX',
    'payment_type_Stripe Bank Transfer' => 'Stripe Bankoverførsel',
    'activity_166' => 'Bruger :notes blev slettet af :user',
    'purged_user' => 'Bruger blev Succesfuldt renset ud',
    'quickbooks_connect_description' => 'Forbind din QuickBooks- konto til Faktura Ninja for automatisk at synkronisere dine transaktioner og >Faktura er .',
    'sync_direction_description' => 'Disse Indstillinger bestemmer, hvordan Faktura Ninja synkroniseres med QuickBooks.',
    'sync_direction_none_help' => 'Faktura Ninja synkroniserer ikke data til eller fra QuickBooks.',
    'sync_direction_pull_help' => 'Faktura Ninja vil trække data fra QuickBooks.',
    'sync_direction_push_help' => 'Faktura Ninja vil sende data til QuickBooks.',
    'sync_direction_bidirectional_help' => 'Faktura Ninja vil både trække og hente data til QuickBooks.',
    'sync_settings' => 'Synkroniser Indstillinger',
    'realm_id' => 'QB Realm-ID',
    'default_income_account' => 'konto',
    'automatic_taxes' => 'Automatiske skatter',
    'automatic_taxes_help' => 'Når automatiske skatter (AST) er aktiveret i Quickbooks, vil Faktura Ninja først Oprette Faktura i Quickbooks og derefter trække den fuldt dannede Faktura tilbage til Faktura Ninja.',
    'pull' => 'Træk',
    'push' => 'Skubbe',
    'bidirectional' => 'Tovejs',
    'sync_started' => 'Synkroniseringen er startet',
    'quickbooks_read_only_data' => 'QuickBooks-indkomstkonti og gemte skattesatser',
    'hide_peppol_sent_status' => 'Skjul Peppol-sendt status',
    'quickbooks_requires_reauth' => 'QuickBooks kræver gengodkendelse',
    'quickbooks_requires_reauth_body' => 'Din QuickBooks-forbindelse er udløbet og kræver gengodkendelse. Log venligst ind på administratorportalen, og genopret forbindelse til din QuickBooks- konto . Vi sender dig denne besked dagligt, indtil problemet er løst.',
    'crop_logo' => 'Beskær logo',
    'passkey' => 'Adgangsnøgle',
    'login_with_passkey' => 'Log ind med en adgangskode',
    'manage_passkeys' => 'Administrer adgangsnøgler',
    'last_used' => 'Sidst brugt',
    'unapplied_payments' => 'Ikke-anvendt Betalinger',
    'debit' => 'Debet',
    'auto_convert_credit_help' => 'Automatisk link eller Oprette en Betaling der matcher disse regler.',
    'clone_client_description' => 'Dette vil Kopiere kunde til en ny kunde .',
    'invalid_id_number_format' => 'Ugyldigt ID- Format',
    'invalid_vat_number_format' => 'Ugyldigt Format',
    'invalid_routing_id_format' => 'Ugyldigt routing-ID Format',
    'invalid_id_number_checkdigit' => 'Ugyldigt ID-nummer: fejl i kontrolciffer. Bekræft venligst, at nummeret er korrekt.',
    'invalid_vat_number_checkdigit' => 'Ugyldigt momsnummer: fejl i kontrolciffer. Bekræft venligst, at nummeret er korrekt.',
    'invalid_routing_id_checkdigit' => 'Ugyldigt routing-ID: fejl i kontrolciffer. Bekræft venligst, at nummeret er korrekt.',
    'sign_the_document' => 'Underskriv dokumentet',
    'client_not_found_on_peppol_network' => 'Kunde kunne ikke identificeres på PEPPOL-netværket.',
    'too_many_requests' => 'For mange anmodninger',
    'custom_text_with_formatting' => 'Speciel med formatering',
    'client_name_and_address' => 'Kunde navn og adresse',
    'bill_to' => 'Fakturér til:',
    'entity_details' => 'Antal, dato, Forfalden dato, Beløb , saldo',
    'product_line_items_with_columns' => 'Produktlinjeposter med kolonner',
    'task_line_items_with_columns' => 'Opgave linjeposter med kolonner',
    'divider_line' => 'Vandret separator',
    'signature_line' => 'Signaturområde',
    'authorized_signature' => 'Autoriseret underskrift',
    'essential' => 'Væsentlig',
    'public_notes_will_appear_here' => 'Offentlige noter vises her',
    'footer_will_appear_here' => 'Sidefoden vil blive vist her',
    'terms_will_appear_here' => 'Betingelser vil blive vist her',
    'sepa_qr' => 'SEPA QR',
    'swiss_qr' => 'Schweizisk QR',
    'spc_qr' => 'SPC QR',
    'verifactu_qr' => 'Bekræft QR',
    'payment_qr' => 'Betaling QR',
    'download_json' => 'Download JSON',
    'copy_block_to_clipboard' => 'Kopiér blok til udklipsholder',
    'duplicate_block' => 'Duplikerblok',
    'delete_block' => 'Slet',
    'height_placeholder_example' => 'f.eks. 40px',
    'select_starting_point_for_invoice_design' => 'Vælg et udgangspunkt for dit Faktura design',
    'no_templates_found_in_category' => 'Ingen skabeloner fundet i denne kategori',
    'preview_uses_sample_data' => 'Forhåndsvisning bruger eksempeldata',
    'download_html' => 'Download HTML',
    'blocks_in_design' => 'blokke i designet',
    'actual_invoices_use_real_data' => 'Faktisk >Faktura er vil bruge rigtige kunde og Faktura data',
    'cloned_client' => 'Succesfuldt klonet kunde',
    'update_tax_details' => 'Opdater detaljer',
    'cc_only' => 'Kun CC',
    'e_invoice_forward_email' => 'PEPPOL videresendelsestjeneste for e-mail',
    'e_invoice_forward_email_help' => 'Videresendte e- Fakturaer til en tredjepartsbehandlingstjeneste som Yuki eller WinAuditor',
    'skip_automatic_email_with_peppol' => 'Deaktiver e-mail ved afsendelse via PEPPOL',
    'skip_automatic_email_with_peppol_help' => 'Hvis aktiveret, vil Fakturaer sendt via PEPPOL-netværket ikke blive sendt via e-mail til kunde .',
    'web_session_timeout_help' => 'Den tid, en browsersession forbliver aktiv, før den logges ud.',
    'password_timeout_help' => 'Tid før en administratoradgangskode skal indtastes igen.',
    'invoice_status_paid' => 'Faktura er lige blevet betalt! Posten er nu blevet opdateret .',
    'attach_audit_log_to_completed_email' => 'Vedhæft revisionslog til fuldført e-mail',
    'attach_audit_log_to_completed_email_help' => 'Hvis aktiveret, vil revisionsloggen blive vedhæftet den e-mail med det underskrevne dokument, der er udfyldt.',
    'e_expense_forward_email' => 'Udgift Videresendelse af e-mail Service',
    'e_expense_forward_email_help' => 'Videresender modtagne e-udgifter til en tredjepartsbehandlingstjeneste som Yuki eller WinAuditor',
    'regenerate_token' => 'Regenerer token',
    'token_regenerated' => 'Token regenereret Succesfuldt',
    'token_regeneration_failed' => 'Tokenregenerering mislykkedes',
    'show_header' => 'Vis overskrift',
    'select_a_component_to_edit_properties' => 'Vælg en komponent at Redigér',
    'drag_and_drop_to_add' => 'Træk og slip til Tilføj',
    'max_width' => 'Maksimal bredde',
    'max_height' => 'Maksimal højde',
    'alignment' => 'Justering',
    'object_fit' => 'Objekttilpasning',
    'padding' => 'Polstring',
    'fix_overlaps' => 'Ret overlapninger',
    'spacer' => 'Afstandsstykke',
    'line_height' => 'Linjehøjde',
    'text_color' => 'Tekstfarve',
    'font_style' => 'Skrifttypestil',
    'alternate_row_colors' => 'Alternative rækkefarver',
    'show_borders' => 'Vis rammer',
    'cell_padding' => 'Cellepolstring',
    'suffix' => 'Suffiks',
    'hide_if_empty' => 'Skjul hvis tom',
    'qr_code' => 'QR-kode',
    'qr_code_type' => 'QR-kodetype',
    'label_padding' => 'Mellemrum omkring hver etiket.',
    'value_padding' => 'Mellemrum omkring hver værdi.',
    'label_value_gap' => 'Gabet mellem etiket og værdi.',
    'row_spacing' => 'Hvor meget lodret plads der er mellem hver række.',
    'value_min_width' => 'Minimumbredde for værdier.',
    'restored_template' => 'Skabelon til Succesfuldt genskabt',
    'archived_template' => 'Succesfuldt arkiveret skabelon',
    'deleted_template' => 'Skabelon Succesfuldt slettet',
    'top' => 'Top',
    'table_rows' => 'Rækker',
    'style' => 'Stil',
    'widget_defaults' => 'Widget-standardindstillinger',
    'show_label' => 'Vis etiket',
    'show_label_help' => 'Vis widgettens etiket ud for dens værdi.',
    'widget_border_style' => 'Widget-kantstil',
    'widget_border_style_help' => 'Kantstil for widget-området.',
    'widget_border_color' => 'Widgetkantfarve',
    'widget_border_color_help' => 'Farven på kanten omkring widget-området.',
    'card_already_exists' => 'Kortet findes allerede',
    'income_account' => 'konto',
    'payment_period' => 'Betaling',
    'payment_period_help' => 'Den tilladte tid for fuldførelse Betaling i sekunder. Accepteret interval 60-600.',
    'payware_partner_id_label' => 'Partneridentifikator',
    'payware_partner_id_help' => 'Leveret af payware ved registrering',
    'payware_vpos_id_label' => 'webPOS-identifikator',
    'payware_vpos_id_help' => 'webPOS-identifikator fra payware-dashboardet',
    'payware_public_key_help' => 'RSA offentlig nøgle til validering af webhook-signatur',
    'gateway_onboarding_description' => 'Din Betaling er blevet Succesfuldt . Du kan nu konfigurere Betaling og indstille transaktionsgrænser eller gebyrer.',
    'gateway_onboarding_payment_methods_help' => 'Aktivér eller deaktiver accepterede Betaling for din Kunder .',
    'gateway_onboarding_limits_fees_help' => 'Indstil minimums- og maksimumsgrænser for transaktioner, og konfigurer behandlingsgebyrer.',
    'gateway_setup_complete' => 'Gateway -opsætning fuldført',
    'activity_167' => 'E- Faktura :invoice status opdateret til :notes',
    'activity_168' => ':notes til :client',
    'activity_169' => ':notes til :client',
    'peppol_accepted' => 'E- Faktura accepteret af modtager.',
    'peppol_rejected' => 'E- Faktura afvist af modtager.',
    'peppol_partially_paid' => 'E- Faktura delvist betalt.',
    'peppol_paid' => 'E- Faktura betalt.',
    'server_not_reachable' => 'Serveren kan ikke nås. Tjek din internetforbindelse, og prøv igen senere.',
    'connecting_calendar' => 'Forbinder din kalender…',
    'redirecting' => 'Omdirigerer…',
    'calendar_connection_denied' => 'Forbindelse afbrudt',
    'calendar_connection_denied_body' => 'Du har afbrudt forbindelsen. Du kan prøve igen når som helst.',
    'calendar_handoff_expired' => 'Forbindelseslinket er udløbet',
    'calendar_handoff_expired_body' => 'Forbindelseslinket er ikke længere gyldigt. Start venligst forbindelsen igen.',
    'calendar_handoff_invalid' => 'Kunne ikke fuldføre forbindelsen',
    'calendar_handoff_invalid_body' => 'Noget gik galt under valideringen af forbindelsen. Prøv igen.',
    'calendar_connect_failed' => 'Kalenderforbindelse mislykkedes',
    'calendar_connect_failed_body' => 'Vi kunne ikke afslutte forbindelsen til din kalender. Prøv igen.',
    'back_to_calendar' => 'Tilbage til kalenderen',
    'tag' => 'Tag',
    'new_tag' => 'Nyt tag',
    'edit_tag' => 'Redigér tag',
    'task_tags' => 'Opgave Tags',
    'project_tags' => 'Projektmærker',
    'created_tag' => 'Succesfuldt oprettet tag',
    'updated_tag' => 'Tagget opdateret Succesfuldt',
    'archived_tag' => 'Etiket Succesfuldt arkiveret',
    'restored_tag' => 'Succesfuldt genskabt tag',
    'deleted_tag' => 'Succesfuldt slettet tag',
    'e_reporting_enabled' => 'E-rapportering aktiveret',
    'ten_day_reporting' => 'Ti dages rapportering',
    'monthly_reporting' => 'Månedlig rapportering',
    'ten_day_reporting_help' => 'Rapportér transaktioner for den aktuelle periode i intervaller af 10 dage.',
    'monthly_reporting_help' => 'Rapportér transaktioner for den aktuelle periode i månedlige intervaller.',
    'quickbooks_deposit_disabled_warning' => 'Indbetalinger er slået fra i din tilknyttede QuickBooks- konto . Dette dokument synkroniseres ikke med QuickBooks, hvis der er en indbetaling.',
    'tour_template_signatory_swap' => 'Dette dokument blev oprettet fra din skabelon. Brug rullemenuen til at udskifte pladsholderunderskriveren med en rigtig kunde eller kontakt Bruger',
    'tour_template_save_document' => 'Klik her for at Gem dine ændringer i dokumentet.',
    'tour_template_send_document' => 'Når du er klar, skal du klikke her for at sende dokumentet til dine underskrivere.',
    'filter_by_user' => 'Filtrer efter Bruger',
    'add_condition' => 'Tilføj Condition',
    'add_new_option' => 'Tilføj Ny mulighed',
    'add_one_interactive_field_before_sending' => 'Tilføj mindst ét interaktivt felt (f.eks. signatur, input, dato) før afsendelse.',
    'add_option' => 'Tilføj -mulighed',
    'add_rectangle_for_signatory' => 'Sørg for at Tilføj mindst ét rektangel til underskrivere, før du gemmer.',
    'all_conditions_and' => 'Alle betingelser (OG)',
    'already_invited_uninvite_confirmation' => 'Det ser ud til, at denne underskriver allerede er blevet inviteret. Er du sikker på, at du vil afmelde invitationen?',
    'already_signed_no_email' => 'Disse brugere har allerede tilmeldt sig og vil ikke modtage flere e-mail :',
    'already_signed_removal_confirmation' => 'Disse brugere har allerede underskrevet, og deres bidrag vil blive fjernet. Er du sikker på, at du vil fortsætte?',
    'already_used' => ' - allerede brugt',
    'always_required' => 'Altid påkrævet',
    'always_visible' => 'Altid synlig',
    'and' => ' OG',
    'any_condition_or' => 'Enhver tilstand (ELLER)',
    'border_color' => 'Kantfarve',
    'border_style' => 'Kantstil',
    'character_range' => ':min - :max tegn',
    'clear_default' => 'Ryd standard',
    'command_palette' => 'Kommandopalet',
    'condition' => 'Tilstand',
    'condition_number' => 'Betingelse :number',
    'contains_all' => 'indeholder alle',
    'contains_any' => 'indeholder nogen af',
    'copy_to_all_pages' => 'Kopiér til alle sider ( :count sider)',
    'custom_regex' => 'Speciel Regex',
    'custom_regex_pattern' => 'Speciel Regex-mønster',
    'decimal_places' => 'Decimaler',
    'default_initials' => 'Standard initialer',
    'default_number' => 'Standardnummer',
    'default_text' => 'Standardtekst',
    'default_to_checked' => 'Standardindstilling er markeret',
    'default_to_signing_date' => 'Standard til underskriftsdato',
    'default_values_comma_separated' => 'Standardværdier (kommasepareret)',
    'delete_shortcut' => 'Slet (Del/Backspace)',
    'document_sent' => 'Dokument sendt',
    'document_sent_locked' => 'Dette dokument er blevet sendt og er nu låst. Der kan ikke foretages yderligere redigeringer.',
    'document_voided_description' => 'Dette dokument er blevet annulleret og er ikke længere tilgængeligt.',
    'document_voided_title' => 'Dokument annulleret',
    'does_not_contain' => 'indeholder ikke',
    'does_not_equal' => 'er ikke lig med',
    'dotted' => 'Prikket',
    'drag_to_change_signing_order' => 'Træk for at ændre underskriftsrækkefølgen',
    'drop_files_or_click' => 'Slip filer eller klik for at uploade',
    'duplicate_shortcut' => 'Dupliker (Ctrl/Cmd+D)',
    'eg_initials' => 'f.eks. JD',
    'ein' => 'EIN',
    'ein_format_invalid' => 'EIN- Format er ugyldigt',
    'ein_validation_help' => 'EIN-validering: Skal være i Format XX-XXXXXXX',
    'email_invalid' => 'e-mail Format ugyldigt',
    'email_validation_help' => 'e-mail -validering: Skal være et gyldigt e-mail Format',
    'ends_with' => 'slutter med',
    'enter_a_number' => 'Indtast et nummer',
    'enter_default_initials' => 'Indtast standard initialer...',
    'enter_default_text' => 'Indtast standardtekst...',
    'enter_default_values_comma_separated' => 'Indtast standardværdier adskilt af kommaer...',
    'enter_initials' => 'Indtast -initialer',
    'enter_number_here' => 'Indtast -nummer her',
    'enter_option_text' => 'Indtast -mulighedstekst...',
    'enter_regex_pattern' => 'Indtast regex-mønster...',
    'enter_text' => 'Indtast tekst',
    'enter_text_here' => 'Indtast tekst her',
    'enter_value' => 'Indtast værdi...',
    'enter_values_comma_separated' => 'Indtast værdier adskilt af kommaer...',
    'equals' => 'lig med',
    'failed_to_rename' => 'Kunne ikke omdøbe filen.',
    'field_appears_on_all_pages' => 'Feltet vil blive vist på alle sider. Underskriver udfylder det kun én gang.',
    'field_visibility' => 'Synlighed i marken',
    'field_visibility_help' => 'Feltet vises kun, når disse betingelser er opfyldt',
    'file_processing_confirmation_timeout' => 'Serveren bekræftede ikke denne upload efter gentagne kontroller. Fjern den, og prøv igen.',
    'file_processing_failed' => 'Behandling mislykkedes',
    'file_ready' => 'Parat',
    'files_not_ready' => 'Filerne er ikke klar.',
    'google_drive_import_error' => 'Noget gik galt under importen fra Google Drev. Prøv igen.',
    'hide_label_shortcut' => 'Skjul etiket (Ctrl/Cmd+L)',
    'importing_from_google_drive' => 'Importerer fil(er) fra Google Drev...',
    'initials_instruction' => 'Indtast dine initialer (maks. 10 tegn)',
    'input' => 'Input',
    'invalid_validation_pattern' => 'Ugyldigt valideringsmønster',
    'invitation_not_found' => 'Invitationen blev ikke fundet.',
    'is_after' => 'er efter',
    'is_after_or_equal' => 'er efter eller lig med',
    'is_before' => 'er før',
    'is_before_or_equal' => 'er før eller lig med',
    'is_checked' => 'er markeret',
    'is_greater_than' => 'er større end',
    'is_greater_than_or_equal' => 'er større end eller lig med',
    'is_less_than' => 'er mindre end',
    'is_less_than_or_equal' => 'er mindre end eller lig med',
    'is_not_empty' => 'er ikke tom',
    'is_unchecked' => 'er ikke markeret',
    'length' => 'Længde',
    'letters_only' => 'Kun bogstaver',
    'letters_only_help' => 'Kun bogstaver: Feltet accepterer kun alfabetiske tegn',
    'mark_optional_shortcut' => 'Markér som valgfrit (Ctrl/Cmd+R)',
    'mark_required_shortcut' => 'Markering påkrævet (Ctrl/Cmd+R)',
    'match' => 'Kamp',
    'maximum_length_is' => 'Maksimal længde er :max Længde',
    'max_length' => 'Maksimal længde',
    'max_value' => 'Maksimal værdi',
    'minimum_length_is' => 'Minimumslængden er :min',
    'min_length' => 'Min. længde',
    'min_value' => 'Min. værdi',
    'multi_select' => 'Multivalg',
    'multiselect_field_needs_options' => 'Flervalgsfelter skal have mindst én mulighed, før de gemmes.',
    'no_default' => 'Ingen standard',
    'no_fields_for_conditions' => 'Ingen felter tilgængelige for Oprette forhold. Tilføj felter først.',
    'no_maximum' => 'Intet maksimum',
    'no_minimum' => 'Intet minimum',
    'no_options_configured' => 'Ingen konfigurerede indstillinger.',
    'no_options_configured_add_above' => 'Ingen indstillinger konfigureret. Tilføj indstillingerne ovenfor.',
    'number_format' => 'Format',
    'numbers_only' => 'Kun tal',
    'numbers_only_help' => 'Kun tal: Feltet accepterer kun numeriske tegn',
    'only_letters_allowed' => 'Kun bogstaver er tilladt',
    'only_numbers_allowed' => 'Kun tal er tilladt',
    'options_count' => 'Valgmuligheder ( :count )',
    'or_import_from' => 'eller importere fra',
    'page_number' => 'Side :number',
    'pattern_label' => 'Mønster: :mønster',
    'pattern_not_matched' => 'Mønsteret matchede ikke',
    'pdf_password_incorrect' => 'Den angivne adgangskode til &quot; :name &quot; er forkert. Indtast venligst den korrekte adgangskode:',
    'pdf_password_protected' => 'PDF filen &quot; :name &quot; er beskyttet med en adgangskode. Indtast venligst adgangskoden:',
    'radio' => 'Radio',
    'radio_group' => 'Radiogruppe',
    'radio_selection' => 'Radiovalg',
    'required_when' => 'Påkrævet når...',
    'search_for_command' => 'Søg efter en kommando at køre...',
    'select_field_needs_options' => 'Vælg felter skal have mindst én valgmulighed, før de gemmes.',
    'select_one_or_more_options' => 'Vælg en eller flere muligheder',
    'select_option' => 'Vælg en mulighed',
    'select_option_default' => 'Vælg en mulighed (Standard: :label)',
    'send_email_to_contacts' => 'Vi sender en e-mail til følgende kontakter:',
    'settings_shortcut' => 'Indstillinger (Ctrl/Cmd+E)',
    'show_label_shortcut' => 'Vis etiket (Ctrl/Cmd+L)',
    'shown_later_in_form' => ' - vist senere i form',
    'show_when' => 'Vis hvornår...',
    'signatories' => 'Underskrivere',
    'signatory_number' => 'Underskriver :number',
    'signatory_required_for_signatures' => 'Der skal vælges en underskriver for at kunne Oprette underskrifter.',
    'signing_error' => 'Signeringsfejl',
    'solid' => 'Solid',
    'something_went_wrong' => 'Noget gik galt',
    'ssn' => 'CPR-nummer',
    'ssn_format_invalid' => 'CPR- Format er ugyldigt',
    'ssn_validation_help' => 'CPR-validering: Skal være i Format XXX-XX-XXXX',
    'successfully_deleted' => 'Filen Succesfuldt slettet .',
    'successfully_imported_from_google_drive' => 'Fil(er) Succesfuldt fra Google Drev.',
    'successfully_renamed' => 'Fil omdøbt Succesfuldt .',
    'successfully_saved' => 'Ændringerne er blevet Succesfuldt .',
    'successfully_updated_document_title' => 'Dokumenttitel Succesfuldt opdateret .',
    'successfully_uploaded' => 'Fil(er) uploadet Succesfuldt .',
    'template_variable' => 'Skabelonvariabel',
    'template_variable_help' => 'Vælg en foruddefineret variabel, der skal vises i dokumentet.',
    'toolbox_help_text' => 'Vælg venligst underskriver, og tegn derefter en pladsholder til underskriften.',
    'uninvited_parties_error' => 'Det ser ud til, at du har ubudne fester. Byt dem venligst med rigtige brugere eller Kunder .',
    'unknown_signatory' => 'Ukendt underskriver',
    'unnamed_contact' => 'Unavngivet kontakt ( :email )',
    'unnamed_user' => 'Unavngiven Bruger',
    'untitled_blueprint' => 'Unavngivet plan',
    'upload_cancelled_no_password' => 'Upload afbrudt for &quot; :name &quot;. Ingen adgangskode angivet.',
    'upload_error' => 'Noget gik galt under upload af filen/filerne. Prøv igen.',
    'uploading_files' => 'Uploader fil(er)...',
    'uploading_source_file' => 'Uploader kildefil',
    'url_invalid' => 'URL- Format er ugyldigt',
    'url_validation_help' => 'URL-validering: Skal være et gyldigt URL- Format',
    'use_default_value' => 'Brug standardværdi',
    'validation' => 'Validering',
    'validation_rule' => 'Valideringsregel',
    'value_must_be_at_least' => 'Værdien skal være mindst :value',
    'value_must_be_at_most' => 'Værdien må højst være :value',
    'variable' => 'Variabel',
    'widget_type' => 'Widget-type',
    'zip' => 'Postnummer',
    'zip_format_invalid' => 'ZIP- Format er ugyldigt',
    'zip_validation_help' => 'Postnummervalidering: Skal være 5 cifre eller 5+4 Format (XXXXX-XXXX)',
    'zoom' => 'Zoom',
    'report_too_large_to_preview' => 'Rapporten er for stor til at blive vist. Download venligst rapporten for at Vis den.',
    'log_time' => 'Logtid',
    'filter_by_project' => 'Filtrer efter projekt',
    'google' => 'Google',
    'app_maintenance' => 'App-vedligeholdelse i gang',
    'cloned_design' => 'klonet Design',
    'no_expenses_selected' => 'Ingen udgifter valgt',
    'sync' => 'Synkroniser',
    'updated_tax_data' => 'opdateret skattedata',
    'upload_failed' => 'Upload mislykkedes',
    'wrong_file_extension' => 'Forkert filtypenavn',
    'not_ready_for_download' => 'Filen er ikke klar til download',
    'list' => 'Liste',
    'already_linked' => 'Allerede linket',
    'convert_to_task' => 'Konvertér til Opgave',
    'duplicated_entries' => 'Duplikerede poster',
    'no_entries_to_duplicate' => 'Ingen poster at duplikere',
    'please_enter_a_valid_duration' => 'Indtast venligst en gyldig varighed',
    'calendar_unavailable' => 'Kalender ikke tilgængelig',
    'connect_calendar' => 'Forbind Kalender',
    'disconnect_calendar_confirmation' => 'Er du sikker på, at du vil afbryde din kalender?',
    'duplicate_yesterday' => 'Duplikat i går',
    'hide_events' => 'Skjul begivenheder',
    'show_events' => 'Vis begivenheder',
    'merge_client' => 'Merge Kunde',
    'merge_vendor' => 'Merge Sælger',
    'global' => 'Global',
    'disable_all' => 'Deaktiver alle',
    'press_keys' => 'Tryk på tasterne',
    'no_payment_required' => 'Denne planændring kræver ikke en Betaling . Gå venligst tilbage og bekræft planændringen.',
    'subscription_payment_required' => 'Total er ændret, og Betaling er nu påkrævet. Vælg en Betaling for at fortsætte.',
    'task_distribution' => 'Opgave Distribution',
    'team_distribution' => 'Holdfordeling',
    'task_velocity' => 'Opgave',
    'daily_velocity' => 'Daglig hastighed',
    'forecast_finish' => 'Prognose slut',
    'days_ahead' => 'Dage forude',
    'days_behind' => 'Dage bagud',
    'forecast' => 'Vejrudsigt',
    'estimated_vs_actual' => 'Estimeret vs. Faktisk',
    'budgeted_amount' => 'Budgetteret Beløb',
    'burn_up' => 'Brænd op',
    'actual_spend' => 'Faktisk forbrug',
    'margin' => 'Margin',
    'target' => 'Mål',
    'persist_table_filters' => 'Bevar tabelfiltre',
    'persist_table_filters_help' => 'Hvis aktiveret, vil tabelfiltrene blive bevaret, når siden genindlæses.',
    'billing_progress' => 'Faktureringsstatus',
    'budget_vs_actual' => 'Budget vs. faktisk',
    'unbilled_work' => 'Ikke-faktureret arbejde',
    'save_for_later' => 'Gem til senere',
    'deletion_violation_regulatory' => 'Dette dokument kan ikke slettet , da det er underlagt lovgivningsmæssige rapporteringskrav.',
    'currency_syrian_pound' => 'Syrisk pund',
    'account_plan_expired' => 'konto Plan udløbet',
    'add_files' => 'Tilføj filer',
    'add_reminder_schedule' => 'Tilføj Påmindelsesplan',
    'advanced_options' => 'Avancerede muligheder',
    'after_event' => 'efter begivenheden',
    'after_send' => 'Efter afsendelse',
    'before_event' => 'før begivenheden',
    'checklist_fields' => 'Placer felter i dokumentet',
    'checklist_ready' => 'Klar til brug',
    'checklist_send' => 'Send dokument',
    'checklist_signatories' => 'Tilføj -underskrivere',
    'checklist_title' => 'Dokumenttjekliste',
    'checklist_upload' => 'Upload et dokument',
    'click_to_assign' => 'Klik for at tildele',
    'companies' => 'Virksomheder',
    'confirm_remove_signatory' => 'Er du sikker på, at du vil fjerne denne underskriver?',
    'created_reminder_schedule' => 'Påmindelsesplan oprettet',
    'deleted_reminder_schedule' => 'slettet',
    'document_sent_successfully' => 'Dokument sendt Succesfuldt',
    'docuninja_join_esignatures' => 'E-signaturer',
    'docuninja_join_esignatures_help' => 'Indsaml underskrifter med sporing',
    'docuninja_join_features_title' => 'Alt du får',
    'docuninja_join_integration' => 'Dyb integration',
    'docuninja_join_integration_help' => 'Arbejder med Fakturaer , Tilbud &amp; bestillinger',
    'docuninja_creating_account' => 'Opretter din konto ...',
    'documents_public_by_default' => 'Angiv dokumenter som standard offentlige',
    'documents_public_by_default_help' => 'Hvis aktiveret, vil ny dokumenter som standard være offentlige.',
    'docuninja_join_tagline' => 'Oprette , send og e-signer dokumenter direkte fra Faktura Ninja.',
    'docuninja_join_templates_help' => 'Genanvendelige dokumenttegninger',
    'edit_reminder_schedule' => 'Redigér påmindelsesplan',
    'fewer_tools' => 'Færre værktøjer',
    'global_tag_inheritance' => 'Global tag-arv',
    'global_tag_inheritance_help' => 'Bestemmer, om underordnede enheder arver tags fra deres overordnede enheder.',
    'more_tools' => 'Flere værktøjer',
    'no_reminder_schedules_found' => 'Ingen påmindelsesplaner fundet',
    'no_template' => 'Ingen skabelon',
    'reminder_schedules' => 'Påmindelsesplaner',
    'sending_document' => 'Sender dokument',
    'single_signatory_description' => 'Vælg, hvem du vil sende dette dokument til, og fortsæt derefter.',
    'trigger_event' => 'Udløserhændelse',
    'updated_reminder_schedule' => 'opdateret af påmindelsesplan',
    'validation_errors' => 'Valideringsfejl',
    'view_details' => 'Vis detaljer',
    'who_to_send_to' => 'Hvem skal man sende til?',
    'wait_for_file_processing' => 'Vent på, at filbehandlingen er færdig, eller fjern mislykkede uploads.',
    'yyyy_mm_dd' => 'åååå-mm-dd',
    'docuninja_unavailable' => 'DocuNinja er ikke tilgængelig i øjeblikket. Prøv igen senere.',
    'add_tax' => 'Tilføj Skat',
    'what_are_you_charging_for' => 'Hvad opkræver du betaling for?',
    'add_value_as_new_client' => 'Tilføj ` :value ` Som ny Kunde',
    'stripe_ach_verifiation_pending' => 'Denne Betaling er endnu ikke klar til brug. Bekræftelse afventer.',
    'deleted_invoices_exist' => 'Denne Betaling er knyttet til en eller flere slettet Fakturaer og kan ikke slettet , du skal først Genskab the Fakturaer , derefter Slet the >Betaling er .',
    'show_date' => 'Vis dato',
    'show_signature_line' => 'Vis signaturlinje',
    'page_break' => 'Sideskiftkontrol',
    'page_break_help' => 'Forhindr indhold i at opdeles på tværs af sider.',
    'spacing' => 'Afstand',
    'designer' => 'Designer',
    'typography' => 'Typografi',
    'design_name_required' => 'Designnavn er påkrævet',
    'preview_indicative_only' => 'Forhåndsvisninger er kun vejledende. Det endelige layout vil variere baseret på de faktiske data.',
    'total_task_estimated_duration' => 'Opgaver Estimeret Tid',
    'total_task_remaining_estimated_duration' => 'Opgaver Resterende tid',
    'total_unestimated_tasks' => 'Opgaver Uvurderet',
