...
$lang = array(
    ...
    'register_to_add_user' => 'Regístrate para agregar un usuario',
    'user_state' => 'Estado',
    ...
    'payment_cvv' => '*Este son los 3-4 dígitos en la parte trasera de su tarjeta',
    ...
    'no_passkeys_registered' => 'No hay contraseñas registradas para esta cuenta. Inicie sesión con su contraseña o registre una contraseña primero.',
    ...
    'activity_10' => ':user ingresó el pago :payment para :payment_amount  en la factura :invoice para :client',
    ...
    'trial_card_authorization_notice' => 'Hoy no se realizará ningún cobro. Realizaremos una autorización temporal de $1 en su tarjeta de crédito, la cual se liberará inmediatamente después de la verificación. Es posible que su banco la muestre brevemente como pendiente. Al finalizar el período de prueba de 14 días, se le cobrarán $14 al mes en su tarjeta. Puede cancelar cuando lo desee.',
    'trial_card_verification_failed' => 'No pudimos verificar esta tarjeta de crédito. No se realizó ningún cargo. Por favor, utilice una tarjeta de crédito válida con al menos $1 de crédito disponible.',
    'trial_credit_card_required' => 'Solo se aceptan tarjetas de crédito. No se pueden usar tarjetas de débito, prepago ni tarjetas no clasificadas. No se realizó ningún cargo.',
    'trial_card_gateway_error' => 'No pudimos contactar con la entidad emisora de la tarjeta. No se realizó ningún cargo. Inténtelo de nuevo.',
    'trial_card_release_failed' => 'Tu tarjeta fue autorizada, pero no pudimos confirmar que la autorización temporal se haya liberado. Tu prueba no se inició. Inténtalo de nuevo más tarde o ponte en contacto con el servicio de asistencia.',
    'trial_verification_in_progress' => 'La verificación de su tarjeta ya se está procesando. Por favor, espere un momento e inténtelo de nuevo.',
    'trial_no_longer_available' => 'Esta cuenta ya no cumple los requisitos para la prueba gratuita.',
    'overdue' => 'Overdue',
    ...
    'activity_39' => ':user canceló :payment_amount pago :payment',
    ...
    'remove' => 'Remove',
    'remove_failed_upload' => 'Eliminar la carga fallida',
    ...
    'currency_japanese_yen' => 'Yen japonés',
    ...
    'save_or_discard' => 'Guardar o descartar tus cambios',
    ...
    'deleted_scheduled_report' => 'Programación;on de reporte cancelada con éxito',
    ...
    'preparing_canonical_pdf' => 'Preparación del PDF canónico',
    'preparing_server_preview' => 'Preparando la vista previa del servidor',
    ...
    'applied_amount' => 'Importe aplicado',
    'applied_refunded' => 'Reembolsado aplicado',
    ...
    'layout' => 'Disposición',
    'module' => 'Módulo',
    'first_custom' => 'Personalizado 1',
    'second_custom' => 'Personalizado 2',
    'third_custom' => 'Personalizado 3',
    ...
    'invoice_not_related_to_payment' => 'La factura n.° :invoice no está relacionada con este pago',
    'credit_not_related_to_payment' => 'El crédito # :credit no está relacionado con este pago',
    ...
    'notification_invoice_overdue_subject' => 'La factura :invoice está vencida para :client',
    'notification_invoice_overdue' => 'La siguiente factura :invoice para el cliente :client y :amount se encuentra vencida.',
    ...
    'invoices_by_month' => 'Facturas por mes',
    'payments_by_month' => 'Pagos mensuales',
    'monthly_breakdown_skipped' => 'Desglose mensual omitido: el rango de fechas supera los 24 meses.',
    ...
    'taxable_sales' => 'Ventas sujetas a impuestos',
    'exempt_sales' => 'Ventas exentas',
    'non_taxable_sales' => 'Ventas no sujetas a impuestos',
    'zero_rated_sales' => 'Ventas con tasa cero',
    'accounting_basis' => 'Base contable',
    'tax_treatment' => 'Tratamiento fiscal',
    'summary_source' => 'Fuente del resumen',
    'sales_breakdown_source' => 'Desglose de ventas',
    'legacy_tax_detail_source' => 'Detalle del impuesto sobre el patrimonio',
    'monthly_filing_summary' => 'Resumen de la presentación mensual',
    'filing_overview' => 'Resumen de presentación de documentos',
    'jurisdiction_breakdown' => 'Desglose de jurisdicciones',
    'state_breakdown' => 'Desglose del estado',
    'filing_period' => 'Período de presentación',
    'period_start' => 'Inicio del período',
    'period_end' => 'Fin de período',
    'jurisdiction_source' => 'Fuente de jurisdicción',
    'tax_data_source' => 'Datos fiscales',
    'client_shipping_source' => 'Dirección de envío del cliente',
    'client_billing_source' => 'Dirección de facturación del cliente',
    'tax_detail_source' => 'Código postal con detalles fiscales',
    'unknown_source' => 'Fuente desconocida',
    'district' => 'Distrito',
    'metric' => 'Métrico',
    'report_period' => 'Período del informe',
    'current_filing_rows' => 'Filas de archivo actuales',
    'correction_rows' => 'Filas de corrección',
    'states_reported' => 'Estados informados',
    'jurisdictions_reported' => 'Jurisdicciones reportadas',
    'rows_missing_state' => 'Filas Estado faltante',
    'rows_using_client_fallback' => 'Filas que utilizan la reserva del cliente',
    'prior_period_corrections' => 'Correcciones del período anterior',
    'corrections_review' => 'Revisión de correcciones',
    'original_tax_period' => 'Período fiscal original',
    'correction_recorded_period' => 'Período de corrección registrado',
    'correction_type' => 'Tipo de corrección',
    'requires_review' => 'Requiere revisión',
    'current_period_activity' => 'Actividad del período actual',
    'invoice_correction' => 'Corrección de factura',
    'payment_correction' => 'Corrección de pago',
    'status_correction' => 'Corrección de estado',
    'legacy_unknown' => 'Legado desconocido',
    'tax_summary' => 'Resumen de impuestos',
    'reporting_bucket' => 'Cubo de informes',
    ...
    'payment_expired' => 'El pago ha caducado. Por favor, vuelva atrás e inténtelo de nuevo.',
    'payment_was_not_completed' => 'El pago no se ha completado. Inténtalo de nuevo.',
    'no_compatible_app_installed' => 'Si no ocurre nada, es posible que no tengas instalada una aplicación compatible.',
    'payment_type_Mobile Payment' => 'Pago móvil',
    'gateway_temporarily_unavailable' => 'Este método de pago no está disponible temporalmente. Inténtelo de nuevo más tarde o elija otro método de pago.',
    'mybank' => 'Mi banco',
    ...
    'use_unapplied_payments' => 'Utilizar pagos no aplicados',
    ...
    'end_all_sessions_help' => 'Cierra la sesión de todos los usuarios y les exige que se vuelvan a autenticar.',
    ...
    'peppol_credits_info' => 'Se requieren créditos electrónicos para enviar y recibir facturas electrónicas. Se cobran por documento. Si ya tiene créditos, haga clic en Continuar.',
    ...
    'peppol_negative_line_price' => 'Los precios de los artículos no pueden ser negativos para la facturación electrónica. Introduzca un precio positivo y aplique cualquier descuento o una cantidad negativa.',
    ...
    'of_budget' => 'de Presupuesto',
    'invoiced_hours' => 'Horas facturadas',
    'less' => 'Menos',
    ...
    'downgrade_to_free_description' => 'Esto eliminará todas las funciones pagas de su cuenta.',
    ...
    'docuninja_grant_access_help' => 'Otorgar acceso a DocuNinja a los usuarios de Invoice Ninja',
    ...
    'order_columns' => 'Ordenar columnas',
    'topic_arn' => 'Tema ARN',
    'lang_Catalan' => 'catalán',
    'lang_Afrikaans' => 'africaans',
    'lang_Indonesian' => 'indonesio',
    'replaced' => 'Reemplazado',
    'ses_from_address' => 'Dirección de origen del SES',
    'ses_from_address_help' => 'La dirección de correo electrónico de envío debe estar verificada en AWS',
    'unauthorized_action' => 'No estás autorizado para realizar esta acción.',
    'einvoice_received_subject' => 'Factura(s) electrónica(s) recibida(s)',
    'einvoice_received_body' => 'Ha recibido :count nueva(s) factura(s) electrónica(s).<br><br> Inicie sesión para ver.',
    'download_files_too_large' => 'Algunos archivos eran demasiado grandes para adjuntarlos directamente al correo electrónico. Utilice los enlaces a continuación para descargarlos individualmente.',
    'restore_disabled_verifactu' => 'No se puede restaurar una factura una vez eliminada',
    'delete_disabled_verifactu' => 'No se puede eliminar una factura una vez que se ha cancelado o modificado',
    'rectify' => 'Rectificar',
    'verifactu_invoice_send_success' => 'Factura :invoice para :client enviada a AEAT correctamente',
    'verifactu_invoice_sent_failure' => 'La factura :invoice para :client no se pudo enviar a AEAT :notes',
    'verifactu_cancellation_send_success' => 'Cancelación de factura :invoice enviada a la AEAT correctamente',
    'verifactu_cancellation_send_failure' => 'La cancelación de factura para :invoice no se pudo enviar a AEAT :notes',
    'verifactu' => 'Verifactu',
    'justify' => 'Justificar',
    ...
    'feedback' => 'Comentario',
    'feedback_modal_description' => '¡Nos encantaría conocer tus comentarios!',
    'do_not_ask_again' => 'No vuelvas a preguntar',
    'not_likely' => 'No es probable',
    'extremely_likely' => 'Extremadamente probable',
    'feedback_slider_title' => '¿Qué probabilidades hay de que recomiende Invoice Ninja a un amigo o colega?',
    'actual_delivery_date' => 'Fecha de entrega real',
    'actual_delivery_date_help' => 'A veces se requiere al facturar internacionalmente. Define la fecha EXACTA de entrega de la mercancía.',
    'invoice_period' => 'Período de facturación',
    'invoice_period_help' => 'Define el período de tiempo durante el cual se prestaron los servicios.',
    'paused_recurring_invoice_helper' => '¡Precaución! Al reiniciar una factura recurrente, asegúrese de que la próxima fecha de envío sea posterior.',
    'thank_you_for_feedback' => '¡Gracias por tus comentarios!',
    'use_legacy_editor' => 'Usar el editor Wysiwyg heredado',
    'use_legacy_editor_help' => 'Utilice el editor TinyMCE.',
    'enable_e_invoice_received_notification' => 'Habilitar notificación de factura electrónica recibida',
    'enable_e_invoice_received_notification_help' => 'Reciba una notificación por correo electrónico cuando se reciba una nueva factura electrónica.',
    'price_changes' => 'Cambios en los precios de los planes a partir del 1 de enero de 2026',
    'notification_quote_rejected_subject' => 'La cita :quote fue rechazada por :client',
    'notification_quote_rejected' => 'El siguiente cliente :client rechazó la cotización :quote para :amount :notes .',
    'activity_150' => 'Se eliminó la cuenta :notes',
    ...
    'activity_153' => 'El cliente :notes fue purgado por :user',
    'activity_154' => 'Factura electrónica :invoice para :client enviada a AEAT correctamente',
    'activity_155' => 'La factura electrónica :invoice para :client no se pudo enviar a AEAT :notes',
    'activity_156' => 'Cancelación de factura :invoice enviada a la AEAT correctamente',
    'activity_157' => 'La cancelación de factura para :invoice no se pudo enviar a AEAT :notes',
    'activity_158' => 'La cita :quote fue rechazada por :client :notes',
    'quotes_with_status_sent_can_be_rejected' => 'Sólo se podrán rechazar las cotizaciones con estado &quot;Enviado&quot;.',
    'reject' => 'Rechazar',
    'rejected' => 'Rechazado',
    'reject_quote' => 'Rechazar cotización',
    'reject_quote_confirmation' => '¿Está seguro que desea rechazar esta cotización?',
    'reason' => 'Razón',
    'enter_reason' => 'Introduzca un motivo...',
    'notification_invoice_overdue_summary_subject' => 'Resumen de factura vencida: :date',
    'notification_invoice_overdue_summary' => 'Las siguientes facturas están vencidas:',
    'purge_user_confirmation' => '¡Advertencia! Esta acción reasignará todas las entidades al propietario de la cuenta y eliminará permanentemente al usuario en todas las empresas y cuentas. ¿Seguro que desea continuar?',
    'peppol_sending_failed' => '¡Error en el envío de factura electrónica!',
    'peppol_sending_success' => '¡Factura electrónica enviada exitosamente!',
    'auto_generate' => 'Generar automáticamente',
    'mollie_payment_pending' => 'Su pago está pendiente. Espere a que se procese. Le enviaremos un correo electrónico cuando se complete.',
    'over_payment_helper' => 'Opcional: puedes pagar más del monto que se muestra aquí (es decir, propina, redondeo)',
    'new_resource' => 'Nuevo recurso',
    'drop_your_logo_here' => 'Deja tu logo aquí o haz clic para buscar',
    'save_to_enable_health_check' => 'La comprobación de estado estará disponible después de guardar los cambios de la puerta de enlace.',
    'audit_log' => 'Registro de auditoría',
    'clone_to_template' => 'Clonar a plantilla',
    'clone_document_description' => 'Clonar a un nuevo documento',
    'add_signatories' => 'Agregar firmantes',
    'authorized_to_sign' => 'Autorizado para firmar',
    'ninja_quote_notification' => 'Notificación firmada de cotización',
    'ninja_invoice_notification' => 'Notificación de factura firmada',
    'ninja_credit_notification' => 'Notificación firmada de crédito',
    'ninja_purchase_order_notification' => 'Notificación firmada de orden de compra',
    'email_client_when_quote_signed_description' => 'Enviar correo electrónico al cliente cuando se firma la cotización',
    'email_client_when_invoice_signed_description' => 'Cliente de correo electrónico cuando se firma la factura',
    'email_client_when_credit_signed_description' => 'Enviar correo electrónico al cliente cuando se firma el crédito',
    'email_vendor_when_purchase_order_signed_description' => 'Enviar un correo electrónico al proveedor cuando se firme la orden de compra',
    'custom_document_completed' => 'Documento personalizado completado',
    'email_client_when_custom_document_completed' => 'Cliente de correo electrónico cuando se ha firmado un documento personalizado',
    'sender' => 'Remitente',
    ...
    'document_type_description' => 'Seleccione el tipo de documento en el que desea configurar las firmas',
    'new_signatory' => 'Nuevo signatario',
    'signatory' => 'Signatario',
    'invoice_ninja_template_description' => 'Personalice la ubicación de las firmas en documentos de Invoice Ninja como facturas, cotizaciones, etc.',
    'activity_159' => 'Se firmó la factura :invoice para :client',
    'activity_160' => 'La cita :quote para :client fue firmada',
    'activity_161' => 'Se firmó el crédito :credit para :client',
    'activity_162' => 'Se firmó la orden de compra :purchase_order para :vendor',
    'activity_163' => 'Documento personalizado: se firmó el documento para :client',
    'activity_164' => 'Error de sincronización de QuickBooks. :notes',
    'activity_165' => 'Sincronización de QuickBooks exitosa. :notes',
    'create_your_own' => 'Crea el tuyo propio',
    'create_your_own_description' => 'Crea tu propia plantilla usando tu propio documento PDF para cargar',
    'new_template_description' => 'Seleccione una de nuestras plantillas prediseñadas para comenzar, por ejemplo, NDA, acuerdo de venta, etc.',
    'choose_template_type' => 'Seleccione el tipo de plantilla que desea crear',
    'template' => 'Plantilla',
    'templates' => 'Plantillas',
    'new_template' => 'Nueva plantilla',
    'user_limit_reached' => '¿Necesitas más usuarios? ¡Mejora tu plan!',
    'requires_approval' => 'Requiere aprobación',
    'document_viewed_notification' => 'Notificaciones de documentos vistos',
    'document_created_notification' => 'Notificaciones de creación de documentos',
    'document_sent_notification' => 'Notificaciones de envío de documentos',
    'document_signed_notification' => 'Notificaciones firmadas de documentos',
    'document_completed_notification' => 'Notificaciones de documentos completados',
    'document_rejected_notification' => 'Notificaciones de rechazo de documentos',
    'document_voided_notification' => 'Notificaciones de documentos anulados',
    'document_expired_notification' => 'Notificaciones de documentos vencidos',
    'document_created' => 'Documento creado',
    'template_loaded' => 'Plantilla cargada',
    'select_user_or_client' => 'Seleccionar Usuario o Cliente',
    'docuninja_quota_available_but_no_users' => 'Primero agregue un usuario a Invoice Ninja y luego concédale acceso a DocuNinja aquí',
    'send_confirmation' => 'Enviar confirmación',
    'send_emails_to_following' => 'Vamos a enviar correos electrónicos a las siguientes personas:',
    'document_queued_for_sending' => 'Documento en cola para envío',
    'document_voided' => 'Documento anulado',
    'view_document' => 'Ver documento',
    'make_template' => 'Crear plantilla',
    'use_template' => 'Usar plantilla',
    'map_signatories' => 'Firmantes del mapa',
    'map_signatories_instructions' => 'Asignar los firmantes a la plantilla',
    'total_signatories' => 'Total de firmantes',
    'mapped' => 'Mapeado',
    'docuninja_splash_message' => 'Cargando DocuNinja...',
    'docuninja_contact_admin_for_access' => 'Comuníquese con su administrador para obtener acceso a DocuNinja.',
    'void' => 'Vacío',
    'invitation_signatory_help' => 'Los documentos se firman secuencialmente, luego de que el primer firmante haya firmado, el siguiente firmante podrá firmar.',
    'timeline' => 'Cronología',
    'cloned_document' => 'Documento clonado',
    'voided_document' => 'Documento anulado',
    'voided' => 'Anulado',
    'archive_document_description' => '¿Está seguro de que desea archivar este documento?',
    'restore_document_description' => '¿Está seguro de que desea restaurar este documento?',
    'delete_document_description' => '¿Está seguro de que desea eliminar este documento?',
    'document_archived' => 'Documento archivado',
    'document_restored' => 'Documento restaurado',
    'document_deleted' => 'Documento eliminado',
    'sign_now' => 'Regístrate ahora',
    'signed_document' => 'Documento firmado',
    'tour_document_upload' => 'Para empezar a firmar, sube tu documento aquí. Arrastra y suelta tus archivos en esta área.',
    'tour_signatory_selector' => 'Este es el selector de firmantes. Úselo para administrar los firmantes de su documento. Seleccione un firmante para continuar.',
    'tour_continue_select_signatory' => 'Continúe seleccionando un firmante.',
    'tour_toolbox_description' => 'A la derecha se encuentra la caja de herramientas. Úsela para agregar campos y elementos con los que los firmantes puedan interactuar. El campo de firma ya está seleccionado. Haga clic para continuar.',
    'tour_document_canvas' => 'Este es el lienzo de tu documento. Coloca y posiciona aquí los campos para tus firmantes.',
    'tour_save_document' => 'Cuando haya terminado, haga clic aquí para guardar su documento.',
    'create_signature' => 'Crear firma',
    'signature_name' => 'Nombre de la firma',
    'close_tab' => 'Cerrar pestaña',
    'sign' => 'Firmar',
    'add_open_exchange' => 'Agregar clave de Open Exchange',
    'all_entity_types_created' => 'Todos los tipos de entidades creados',
    'amount_must_be_greater_than_zero' => 'El importe debe ser mayor que cero',
    'autobill_failure' => 'La facturación automática falló',
    'autobill_success' => 'Facturación automática exitosa',
    'available' => 'Disponible',
    'blueprint' => 'Cianotipo',
    'capabilities' => 'Capacidades',
    'card_holder_help' => 'Nombre del titular de la tarjeta',
    'cards' => 'Tarjetas',
    'charts' => 'Gráficos',
    'company_logo' => 'Logotipo de la empresa',
    'create_client_or_user' => 'Crear cliente o usuario',
    'create_docuninja_account' => 'Crear una cuenta DocuNinja',
    'create_recurring_expense' => 'Crear gasto recurrente',
    'create_recurring_invoice' => 'Crear factura recurrente',
    'create_recurring_quote' => 'Crear cotización recurrente',
    'create_subscription' => 'Crear suscripción',
    'create_user' => 'Crear usuario',
    'created' => 'Creado',
    'creating' => 'Creando',
    'credit_signed_notification' => 'Notificación firmada de crédito',
    'customize_cards' => 'Personalizar tarjetas',
    'datatable' => 'Tabla de datos',
    'date_must_be_after_previous_schedule' => 'La fecha debe ser posterior a la programación anterior.',
    'default_checkbox_label' => 'Casilla de verificación predeterminada',
    'default_multiselect_label' => 'Selección múltiple predeterminada',
    'default_radio_group_label' => 'Grupo de radio predeterminado',
    'default_select_label' => 'Selección predeterminada',
    'delete_document' => 'Eliminar documento',
    'delete_docuninja_document' => 'Eliminar archivo',
    'delete_docuninja_document_confirmation' => '¿Está seguro de que desea eliminar este archivo del documento?',
    'delete_subscription' => 'Eliminar suscripción',
    'disable_docuninja' => 'Desactivar DocuNinja',
    'document_not_found' => 'Documento no encontrado',
    'docuninja_access_grant_failed' => '',
    'docuninja_access_granted_successfully' => 'Acceso a DocuNinja concedido correctamente',
    'download_signed_document' => 'Descargar documento firmado',
    'e_expense_created' => 'Gasto electrónico creado',
    'edit_rule' => 'Editar regla',
    'einvoice_delivery_failure' => 'Error en la entrega de la factura electrónica',
    'einvoice_delivery_success' => 'Entrega exitosa de factura electrónica',
    'einvoice_sent' => 'Factura electrónica enviada',
    'element' => 'Elemento',
    'email_invoice_failed' => 'El correo electrónico no se pudo enviar',
    'empty_checkbox_label' => 'Casilla de verificación vacía',
    'end_of_month' => 'Fin de mes',
    'error_fetching_pricing' => 'Error al obtener el precio',
    'exchange_rate_not_enabled' => 'Tipo de cambio no habilitado',
    'failed_payment' => 'Pago fallido',
    'field_is_required' => 'El campo es obligatorio',
    'generate' => 'Generar',
    'google_drive' => 'Google Drive',
    'initials' => 'Iniciales',
    'initials_description' => 'Descripción de las iniciales',
    'invalid_state' => 'Estado inválido',
    'invoice_signed_notification' => 'Notificación de factura firmada',
    'link_copied' => 'Enlace copiado',
    'make_template_description' => 'Crea tu propia plantilla usando tu propio documento PDF para cargar',
    'manage' => 'Administrar',
    'multiselect_needs_two_options' => 'La selección múltiple necesita dos opciones',
    'no_cards_selected' => 'No hay tarjetas seleccionadas',
    'no_templates_found' => 'No se encontraron plantillas',
    'nordigen' => 'Nordigen',
    'pages' => 'Páginas',
    'passed' => 'Aprobado',
    'payment_emailed' => 'Pago enviado por correo electrónico',
    'payment_successful' => 'Pago exitoso',
    'pdf_password_required' => 'Se requiere contraseña PDF',
    'pending_approval' => 'Pendiente de aprobación',
    'pending_file' => 'Archivo pendiente',
    'please_select_at_least_one_user' => 'Por favor seleccione al menos un usuario',
    'please_select_plan' => 'Por favor seleccione un plan',
    'please_select_signer' => 'Por favor seleccione un firmante',
    'proformal_invoices' => 'Facturas proforma',
    'purchase_order_signed_notification' => 'Notificación firmada de orden de compra',
    'queue' => 'Cola',
    'quote_field' => 'Campo de cotización',
    'quote_signed_notification' => 'Notificación firmada de cita',
    'radio_needs_two_options' => 'La radio necesita dos opciones',
    ...
    'restore_subscription' => 'Restaurar suscripción',
    'sales_above_threshold' => 'Ventas por encima del umbral',
    'save_to_add_locations' => 'Guardar para agregar ubicaciones',
    'saving' => 'Ahorro',
    'select_design' => 'Seleccionar diseño',
    'select_needs_two_options' => 'Seleccione necesita dos opciones',
    'sending' => 'Envío',
    'setting_up' => 'Configuración',
    'setup_company' => 'Empresa de configuración',
    'signature-placeholder' => 'Marcador de posición de firma',
    'signature:font-updated' => 'Fuente de la firma actualizada',
    'signature_description' => 'Descripción de la firma',
    'snappdf_not_enabled' => 'Snappdf no habilitado',
    'start_signing' => 'Empezar a firmar',
    'successfully_signed_document' => 'Documento firmado exitosamente',
    'swap_signatory' => 'Firmante del swap',
    'template_details' => 'Detalles de la plantilla',
    'tips_and_notes' => 'Consejos y notas',
    'too_many_files' => 'Demasiados archivos',
    'type_signature' => 'Tipo de firma',
    'untitled_document' => 'Documento sin título',
    'untitled_template' => 'Plantilla sin título',
    'update_recurring_expense' => 'Actualizar gastos recurrentes',
    'update_recurring_invoice' => 'Actualizar factura recurrente',
    'update_recurring_quote' => 'Actualizar cotización recurrente',
    'update_subscription' => 'Actualizar suscripción',
    'update_user' => 'Actualizar usuario',
    'upgrade_account_message' => 'Mensaje de actualización de cuenta',
    'upgrade_now' => 'Actualice ahora',
    'upgrade_plan_docuninja' => 'Actualice su plan para habilitar DocuNinja',
    'use_signature' => 'Usar firma',
    'use_snappdf' => 'Utilice snappdf',
    'user_note' => 'Nota de usuario',
    'vendor_notification_email' => 'Correo electrónico de notificación al proveedor',
    'void_document_description' => 'Descripción del documento nulo',
    'voided_payment' => 'Pago anulado',
    'welcome_to_docuninja' => 'Bienvenido a DocuNinja',
    'yodlee' => 'Canción yodlee',
    'location_name' => 'Nombre de la ubicación',
    'quote_rejected' => 'Cotización rechazada',
    'e_invoice_received_notification' => 'Notificación de factura electrónica recibida',
    'e_invoice_received_notification_help' => 'Enviar un correo electrónico cuando se haya recibido una factura electrónica',
    'location_field' => 'Campo de ubicación',
    'access_key' => 'Tecla de acceso',
    'payment_type_FPX' => 'FPX',
    'payment_type_Stripe Bank Transfer' => 'Transferencia bancaria Stripe',
    'activity_166' => 'El usuario :notes fue purgado por :user',
    'purged_user' => 'Usuario eliminado con éxito',
    'quickbooks_connect_description' => 'Conecta tu cuenta de QuickBooks con Invoice Ninja para sincronizar automáticamente tus transacciones y facturas.',
    'sync_direction_description' => 'Estos ajustes determinan cómo se sincronizará Invoice Ninja con QuickBooks.',
    'sync_direction_none_help' => 'Invoice Ninja no sincronizará ningún dato con QuickBooks ni desde él.',
    'sync_direction_pull_help' => 'Invoice Ninja extraerá los datos de QuickBooks.',
    'sync_direction_push_help' => 'Invoice Ninja enviará los datos a QuickBooks.',
    'sync_direction_bidirectional_help' => 'Invoice Ninja extraerá y enviará datos a QuickBooks.',
    'sync_settings' => 'Configuración de sincronización',
    'realm_id' => 'ID de dominio QB',
    'default_income_account' => 'Cuenta de ingresos predeterminada',
    'automatic_taxes' => 'Impuestos automáticos',
    'automatic_taxes_help' => 'Cuando la función de Impuestos Automáticos (AST, por sus siglas en inglés) está habilitada en QuickBooks, Invoice Ninja primero creará la factura en QuickBooks y luego transferirá la factura completa a Invoice Ninja.',
    'pull' => 'Jalar',
    'push' => 'Empujar',
    'bidirectional' => 'Bidireccional',
    'sync_started' => 'La sincronización ha comenzado.',
    'quickbooks_read_only_data' => 'Cuentas de ingresos y tasas impositivas almacenadas en QuickBooks',
    'hide_peppol_sent_status' => 'Ocultar estado de envío de Peppol',
    'quickbooks_requires_reauth' => 'QuickBooks requiere una nueva autenticación.',
    'quickbooks_requires_reauth_body' => 'Tu conexión a QuickBooks ha caducado y requiere que vuelvas a autenticarte. Inicia sesión en el portal de administración y vuelve a conectar tu cuenta de QuickBooks. Te enviaremos esta notificación diariamente hasta que se resuelva el problema.',
    'crop_logo' => 'Logotipo recortado',
    'passkey' => 'Llave maestra',
    'login_with_passkey' => 'Iniciar sesión con una clave de acceso',
    'manage_passkeys' => 'Administrar claves de acceso',
    'last_used' => 'Último uso',
    'unapplied_payments' => 'Pagos no aplicados',
    'debit' => 'Débito',
    'auto_convert_credit_help' => 'Vincula o crea automáticamente un pago que cumpla con estas reglas.',
    'clone_client_description' => 'Esto clonará al cliente en un nuevo registro de cliente.',
    'invalid_id_number_format' => 'Formato de número de identificación no válido',
    'invalid_vat_number_format' => 'Formato de número de IVA no válido',
    'invalid_routing_id_format' => 'Formato de ID de enrutamiento no válido',
    'invalid_id_number_checkdigit' => 'Número de identificación no válido: error en el dígito de control, verifique que el número sea correcto.',
    'invalid_vat_number_checkdigit' => 'Número de IVA no válido: error en el dígito de control, verifique que el número sea correcto.',
    'invalid_routing_id_checkdigit' => 'ID de enrutamiento no válido: error de dígito de control, verifique que el número sea correcto.',
    'sign_the_document' => 'Firma el documento',
    'client_not_found_on_peppol_network' => 'No se pudo identificar al cliente en la red PEPPOL.',
    'too_many_requests' => 'Demasiadas solicitudes',
    'custom_text_with_formatting' => 'Texto personalizado con formato',
    'client_name_and_address' => 'Nombre y dirección del cliente',
    'bill_to' => 'Cobrar a:',
    'entity_details' => 'Número, fecha, fecha de vencimiento, importe, saldo',
    'product_line_items_with_columns' => 'Elementos de la línea de productos con columnas',
    'task_line_items_with_columns' => 'Elementos de la línea de tareas con columnas',
    'divider_line' => 'separador horizontal',
    'signature_line' => 'Área de firmas',
    'authorized_signature' => 'Firma autorizada',
    'essential' => 'Básico',
    'public_notes_will_appear_here' => 'Las notas públicas aparecerán aquí.',
    'footer_will_appear_here' => 'El pie de página aparecerá aquí.',
    'terms_will_appear_here' => 'Los términos aparecerán aquí.',
    'sepa_qr' => 'SEPA QR',
    'swiss_qr' => 'Código QR suizo',
    'spc_qr' => 'SPC QR',
    'verifactu_qr' => 'Verifactu QR',
    'payment_qr' => 'Código QR de pago',
    'download_json' => 'Descargar JSON',
    'copy_block_to_clipboard' => 'Copiar bloque al portapapeles',
    'duplicate_block' => 'Bloque duplicado',
    'delete_block' => 'Bloque de eliminación',
    'height_placeholder_example' => 'Por ejemplo, 40 píxeles',
    'select_starting_point_for_invoice_design' => 'Seleccione un punto de partida para el diseño de su factura.',
    'no_templates_found_in_category' => 'No se encontraron plantillas en esta categoría.',
    'preview_uses_sample_data' => 'La vista previa utiliza datos de muestra.',
    'download_html' => 'Descargar HTML',
    'blocks_in_design' => 'bloques en el diseño',
    'actual_invoices_use_real_data' => 'Las facturas reales utilizarán datos reales del cliente y de la factura.',
    'cloned_client' => 'Cliente clonado con éxito',
    'update_tax_details' => 'Actualizar detalles fiscales',
    'cc_only' => 'Solo para CC',
    'e_invoice_forward_email' => 'Servicio de reenvío de correo electrónico de PEPPOL',
    'e_invoice_forward_email_help' => 'Reenvía las facturas electrónicas enviadas a un servicio de procesamiento de terceros como Yuki o WinAuditor.',
    'skip_automatic_email_with_peppol' => 'Deshabilitar el correo electrónico cuando se envíe a través de PEPPOL',
    'skip_automatic_email_with_peppol_help' => 'Si esta opción está habilitada, las facturas enviadas a través de la red PEPPOL no se enviarán por correo electrónico al cliente.',
    'web_session_timeout_help' => 'Tiempo que una sesión del navegador permanecerá activa antes de cerrarse.',
    'password_timeout_help' => 'Tiempo antes de que sea necesario volver a introducir la contraseña de administrador.',
    'invoice_status_paid' => '¡La factura acaba de ser pagada! El registro ya ha sido actualizado.',
    'attach_audit_log_to_completed_email' => 'Adjunte el registro de auditoría al correo electrónico completado.',
    'attach_audit_log_to_completed_email_help' => 'Si está habilitado, el registro de auditoría se adjuntará al correo electrónico de confirmación de la finalización del documento firmado.',
    'e_expense_forward_email' => 'Servicio de reenvío de gastos por correo electrónico',
    'e_expense_forward_email_help' => 'Reenvía los gastos electrónicos recibidos a un servicio de procesamiento de terceros como Yuki o WinAuditor.',
    'regenerate_token' => 'Regenerar token',
    'token_regenerated' => 'El token se regeneró correctamente.',
    'token_regeneration_failed' => 'Falló la regeneración del token.',
    'show_header' => 'Mostrar encabezado',
    'select_a_component_to_edit_properties' => 'Seleccione un componente para editar.',
    'drag_and_drop_to_add' => 'Arrastra y suelta para añadir',
    'max_width' => 'Ancho máximo',
    'max_height' => 'Altura máxima',
    'alignment' => 'Alineación',
    'object_fit' => 'Ajuste del objeto',
    'padding' => 'Relleno',
    'fix_overlaps' => 'Corregir superposiciones',
    'spacer' => 'espaciador',
    'line_height' => 'Altura de línea',
    'text_color' => 'Color del texto',
    'font_style' => 'Estilo de fuente',
    'alternate_row_colors' => 'Colores de fila alternos',
    'show_borders' => 'Mostrar bordes',
    'cell_padding' => 'Relleno de celdas',
    'suffix' => 'Sufijo',
    'hide_if_empty' => 'Ocultar si está vacío',
    'qr_code' => 'Código QR',
    'qr_code_type' => 'Tipo de código QR',
    'label_padding' => 'Espacio alrededor de cada etiqueta.',
    'value_padding' => 'Espacio alrededor de cada valor.',
    'label_value_gap' => 'Brecha entre la etiqueta y el valor.',
    'row_spacing' => '¿Cuánto espacio vertical hay entre cada fila?',
    'value_min_width' => 'Ancho mínimo para valores.',
    'restored_template' => 'Plantilla restaurada correctamente',
    'archived_template' => 'Plantilla archivada correctamente',
    'deleted_template' => 'Plantilla eliminada correctamente',
    'top' => 'Arriba',
    'table_rows' => 'Filas',
    'style' => 'Estilo',
    'widget_defaults' => 'Valores predeterminados del widget',
    'show_label' => 'Mostrar etiqueta',
    'show_label_help' => 'Muestra la etiqueta del widget junto a su valor.',
    'widget_border_style' => 'Estilo de borde del widget',
    'widget_border_style_help' => 'Estilo del borde del área de widgets.',
    'widget_border_color' => 'Color del borde del widget',
    'widget_border_color_help' => 'Color del borde que rodea el área del widget.',
    'card_already_exists' => 'La tarjeta ya existe.',
    'income_account' => 'Cuenta de ingresos',
    'payment_period' => 'Período de pago',
    'payment_period_help' => 'Tiempo permitido para completar el pago en segundos. Rango aceptado: 60 - 600.',
    ...
    'payware_vpos_id_help' => 'Identificador de webPOS del panel de control de payware',
    'payware_public_key_help' => 'Clave pública RSA para la validación de firmas de webhook',
    'gateway_onboarding_description' => 'Tu pasarela de pago se ha conectado correctamente. Ahora puedes configurar los métodos de pago y establecer límites o comisiones por transacción.',
    'gateway_onboarding_payment_methods_help' => 'Habilita o deshabilita los métodos de pago aceptados para tus clientes.',
    'gateway_onboarding_limits_fees_help' => 'Establezca límites mínimos y máximos para las transacciones y configure las tarifas de procesamiento.',
    'gateway_setup_complete' => 'Configuración de la puerta de enlace completada',
    'activity_167' => 'El estado de la factura electrónica :invoice se ha actualizado a :notes',
    'activity_168' => ':notes para :client',
    'activity_169' => ':notes para :client',
    'peppol_accepted' => 'Factura electrónica aceptada por el destinatario.',
    'peppol_rejected' => 'Factura electrónica rechazada por el destinatario.',
    'peppol_partially_paid' => 'Factura electrónica pagada parcialmente.',
    'peppol_paid' => 'Factura electrónica pagada.',
    'server_not_reachable' => 'Servidor no disponible. Compruebe su conexión a internet e inténtelo de nuevo más tarde.',
    'connecting_calendar' => 'Conectando tu calendario…',
    'redirecting' => 'Redireccionando…',
    'calendar_connection_denied' => 'Conexión cancelada',
    'calendar_connection_denied_body' => 'Has cancelado la conexión. Puedes intentarlo de nuevo cuando quieras.',
    'calendar_handoff_expired' => 'El enlace de conexión ha caducado.',
    'calendar_handoff_expired_body' => 'El enlace de conexión ya no es válido. Por favor, intente conectarse de nuevo.',
    'calendar_handoff_invalid' => 'No se pudo completar la conexión.',
    'calendar_handoff_invalid_body' => 'Se produjo un error al validar la conexión. Inténtalo de nuevo.',
    'calendar_connect_failed' => 'Falló la conexión con el calendario.',
    'calendar_connect_failed_body' => 'No pudimos finalizar la conexión con tu calendario. Por favor, inténtalo de nuevo.',
    ...
    'created_tag' => 'Etiqueta creada con éxito',
    'updated_tag' => 'Etiqueta actualizada correctamente',
    'archived_tag' => 'Etiqueta archivada correctamente',
    'restored_tag' => 'Etiqueta restaurada con éxito',
    'deleted_tag' => 'Etiqueta eliminada correctamente',
    'e_reporting_enabled' => 'Informes electrónicos habilitados',
    'ten_day_reporting' => 'Informe de diez días',
    'monthly_reporting' => 'Informes mensuales',
    'ten_day_reporting_help' => 'Reporte las transacciones del período actual en intervalos de 10 días.',
    'monthly_reporting_help' => 'Registrar las transacciones del período actual en incrementos mensuales.',
    'quickbooks_deposit_disabled_warning' => 'Los depósitos están desactivados en tu cuenta de QuickBooks conectada; este documento no se sincronizará con QuickBooks si hay un depósito registrado.',
    'tour_template_signatory_swap' => 'Este documento se creó a partir de su plantilla. Utilice el menú desplegable para reemplazar el firmante de ejemplo con un contacto o usuario real del cliente.',
    'tour_template_save_document' => 'Haz clic aquí para guardar los cambios en el documento.',
    'tour_template_send_document' => 'Cuando esté listo, haga clic aquí para enviar el documento a sus firmantes.',
    'filter_by_user' => 'Filtrar por usuario',
    'add_condition' => 'Agregar condición',
    'add_new_option' => 'Agregar nueva opción',
    'add_one_interactive_field_before_sending' => 'Agregue al menos un campo interactivo (por ejemplo, firma, texto, fecha) antes de enviar.',
    'add_option' => 'Agregar opción',
    'add_rectangle_for_signatory' => 'Asegúrese de agregar al menos un rectángulo para los firmantes antes de guardar.',
    'all_conditions_and' => 'Todas las condiciones (Y)',
    'already_invited_uninvite_confirmation' => 'Parece que este firmante ya ha sido invitado. ¿Seguro que quieres cancelar su invitación?',
    'already_signed_no_email' => 'Estos usuarios ya se han registrado y no recibirán otro correo electrónico:',
    'already_signed_removal_confirmation' => 'Estos usuarios ya han firmado y sus envíos serán eliminados. ¿Está seguro de que desea continuar?',
    'already_used' => ' - ya usado',
    'always_required' => 'Siempre requerido',
    'always_visible' => 'Siempre visible',
    'and' => ' Y',
    'any_condition_or' => 'Cualquier condición (O)',
    'border_color' => 'Color del borde',
    'border_style' => 'Estilo de borde',
    'character_range' => 'Caracteres :min - :max',
    'clear_default' => 'Borrar valores predeterminados',
    'command_palette' => 'Paleta de comandos',
    'condition' => 'Condición',
    'condition_number' => 'Condición :number',
    'contains_all' => 'contiene todo',
    'contains_any' => 'contiene cualquiera de',
    'copy_to_all_pages' => 'Copiar a todas las páginas (páginas :count )',
    'custom_regex' => 'Expresión regular personalizada',
    'custom_regex_pattern' => 'Patrón de expresión regular personalizado',
    'decimal_places' => 'Cifras decimales',
    'default_initials' => 'Iniciales predeterminadas',
    'default_number' => 'Número predeterminado',
    'default_text' => 'Texto predeterminado',
    'default_to_checked' => 'Por defecto, marcado.',
    'default_to_signing_date' => 'Por defecto, se utilizará la fecha de firma.',
    'default_values_comma_separated' => 'Valores predeterminados (separados por comas)',
    'delete_shortcut' => 'Suprimir (Supr/Retroceso)',
    'document_sent' => 'Documento enviado',
    'document_sent_locked' => 'Este documento ha sido enviado y ahora está bloqueado. No se pueden realizar más modificaciones.',
    'document_voided_description' => 'Este documento ha sido invalidado y ya no está disponible.',
    'document_voided_title' => 'Documento anulado',
    'does_not_contain' => 'no contiene',
    'does_not_equal' => 'no es igual',
    'dotted' => 'Punteado',
    'drag_to_change_signing_order' => 'Arrastra para cambiar el orden de firma',
    'drop_files_or_click' => 'Arrastra los archivos o haz clic para cargarlos.',
    'duplicate_shortcut' => 'Duplicar (Ctrl/Cmd+D)',
    'eg_initials' => 'p. ej., JD',
    'ein' => 'EIN',
    'ein_format_invalid' => 'El formato EIN no es válido.',
    'ein_validation_help' => 'Validación del EIN: Debe estar en formato XX-XXXXXXX',
    'email_invalid' => 'El formato del correo electrónico no es válido.',
    'email_validation_help' => 'Validación de correo electrónico: Debe ser un formato de correo electrónico válido.',
    'ends_with' => 'termina con',
    'enter_a_number' => 'Introduzca un número',
    'enter_default_initials' => 'Introduzca las iniciales predeterminadas...',
    'enter_default_text' => 'Introduzca el texto predeterminado...',
    'enter_default_values_comma_separated' => 'Introduzca los valores predeterminados separados por comas...',
    'enter_initials' => 'Ingrese sus iniciales',
    'enter_number_here' => 'Introduzca el número aquí',
    'enter_option_text' => 'Introduzca el texto de la opción...',
    'enter_regex_pattern' => 'Introduzca el patrón de expresión regular...',
    'enter_text' => 'Introduzca texto',
    'enter_text_here' => 'Introduzca el texto aquí',
    'enter_value' => 'Introduzca el valor...',
    'enter_values_comma_separated' => 'Introduzca los valores separados por comas...',
    'equals' => 'igual',
    'failed_to_rename' => 'No se pudo cambiar el nombre del archivo.',
    'field_appears_on_all_pages' => 'Este campo aparecerá en todas las páginas. El firmante solo debe rellenarlo una vez.',
    'field_visibility' => 'Visibilidad del campo',
    'field_visibility_help' => 'El campo solo aparece cuando se cumplen estas condiciones.',
    'file_processing_confirmation_timeout' => 'El servidor no confirmó la subida tras varias comprobaciones. Elimínala e inténtalo de nuevo.',
    'file_processing_failed' => 'El procesamiento falló.',
    'file_ready' => 'Listo',
    'files_not_ready' => 'Los archivos no están listos.',
    'google_drive_import_error' => 'Se produjo un error al importar desde Google Drive. Inténtalo de nuevo.',
    'hide_label_shortcut' => 'Hide label (Ctrl/Cmd+L)',
    'importing_from_google_drive' => 'Importando archivo(s) desde Google Drive...',
    'initials_instruction' => 'Introduce tus iniciales (máximo 10 caracteres)',
    'input' => 'Aporte',
    'invalid_validation_pattern' => 'Patrón de validación no válido',
    'invitation_not_found' => 'No se encontró la invitación.',
    'is_after' => 'es después',
    'is_after_or_equal' => 'es posterior o igual a',
    'is_before' => 'es antes',
    'is_before_or_equal' => 'es anterior o igual a',
    'is_checked' => 'está comprobado',
    ...
    'is_unchecked' => 'no está controlado',
    'length' => 'Longitud',
    'letters_only' => 'Solo cartas',
    'letters_only_help' => 'Solo letras: El campo solo aceptará caracteres alfabéticos.',
    'mark_optional_shortcut' => 'Marcar (opcional) (Ctrl/Cmd+R)',
    'mark_required_shortcut' => 'Se requiere marcar (Ctrl/Cmd+R)',
    'match' => 'Fósforo',
    'maximum_length_is' => 'La longitud máxima es :max Longitud',
    'max_length' => 'Longitud máxima',
    'max_value' => 'Valor máximo',
    'minimum_length_is' => 'La longitud mínima es :min Longitud',
    'min_length' => 'Longitud mínima',
    'min_value' => 'Valor mínimo',
    'multi_select' => 'Selección múltiple',
    'multiselect_field_needs_options' => 'Los campos de selección múltiple deben tener al menos una opción antes de guardar.',
    'no_default' => 'Sin valor predeterminado',
    'no_fields_for_conditions' => 'No hay campos disponibles para crear condiciones. Añada los campos primero.',
    'no_maximum' => 'Sin máximo',
    'no_minimum' => 'Sin mínimo',
    'no_options_configured' => 'No se han configurado opciones.',
    'no_options_configured_add_above' => 'No hay opciones configuradas. Añada las opciones arriba.',
    'number_format' => 'Formato de número',
    'numbers_only' => 'Solo números',
    'numbers_only_help' => 'Solo números: este campo solo aceptará caracteres numéricos.',
    'only_letters_allowed' => 'Solo se permiten letras',
    'only_numbers_allowed' => 'Solo se permiten números.',
    'options_count' => 'Opciones ( :count )',
    'or_import_from' => 'o importar desde',
    'page_number' => 'Página :number',
    'pattern_label' => 'Patrón: :patrón',
    'pattern_not_matched' => 'Patrón no coincidente',
    'pdf_password_incorrect' => 'La contraseña proporcionada para &quot; :name &quot; es incorrecta. Introduzca la contraseña correcta:',
    'pdf_password_protected' => 'El archivo PDF &quot; :name &quot; está protegido con contraseña. Introduzca la contraseña:',
    'radio' => 'Radio',
    'radio_group' => 'Grupo de Radio',
    'radio_selection' => 'Selección de radio',
    'required_when' => 'Requerido cuando...',
    'search_for_command' => 'Buscar un comando para ejecutar...',
    'select_field_needs_options' => 'Los campos seleccionados deben tener al menos una opción antes de guardar.',
    'select_one_or_more_options' => 'Seleccione una o más opciones',
    'select_option' => 'Seleccione una opción',
    'select_option_default' => 'Seleccione una opción (Predeterminado: :label)',
    'send_email_to_contacts' => 'Enviaremos un correo electrónico a los siguientes contactos:',
    'settings_shortcut' => 'Configuración (Ctrl/Cmd+E)',
    'show_label_shortcut' => 'Mostrar etiqueta (Ctrl/Cmd+L)',
    'shown_later_in_form' => ' - se muestra más adelante en forma',
    'show_when' => 'Mostrar cuándo...',
    'signatories' => 'Firmantes',
    'signatory_number' => 'Firmante :number',
    'signatory_required_for_signatures' => 'Para crear firmas, es necesario seleccionar un firmante.',
    'signing_error' => 'Error de firma',
    'solid' => 'Sólido',
    'something_went_wrong' => 'Algo salió mal',
    'ssn' => 'Número de Seguro Social',
    'ssn_format_invalid' => 'El formato del número de seguro social no es válido.',
    'ssn_validation_help' => 'Validación del número de seguro social: Debe estar en formato XXX-XX-XXXX',
    'successfully_deleted' => 'Archivo eliminado correctamente.',
    'successfully_imported_from_google_drive' => 'Archivo(s) importado(s) correctamente desde Google Drive.',
    'successfully_renamed' => 'El archivo se ha renombrado correctamente.',
    'successfully_saved' => 'Los cambios se han guardado correctamente.',
    'successfully_updated_document_title' => 'Título del documento actualizado correctamente.',
    'successfully_uploaded' => 'Archivo(s) cargado(s) correctamente.',
    'template_variable' => 'Variable de plantilla',
    'template_variable_help' => 'Seleccione una variable predefinida para mostrar en el documento.',
    'toolbox_help_text' => 'Seleccione al firmante y, a continuación, dibuje un espacio reservado para la firma.',
    'uninvited_parties_error' => 'Parece que tienes invitados no deseados. Por favor, reemplázalos con usuarios o clientes reales.',
    'unknown_signatory' => 'Firmante desconocido',
    'unnamed_contact' => 'Contacto sin nombre ( :email )',
    'unnamed_user' => 'Usuario anónimo',
    'untitled_blueprint' => 'Plano sin título',
    'upload_cancelled_no_password' => 'Se ha cancelado la carga para &quot; :name &quot;. No se ha proporcionado contraseña.',
    'upload_error' => 'Se produjo un error al subir el/los archivo(s). Inténtalo de nuevo.',
    'uploading_files' => 'Subiendo archivo(s)...',
    'uploading_source_file' => 'Cargando archivo fuente',
    'url_invalid' => 'El formato de la URL no es válido.',
    'url_validation_help' => 'Validación de URL: Debe ser un formato de URL válido.',
    'use_default_value' => 'Utilizar el valor predeterminado',
    'validation' => 'Validación',
    'validation_rule' => 'Regla de validación',
    'value_must_be_at_least' => 'El valor debe ser al menos :value',
    'value_must_be_at_most' => 'El valor debe ser como máximo :value',
    'variable' => 'Variable',
    'widget_type' => 'Tipo de widget',
    'zip' => 'CREMALLERA',
    'zip_format_invalid' => 'El formato ZIP no es válido.',
    'zip_validation_help' => 'Validación del código postal: Debe tener 5 dígitos o formato 5+4 (XXXXX-XXXX).',
    'zoom' => 'Zoom',
    'report_too_large_to_preview' => 'El informe es demasiado grande para previsualizarlo. Descárguelo para verlo.',
    'log_time' => 'Registrar hora',
    'filter_by_project' => 'Filtrar por proyecto',
    'google' => 'Google',
    'app_maintenance' => 'Mantenimiento de la aplicación en curso',
    'cloned_design' => 'Diseño clonado',
    'no_expenses_selected' => 'No se seleccionaron gastos',
    'sync' => 'Sincronizar',
    'updated_tax_data' => 'Datos fiscales actualizados',
    'upload_failed' => 'Error al cargar',
    'wrong_file_extension' => 'Extensión de archivo incorrecta',
    'not_ready_for_download' => 'El archivo no está listo para descargar.',
    'list' => 'Lista',
    'already_linked' => 'Ya vinculado',
    'convert_to_task' => 'Convertir en tarea',
    'duplicated_entries' => 'Entradas duplicadas',
    'no_entries_to_duplicate' => 'No hay entradas duplicadas',
    'please_enter_a_valid_duration' => 'Por favor, introduzca una duración válida.',
    'calendar_unavailable' => 'Calendario no disponible',
    'connect_calendar' => 'Calendario de conexión',
    'disconnect_calendar_confirmation' => '¿Estás seguro de que quieres desconectar tu calendario?',
    'duplicate_yesterday' => 'Duplicado ayer',
    'hide_events' => 'Ocultar eventos',
    'show_events' => 'Eventos de espectáculos',
    'merge_client' => 'Cliente de fusión',
    'merge_vendor' => 'Fusionar proveedores',
    'global' => 'Global',
    'disable_all' => 'Deshabilitar todo',
    'press_keys' => 'Pulsa las teclas',
    'no_payment_required' => 'Este cambio de plan no requiere ningún pago. Por favor, vuelva atrás y confirme el cambio de plan.',
    'subscription_payment_required' => 'El total ha cambiado y ahora se requiere el pago. Seleccione un método de pago para continuar.',
    'task_distribution' => 'Distribución de tareas',
    'team_distribution' => 'Distribución del equipo',
    'task_velocity' => 'Velocidad de la tarea',
    'daily_velocity' => 'Velocidad diaria',
    'forecast_finish' => 'Finalización de la previsión',
    'days_ahead' => 'Días venideros',
    'days_behind' => 'Días de retraso',
    'forecast' => 'Pronóstico',
    'estimated_vs_actual' => 'Estimado vs. Real',
    'budgeted_amount' => 'Cantidad presupuestada',
    'burn_up' => 'Consumirse completamente',
    'actual_spend' => 'Gasto real',
    'margin' => 'Margen',
    'target' => 'Objetivo',
    'persist_table_filters' => 'Filtros de tabla persistentes',
    'persist_table_filters_help' => 'Si están habilitados, los filtros de la tabla se mantendrán incluso después de recargar la página.',
    'billing_progress' => 'Progreso de facturación',
    'budget_vs_actual' => 'Presupuesto vs. Real',
    'unbilled_work' => 'Trabajo no facturado',
    'save_for_later' => 'Guardar para más tarde',
    'deletion_violation_regulatory' => 'Este documento no puede eliminarse porque está sujeto a requisitos de información reglamentaria.',
    'currency_syrian_pound' => 'Libra siria',
    'account_plan_expired' => 'El plan de cuenta ha caducado.',
    'add_files' => 'Agregar archivos',
    'add_reminder_schedule' => 'Agregar recordatorio',
    'advanced_options' => 'Opciones avanzadas',
    'after_event' => 'después del evento',
    'after_send' => 'Después de enviar',
    'before_event' => 'antes del evento',
    'checklist_fields' => 'Colocar campos en el documento',
    'checklist_ready' => 'Preparado para usar',
    'checklist_send' => 'Enviar documento',
    'checklist_signatories' => 'Agregar firmantes',
    'checklist_title' => 'Lista de verificación de documentos',
    'checklist_upload' => 'Subir un documento',
    'click_to_assign' => 'Haga clic para asignar',
    'companies' => 'Empresas',
    'confirm_remove_signatory' => '¿Está seguro de que desea eliminar a este firmante?',
    'created_reminder_schedule' => 'Se ha creado un calendario de recordatorios.',
    'deleted_reminder_schedule' => 'Se eliminó el calendario de recordatorios.',
    'document_sent_successfully' => 'Documento enviado correctamente',
    'docuninja_join_esignatures' => 'Firmas electrónicas',
    'docuninja_join_esignatures_help' => 'Recopilación de firmas con seguimiento',
    'docuninja_join_features_title' => 'Todo lo que obtienes',
    'docuninja_join_integration' => 'Integración profunda',
    'docuninja_join_integration_help' => 'Trabaja con facturas, presupuestos y pedidos.',
    'docuninja_creating_account' => 'Creando tu cuenta...',
    'documents_public_by_default' => 'Establecer documentos como públicos por defecto',
    'documents_public_by_default_help' => 'Si está habilitada esta opción, los nuevos documentos serán públicos por defecto.',
    'docuninja_join_tagline' => 'Crea, envía y firma electrónicamente documentos directamente desde Invoice Ninja.',
    'docuninja_join_templates_help' => 'Planos de documentos reutilizables',
    'edit_reminder_schedule' => 'Editar calendario de recordatorios',
    'fewer_tools' => 'Menos herramientas',
    'global_tag_inheritance' => 'Herencia de etiquetas globales',
    'global_tag_inheritance_help' => 'Determina si las entidades hijas heredan las etiquetas de sus entidades padre.',
    'more_tools' => 'Más herramientas',
    'no_reminder_schedules_found' => 'No se encontraron horarios de recordatorio',
    'no_template' => 'Sin plantilla',
    'reminder_schedules' => 'Horarios de recordatorio',
    'sending_document' => 'Envío de documento',
    'single_signatory_description' => 'Seleccione a quién desea enviar este documento y, a continuación, continúe.',
    'trigger_event' => 'Evento desencadenante',
    'updated_reminder_schedule' => 'Calendario de recordatorios actualizado',
    'validation_errors' => 'Errores de validación',
    'view_details' => 'Ver detalles',
    'who_to_send_to' => '¿A quién enviarlo?',
    'wait_for_file_processing' => 'Espere a que finalice el procesamiento de los archivos o elimine las cargas fallidas.',
    'yyyy_mm_dd' => 'aaaa-mm-dd',
    'docuninja_unavailable' => 'DocuNinja no está disponible actualmente. Inténtalo de nuevo más tarde.',
    'add_tax' => 'Agregar impuestos',
    'what_are_you_charging_for' => '¿Qué es lo que está cobrando?',
    'add_value_as_new_client' => 'Agregar ` :value como nuevo cliente.',
    'stripe_ach_verifiation_pending' => 'Este método de pago aún no está disponible. La verificación está pendiente.',
    'deleted_invoices_exist' => 'Este pago está vinculado a una o más facturas eliminadas y no se puede borrar. Primero debe restaurar las facturas y luego eliminar los pagos.',
    'show_date' => 'Fecha del espectáculo',
    'show_signature_line' => 'Mostrar la línea de firmas',
    'page_break' => 'Control de salto de página',
    'page_break_help' => 'Evita que el contenido se divida entre páginas.',
    'spacing' => 'Espaciado',
    'designer' => 'Diseñador',
    'typography' => 'Tipografía',
    'design_name_required' => 'Se requiere el nombre del diseño.',
    'preview_indicative_only' => 'Las vistas previas son meramente indicativas. El diseño final variará en función de los datos reales.',
    'total_task_estimated_duration' => 'Tareas Tiempo estimado',
    'total_task_remaining_estimated_duration' => 'Tareas Tiempo restante',
    'total_unestimated_tasks' => 'Tareas no estimadas',
