...
',
    ...
    'estimated_duration' => 'Очаквана продължителност',
    ...
    'no_passkeys_registered' => 'Няма регистрирани пароли за тази сметка . Моля, използвайте парола за вход или първо регистрирайте парола.',
    ...
    'trial_card_authorization_notice' => 'Днес няма да бъдат събрани Плащане . Ще направим временна оторизация от 1 долар по кредитната ви карта и ще я освободим веднага след проверка. Вашата Банка може за кратко да я покаже като чакаща. В края на 14-дневния пробен период картата ви ще бъде таксувана с 14 долара на месец. анулиране по всяко време.',
    'trial_card_verification_failed' => 'Не успяхме да потвърдим тази кредитна карта. Не е начислена такса. Моля, използвайте валидна кредитна карта с поне 1 долар наличен кредит.',
    'trial_credit_card_required' => 'Приемат се само кредитни карти. Дебитни, предплатени и некласифицирани карти не могат да се използват. Не е начислена такса.',
    'trial_card_gateway_error' => 'Не успяхме контакт доставчика на картата. Не беше начислена такса. Моля, опитайте отново.',
    'trial_card_release_failed' => 'Картата ви беше оторизирана, но не успяхме да потвърдим, че временното оторизиране е било освободено. Пробният ви период не е започнат. Моля, опитайте отново по-късно или контакт поддръжката.',
    'trial_verification_in_progress' => 'Проверката на картата ви вече се обработва. Моля, изчакайте малко и опитайте отново.',
    'trial_no_longer_available' => 'Тази сметка вече не отговаря на условията за безплатен пробен период.',
    'overdue' => 'Просрочие',
    ...
    'remove' => 'Премахване',
    'remove_failed_upload' => 'Премахване на неуспешно качване',
    ...
    'pro_upgrade_feature1' => 'Вашата Марка. фактуриране .co',
    ...
    'preparing_canonical_pdf' => 'Подготовка на каноничен PDF',
    'preparing_server_preview' => 'Подготовка на предварителен преглед на сървъра',
    ...
    'applied' => 'Приложено',
    'applied_date' => 'Дата на прилагане',
    'applied_amount' => 'Приложен Сума',
    'applied_refunded' => 'Приложено Възстановено',
    ...
    'invoice_not_related_to_payment' => 'Фактура # :invoice не е свързана до това Плащане',
    'credit_not_related_to_payment' => 'Кредит # :credit не е свързан до това Плащане',
    ...
    'notification_invoice_overdue_subject' => 'Фактура :invoice е просрочена за :client',
    'notification_invoice_overdue' => 'Следната Фактура :invoice за клиент :client и :amount вече е просрочена.',
    ...
    'invoices_by_month' => 'Фактури по месеци',
    'payments_by_month' => 'Плащания по месеци',
    'monthly_breakdown_skipped' => 'Пропусната е месечна разбивка: диапазонът от дати надвишава 24 месеца',
    ...
    'gross_sales' => 'Брутни продажби',
    'taxable_sales' => 'Облагаеми продажби',
    'exempt_sales' => 'Освободени продажби',
    'non_taxable_sales' => 'Необлагаеми продажби',
    'zero_rated_sales' => 'Продажби с нулева ставка',
    'accounting_basis' => 'Счетоводна основа',
    'tax_treatment' => 'Данъчно третиране',
    'summary_source' => 'Източник на обобщението',
    'sales_breakdown_source' => 'Разбивка на продажбите',
    'legacy_tax_detail_source' => 'Данъчни данни за наследени данъци',
    'monthly_filing_summary' => 'Месечно обобщение на подадените документи',
    'filing_overview' => 'Общ преглед на подаването',
    'jurisdiction_breakdown' => 'Разбивка по юрисдикция',
    'state_breakdown' => 'Разбивка на щатите',
    'filing_period' => 'Период на подаване',
    'period_start' => 'начало на периода',
    'period_end' => 'Край на периода',
    'jurisdiction_source' => 'Източник на юрисдикция',
    'tax_data_source' => 'Данъчни данни',
    'client_shipping_source' => 'Адрес за доставка Клиент',
    'client_billing_source' => 'Адрес за фактуриране на Клиент',
    'tax_detail_source' => 'Данъчни данни Пощенски код',
    'unknown_source' => 'Неизвестен източник',
    'district' => 'област',
    'metric' => 'Метричен',
    'report_period' => 'Отчетният период',
    'current_filing_rows' => 'Текущи редове за подаване',
    'correction_rows' => 'Корекционни редове',
    'states_reported' => 'Докладвани щати',
    'jurisdictions_reported' => 'Докладвани юрисдикции',
    'rows_missing_state' => 'Липсващо състояние на редове',
    'rows_using_client_fallback' => 'Редове, използващи Резервен Клиент',
    'prior_period_corrections' => 'Корекции от предходни периоди',
    'corrections_review' => 'Преглед на корекциите',
    'original_tax_period' => 'Първоначален данъчен период',
    'correction_recorded_period' => 'Период на регистриране на корекция',
    'correction_type' => 'Тип корекция',
    'requires_review' => 'Изисква преглед',
    'current_period_activity' => 'Активност в текущия период',
    'invoice_correction' => 'Корекция Фактура',
    'payment_correction' => 'Плащане Корекция',
    'status_correction' => 'Корекция на състоянието',
    'legacy_unknown' => 'Наследство Неизвестно',
    'tax_summary' => 'Данъчно резюме',
    'reporting_bucket' => 'Кофа за отчитане',
    'invoice_count' => 'Фактура Брой',
    ...
    'mobile_payment' => 'Мобилни Плащане',
    'awaiting_payment' => 'В очакване Плащане',
    'payment_confirmed' => 'Плащане потвърдено',
    'payment_expired' => 'Плащане е изтекло. Моля, върнете се и опитайте отново.',
    'payment_was_not_completed' => 'Плащане не беше завършено. Моля, опитайте отново.',
    'no_compatible_app_installed' => 'Ако нищо не се случи, може да нямате инсталирано съвместимо приложение.',
    'payment_type_Mobile Payment' => 'Мобилни Плащане',
    'gateway_temporarily_unavailable' => 'Този метод Плащане временно не е наличен. Моля, опитайте отново по-късно или изберете друг метод Плащане .',
    'mybank' => 'MyBank',
    ...
    'show_pdfhtml_on_mobile' => 'Показване на HTML версия при преглед на мобилно устройство',
    ...
    'use_unapplied_payments' => 'Използвайте неприложени Плащания',
    ...
    'end_all_sessions_help' => 'Излиза от системата на всички потребители, изисква потребителите до се удостоверят отново.',
    ...
    'peppol_credits_info' => 'до изпращане и получаване на електронни фактури са необходими електронни кредити. Те се таксуват за всеки отделен документ. Ако вече имате кредити, щракнете върху „Продължи“.',
    ...
    'peppol_negative_line_price' => 'Цените на артикулите не могат да бъдат отрицателни за електронно фактуриране . Моля Въведи положителна цена и приложете всяко намаление като отстъпка или отрицателно количество.',
    ...
    'just_now' => 'Точно сега',
    'yesterday' => 'Вчера',
    'enable_client_profile_update' => 'Разрешете на Клиенти до актуализират своя профил',
    ...
    'downgrade_to_free_description' => 'Това ще премахне всички платени функции от вашата сметка .',
    ...
    'pro_plan_feature_3' => 'имейл Фактури чрез Gmail &amp; Microsoft',
    ...
    'enterprise_plan_feature_1' => 'Допълнителни потребители и разрешения за сметка',
    'enterprise_plan_feature_2' => 'Качване и прикачване на файлове',
    'enterprise_plan_feature_3' => 'персонализиран домейн на портала',
    'enterprise_plan_feature_4' => 'Банкова сметка sync',
    ...
    'currency_caribbean_guilder' => 'Карибски гулден',
    'is_shipping' => 'Доставката е',
    'added_location' => 'Успешно добавено местоположение',
    'send_emails' => 'Изпращане на имейли',
    'send_emails_permission' => 'Разрешаване Потребител до изпращане на имейли',
    'cancel_trial' => 'анулиране пробно',
    'cancel_trial_description' => 'Това ще анулиране вашата пробна версия и ще премахне всички платени функции от вашата сметка .',
    'existing_gateway' => 'вход вече съществува',
    'docuninja' => 'ДокуНинджа',
    'pro_rata' => 'Пропорционално',
    'change_docuninja_plan' => 'Промяна на плана на DocuNinja',
    'downgrade_end_of_cycle' => 'Вашият план автоматично ще бъде понижен в края на текущия цикъл на фактуриране.',
    'docuninja_change_users' => 'Нов лимит на DocuNinja Потребител',
    'docuninja_disable_warning' => 'Това ще премахне целия достъп до вашата сметка DocuNinja.',
    'docuninja_downgrade_info' => 'Вашият лимит Потребител ще бъде автоматично намален в края на текущия цикъл на фактуриране.',
    'docuninja_grant_access_help' => 'Предоставете достъп на потребителите Фактура Ninja до DocuNinja',
    'recurring_invoice_item' => 'Периодична Фактура Item',
    'disable_recurring_payment_notification' => 'Disable Периодична Плащане Notification',
    'disable_recurring_payment_notification_help' => 'Successful Периодична Фактура Плащане notifications will not be send.',
    'invoice_outstanding_tasks' => 'Фактура Изключителни Задачи',
    'payment_schedule' => 'График Плащане',
    'time_zone' => 'Часова зона',
    'tax_names' => 'Данъчни имена',
    'auto_bill_help' => 'Ако е активирано, когато графикът се изпълнява, ще се направи опит за автоматично фактуриране за планираната Сума',
    'choose_schedule_type' => 'Изберете тип график',
    'split_payments' => 'Сплит Плащания',
    'split_payments_help' => 'Разделя Фактура Сума на множество Плащания за определен период от време. т.е. 4 Плащания за 4 месеца',
    'custom_schedule' => 'Ръчно Създай персонализиран график Плащане',
    'custom_schedule_help' => 'Създай персонализиран график Плащане , позволяващ създаване на точни дати и суми за всеки график',
    'schedule_frequency_help' => 'Интервалът време между всяко Плащане',
    'first_payment_date' => 'Първа дата Плащане',
    'first_payment_date_help' => 'Датата на първото Плащане',
    'payment_schedule_interval' => 'Плащане :индекс на :total за :amount',
    'payment_schedule_table' => 'Плащане :ключ на :date за :amount',
    'auto_send' => 'Автоматично изпращане',
    'auto_send_help' => 'Автоматично изпраща Фактура до клиент по имейл',
    'include_project_tasks' => 'Включи проект Задачи',
    'include_project_tasks_help' => 'Също Фактура Задачи , които са част от проект',
    'tax_nexus' => 'Данъчна връзка',
    'tax_period_report' => 'Отчет за данъчен период',
    'creator' => 'Създадена от',
    'ses_topic_arn_help' => 'Темата SES (по избор, само за проследяване на уеб куки)',
    'ses_region_help' => 'Регионът AWS, т.е. us-east-1',
    'ses_secret_key' => 'SES секретен ключ',
    'ses_access_key' => 'Идентификационен номер на SES ключ за достъп',
    'lifecycle' => 'Жизнен цикъл',
    'order_columns' => 'Поръчай колони',
    'topic_arn' => 'Тема ARN',
    'lang_Catalan' => 'Каталонски',
    'lang_Afrikaans' => 'африкаанс',
    'lang_Indonesian' => 'Индонезийски',
    'replaced' => 'Заменен',
    'ses_from_address' => 'Адрес на SES от',
    'ses_from_address_help' => 'Адресът на изпращащия имейл трябва да бъде проверен в AWS',
    'unauthorized_action' => 'Нямате право до извършите това действие',
    'einvoice_received_subject' => 'Получена електронна Фактура',
    'einvoice_received_body' => 'Получихте :count нов E- Фактура /s.<br><br> Вход до Прегледай .',
    'download_files_too_large' => 'Някои файлове бяха твърде големи до ги прикачите директно до имейл . Моля, използвайте връзките по-долу до ги изтеглите поотделно.',
    'restore_disabled_verifactu' => 'Не можете Възстанови една Фактура , след като тя е била изтрит',
    'delete_disabled_verifactu' => 'Не можете Изтрий Фактура , след като тя е била анулирана или променена',
    'rectify' => 'Изправител',
    'verifactu_invoice_send_success' => 'Фактура :invoice за :client изпратен до AEAT Успешно',
    'verifactu_invoice_sent_failure' => 'Фактура :invoice за :client неуспешно до до AEAT :notes',
    'verifactu_cancellation_send_success' => 'Фактура анулиране за :invoice изпратено до AEAT Успешно',
    'verifactu_cancellation_send_failure' => 'Фактура анулиране за :invoice неуспешно до до AEAT :notes',
    'verifactu' => 'Проверено',
    ...
    'feedback_modal_description' => 'Ще се радваме до чуем вашата обратна връзка!',
    'do_not_ask_again' => 'Не питай отново',
    'not_likely' => 'Малко вероятно',
    'extremely_likely' => 'Изключително вероятно',
    'feedback_slider_title' => 'Колко вероятно е до препоръчате Фактура Ninja до приятел или колега?',
    'actual_delivery_date' => 'Действителна дата на доставка',
    'actual_delivery_date_help' => 'Понякога се изисква при фактуриране зад граница. Определя ТОЧНАТА дата на доставка на стоките.',
    'invoice_period' => 'Фактура Период',
    'invoice_period_help' => 'Определя периода от време, за който са били предоставяни услугите.',
    'paused_recurring_invoice_helper' => 'Внимание! Когато рестартирате Периодична Фактура , уверете се, че следващата дата на изпращане е в бъдещето.',
    'thank_you_for_feedback' => 'Благодаря ви за обратната връзка!',
    'use_legacy_editor' => 'Използване на стар Wysiwyg редактор',
    'use_legacy_editor_help' => 'Използвайте редактора TinyMCE.',
    'enable_e_invoice_received_notification' => 'Разрешете E- Фактура Получено известие',
    'enable_e_invoice_received_notification_help' => 'Получаване на известие имейл при получаване на нов E- Фактура .',
    'price_changes' => 'Промени в цените на плановете от 1 януари 2026 г.',
    'notification_quote_rejected_subject' => 'цитат :quote беше отхвърлен от :client',
    'notification_quote_rejected' => 'Следният клиент :client отхвърли цитат :quote за :amount :notes .',
    'activity_150' => 'сметка беше изтрит :notes',
    'activity_151' => 'Клиент :notes беше обединен с :client от :user',
    'activity_152' => 'Доставчик :notes беше обединен с :vendor от :user',
    'activity_153' => 'Клиент :notes беше премахнат от :user',
    'activity_154' => 'E- Фактура :invoice for :client изпратен до AEAT Успешно',
    'activity_155' => 'E- Фактура :invoice за :client неуспешно до до AEAT :notes',
    'activity_156' => 'Фактура отмяна за :invoice изпратена до AEAT Успешно',
    'activity_157' => 'Фактура анулиране за :invoice неуспешно до до AEAT :notes',
    'activity_158' => 'цитат :quote беше отхвърлен от :client :notes',
    'quotes_with_status_sent_can_be_rejected' => 'Само цитати със статус „Изпратени“ могат да бъдат отхвърлени.',
    'reject' => 'Отхвърляне',
    'rejected' => 'Отхвърлено',
    'reject_quote' => 'Отхвърляне цитат',
    'reject_quote_confirmation' => 'Сигурни ли сте, че искате до отхвърлите този цитат ?',
    'reason' => 'Причина',
    'enter_reason' => 'Въведи причина...',
    'notification_invoice_overdue_summary_subject' => 'Фактура Просрочено резюме: :date',
    'notification_invoice_overdue_summary' => 'Следните Фактури са просрочени:',
    'purge_user_confirmation' => 'Внимание! Това действие ще преназначи всички обекти до собственика на сметка и Изтрий завинаги Потребител във всички компании и акаунти. Сигурни ли сте, че искате до продължите?',
    'peppol_sending_failed' => 'Неуспешно изпращане на E- Фактура !',
    'peppol_sending_success' => 'E- Фактура изпратено Успешно !',
    'auto_generate' => 'Автоматично генериране',
    'mollie_payment_pending' => 'Вашето Плащане е в процес на обработка. Моля, изчакайте обработката до . Ще ви имейл когато приключи.',
    'over_payment_helper' => 'По избор: можете да платите повече от показаната тук Сума (напр. бакшиш, закръгляване нагоре).',
    'new_resource' => 'Нов ресурс',
    'drop_your_logo_here' => 'Пуснете логото си тук или кликнете до Разгледай“',
    'save_to_enable_health_check' => 'Проверката на състоянието ще бъде налична след запазване на промените във вход .',
    'audit_log' => 'Дневник на одита',
    'clone_to_template' => 'Копирай до шаблона',
    'clone_document_description' => 'Копирай до нов документ',
    'add_signatories' => 'Добавете подписалите',
    'authorized_to_sign' => 'Оторизиран знак до',
    'ninja_quote_notification' => 'цитат Подписано известие',
    'ninja_invoice_notification' => 'Фактура Подписано уведомление',
    'ninja_credit_notification' => 'Известие за подписан кредит',
    'ninja_purchase_order_notification' => 'Известие за подписана поръчка за покупка',
    'email_client_when_quote_signed_description' => 'имейл клиент , когато цитат е подписан',
    'email_client_when_invoice_signed_description' => 'имейл клиент , когато Фактура е подписан',
    'email_client_when_credit_signed_description' => 'имейл клиент , когато кредитът е подписан',
    'email_vendor_when_purchase_order_signed_description' => 'имейл Доставчик когато поръчката за покупка е подписана',
    'custom_document_completed' => 'персонализиран Документът е завършен',
    'email_client_when_custom_document_completed' => 'имейл клиент , когато е подписан персонализиран документ',
    'sender' => 'Изпращач',
    'create_template' => 'Създай шаблон',
    'edit_template' => 'Редактирай шаблон',
    'delete_template' => 'Изтрий шаблон',
    'template_created' => 'Създадена шаблон',
    'template_updated' => 'Шаблонът обновена',
    'template_deleted' => 'Шаблонът изтрит',
    'template_name' => 'Име на шаблона',
    'template_description' => 'Описание на шаблона',
    'document_type' => 'Тип документ',
    'document_type_description' => 'Изберете типа документ до да конфигурирате подписи',
    'new_signatory' => 'Нов подписващ',
    'signatory' => 'Подписващ',
    'invoice_ninja_template_description' => 'Персонализирайте местоположението на подписите на Фактура Ninja документи като Фактури , цитати и др',
    'activity_159' => 'Фактура :invoice за :client беше подписана',
    'activity_160' => 'цитат :quote за :client беше подписан',
    'activity_161' => 'Кредитът :credit за :client беше подписан',
    'activity_162' => 'Поръчката за покупка :purchase_order за :vendor беше подписана',
    'activity_163' => 'персонализиран Документ :подписан е документ за :client',
    'activity_164' => 'Синхронизирането на QuickBooks не бе успешно. :notes',
    'activity_165' => 'Синхронизирането на QuickBooks е успешно. :notes',
    'create_your_own' => 'Създай свой собствен',
    'create_your_own_description' => 'Създай свой собствен шаблон, използвайки собствен PDF документ до качване',
    'new_template_description' => 'Изберете един от нашите предварително изготвени шаблони, до започнете, например NDA, споразумение за продажба и др.',
    'choose_template_type' => 'Изберете типа на шаблона, който искате до Създай',
    'template' => 'Шаблон',
    'templates' => 'Шаблони',
    'new_template' => 'Нов шаблон',
    'user_limit_reached' => 'Нуждаете се от повече потребители? Надстройте плана си!',
    'requires_approval' => 'Изисква одобрение',
    'document_viewed_notification' => 'Известия за преглеждане на документи',
    'document_created_notification' => 'Документ Създадена уведомления',
    'document_sent_notification' => 'Известия за изпращане на документи',
    'document_signed_notification' => 'Известия за подписани документи',
    'document_completed_notification' => 'Известия за завършени документи',
    'document_rejected_notification' => 'Известия за отхвърлени документи',
    'document_voided_notification' => 'Анулирани известия за документи',
    'document_expired_notification' => 'Известия за изтекъл срок на документа',
    'document_created' => 'Документът Създадена',
    'template_loaded' => 'Шаблонът е зареден',
    'select_user_or_client' => 'Изберете Потребител или Клиент',
    'docuninja_quota_available_but_no_users' => 'Първо Добавете Потребител до Фактура Ninja, след което им дайте достъп до DocuNinja тук',
    'send_confirmation' => 'Изпращане на потвърждение',
    'send_emails_to_following' => 'до изпращаме имейли до следния начин:',
    'document_queued_for_sending' => 'Документът е в опашка за изпращане',
    'document_voided' => 'Документът е анулиран',
    'view_document' => 'Прегледай документа',
    'make_template' => 'Създаване на шаблон',
    'use_template' => 'Използване на шаблон',
    'map_signatories' => 'Подписали картата',
    'map_signatories_instructions' => 'Задайте подписващите лица до шаблона',
    'total_signatories' => 'Общо подписали',
    'mapped' => 'Картирано',
    'docuninja_splash_message' => 'Зареждане на DocuNinja...',
    'docuninja_contact_admin_for_access' => 'контакт вашия администратор за достъп до DocuNinja.',
    'void' => 'Празнота',
    'invitation_signatory_help' => 'Документите се подписват последователно, като след като първият подписа, следващият ще може до подпише.',
    'timeline' => 'Хронология',
    'cloned_document' => 'Документът копирана',
    'voided_document' => 'Документът е анулиран',
    'voided' => 'Анулиран',
    'archive_document_description' => 'Сигурни ли сте, че искате до Архивирай този документ?',
    'restore_document_description' => 'Сигурни ли сте, че искате до Възстанови този документ?',
    'delete_document_description' => 'Сигурни ли сте, че искате до Изтрий този документ?',
    'document_archived' => 'архивиран документ',
    'document_restored' => 'Документ възстановена',
    'document_deleted' => 'Документът изтрит',
    'sign_now' => 'Подпишете сега',
    'signed_document' => 'Подписан документ',
    'tour_document_upload' => 'до започнете да подписвате, качете документа си тук. Плъзнете и пуснете файловете си в тази област.',
    'tour_signatory_selector' => 'Това е селекторът на подписващи. Използвайте го до да управлявате подписващите за вашия документ. Изберете подписващ до продължите.',
    'tour_continue_select_signatory' => 'Продължете, като изберете подписващ.',
    ...
    'sign' => 'Знак',
    'add_open_exchange' => 'Добавете Open Exchange Key',
    'all_entity_types_created' => 'Всички типове обекти Създадена',
    'amount_must_be_greater_than_zero' => 'Сума трябва да е по-голяма от нула',
    'autobill_failure' => 'Автоматичното фактуриране не беше успешно',
    'autobill_success' => 'Автоматичното фактуриране е успешно',
    'available' => 'Налично',
    'blueprint' => 'План',
    'capabilities' => 'Възможности',
    'card_holder_help' => 'Име на притежателя на картата',
    'cards' => 'Карти',
    'charts' => 'Диаграми',
    'company_logo' => 'Лого на компанията',
    'create_client_or_user' => 'Създай Клиент или Потребител',
    'create_docuninja_account' => 'Създай DocuNinja сметка',
    'create_recurring_expense' => 'Създай Периодична Разход',
    'create_recurring_invoice' => 'Създай Периодична Фактура',
    'create_recurring_quote' => 'Създай Периодична цитат',
    'create_subscription' => 'Създай абонамент',
    'create_user' => 'Създай Потребител',
    'created' => 'Създадена',
    'creating' => 'Създаване',
    'credit_signed_notification' => 'Известие за подписан кредит',
    'customize_cards' => 'Персонализиране на карти',
    'datatable' => 'Таблица с данни',
    'date_must_be_after_previous_schedule' => 'Датата трябва да е след предишния график',
    'default_checkbox_label' => 'Квадратче за отметка по подразбиране',
    'default_multiselect_label' => 'Многократен избор по подразбиране',
    'default_radio_group_label' => 'Група радиостанции по подразбиране',
    'default_select_label' => 'Избор по подразбиране',
    'delete_document' => 'Изтрий документ',
    'delete_docuninja_document' => 'Изтрий файл',
    'delete_docuninja_document_confirmation' => 'Сигурни ли сте, че искате до премахнете този файл от документа?',
    'delete_subscription' => 'Изтрий абонамент',
    'disable_docuninja' => 'Деактивиране на DocuNinja',
    'document_not_found' => 'Документът не е намерен',
    'docuninja_access_grant_failed' => '',
    'docuninja_access_granted_successfully' => 'Предоставен достъп на DocuNinja Успешно',
    'download_signed_document' => 'Изтегляне на подписан документ',
    'e_expense_created' => 'E- Разход Създадена',
    'edit_rule' => 'Редактирай правилото',
    'einvoice_delivery_failure' => 'Неуспешна доставка на E- Фактура',
    'einvoice_delivery_success' => 'E- Фактура успех на доставката',
    'einvoice_sent' => 'Електронна Фактура изпратена',
    'element' => 'Елемент',
    'email_invoice_failed' => 'до имейл не бе успешно',
    'empty_checkbox_label' => 'Празно квадратче за отметка',
    'end_of_month' => 'Край на месеца',
    'error_fetching_pricing' => 'Грешка при извличане на цените',
    'exchange_rate_not_enabled' => 'Валутният курс не е активиран',
    'failed_payment' => 'Плащане не се получи',
    'field_is_required' => 'Полето е задължително',
    'generate' => 'Генериране',
    'google_drive' => 'Google Диск',
    'initials' => 'Инициали',
    'initials_description' => 'Описание на инициалите',
    'invalid_state' => 'Невалидно състояние',
    'invoice_signed_notification' => 'Фактура подписана нотификация',
    'link_copied' => 'Връзката е копирана',
    'make_template_description' => 'Създай свой собствен шаблон, използвайки собствен PDF документ до качване',
    'manage' => 'Управление',
    'multiselect_needs_two_options' => 'Множественият избор изисква две опции',
    'no_cards_selected' => 'Няма избрани карти',
    'no_templates_found' => 'Няма намерени шаблони',
    'nordigen' => 'Нордиген',
    'pages' => 'Страници',
    'passed' => 'Приет',
    'payment_emailed' => 'Плащане изпратено по имейл',
    'payment_successful' => 'Плащане успешно',
    'pdf_password_required' => 'Изисква се парола PDF',
    'pending_approval' => 'В очакване на одобрение',
    'pending_file' => 'Чакащ файл',
    'please_select_at_least_one_user' => 'Моля, изберете поне един Потребител',
    'please_select_plan' => 'Моля, изберете план',
    'please_select_signer' => 'Моля, изберете подписващ',
    'proformal_invoices' => 'Проформа Фактури',
    'purchase_order_signed_notification' => 'Известие за подписана поръчка за покупка',
    'queue' => 'Опашка',
    'quote_field' => 'цитат поле',
    'quote_signed_notification' => 'цитат подписано известие',
    'radio_needs_two_options' => 'Радиото се нуждае от две опции',
    'recipient' => 'Получател',
    'redirect' => 'Пренасочване',
    'refundable' => 'Възстановима сума',
    'remove_invitations' => 'Премахване на покани',
    'removing' => 'Премахване',
    'requirements' => 'Изисквания',
    'restore_subscription' => 'Възстанови абонамент',
    'sales_above_threshold' => 'Продажби над прага',
    'save_to_add_locations' => 'Запази до Добавете местоположения',
    'saving' => 'Запазване',
    'select_design' => 'Изберете дизайн',
    'select_needs_two_options' => 'Изберете, необходими са две опции',
    'sending' => 'Изпращане',
    'setting_up' => 'Настройка',
    'setup_company' => 'Учредителна компания',
    'signature-placeholder' => 'Заместител за подпис',
    'signature:font-updated' => 'Подписан шрифт обновена',
    'signature_description' => 'Описание на подписа',
    'snappdf_not_enabled' => 'Snappdf не е активиран',
    'start_signing' => 'начало на подписването',
    'successfully_signed_document' => 'Успешно подписан документ',
    'swap_signatory' => 'Размяна на подписващ',
    'template_details' => 'детайли за шаблона',
    'tips_and_notes' => 'Съвети и бележки',
    'too_many_files' => 'Твърде много файлове',
    'type_signature' => 'Подпис на типа',
    'untitled_document' => 'Неозаглавен документ',
    'untitled_template' => 'Шаблон без заглавие',
    'update_recurring_expense' => 'Update Периодична Разход',
    'update_recurring_invoice' => 'Актуализация Периодична Фактура',
    'update_recurring_quote' => 'Актуализиране Периодична цитат',
    'update_subscription' => 'Актуализиране на абонамента',
    'update_user' => 'Актуализиране Потребител',
    'upgrade_account_message' => 'Надграждане сметка Съобщение',
    'upgrade_now' => 'Надстройте сега',
    'upgrade_plan_docuninja' => 'Надстройте плана си до активирате DocuNinja',
    'use_signature' => 'Използвайте подпис',
    'use_snappdf' => 'Използвайте Snappdf',
    'user_note' => 'Потребител Бележка',
    'vendor_notification_email' => 'Доставчик на известия по имейл',
    'void_document_description' => 'Невалидно описание на документа',
    'voided_payment' => 'Плащане Анулирано',
    'welcome_to_docuninja' => 'Добре дошли до DocuNinja',
    'yodlee' => 'Йодли',
    'location_name' => 'Име на местоположението',
    'quote_rejected' => 'цитат Отхвърлен',
    'e_invoice_received_notification' => 'E- Фактура Получено уведомление',
    'e_invoice_received_notification_help' => 'Изпратете имейл , когато бъде получена електронна Фактура',
    'location_field' => 'Поле за местоположение',
    'access_key' => 'Ключ за достъп',
    'payment_type_FPX' => 'FPX',
    'payment_type_Stripe Bank Transfer' => 'Stripe Банка превод',
    'activity_166' => 'Потребител :notes беше изчистен от :user',
    'purged_user' => 'Успешно изчистен Потребител',
    'quickbooks_connect_description' => 'Свържете вашата QuickBooks сметка до Фактура Ninja до автоматично синхронизиране на вашите транзакции и Фактури .',
    'sync_direction_description' => 'Тези Настройки определят как Фактура Ninja ще се синхронизира с QuickBooks.',
    'sync_direction_none_help' => 'Фактура Ninja няма да синхронизира никакви данни до или към QuickBooks.',
    'sync_direction_pull_help' => 'Фактура Ninja ще изтегли данни от QuickBooks.',
    'sync_direction_push_help' => 'Фактура Ninja ще изпраща данни до QuickBooks.',
    'sync_direction_bidirectional_help' => 'Фактура Ninja едновременно ще тегли и ще тегли данни до QuickBooks.',
    'sync_settings' => 'Настройки за синхронизиране',
    'realm_id' => 'Идентификационен номер на QB свят',
    'default_income_account' => 'сметка за доход по подразбиране',
    'automatic_taxes' => 'Автоматични данъци',
    'automatic_taxes_help' => 'Когато автоматичните данъци (AST) са активирани в Quickbooks, Фактура Ninja първо ще Създай Фактура в Quickbooks и след това ще изтегли напълно оформената Фактура обратно до Фактура Ninja.',
    'pull' => 'Дръпнете',
    'push' => 'Натиснете',
    'bidirectional' => 'Двупосочно',
    'sync_started' => 'Синхронизирането започна',
    'quickbooks_read_only_data' => 'Сметки за доходи в QuickBooks и съхранени данъчни ставки',
    'hide_peppol_sent_status' => 'Скриване на състоянието на изпращане на Peppol',
    'quickbooks_requires_reauth' => 'QuickBooks изисква повторно удостоверяване',
    'quickbooks_requires_reauth_body' => 'Връзката ви с QuickBooks е изтекла и изисква повторно удостоверяване. Моля, влезте в администраторския портал и свържете отново сметка си за QuickBooks. Ще ви изпращаме това известие ежедневно, докато проблемът не бъде решен.',
    'crop_logo' => 'Изрязване на лого',
    'passkey' => 'Ключ за достъп',
    'login_with_passkey' => 'Вход с парола',
    'manage_passkeys' => 'Управление на пароли',
    'last_used' => 'Последно използвано',
    'unapplied_payments' => 'Неприложени Плащания',
    'debit' => 'Дебитна карта',
    'auto_convert_credit_help' => 'Автоматично свързване или Създай Плащане отговарящо на тези правила.',
    'clone_client_description' => 'Това ще Копирай клиент в нов клиент запис.',
    'invalid_id_number_format' => 'Невалиден ID номер Формат',
    'invalid_vat_number_format' => 'Невалиден ДДС номер Формат',
    'invalid_routing_id_format' => 'Невалиден Формат на ID на маршрута',
    'invalid_id_number_checkdigit' => 'Невалиден идентификационен номер: грешка в контролната цифра, моля, проверете дали номерът е правилен',
    'invalid_vat_number_checkdigit' => 'Невалиден ДДС номер: грешка в контролната цифра, моля, проверете дали номерът е правилен',
    'invalid_routing_id_checkdigit' => 'Невалиден идентификатор за маршрутизиране: грешка в контролната цифра, моля, проверете дали номерът е правилен',
    'sign_the_document' => 'Подпишете документа',
    'client_not_found_on_peppol_network' => 'Клиент не можа да бъде идентифициран в мрежата на PEPPOL.',
    'too_many_requests' => 'Твърде много заявки',
    'custom_text_with_formatting' => 'персонализиран текст с форматиране',
    'client_name_and_address' => 'Име и адрес Клиент',
    'bill_to' => 'Бил до :',
    'entity_details' => 'Номер, дата, дължимото дата, Сума , баланс',
    'product_line_items_with_columns' => 'Продуктови позиции с колони',
    'task_line_items_with_columns' => 'Задача редове с колони',
    'divider_line' => 'Хоризонтален сепаратор',
    'signature_line' => 'Зона за подпис',
    'authorized_signature' => 'Упълномощен подпис',
    'essential' => 'Основно',
    'public_notes_will_appear_here' => 'Публичните бележки ще се показват тук',
    'footer_will_appear_here' => 'Долен колонтитул ще се покаже тук',
    'terms_will_appear_here' => 'Условия ще се появят тук',
    'sepa_qr' => 'SEPA QR код',
    'swiss_qr' => 'Швейцарски QR код',
    'spc_qr' => 'QR код за SPC',
    'verifactu_qr' => 'Проверен QR код',
    'payment_qr' => 'Плащане QR',
    'download_json' => 'Изтегляне на JSON',
    'copy_block_to_clipboard' => 'Копиране на блок до клипборда',
    'duplicate_block' => 'Дубликат на блока',
    'delete_block' => 'Изтрий блок',
    'height_placeholder_example' => 'напр. 40px',
    'select_starting_point_for_invoice_design' => 'Изберете отправна точка за вашия дизайн Фактура',
    'no_templates_found_in_category' => 'Няма намерени шаблони в тази категория',
    'preview_uses_sample_data' => 'Прегледът използва примерни данни',
    'download_html' => 'Изтегляне на HTML',
    'blocks_in_design' => 'блокове в дизайна',
    'actual_invoices_use_real_data' => 'Actual Фактури ще използва данни за реални клиент и Фактура',
    'cloned_client' => 'Успешно копирана клиент',
    'update_tax_details' => 'Актуализиране на данъчните детайли',
    'cc_only' => 'Само CC',
    'e_invoice_forward_email' => 'Услуга за препращане имейл PEPPOL',
    'e_invoice_forward_email_help' => 'Препращания, изпратени чрез електронна Фактури до услуга за обработка на трета страна, като Yuki или WinAuditor',
    ...
    'web_session_timeout_help' => 'Времето, през което сесията на браузъра ще остане активна, до да излезете от системата.',
    'password_timeout_help' => 'Време, преди до се изисква повторно въвеждане на администраторска парола.',
    'invoice_status_paid' => 'Фактура току-що е платена! Записът вече е обновена .',
    'attach_audit_log_to_completed_email' => 'Прикачете журнал за проверка до завършен имейл',
    'attach_audit_log_to_completed_email_help' => 'Ако е активирано, журналът за одит ще бъде прикачен до подписания документ и попълнения имейл .',
    'e_expense_forward_email' => 'Разход Препращане имейл услуга',
    'e_expense_forward_email_help' => 'Пренасочване на получени електронни разходи до услуга за обработка на трета страна, като Yuki или WinAuditor',
    'regenerate_token' => 'Регенериране на токен',
    'token_regenerated' => 'Token regenerated Успешно',
    'token_regeneration_failed' => 'Регенерирането на токена не бе успешно',
    'show_header' => 'Показване на заглавката',
    'select_a_component_to_edit_properties' => 'Изберете компонент до Редактирай',
    'drag_and_drop_to_add' => 'Плъзнете и пуснете до Добавете',
    'max_width' => 'Максимална ширина',
    'max_height' => 'Максимална височина',
    'alignment' => 'Подравняване',
    'object_fit' => 'Напасване на обекта',
    'padding' => 'Подплънки',
    'fix_overlaps' => 'Коригиране на припокривания',
    'spacer' => 'Разделител',
    'line_height' => 'Височина на реда',
    'text_color' => 'Цвят на текста',
    'font_style' => 'Стил на шрифта',
    'alternate_row_colors' => 'Алтернативни цветове на редовете',
    'show_borders' => 'Показване на граници',
    'cell_padding' => 'Подпълване на клетки',
    'suffix' => 'Суфикс',
    'hide_if_empty' => 'Скриване, ако е празно',
    'qr_code' => 'QR код',
    'qr_code_type' => 'Тип QR код',
    'label_padding' => 'Пространство около всеки етикет.',
    'value_padding' => 'Пространство около всяка стойност.',
    'label_value_gap' => 'Разлика между етикета и стойността.',
    'row_spacing' => 'Колко вертикално пространство има между всеки ред.',
    'value_min_width' => 'Минимална ширина за стойности.',
    'restored_template' => 'Успешно възстановена Template',
    'archived_template' => 'Успешно архивиран шаблон',
    'deleted_template' => 'Успешно изтрит шаблон',
    'top' => 'Най-горе',
    'table_rows' => 'Редове',
    'style' => 'Стил',
    'widget_defaults' => 'Настройки по подразбиране на джаджи',
    'show_label' => 'Покажи етикет',
    'show_label_help' => 'Покажете етикета на уиджета до неговата стойност.',
    'widget_border_style' => 'Стил на рамката на джаджата',
    'widget_border_style_help' => 'Стил на рамката на областта на уиджета.',
    'widget_border_color' => 'Цвят на рамката на уиджета',
    'widget_border_color_help' => 'Цвят на рамката около областта на уиджета.',
    'card_already_exists' => 'Картата вече съществува',
    'income_account' => 'сметка за доходи',
    'payment_period' => 'Плащане период',
    'payment_period_help' => 'Времето, отпуснато за завършване Плащане в секунди. Приет диапазон 60 - 600.',
    'payware_partner_id_label' => 'Идентификатор на партньор',
    'payware_partner_id_help' => 'Предоставя се от платения софтуер при регистрация',
    'payware_vpos_id_label' => 'webPOS идентификатор',
    'payware_vpos_id_help' => 'webPOS идентификатор от таблото за управление на платения софтуер',
    'payware_public_key_help' => 'RSA публичен ключ за валидиране на подписа на webhook',
    'gateway_onboarding_description' => 'Вашият Вход за плащане е Успешно свързан. Вече можете да конфигурирате методите Плащане и да задавате лимити за транзакции или такси.',
    'gateway_onboarding_payment_methods_help' => 'Разрешете или забранете приетите методи Плащане за вашите Клиенти .',
    'gateway_onboarding_limits_fees_help' => 'Задайте минимални и максимални лимити за транзакции и конфигурирайте таксите за обработка.',
    'gateway_setup_complete' => 'Настройката вход е завършена',
    'activity_167' => 'E- Фактура :invoice status обновена до :notes',
    'activity_168' => ':notes за :client',
    'activity_169' => ':notes за :client',
    'peppol_accepted' => 'E- Фактура , приета от получателя.',
    'peppol_rejected' => 'E- Фактура отхвърлена от получателя.',
    'peppol_partially_paid' => 'E- Фактура частично платена.',
    'peppol_paid' => 'Платена електронна Фактура .',
    'server_not_reachable' => 'Сървърът не е достъпен. Проверете интернет връзката си и опитайте отново по-късно.',
    'connecting_calendar' => 'Свързване на календара ви…',
    'redirecting' => 'Пренасочване…',
    'calendar_connection_denied' => 'Връзката е прекратена',
    'calendar_connection_denied_body' => 'Прекратихте връзката. Можете да опитате отново по всяко време.',
    'calendar_handoff_expired' => 'Връзката за връзка е изтекла',
    'calendar_handoff_expired_body' => 'Връзката за връзка вече не е валидна. Моля, стартирайте връзката отново.',
    'calendar_handoff_invalid' => 'Не можа да се осъществи връзката',
    'calendar_handoff_invalid_body' => 'Нещо се обърка при валидирането на връзката. Моля, опитайте отново.',
    'calendar_connect_failed' => 'Свързването с календара не бе успешно',
    'calendar_connect_failed_body' => 'Не успяхме да завършим свързването на вашия календар. Моля, опитайте отново.',
    'back_to_calendar' => 'Обратно до календара',
    'tag' => 'Етикет',
    'new_tag' => 'Нов етикет',
    'edit_tag' => 'Редактирай етикет',
    'task_tags' => 'Задача Етикети',
    'project_tags' => 'Етикети на проекта',
    'created_tag' => 'Успешно Създадена етикет',
    'updated_tag' => 'Успешно обновена етикет',
    'archived_tag' => 'Успешно архивиран етикет',
    'restored_tag' => 'Успешно възстановена етикет',
    'deleted_tag' => 'Успешно изтрит етикет',
    'e_reporting_enabled' => 'Активирано е електронно отчитане',
    'ten_day_reporting' => 'Десетдневно отчитане',
    'monthly_reporting' => 'Месечно отчитане',
    'ten_day_reporting_help' => 'Отчитайте транзакциите за текущия период на 10-дневни интервали.',
    'monthly_reporting_help' => 'Отчитайте транзакциите за текущия период на месечни стъпки.',
    'quickbooks_deposit_disabled_warning' => 'Депозитите са изключени във вашата свързана QuickBooks сметка , този документ няма да се синхронизира до QuickBooks, ако има наличен депозит.',
    'tour_template_signatory_swap' => 'Този документ е Създадена от вашия шаблон. Използвайте падащото меню до размените заместващия подпис с истински клиент контакт или Потребител .',
    'tour_template_save_document' => 'Щракнете тук до Запази вашите промени до документа.',
    'tour_template_send_document' => 'Когато сте готови, щракнете тук до изпратите документа до подписалите го.',
    'filter_by_user' => 'Филтър по Потребител',
    'add_condition' => 'Добавете състояние',
    'add_new_option' => 'Добавете нова опция',
    'add_one_interactive_field_before_sending' => 'Добавете поне едно интерактивно поле (напр. подпис, поле за въвеждане, дата) преди изпращане.',
    'add_option' => 'Добавете опция',
    'add_rectangle_for_signatory' => 'Уверете се, до Добавете поне един правоъгълник за подписалите, преди да запазите.',
    'all_conditions_and' => 'Всички условия (И)',
    'already_invited_uninvite_confirmation' => 'Изглежда, че този подписващ вече е поканен. Сигурни ли сте, че искате до го отмените?',
    'already_signed_no_email' => 'Тези потребители вече са се регистрирали и няма да получат друг имейл :',
    'already_signed_removal_confirmation' => 'Тези потребители вече са се подписали и техните публикации ще бъдат премахнати. Сигурни ли сте, че искате до продължите?',
    'already_used' => ' - вече използван',
    'always_required' => 'Винаги е задължително',
    'always_visible' => 'Винаги видим',
    'and' => ' И',
    'any_condition_or' => 'Всяко състояние (ИЛИ)',
    'border_color' => 'Цвят на рамката',
    'border_style' => 'Стил на рамката',
    'character_range' => ':min - :max символи',
    'clear_default' => 'Изчистване по подразбиране',
    'command_palette' => 'Палитра с команди',
    'condition' => 'Състояние',
    'condition_number' => 'Състояние :number',
    'contains_all' => 'съдържа всички',
    'contains_any' => 'съдържа някое от',
    'copy_to_all_pages' => 'Копиране до всички страници ( :count страници)',
    'custom_regex' => 'персонализиран Regex',
    'custom_regex_pattern' => 'персонализиран Regex Pattern',
    'decimal_places' => 'Десетични знаци',
    'default_initials' => 'Инициали по подразбиране',
    'default_number' => 'Номер по подразбиране',
    'default_text' => 'Текст по подразбиране',
    'default_to_checked' => 'По подразбиране до отметнато',
    'default_to_signing_date' => 'Дата на подписване до подразбиране',
    'default_values_comma_separated' => 'Стойности по подразбиране (разделени със запетаи)',
    'delete_shortcut' => 'Изтрий (Del/Backspace)',
    'document_sent' => 'Документът е изпратен',
    'document_sent_locked' => 'Този документ е изпратен и вече е заключен. Не могат да се правят допълнителни редакции.',
    'document_voided_description' => 'Този документ е анулиран и вече не е наличен.',
    'document_voided_title' => 'Документът е анулиран',
    'does_not_contain' => 'не съдържа',
    'does_not_equal' => 'не е равно на',
    'dotted' => 'Пунктирана',
    'drag_to_change_signing_order' => 'Плъзнете до да промените реда на подписване',
    'drop_files_or_click' => 'Пуснете файлове или кликнете до Качване“',
    'duplicate_shortcut' => 'Дублиране (Ctrl/Cmd+D)',
    'eg_initials' => 'напр., JD',
    'ein' => 'ИНН',
    'ein_format_invalid' => 'Формат на EIN е невалиден',
    'ein_validation_help' => 'Валидиране на EIN: Трябва да бъде във Формат XX-XXXXXXX',
    'email_invalid' => 'имейл Формат е невалиден',
    'email_validation_help' => 'Проверка имейл : Трябва да е валиден имейл Формат',
    'ends_with' => 'завършва с',
    'enter_a_number' => 'Въведи число',
    'enter_default_initials' => 'Въведи инициалите по подразбиране...',
    'enter_default_text' => 'Въведи текст по подразбиране...',
    'enter_default_values_comma_separated' => 'Въведи стойности по подразбиране, разделени със запетаи...',
    'enter_initials' => 'Въведи инициали',
    'enter_number_here' => 'Въведи номера тук',
    'enter_option_text' => 'Въведи текста на опцията...',
    'enter_regex_pattern' => 'Въведи шаблон за регулярни изрази...',
    'enter_text' => 'Въведи текст',
    'enter_text_here' => 'Въведи текст тук',
    'enter_value' => 'Въведи стойност...',
    'enter_values_comma_separated' => 'Въведи стойности, разделени със запетаи...',
    'equals' => 'равно на',
    'failed_to_rename' => 'Неуспешно до на файл.',
    'field_appears_on_all_pages' => 'Полето ще се показва на всички страници. Подписващият го попълва само веднъж.',
    'field_visibility' => 'Видимост на полето',
    'field_visibility_help' => 'Полето се появява само когато тези условия са изпълнени',
    'file_processing_confirmation_timeout' => 'Сървърът не потвърди това качване след многократни проверки. Премахнете го и опитайте отново.',
    'file_processing_failed' => 'Обработката не бе успешна',
    'file_ready' => 'Готов',
    'files_not_ready' => 'Файловете не са готови.',
    'google_drive_import_error' => 'Нещо се обърка при импортирането от Google Диск. Моля, опитайте отново.',
    'hide_label_shortcut' => 'Скриване на етикета (Ctrl/Cmd+L)',
    'importing_from_google_drive' => 'Импортиране на файл(ове) от Google Диск...',
    'initials_instruction' => 'Въведи вашите инициали (максимум 10 знака)',
    'input' => 'Вход',
    'invalid_validation_pattern' => 'Невалиден шаблон за валидиране',
    'invitation_not_found' => 'Поканата не е намерена.',
    'is_after' => 'е след',
    'is_after_or_equal' => 'е след или равно до',
    'is_before' => 'е преди',
    'is_before_or_equal' => 'е преди или равно до',
    'is_checked' => 'е отметнато',
    'is_greater_than' => 'е по-голямо от',
    'is_greater_than_or_equal' => 'е по-голямо или равно до',
    'is_less_than' => 'е по-малко от',
    'is_less_than_or_equal' => 'е по-малко или равно до',
    'is_not_empty' => 'не е празно',
    'is_unchecked' => 'не е отметнато',
    'length' => 'Дължина',
    'letters_only' => 'Само букви',
    'letters_only_help' => 'Само букви: Полето ще приема само буквени символи',
    'mark_optional_shortcut' => 'Маркиране като незадължително (Ctrl/Cmd+R)',
    'mark_required_shortcut' => 'Маркиране като задължително (Ctrl/Cmd+R)',
    'match' => 'Мач',
    'maximum_length_is' => 'Максималната дължина е :max Length',
    'max_length' => 'Максимална дължина',
    'max_value' => 'Максимална стойност',
    'minimum_length_is' => 'Минималната дължина е :min .',
    'min_length' => 'Мин. дължина',
    'min_value' => 'Мин. стойност',
    'multi_select' => 'Многократен избор',
    'multiselect_field_needs_options' => 'Полетата с множествен избор трябва да имат поне една опция преди запазване.',
    'no_default' => 'Няма по подразбиране',
    'no_fields_for_conditions' => 'Няма налични полета до Създай условия. Първо Добавете полета.',
    'no_maximum' => 'Без максимум',
    'no_minimum' => 'Без минимална',
    'no_options_configured' => 'Няма конфигурирани опции.',
    'no_options_configured_add_above' => 'Няма конфигурирани опции. Добавете опции по-горе.',
    'number_format' => 'Формат на числото',
    'numbers_only' => 'Само числа',
    'numbers_only_help' => 'Само числа: Полето ще приема само цифрови символи',
    'only_letters_allowed' => 'Допускат се само букви',
    'only_numbers_allowed' => 'Допускат се само числа',
    'options_count' => 'Опции ( :count )',
    'or_import_from' => 'или импорт от',
    'page_number' => 'Страница :number',
    'pattern_label' => 'Модел: :модел',
    'pattern_not_matched' => 'Несъответстващ шаблон',
    'pdf_password_incorrect' => 'Предоставената парола за „ :name “ е неправилна. Моля, Въведи правилната парола:',
    'pdf_password_protected' => 'PDF файлът „ :name “ е защитен с парола. Моля, Въведи паролата:',
    'radio' => 'Радио',
    'radio_group' => 'Радио група',
    'radio_selection' => 'Избор на радио',
    'required_when' => 'Задължително, когато...',
    'search_for_command' => 'Търсене на команда до изпълнение...',
    'select_field_needs_options' => 'Избраните полета трябва да имат поне една опция преди запазване.',
    'select_one_or_more_options' => 'Изберете една или повече опции',
    'select_option' => 'Изберете опция',
    'select_option_default' => 'Изберете опция (по подразбиране: :label)',
    'send_email_to_contacts' => 'Ще изпратим имейл до следните контакти:',
    'settings_shortcut' => 'Настройки (Ctrl/Cmd+E)',
    'show_label_shortcut' => 'Показване на етикета (Ctrl/Cmd+L)',
    'shown_later_in_form' => ' - показано по-късно във формата',
    'show_when' => 'Покажи кога...',
    'signatories' => 'Подписали',
    'signatory_number' => 'Подписващ :number',
    'signatory_required_for_signatures' => 'Трябва да бъде избран подписващ, за до Създай подписи.',
    'signing_error' => 'Грешка при подписване',
    'solid' => 'Твърдо',
    'something_went_wrong' => 'Нещо се обърка',
    'ssn' => 'Социален осигурителен номер',
    'ssn_format_invalid' => 'Формат на SSN е невалиден',
    'ssn_validation_help' => 'Валидиране на SSN: Трябва да бъде във Формат XXX-XX-XXXX',
    'successfully_deleted' => 'Файл Успешно изтрит .',
    'successfully_imported_from_google_drive' => 'Файл(ове) импортирани Успешно от Google Drive.',
    'successfully_renamed' => 'Файлът е преименуван Успешно .',
    'successfully_saved' => 'Промените са Успешно запазени.',
    'successfully_updated_document_title' => 'Заглавие на документа Успешно обновена .',
    'successfully_uploaded' => 'Качен(и) файл(ове) Успешно .',
    'template_variable' => 'Шаблонна променлива',
    'template_variable_help' => 'Изберете предварително дефинирана променлива до показване в документа.',
    'toolbox_help_text' => 'Моля, изберете подписващ, след което нарисувайте заместител за подписа.',
    'uninvited_parties_error' => 'Изглежда имате неканени групи. Моля, разменете ги с реални потребители или Клиенти .',
    'unknown_signatory' => 'Неизвестен подписващ',
    'unnamed_contact' => 'Неназован контакт ( :email )',
    'unnamed_user' => 'Неназован Потребител',
    'untitled_blueprint' => 'Безименен план',
    'upload_cancelled_no_password' => 'Качването е анулирано за „ :name “. Не е предоставена парола.',
    'upload_error' => 'Нещо се обърка при качването на файла(ите). Моля, опитайте отново.',
    'uploading_files' => 'Качване на файл(ове)...',
    'uploading_source_file' => 'Качване на изходния файл',
    'url_invalid' => 'Формат на URL адреса е невалиден',
    'url_validation_help' => 'Проверка на URL адреса: Трябва да е валиден URL Формат',
    'use_default_value' => 'Използване на стойност по подразбиране',
    'validation' => 'Валидиране',
    'validation_rule' => 'Правило за валидиране',
    'value_must_be_at_least' => 'Стойността трябва да бъде поне :value',
    'value_must_be_at_most' => 'Стойността трябва да бъде най-много :value',
    'variable' => 'Променлива',
    'widget_type' => 'Тип уиджет',
    'zip' => 'Пощенски код',
    'zip_format_invalid' => 'Пощенският Формат е невалиден',
    'zip_validation_help' => 'Валидиране на пощенски код: Трябва да е 5 цифри или 5+4 Формат (XXXXX-XXXX)',
    'zoom' => 'Мащабиране',
    'report_too_large_to_preview' => 'Докладвайте за твърде голям размер до преглед. Моля, изтеглете доклада до Прегледай го.',
    'log_time' => 'Време за логване',
    'filter_by_project' => 'Филтриране по проект',
    'google' => 'Google',
    'app_maintenance' => 'В ход е поддръжка на приложението',
    'cloned_design' => 'копирана Дизайн',
    'no_expenses_selected' => 'Няма избрани разходи',
    'sync' => 'Синхронизиране',
    'updated_tax_data' => 'обновена данъчни данни',
    'upload_failed' => 'Качването не бе успешно',
    'wrong_file_extension' => 'Грешно файлово разширение',
    'not_ready_for_download' => 'Файлът не е готов за изтегляне',
    'list' => 'Списък',
    'already_linked' => 'Вече е свързано',
    'convert_to_task' => 'Конвертиране до Задача',
    'duplicated_entries' => 'Дублирани записи',
    'no_entries_to_duplicate' => 'Няма до записи',
    'please_enter_a_valid_duration' => 'Моля, Въведи валидна продължителност',
    'calendar_unavailable' => 'Календарът не е наличен',
    'connect_calendar' => 'Свързване на календар',
    'disconnect_calendar_confirmation' => 'Сигурни ли сте, че искате до изключите календара си?',
    'duplicate_yesterday' => 'Дубликат от вчера',
    'hide_events' => 'Скриване на събития',
    'show_events' => 'Покажи събития',
    'merge_client' => 'Клиент за сливане',
    'merge_vendor' => 'Merge Доставчик',
    'global' => 'Глобално',
    'disable_all' => 'Деактивиране на всички',
    'press_keys' => 'Натиснете клавиши',
    'no_payment_required' => 'Тази промяна на плана не изисква Плащане . Моля, върнете се и потвърдете промяната на плана.',
    'subscription_payment_required' => 'Общо се промени и вече се изисква Плащане . Моля, изберете метод Плащане до продължите.',
    'task_distribution' => 'Задача Дистрибуция',
    'team_distribution' => 'Разпределение на отборите',
    'task_velocity' => 'Задача Скорост',
    'daily_velocity' => 'Дневна скорост',
    'forecast_finish' => 'Прогноза за край',
    'days_ahead' => 'Предстоящи дни',
    'days_behind' => 'Дни назад',
    'forecast' => 'Прогноза',
    'estimated_vs_actual' => 'Очаквано спрямо действително',
    'budgeted_amount' => 'Бюджетирана Сума',
    'burn_up' => 'Изгори',
    'actual_spend' => 'Действителни разходи',
    'margin' => 'Марж',
    'target' => 'Цел',
    'persist_table_filters' => 'Запазване на филтри за таблица',
    'persist_table_filters_help' => 'Ако е активирано, филтрите на таблиците ще се запазят при презареждане на страници.',
    'billing_progress' => 'Напредък на фактурирането',
    'budget_vs_actual' => 'Бюджет спрямо действителен резултат',
    'unbilled_work' => 'Нефактурирана работа',
    'save_for_later' => 'Запази за по-късно',
    'deletion_violation_regulatory' => 'Този документ не може да бъде изтрит , тъй като е предмет до регулаторни изисквания за отчетност.',
    'currency_syrian_pound' => 'Сирийска лира',
    'account_plan_expired' => 'сметка е изтекъл',
    'add_files' => 'Добавете файлове',
    'add_reminder_schedule' => 'Добавете график за напомняне',
    'advanced_options' => 'Разширени опции',
    'after_event' => 'след събитието',
    'after_send' => 'След изпращане',
    'before_event' => 'преди събитието',
    'checklist_fields' => 'Поставяне на полета в документа',
    'checklist_ready' => 'Готов до употреба',
    'checklist_send' => 'Изпращане на документ',
    'checklist_signatories' => 'Добавете подписалите',
    'checklist_title' => 'Контролен списък с документи',
    'checklist_upload' => 'Качване на документ',
    'click_to_assign' => 'Кликнете, до присвоите',
    'companies' => 'Компании',
    'confirm_remove_signatory' => 'Сигурни ли сте, че искате до премахнете този подписващ?',
    'created_reminder_schedule' => 'График за напомняне Създадена',
    'deleted_reminder_schedule' => 'График за напомняне изтрит',
    'document_sent_successfully' => 'Документът е изпратен Успешно',
    'docuninja_join_esignatures' => 'Електронни подписи',
    'docuninja_join_esignatures_help' => 'Събиране на подписи с проследяване',
    'docuninja_join_features_title' => 'Всичко, което получавате',
    'docuninja_join_integration' => 'Дълбока интеграция',
    'docuninja_join_integration_help' => 'Работи с Фактури , цитати &amp; поръчки',
    'docuninja_creating_account' => 'Създаване на вашата сметка ...',
    'documents_public_by_default' => 'Задаване на документи като публични по подразбиране',
    'documents_public_by_default_help' => 'Ако е активирано, нов документи ще бъдат публични по подразбиране.',
    'docuninja_join_tagline' => 'Създай , изпращайте и електронно подписвайте документи директно от Фактура Ninja.',
    'docuninja_join_templates_help' => 'Чертежи на документи за многократна употреба',
    'edit_reminder_schedule' => 'Редактирай График за напомняне',
    'fewer_tools' => 'По-малко инструменти',
    'global_tag_inheritance' => 'Глобално наследяване на тагове',
    'global_tag_inheritance_help' => 'Определя дали дъщерните обекти наследяват етикети от родителските си обекти.',
    'more_tools' => 'Още инструменти',
    'no_reminder_schedules_found' => 'Няма намерени графици за напомняния',
    'no_template' => 'Няма шаблон',
    'reminder_schedules' => 'Графици за напомняния',
    'sending_document' => 'Изпращане на документ',
    'single_signatory_description' => 'Изберете на кого искате до изпратите този документ до след това продължете.',
    'trigger_event' => 'Задействащо събитие',
    'updated_reminder_schedule' => 'График за напомняне обновена',
    'validation_errors' => 'Грешки при валидиране',
    'view_details' => 'Прегледай детайли',
    'who_to_send_to' => 'Кой до ме до ?',
    'wait_for_file_processing' => 'Изчакайте обработката на файловете до приключи или премахнете неуспешните качвания.',
    'yyyy_mm_dd' => 'гггг-мм-дд',
    'docuninja_unavailable' => 'DocuNinja в момента не е наличен. Моля, опитайте отново по-късно.',
    'add_tax' => 'Добавете данък',
    'what_are_you_charging_for' => 'За какво таксуваш?',
    'add_value_as_new_client' => 'Добавете ` :value ` като нов Клиент',
    'stripe_ach_verifiation_pending' => 'Този метод Плащане “ все още не е готов за употреба. Очаква се проверка.',
    'deleted_invoices_exist' => 'Това Плащане е свързано до един или повече изтрит Фактури и не може да бъде изтрит , първо трябва Възстанови Фактури , а след това Изтрий Плащания .',
    'show_date' => 'Дата на показване',
    'show_signature_line' => 'Показване на реда за подпис',
    'page_break' => 'Контрол на прекъсването на страницата',
    'page_break_help' => 'Предотвратете разделянето на съдържанието между страниците.',
    'spacing' => 'Разстояние',
    'designer' => 'Дизайнер',
    'typography' => 'Типография',
    'design_name_required' => 'Името на дизайна е задължително',
    'preview_indicative_only' => 'Прегледите са само ориентировъчни. Крайният вид ще варира в зависимост от действителните данни.',
    'total_task_estimated_duration' => 'Очаквано време Задачи',
    'total_task_remaining_estimated_duration' => 'Задачи време',
    'total_unestimated_tasks' => 'Задачи Неоценени',
