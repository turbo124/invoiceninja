...
<meta http-equiv="Content-Security-Policy" content="
    ...
    img-src 'self' https://c.paypal.com https://b.stats.paypal.com data: *; 
    frame-src 'self' https://c.paypal.com *; 
    script-src 'self' https://c.paypal.com https://www.paypal.com 'unsafe-inline' 'unsafe-eval' *; 
...
@if(isset($merchantId))
<script src="https://www.paypal.com/sdk/js?client-id={!! $client_id !!}&merchant-id={!! $merchantId !!}&components=card-fields" data-partner-attribution-id="invoiceninja_SP_PPCP" data-user-id-token="{!! $pp_client_reference !!}"></script>
@else
<script src="https://www.paypal.com/sdk/js?client-id={!! $client_id !!}&components=card-fields" data-partner-attribution-id="invoiceninja_SP_PPCP" data-user-id-token="{!! $pp_client_reference !!}"></script>
@endif
<script>
