...
<ul><li>Flexible business lines of credit and invoice factoring.</li></ul>',
    ...
    'max_file_size_help' => 'Maximum file size (MB) is limited by your post_max_size and upload_max_filesize variables as set in your PHP.INI',
    ...
    'new_ticket_template_id' => 'New ticket auto responder',
    'new_ticket_autoresponder_help' => 'Selecting a template will send an auto response to a client/contact when a new ticket is created',
    'update_ticket_template_id' => 'Updated ticket auto responder',
    ...
    'close_ticket_template_id' => 'Close ticket auto responder',
    'close_ticket_autoresponder_help' => 'Selecting a template will send an auto response to a client/contact when a ticket is closed',
    'default_priority' => 'Default priority',
    'alert_new_ticket' => 'Alert on new ticket',
    'alert_new_ticket_email_help' => 'Comma separated emails to bcc on new ticket.',
    'alert_comment_ticket' => 'Alert on new comment',
    ...
    'alert_ticket_assign_agent' => 'Alert agent when ticket is assigned to them',
    'alert_ticket_assign_agent_notifications' => 'Additional ticket assigned notifications',
    'alert_ticket_assign_agent_help' => 'Comma separated emails to bcc on ticket assignment.',
    'alert_ticket_transfer_agent' => 'Alert agents when a ticket is transferred to/away from them',
    'alert_ticket_transfer_email' => 'Additional ticket transfer notifications',
    'alert_ticket_transfer_email_help' => 'Comma separated emails to bcc on ticket transfer.',
    'alert_ticket_overdue_agent' => 'Alert agent when a ticket is overdue',
