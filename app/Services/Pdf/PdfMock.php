...
class PdfMock
{
    ...
    public function getStubVariables(): array
    {
        ...
        return ['values'
         => [
             ...
             '$purchase_order.tags' => 'Purchase Order Tag',
    ...
    private function mockTranslatedLabels()
    {
        return [
            ...
            '$purchase_order.tags_label' => ctrans('texts.tags'),
            ...
            '$product.tags_label' => ctrans('texts.tags'),
            '$invoice.tags_label' => ctrans('texts.tags'),
            '$company.tags_label' => ctrans('texts.tags'),
            ...
            '$client.tags_label' => ctrans('texts.tags'),
            '$vendor.tags_label' => ctrans('texts.tags'),
            '$credit.tags_label' => ctrans('texts.tags'),
            ...
            '$quote.tags_label' => ctrans('texts.tags'),
            ...
            '$task.tags_label' => ctrans('texts.tags'),
